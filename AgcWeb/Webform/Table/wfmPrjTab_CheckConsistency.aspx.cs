...
namespace AGC.Webform
{
    ...
    /// </summary>
    public partial class wfmPrjTab_CheckConsistency : CommWebPageBase
    {
        /// <summary>
        /// 常量:当前页面名称
        /// </summary>
        ...
        protected void BindGv_PrjTabFld_Sql()
        {
            ...
            string strTabName = clsPrjTabBLEx.GetObjByTabIdEx(vsTabId).TabName;
        ...
        protected void btnGenNewTabInSQL_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                bool strCodeText = false;
                try
                {
                    strCodeText = clsPrjTabBLEx_GeneCode.GenSQLCode4CreateTab(strTabId,
        ...
        public override void InitParentPageInfo()
        {
            ...
            switch (vsParentPage)
            {
                ...
                case "wfmTabCheckResultB_QUDI.aspx":
                    lbReturnPrjTabList.Text = "返回[表检查]";
                    break;
                case "":
                    break;
                default:
