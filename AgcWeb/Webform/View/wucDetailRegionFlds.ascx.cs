...
namespace AGC.Webform
{
    ...
    /// </summary>
    public partial class wucDetailRegionFlds : System.Web.UI.UserControl
    {
        ...
        //    get
        //    {
        //        return long.Parse(hidTabFldId.Value.Trim());
        //    }
        //    set
        //    {
        //        hidTabFldId.Value = value.ToString();
        //    }
        //}
        ...
        public int Width
        {
            get
            {
                if (string.IsNullOrEmpty(txtWidth.Text.Trim())) return 0;
        ...
        public int ColSpan
        {
            get
            {
                if (string.IsNullOrEmpty(txtColSpan.Text.Trim())) return 0;
        ...
        public int SeqNum
        {
            get
            {
                if (string.IsNullOrEmpty(txtSeqNum.Text.Trim()) == true) return 0;
        ...
        protected void ddlDataNodeId_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ddlFldId.SelectedValue = objDataNode_MinDepth.FldId;
            }
            catch (Exception objException)
            {
            ...
            txtLabelCaption.Text = objFieldTab.Caption;
