...
namespace AGC.Webform
{
    ...
    /// </summary>
    public partial class wfmDetailRegionFlds_QUDI2 : CommWebPageBase
    {
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)	///如果本界面是初次被调用，而不是单击按钮事件所调用
			{
                ...
                if (objvViewRegion != null)
                {
                    ...
                    clsViewInfoBLEx.BindDdl_ViewIdByTabIdEx(ddlViewId, clsPubVar.CurrSelPrjId, objvViewRegion.TabId, clsCommonSession.ViewId);
                }
            ...
            try
            {
                wucDetailRegion4Preview1.ShowControl4Regoin(seRegionId, clsPubVar.CurrSelPrjId, vsKeyId4Test, chkInUse.Checked);
                //	3、设置Gv控件的某些列不可见；
		...
		{
			//wucDetailRegionFlds1.TabFldId = pobjDetailRegionFlds.TabFldId;
			
			clsvDetailRegionFldsEN objvDetailRegionFlds =  clsvDetailRegionFldsBL.GetFirstObj_S("RegionId = '" + seRegionId + "' and FldId = " + pobjDetailRegionFlds.FldId);
            wucDetailRegionFlds1.FldId = objvDetailRegionFlds.FldId;
            ...
            wucDetailRegionFlds1.DataPropertyName = objvDetailRegionFlds.DataPropertyName;
		...
		protected void btnOKUpd_Click(object sender, System.EventArgs e)
		{
			...
			switch(strCommandText)
			{
				...
				case "确认添加":
					...
					{
                        clsViewInfoBLEx.SetViewUpdDate(clsCommonSession.ViewId, clsPubVar.CurrSelPrjId, clsCommonSession.UserId);
                        strMsg = "添加记录成功!";
						clsCommonJsFunc.Alert(this, strMsg);
						lblMsg.Text = "添加记录成功!";
					}
		...
		private void PutDataToDetailRegionFldsClass(clsDetailRegionFldsEN pobjDetailRegionFlds)
		{
            ...
            pobjDetailRegionFlds.OutFldId = wucDetailRegionFlds1.DataNodeId;
            ...
            pobjDetailRegionFlds.RegionId = seRegionId;
            pobjDetailRegionFlds.PrjId = clsPubVar.CurrSelPrjId;
		...
		protected void btnDelete4Dg_Click(object sender, System.EventArgs e)
		{
            ...
            clsDetailRegionFldsBLEx.ReOrder(seRegionId);
		...
		protected void btnCopyFldFromRelaTab_Click(object sender, System.EventArgs e)
		{
            ...
            clsDetailRegionFldsBLEx.ImportRelaFlds(seRegionId, clsPubVar.CurrCmPrjId, UserId);
            //clsViewRegionBLEx.SetFldCount(seRegionId);
            //clsViewRegionBLEx.SetFldCountInUse(seRegionId);
        ...
        protected void btnCopyFromOtherView_Click(object sender, EventArgs e)
        {
            ...
            clsDetailRegionFldsBLEx.CopyTo1(arrRegionId[0], seRegionId, clsPubVar.CurrCmPrjId, clsCommonSession.UserId);
            BindGv_vDetailRegionFlds();
        }
    }
}