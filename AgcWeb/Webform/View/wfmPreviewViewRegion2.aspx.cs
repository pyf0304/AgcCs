...
namespace AGC.Webform
{
    ...
    /// </summary>
    public partial class wfmPreviewViewRegion2 : CommWebPageBase
    {
		//生成有关的变量定义代码
				...
				foreach(clsViewRegionEN objViewRegionEN in arrViewRegionObjList)
				{
					switch(objViewRegionEN.RegionTypeId)
					{
						case clsRegionTypeENEx.QUERYREGION:		//查询区域
                            ...
                            int intRowNum = WebViewCode4Html.DispQryRegionCtrl(phQryRegion, objViewInfoENEx);
                            int intHeight = 40 * intRowNum;
                            divQryRegion.Attributes["Height"] = intHeight.ToString() + "px";
							break;	
