...
{
    /// <summary>
    /// wfmGenViewCode_Web_Net2005 的摘要说明。其中Q代表查询，U代表修改
    /// </summary>
    public partial class wfmGenViewCode_Web_Net2005 : CommWebPageBase
    {
...
//			}
  ...
  //              //strCodeText = clsViewInfoBLEx_GeneCode.GeneViewCode(strViewId, "Net2010",
  ...
  //              //strCodeText = clsViewInfoBLEx_GeneCode.GeneControlCode(strViewId, "Net2010",
  ...
  //          } 
		...
		protected void btnPreView_Click(object sender, System.EventArgs e)
		{
			...
			lblMsg2.Text = "";
			ViewId = strViewId;
			BackGeneCode4WebV2005LinkStr = Page.Request.Url.AbsolutePath;
			Response.Redirect("../View/wfmPreviewViewRegion.aspx?ParentPage=GeneCode4WebV2005");

		}

		protected void btnCtlControlCode4Query_Click(object sender, System.EventArgs e)
		{
    ...
    //            SimpleFName = clsString.GetSimpleFName_S(autoGC5Cs_M.objPrjTabENEx.FileName);
		...
		protected void btnCtlViewCtlCode_Disp_Click(object sender, System.EventArgs e)
		{
			...
			lblMsg2.Text = "";
			WebViewControlCode4CSharp autoGC5Cs_CWeb = new WebViewControlCode4CSharp(strViewId);
			if (objViewInfoENEx.ViewFldNum == 0)
			{
				ShowCode("界面中字段数为0，不能生成界面代码");
				return ;
            ...
            objViewInfoENEx.FolderName = "D:\\FTP\\ClsFile\\" + clsCommonSession.UserId + "\\";
            objViewInfoENEx.CurrUserName = clsCommonSession.UserName;
            //ShowCode(autoGC5Cs_CWeb.A_GenCtlControlCodeforTab_Disp(objViewInfoENEx, ref strRe_ClsName, ref strRe_FileNameWithModuleName);
            txtFileName4GenCode.Text = objViewInfoENEx.FileName;
			SimpleFName = clsString.GetSimpleFName_S(objViewInfoENEx.FileName);
