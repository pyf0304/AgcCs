...
{
    /// <summary>
    /// wfmGenViewCode4JavaV6 的摘要说明。其中Q代表查询，U代表修改
    /// </summary>
    public partial class wfmGenViewCode4JavaV6 : CommWebPageBase
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)	///如果本界面是初次被调用，而不是单击按钮事件所调用
            {
                ...
                clsViewTypeCodeTabBLEx.BindDdl_ViewTypeCodeByAppIdCache(ddlViewTypeCodeq, clsApplicationTypeBLEx.JAVAWEBAPP);
        ...
        protected void btnGenViewCode_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                //AutoGC6J_VWeb autoGC4J_VWeb = new AutoGC6J_VWeb(strViewId);
        ...
        protected void btnGenControlCode_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                //AutoGC6J_CWeb autoGC6J_CWeb = new AutoGC6J_CWeb(strViewGroupId);
                ////			if (autoGC6J_CWeb.ViewFldNum == 0)
                ////			{
                ////				ShowCode("界面中字段数为0，不能生成界面代码";
                ////				return ;
                ////
                ////			}
                ////			if (autoGC6J_CWeb.TabKeyFldNum == 0)
                ////			{
                ////				ShowCode("界面相关表的表关键字段数为0，请检查界面的相关表是否有表关键字段!";
                ////				return ;
                ////			}

                //autoGC6J_CWeb.FolderName = "D:\\FTP\\ClsFile\\" + clsCommonSession.UserId + "\\";
                //autoGC6J_CWeb.CurrUserName = clsCommonSession.UserName;
                //ShowCode(autoGC6J_CWeb.A_GenActionCode(myEncoding ,ref strResult);
                //txtFileName4GenCode.Text = autoGC6J_CWeb.FileName;
                //SimpleFName = clsString.GetSimpleFName_S(autoGC6J_CWeb.FileName);
            }
            catch (Exception objException)
            {
                clsCommonSession.seErrMessage = objException.Message;
        ...
        protected void btnGenGeneLogicCode_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                //    return;
                //}
                //AutoGC6J_M autoGC6J_M = new AutoGC6J_M(strTabId);
                //autoGC6J_M.FolderName = "D:\\FTP\\ClsFile\\" + clsCommonSession.UserId + "\\";
                //autoGC6J_M.CurrUserName = clsCommonSession.UserName;
                //ShowCode(autoGC6J_M.A_GenGeneralLogicCode(ref strResult);
                //txtFileName4GenCode.Text = autoGC6J_M.FileName;
                //SimpleFName = clsString.GetSimpleFName_S(autoGC6J_M.FileName);
            }
            catch (Exception objException)
            {
                clsCommonSession.seErrMessage = objException.Message;
        ...
        protected void btnPreView_Click(object sender, System.EventArgs e)
        {
            ...
            Response.Redirect("../View/wfmPreviewViewRegion.aspx?ParentPage=GeneCode6Java");
        }
        ...
        protected void btnGeneStrutsConfig_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                //AutoGC6J_Manager autoGC6J_Manager = new AutoGC6J_Manager(strViewGroupId);

                //autoGC6J_Manager.FolderName = "D:\\FTP\\ClsFile\\" + clsCommonSession.UserId + "\\";
                //autoGC6J_Manager.CurrUserName = clsCommonSession.UserName;
                //ShowCode(autoGC6J_Manager.A_GenStrutsConfigCode();
                //txtFileName4GenCode.Text = autoGC6J_Manager.FileName;
                //SimpleFName = clsString.GetSimpleFName_S(autoGC6J_Manager.FileName);
            }
            catch (Exception objException)
            {
                clsCommonSession.seErrMessage = objException.Message;
        ...
        protected void btnLogicManagerCode_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                //autoGC6J_Manager.FolderName = "D:\\FTP\\ClsFile\\" + clsCommonSession.UserId + "\\";
                //autoGC6J_Manager.CurrUserName = clsCommonSession.UserName;
                //ShowCode(autoGC6J_Manager.A_GenManagerCode(myEncoding);
                //txtFileName4GenCode.Text = autoGC6J_Manager.FileName;
                //SimpleFName = clsString.GetSimpleFName_S(autoGC6J_Manager.FileName);
            }
            catch (Exception objException)
        ...
        protected void btnGenActionCode_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //autoGC6J_CWeb.FolderName = "D:\\FTP\\ClsFile\\" + clsCommonSession.UserId + "\\";
                //autoGC6J_CWeb.CurrUserName = clsCommonSession.UserName;
                //ShowCode(autoGC6J_CWeb.A_GenActionCode(myEncoding);
                //txtFileName4GenCode.Text = autoGC6J_CWeb.FileName;
                //SimpleFName = clsString.GetSimpleFName_S(autoGC6J_CWeb.FileName);
            }
            catch (Exception objException)
        ...
        protected void btnGenActionFormCode_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //autoGC6J_CWeb.FolderName = "D:\\FTP\\ClsFile\\" + clsCommonSession.UserId + "\\";
                //autoGC6J_CWeb.CurrUserName = clsCommonSession.UserName;
                //ShowCode(autoGC6J_CWeb.A_GenActionFormCode(myEncoding);
                //txtFileName4GenCode.Text = autoGC6J_CWeb.FileName;
                //SimpleFName = clsString.GetSimpleFName_S(autoGC6J_CWeb.FileName);
            }
            catch (Exception objException)
