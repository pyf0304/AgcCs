...
get
{
if (convFeatureRegionFldCount.RegionId  ==  _AttributeName[intIndex])
{
return mstrRegionId;
}
else if (convFeatureRegionFldCount.FldCount  ==  _AttributeName[intIndex])
{
return mintFldCount;
}
else if (convFeatureRegionFldCount.PrjId  ==  _AttributeName[intIndex])
{
return mstrPrjId;
}
return null;
