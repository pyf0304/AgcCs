...
get
{
if (convDetailRegionFldCountInUse.RegionId  ==  _AttributeName[intIndex])
{
return mstrRegionId;
}
else if (convDetailRegionFldCountInUse.FldCount  ==  _AttributeName[intIndex])
{
return mintFldCount;
}
else if (convDetailRegionFldCountInUse.PrjId  ==  _AttributeName[intIndex])
{
return mstrPrjId;
}
return null;
