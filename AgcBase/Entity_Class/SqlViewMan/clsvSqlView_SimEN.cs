...
get
{
if (convSqlView_Sim.SqlViewId  ==  _AttributeName[intIndex])
{
return mstrSqlViewId;
}
else if (convSqlView_Sim.SqlViewName  ==  _AttributeName[intIndex])
{
return mstrSqlViewName;
}
else if (convSqlView_Sim.SqlViewCNName  ==  _AttributeName[intIndex])
{
return mstrSqlViewCNName;
}
else if (convSqlView_Sim.SqlViewText  ==  _AttributeName[intIndex])
{
return mstrSqlViewText;
}
else if (convSqlView_Sim.SqlViewText4Gene  ==  _AttributeName[intIndex])
{
return mstrSqlViewText4Gene;
}
else if (convSqlView_Sim.TextResouce  ==  _AttributeName[intIndex])
{
return mstrTextResouce;
}
else if (convSqlView_Sim.TextResourceTypeId  ==  _AttributeName[intIndex])
{
return mstrTextResourceTypeId;
}
else if (convSqlView_Sim.TextResourceTypeName  ==  _AttributeName[intIndex])
{
return mstrTextResourceTypeName;
}
else if (convSqlView_Sim.RelaTabId  ==  _AttributeName[intIndex])
{
return mstrRelaTabId;
}
else if (convSqlView_Sim.TabStateId  ==  _AttributeName[intIndex])
{
return mstrTabStateId;
}
else if (convSqlView_Sim.FuncModuleAgcId  ==  _AttributeName[intIndex])
{
return mstrFuncModuleAgcId;
}
else if (convSqlView_Sim.AnalysisDate  ==  _AttributeName[intIndex])
{
return mstrAnalysisDate;
}
else if (convSqlView_Sim.GeneCodeDate  ==  _AttributeName[intIndex])
{
return mstrGeneCodeDate;
}
else if (convSqlView_Sim.TopPercent  ==  _AttributeName[intIndex])
{
return mstrTopPercent;
}
else if (convSqlView_Sim.DistinctFlag  ==  _AttributeName[intIndex])
{
return mstrDistinctFlag;
}
else if (convSqlView_Sim.WhereCondition  ==  _AttributeName[intIndex])
{
return mstrWhereCondition;
}
else if (convSqlView_Sim.GroupBy  ==  _AttributeName[intIndex])
{
return mstrGroupBy;
}
else if (convSqlView_Sim.HavingStr  ==  _AttributeName[intIndex])
{
return mstrHavingStr;
}
else if (convSqlView_Sim.OrderBy  ==  _AttributeName[intIndex])
{
return mstrOrderBy;
}
else if (convSqlView_Sim.ErrMsg  ==  _AttributeName[intIndex])
{
return mstrErrMsg;
}
else if (convSqlView_Sim.OrderNum4Refer  ==  _AttributeName[intIndex])
{
return mintOrderNum4Refer;
}
else if (convSqlView_Sim.PrjId  ==  _AttributeName[intIndex])
{
return mstrPrjId;
}
else if (convSqlView_Sim.PrjName  ==  _AttributeName[intIndex])
{
return mstrPrjName;
}
else if (convSqlView_Sim.UpdDate  ==  _AttributeName[intIndex])
{
return mstrUpdDate;
}
else if (convSqlView_Sim.UpdUserId  ==  _AttributeName[intIndex])
{
return mstrUpdUserId;
}
else if (convSqlView_Sim.Memo  ==  _AttributeName[intIndex])
{
return mstrMemo;
}
return null;
