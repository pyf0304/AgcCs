...
public static string[] _AttributeName = new string[] {"mId", "CmPrjId", "FuncModuleAgcId", "OrderNum", "PrjId", "UpdDate", "UpdUser", "Memo"};
...
get
{
if (conCMProjectFuncModule.mId  ==  _AttributeName[intIndex])
{
return mlngmId;
}
else if (conCMProjectFuncModule.CmPrjId  ==  _AttributeName[intIndex])
{
return mstrCmPrjId;
}
else if (conCMProjectFuncModule.FuncModuleAgcId  ==  _AttributeName[intIndex])
{
return mstrFuncModuleAgcId;
}
else if (conCMProjectFuncModule.OrderNum  ==  _AttributeName[intIndex])
{
return mintOrderNum;
}
else if (conCMProjectFuncModule.PrjId  ==  _AttributeName[intIndex])
{
return mstrPrjId;
}
else if (conCMProjectFuncModule.UpdDate  ==  _AttributeName[intIndex])
{
return mstrUpdDate;
}
else if (conCMProjectFuncModule.UpdUser  ==  _AttributeName[intIndex])
{
return mstrUpdUser;
}
else if (conCMProjectFuncModule.Memo  ==  _AttributeName[intIndex])
{
return mstrMemo;
}
return null;
