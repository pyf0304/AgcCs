...
public static string[] _AttributeName = new string[] {"DnFuncMapId", "CmPrjId", "UpdDate", "UpdUser", "Memo"};
...
get
{
if (conDnFuncMapCmPrjIdRela.DnFuncMapId  ==  _AttributeName[intIndex])
{
return mstrDnFuncMapId;
}
else if (conDnFuncMapCmPrjIdRela.CmPrjId  ==  _AttributeName[intIndex])
{
return mstrCmPrjId;
}
else if (conDnFuncMapCmPrjIdRela.UpdDate  ==  _AttributeName[intIndex])
{
return mstrUpdDate;
}
else if (conDnFuncMapCmPrjIdRela.UpdUser  ==  _AttributeName[intIndex])
{
return mstrUpdUser;
}
else if (conDnFuncMapCmPrjIdRela.Memo  ==  _AttributeName[intIndex])
{
return mstrMemo;
}
return null;
