...
public static string[] _AttributeName = new string[] {"Key1", "Name1", "Memo"};
...
get
{
if (conTemplate1.Key1  ==  _AttributeName[intIndex])
{
return mstrKey1;
}
else if (conTemplate1.Name1  ==  _AttributeName[intIndex])
{
return mstrName1;
}
else if (conTemplate1.Memo  ==  _AttributeName[intIndex])
{
return mstrMemo;
}
return null;
