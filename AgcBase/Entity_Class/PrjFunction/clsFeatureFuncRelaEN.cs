...
public static string[] _AttributeName = new string[] {"mId", "ApplicationTypeId", "FeatureId", "FuncId4GC", "UpdDate", "UpdUser", "Memo"};
...
get
{
if (conFeatureFuncRela.mId  ==  _AttributeName[intIndex])
{
return mlngmId;
}
else if (conFeatureFuncRela.ApplicationTypeId  ==  _AttributeName[intIndex])
{
return mintApplicationTypeId;
}
else if (conFeatureFuncRela.FeatureId  ==  _AttributeName[intIndex])
{
return mstrFeatureId;
}
else if (conFeatureFuncRela.FuncId4GC  ==  _AttributeName[intIndex])
{
return mstrFuncId4GC;
}
else if (conFeatureFuncRela.UpdDate  ==  _AttributeName[intIndex])
{
return mstrUpdDate;
}
else if (conFeatureFuncRela.UpdUser  ==  _AttributeName[intIndex])
{
return mstrUpdUser;
}
else if (conFeatureFuncRela.Memo  ==  _AttributeName[intIndex])
{
return mstrMemo;
}
return null;
