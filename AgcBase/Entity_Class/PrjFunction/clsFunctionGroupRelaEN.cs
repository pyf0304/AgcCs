...
public static string[] _AttributeName = new string[] {"mId", "FunctionGroupId", "FuncId4GC", "UpdDate", "UpdUser", "Memo"};
...
get
{
if (conFunctionGroupRela.mId  ==  _AttributeName[intIndex])
{
return mlngmId;
}
else if (conFunctionGroupRela.FunctionGroupId  ==  _AttributeName[intIndex])
{
return mstrFunctionGroupId;
}
else if (conFunctionGroupRela.FuncId4GC  ==  _AttributeName[intIndex])
{
return mstrFuncId4GC;
}
else if (conFunctionGroupRela.UpdDate  ==  _AttributeName[intIndex])
{
return mstrUpdDate;
}
else if (conFunctionGroupRela.UpdUser  ==  _AttributeName[intIndex])
{
return mstrUpdUser;
}
else if (conFunctionGroupRela.Memo  ==  _AttributeName[intIndex])
{
return mstrMemo;
}
return null;
