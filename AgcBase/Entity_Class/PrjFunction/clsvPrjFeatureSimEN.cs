...
public static string[] AttributeName = new string[] {"FeatureId", "FeatureName", "FeatureTypeId", "RegionTypeId", "InUse", "ParentFeatureName", "ParentFeatureId"};
...
get
{
if (convPrjFeatureSim.FeatureId  ==  AttributeName[intIndex])
{
return mstrFeatureId;
}
else if (convPrjFeatureSim.FeatureName  ==  AttributeName[intIndex])
{
return mstrFeatureName;
}
else if (convPrjFeatureSim.FeatureTypeId  ==  AttributeName[intIndex])
{
return mstrFeatureTypeId;
}
else if (convPrjFeatureSim.RegionTypeId  ==  AttributeName[intIndex])
{
return mstrRegionTypeId;
}
else if (convPrjFeatureSim.InUse  ==  AttributeName[intIndex])
{
return mbolInUse;
}
else if (convPrjFeatureSim.ParentFeatureName  ==  AttributeName[intIndex])
{
return mstrParentFeatureName;
}
else if (convPrjFeatureSim.ParentFeatureId  ==  AttributeName[intIndex])
{
return mstrParentFeatureId;
}
return null;
