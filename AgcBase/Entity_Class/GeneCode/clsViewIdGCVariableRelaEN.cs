...
public static string[] AttributeName = new string[] {"IsUseInRegion", "VarId", "ViewId", "RetrievalMethodId", "RegionTypeNames", "ErrMsg", "PrjId", "UpdUser", "UpdDate", "Memo"};
...
else if (conViewIdGCVariableRela.ErrMsg  ==  AttributeName[intIndex])
{
return mstrErrMsg;
}
