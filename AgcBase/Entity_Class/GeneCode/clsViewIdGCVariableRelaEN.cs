...
namespace AGC.Entity
{
    ...
    public class clsViewIdGCVariableRelaEN : clsEntityBase2
    {
        ...
        public static string[] _AttributeName = new string[] { "VarId", "ViewId", "RetrievalMethodId", "RegionTypeNames", "InitValue", "DsTabId", "ErrMsg", "IsUseInRegion", "PrjId", "UpdUser", "UpdDate", "Memo" };
        ...
        public override object this[string strAttributeName]
        {
            get
            {
                if (strAttributeName == conViewIdGCVariableRela.VarId)
                {
                    return mstrVarId;
                }
                ...
                else if (strAttributeName == conViewIdGCVariableRela.InitValue)
                {
                    return mstrInitValue;
                }
                else if (strAttributeName == conViewIdGCVariableRela.DsTabId)
                {
                    return mstrDsTabId;
                }
                else if (strAttributeName == conViewIdGCVariableRela.ErrMsg)
                {
                    return mstrErrMsg;
                }
                else if (strAttributeName == conViewIdGCVariableRela.IsUseInRegion)
                {
            ...
            set
            {
                ...
                else if (strAttributeName == conViewIdGCVariableRela.InitValue)
                {
                    ...
                    AddUpdatedFld(conViewIdGCVariableRela.InitValue);
                }
                else if (strAttributeName == conViewIdGCVariableRela.DsTabId)
                {
                    mstrDsTabId = value.ToString();
                    AddUpdatedFld(conViewIdGCVariableRela.DsTabId);
                }
                else if (strAttributeName == conViewIdGCVariableRela.ErrMsg)
                {
                    mstrErrMsg = value.ToString();
                    AddUpdatedFld(conViewIdGCVariableRela.ErrMsg);
                }
                else if (strAttributeName == conViewIdGCVariableRela.IsUseInRegion)
                {
        ...
        public object this[int intIndex]
        {
            get
            {
                if (conViewIdGCVariableRela.VarId == _AttributeName[intIndex])
                {
                    return mstrVarId;
                }
                else if (conViewIdGCVariableRela.ViewId == _AttributeName[intIndex])
                {
                    return mstrViewId;
                }
                else if (conViewIdGCVariableRela.RetrievalMethodId == _AttributeName[intIndex])
                {
                    return mstrRetrievalMethodId;
                }
                else if (conViewIdGCVariableRela.RegionTypeNames == _AttributeName[intIndex])
                {
                    return mstrRegionTypeNames;
                }
                else if (conViewIdGCVariableRela.InitValue == _AttributeName[intIndex])
                {
                    return mstrInitValue;
                }
                else if (conViewIdGCVariableRela.DsTabId == _AttributeName[intIndex])
                {
                    return mstrDsTabId;
                }
                else if (conViewIdGCVariableRela.ErrMsg == _AttributeName[intIndex])
                {
                    return mstrErrMsg;
                }
                else if (conViewIdGCVariableRela.IsUseInRegion == _AttributeName[intIndex])
                {
                    return mbolIsUseInRegion;
                }
                else if (conViewIdGCVariableRela.PrjId == _AttributeName[intIndex])
                {
                    return mstrPrjId;
                }
                else if (conViewIdGCVariableRela.UpdUser == _AttributeName[intIndex])
                {
                    return mstrUpdUser;
                }
                else if (conViewIdGCVariableRela.UpdDate == _AttributeName[intIndex])
                {
                    return mstrUpdDate;
                }
                else if (conViewIdGCVariableRela.Memo == _AttributeName[intIndex])
                {
                    return mstrMemo;
                }
                return null;
