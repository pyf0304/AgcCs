...
public static string[] _AttributeName = new string[] {"ButtonStyleId", "ButtonStyleName", "CssClass", "Style", "Runat", "FontSize", "FontName", "Width", "Height", "StyleZindex", "StyleLeft", "StylePosition", "StyleTop"};
...
get
{
if (conButtonStyle.ButtonStyleId  ==  _AttributeName[intIndex])
{
return mstrButtonStyleId;
}
else if (conButtonStyle.ButtonStyleName  ==  _AttributeName[intIndex])
{
return mstrButtonStyleName;
}
else if (conButtonStyle.CssClass  ==  _AttributeName[intIndex])
{
return mstrCssClass;
}
else if (conButtonStyle.Style  ==  _AttributeName[intIndex])
{
return mstrStyle;
}
else if (conButtonStyle.Runat  ==  _AttributeName[intIndex])
{
return mstrRunat;
}
else if (conButtonStyle.FontSize  ==  _AttributeName[intIndex])
{
return mstrFontSize;
}
else if (conButtonStyle.FontName  ==  _AttributeName[intIndex])
{
return mstrFontName;
}
else if (conButtonStyle.Width  ==  _AttributeName[intIndex])
{
return mintWidth;
}
else if (conButtonStyle.Height  ==  _AttributeName[intIndex])
{
return mintHeight;
}
else if (conButtonStyle.StyleZindex  ==  _AttributeName[intIndex])
{
return mintStyleZindex;
}
else if (conButtonStyle.StyleLeft  ==  _AttributeName[intIndex])
{
return mintStyleLeft;
}
else if (conButtonStyle.StylePosition  ==  _AttributeName[intIndex])
{
return mstrStylePosition;
}
else if (conButtonStyle.StyleTop  ==  _AttributeName[intIndex])
{
return mintStyleTop;
}
return null;
