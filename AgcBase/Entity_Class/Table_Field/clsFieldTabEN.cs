...
public static string[] AttributeName = new string[] {"FldId", "FldName", "FldCnName", "Caption", "FieldTypeId", "DataTypeId", "FldLength", "FldPrecision", "FldInfo", "IsNull", "IsPrimaryKey", "IsIdentity", "IsChecked", "IsArchive", "IsOnlyOne", "MaxValue", "MinValue", "DefaultValue", "FldStateId", "HomologousFldId", "TabNum", "InUse", "PrjId", "UpdDate", "UpdUser", "Memo", "IsNeedTransCode"};
...
else if (conFieldTab.InUse  ==  AttributeName[intIndex])
{
return mbolInUse;
}
