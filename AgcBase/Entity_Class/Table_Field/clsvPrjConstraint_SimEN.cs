...
public static string[] AttributeName = new string[] {"PrjConstraintId", "ConstraintName", "PrjId", "TabId", "ConstraintTypeId", "InUse"};
...
get
{
if (convPrjConstraint_Sim.PrjConstraintId  ==  AttributeName[intIndex])
{
return mstrPrjConstraintId;
}
else if (convPrjConstraint_Sim.ConstraintName  ==  AttributeName[intIndex])
{
return mstrConstraintName;
}
else if (convPrjConstraint_Sim.PrjId  ==  AttributeName[intIndex])
{
return mstrPrjId;
}
else if (convPrjConstraint_Sim.TabId  ==  AttributeName[intIndex])
{
return mstrTabId;
}
else if (convPrjConstraint_Sim.ConstraintTypeId  ==  AttributeName[intIndex])
{
return mstrConstraintTypeId;
}
else if (convPrjConstraint_Sim.InUse  ==  AttributeName[intIndex])
{
return mbolInUse;
}
return null;
