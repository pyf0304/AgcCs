...
public static string[] AttributeName = new string[] {"TabFeatureId", "TabFeatureName", "TabId", "OrderNum", "InUse", "UpdUser", "UpdDate", "Memo", "FeatureId", "FuncNameCs", "GetDdlDataFuncName4Ex", "CmPrjId", "FuncNameJs", "IsForDiv", "IsForCSharp", "IsForTypeScript", "IsExtendedClass", "IsNeedGC", "ToolTipText"};
...
else if (convTabFeature_Sim.GetDdlDataFuncName4Ex  ==  AttributeName[intIndex])
{
return mstrGetDdlDataFuncName4Ex;
}
...
else if (convTabFeature_Sim.ToolTipText  ==  AttributeName[intIndex])
{
return mstrToolTipText;
}
return null;
