...
public static string[] _AttributeName = new string[] {"FldName", "FldId", "PrjId", "CodeTabId", "CodeTabNameId", "CodeTabCodeId", "UpdDate", "UpdUser", "Memo", "CodeTab", "CodeTabName", "CodeTabCode"};
...
get
{
if (convFieldTab4CodeConv.FldName  ==  _AttributeName[intIndex])
{
return mstrFldName;
}
else if (convFieldTab4CodeConv.FldId  ==  _AttributeName[intIndex])
{
return mstrFldId;
}
else if (convFieldTab4CodeConv.PrjId  ==  _AttributeName[intIndex])
{
return mstrPrjId;
}
else if (convFieldTab4CodeConv.CodeTabId  ==  _AttributeName[intIndex])
{
return mstrCodeTabId;
}
else if (convFieldTab4CodeConv.CodeTabNameId  ==  _AttributeName[intIndex])
{
return mstrCodeTabNameId;
}
else if (convFieldTab4CodeConv.CodeTabCodeId  ==  _AttributeName[intIndex])
{
return mstrCodeTabCodeId;
}
else if (convFieldTab4CodeConv.UpdDate  ==  _AttributeName[intIndex])
{
return mstrUpdDate;
}
else if (convFieldTab4CodeConv.UpdUser  ==  _AttributeName[intIndex])
{
return mstrUpdUser;
}
else if (convFieldTab4CodeConv.Memo  ==  _AttributeName[intIndex])
{
return mstrMemo;
}
else if (convFieldTab4CodeConv.CodeTab  ==  _AttributeName[intIndex])
{
return mstrCodeTab;
}
else if (convFieldTab4CodeConv.CodeTabName  ==  _AttributeName[intIndex])
{
return mstrCodeTabName;
}
else if (convFieldTab4CodeConv.CodeTabCode  ==  _AttributeName[intIndex])
{
return mstrCodeTabCode;
}
return null;
