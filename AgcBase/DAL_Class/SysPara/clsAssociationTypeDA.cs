...
strSQL = $"Select Top {intPageSize} AssociationType.* " + 
$"from AssociationType " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and AssociationType.AssociationTypeId not in " + 
$"(Select top {intTop_In} AssociationType.AssociationTypeId from AssociationType " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
