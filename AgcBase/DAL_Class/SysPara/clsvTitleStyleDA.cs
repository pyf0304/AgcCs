...
strSQL = $"Select Top {intPageSize} vTitleStyle.* " + 
$"from vTitleStyle " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and vTitleStyle.TitleStyleId not in " + 
$"(Select top {intTop_In} vTitleStyle.TitleStyleId from vTitleStyle " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
