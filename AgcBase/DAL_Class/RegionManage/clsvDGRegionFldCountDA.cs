...
strSQL = $"Select Top {intPageSize} vDGRegionFldCount.* " + 
$"from vDGRegionFldCount " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and vDGRegionFldCount.RegionId not in " + 
$"(Select top {intTop_In} vDGRegionFldCount.RegionId from vDGRegionFldCount " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
