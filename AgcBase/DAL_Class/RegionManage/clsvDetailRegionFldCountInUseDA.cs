...
strSQL = $"Select Top {intPageSize} vDetailRegionFldCountInUse.* " + 
$"from vDetailRegionFldCountInUse " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and vDetailRegionFldCountInUse.RegionId not in " + 
$"(Select top {intTop_In} vDetailRegionFldCountInUse.RegionId from vDetailRegionFldCountInUse " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
