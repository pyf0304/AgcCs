...
strSQL = $"Select Top {intPageSize} vFeatureRegionFlds.* " + 
$"from vFeatureRegionFlds " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and vFeatureRegionFlds.ViewFeatureId not in " + 
$"(Select top {intTop_In} vFeatureRegionFlds.ViewFeatureId from vFeatureRegionFlds " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
