...
strSQL = $"Select Top {intPageSize} vViewFeatureFlds.* " + 
$"from vViewFeatureFlds " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and vViewFeatureFlds.mId not in " + 
$"(Select top {intTop_In} vViewFeatureFlds.mId from vViewFeatureFlds " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
