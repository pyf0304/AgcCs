...
strSQL = $"Select Top {intPageSize} PrjProcessType.* " + 
$"from PrjProcessType " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and PrjProcessType.PrjProcessTypeId not in " + 
$"(Select top {intTop_In} PrjProcessType.PrjProcessTypeId from PrjProcessType " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
