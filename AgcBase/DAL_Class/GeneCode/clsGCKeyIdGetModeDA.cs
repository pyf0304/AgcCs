...
strSQL = $"Select Top {intPageSize} GCKeyIdGetMode.* " + 
$"from GCKeyIdGetMode " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and GCKeyIdGetMode.KeyIdGetModeId not in " + 
$"(Select top {intTop_In} GCKeyIdGetMode.KeyIdGetModeId from GCKeyIdGetMode " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
