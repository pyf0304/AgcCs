...
strSQL = $"Select Top {intPageSize} vFrontAndBack4AppType.* " + 
$"from vFrontAndBack4AppType " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and vFrontAndBack4AppType.mId not in " + 
$"(Select top {intTop_In} vFrontAndBack4AppType.mId from vFrontAndBack4AppType " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
