...
strSQL = $"Select Top {intPageSize} DictType4GC.* " + 
$"from DictType4GC " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and DictType4GC.DictTypeId not in " + 
$"(Select top {intTop_In} DictType4GC.DictTypeId from DictType4GC " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
