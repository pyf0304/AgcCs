...
strSQL = $"Select Top {intPageSize} vProgLangType.* " + 
$"from vProgLangType " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and vProgLangType.ProgLangTypeId not in " + 
$"(Select top {intTop_In} vProgLangType.ProgLangTypeId from vProgLangType " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
