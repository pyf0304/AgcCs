...
strSQL = $"Select Top {intPageSize} ViewDesign.* " + 
$"from ViewDesign " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and ViewDesign.ViewDesignId not in " + 
$"(Select top {intTop_In} ViewDesign.ViewDesignId from ViewDesign " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
