    ...
    public class clsViewIdGCVariableRelaDA : clsCommBase4DA
    {
        ...
        public System.Data.DataTable GetDataTableByPager(int intPageIndex, int intPageSize, string strCondition, string strOrderBy)
        {
            ...
            if (intPos_Dot > 0)
            {
                ...
                strSQL = $"Select Top {intPageSize} ViewIdGCVariableRela.* " +
                $"from ViewIdGCVariableRela " +
                $"{strLeftLinkStr} " +
                $"where {strCondition} and ViewIdGCVariableRela.VarId not in " +
                $"(Select top {intTop_In} ViewIdGCVariableRela.VarId from ViewIdGCVariableRela " +
                $"{strLeftLinkStr} " +
                $" where {strCondition} " +
        ...
        public bool GetViewIdGCVariableRela(ref clsViewIdGCVariableRelaEN objViewIdGCVariableRelaEN)
        {
            ...
            try
            {
                ...
                objViewIdGCVariableRelaEN.InitValue = objDT.Rows[0][conViewIdGCVariableRela.InitValue].ToString().Trim(); //初始值(字段类型:varchar,字段长度:1000,是否可空:True)
                objViewIdGCVariableRelaEN.DsTabId = objDT.Rows[0][conViewIdGCVariableRela.DsTabId].ToString().Trim(); //数据源表ID(字段类型:char,字段长度:8,是否可空:False)
                objViewIdGCVariableRelaEN.ErrMsg = objDT.Rows[0][conViewIdGCVariableRela.ErrMsg].ToString().Trim(); //错误信息(字段类型:varchar,字段长度:2000,是否可空:True)
        ...
        public clsViewIdGCVariableRelaEN GetObjByKeyLst(string strVarId, string strViewId)
        {
            ...
            try
            {
                ...
                objViewIdGCVariableRelaEN.InitValue = objRow[conViewIdGCVariableRela.InitValue] == DBNull.Value ? null : objRow[conViewIdGCVariableRela.InitValue].ToString().Trim(); //初始值(字段类型:varchar,字段长度:1000,是否可空:True)
                objViewIdGCVariableRelaEN.DsTabId = objRow[conViewIdGCVariableRela.DsTabId] == DBNull.Value ? null : objRow[conViewIdGCVariableRela.DsTabId].ToString().Trim(); //数据源表ID(字段类型:char,字段长度:8,是否可空:False)
                objViewIdGCVariableRelaEN.ErrMsg = objRow[conViewIdGCVariableRela.ErrMsg] == DBNull.Value ? null : objRow[conViewIdGCVariableRela.ErrMsg].ToString().Trim(); //错误信息(字段类型:varchar,字段长度:2000,是否可空:True)
        ...
        public clsViewIdGCVariableRelaEN GetFirstObj(string strCondition)
        {
            ...
            try
            {
                clsViewIdGCVariableRelaEN objViewIdGCVariableRelaEN = new clsViewIdGCVariableRelaEN()
                {
                    ...
                    InitValue = objRow[conViewIdGCVariableRela.InitValue] == DBNull.Value ? null : objRow[conViewIdGCVariableRela.InitValue].ToString().Trim(), //初始值
                    DsTabId = objRow[conViewIdGCVariableRela.DsTabId] == DBNull.Value ? null : objRow[conViewIdGCVariableRela.DsTabId].ToString().Trim(), //数据源表ID
                    ErrMsg = objRow[conViewIdGCVariableRela.ErrMsg] == DBNull.Value ? null : objRow[conViewIdGCVariableRela.ErrMsg].ToString().Trim(), //错误信息
        ...
        public bool AddNewRecord(clsViewIdGCVariableRelaEN objViewIdGCVariableRelaEN)
        {
            ...
            if (objViewIdGCVariableRelaEN.InitValue != "")
            {
                objRow[conViewIdGCVariableRela.InitValue] = objViewIdGCVariableRelaEN.InitValue; //初始值
            }
            if (objViewIdGCVariableRelaEN.DsTabId != "")
            {
                objRow[conViewIdGCVariableRela.DsTabId] = objViewIdGCVariableRelaEN.DsTabId; //数据源表ID
            }
            if (objViewIdGCVariableRelaEN.ErrMsg != "")
            {
                objRow[conViewIdGCVariableRela.ErrMsg] = objViewIdGCVariableRelaEN.ErrMsg; //错误信息
            }
        ...
        public bool AddNewRecordBySQL2(clsViewIdGCVariableRelaEN objViewIdGCVariableRelaEN)
        {
            ...
            if (objViewIdGCVariableRelaEN.InitValue != null)
            {
                arrFieldListForInsert.Add(conViewIdGCVariableRela.InitValue);
                var strInitValue = objViewIdGCVariableRelaEN.InitValue.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
                arrValueListForInsert.Add("'" + strInitValue + "'");
            }

            if (objViewIdGCVariableRelaEN.DsTabId != null)
            {
                arrFieldListForInsert.Add(conViewIdGCVariableRela.DsTabId);
                var strDsTabId = objViewIdGCVariableRelaEN.DsTabId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
                arrValueListForInsert.Add("'" + strDsTabId + "'");
            }

            if (objViewIdGCVariableRelaEN.ErrMsg != null)
            {
                arrFieldListForInsert.Add(conViewIdGCVariableRela.ErrMsg);
                var strErrMsg = objViewIdGCVariableRelaEN.ErrMsg.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
        ...
        public bool AddnewViewIdGCVariableRelas(System.Data.DataTable oDT)
        {
            ...
            foreach (System.Data.DataRow oRow in oDT.Rows)
            {
                ...
                objRow[conViewIdGCVariableRela.InitValue] = oRow[conViewIdGCVariableRela.InitValue].ToString().Trim(); //初始值
                objRow[conViewIdGCVariableRela.DsTabId] = oRow[conViewIdGCVariableRela.DsTabId].ToString().Trim(); //数据源表ID
                objRow[conViewIdGCVariableRela.ErrMsg] = oRow[conViewIdGCVariableRela.ErrMsg].ToString().Trim(); //错误信息
        ...
        public bool Update(clsViewIdGCVariableRelaEN objViewIdGCVariableRelaEN)
        {
            ...
            if (objViewIdGCVariableRelaEN.IsUpdated(conViewIdGCVariableRela.InitValue))
            {
                objRow[conViewIdGCVariableRela.InitValue] = objViewIdGCVariableRelaEN.InitValue; //初始值
            }
            if (objViewIdGCVariableRelaEN.IsUpdated(conViewIdGCVariableRela.DsTabId))
            {
                objRow[conViewIdGCVariableRela.DsTabId] = objViewIdGCVariableRelaEN.DsTabId; //数据源表ID
            }
            if (objViewIdGCVariableRelaEN.IsUpdated(conViewIdGCVariableRela.ErrMsg))
            {
                objRow[conViewIdGCVariableRela.ErrMsg] = objViewIdGCVariableRelaEN.ErrMsg; //错误信息
            }
        ...
        public bool UpdateBySql2(clsViewIdGCVariableRelaEN objViewIdGCVariableRelaEN)
        {
            ...
            try
            {
                ...
                if (objViewIdGCVariableRelaEN.IsUpdated(conViewIdGCVariableRela.InitValue))
                {
                    ...
                    {
                        var strInitValue = objViewIdGCVariableRelaEN.InitValue.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
                        sbSQL.AppendFormat("{1} = '{0}',", strInitValue, conViewIdGCVariableRela.InitValue); //初始值
                    }
                    else
                    {
                        sbSQL.AppendFormat("{0} = null,", conViewIdGCVariableRela.InitValue); //初始值
                    }
                }
                ...
                if (objViewIdGCVariableRelaEN.IsUpdated(conViewIdGCVariableRela.DsTabId))
                {
                    ...
                    {
                        var strDsTabId = objViewIdGCVariableRelaEN.DsTabId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
                        sbSQL.AppendFormat("{1} = '{0}',", strDsTabId, conViewIdGCVariableRela.DsTabId); //数据源表ID
                    }
                    else
                    {
                        sbSQL.AppendFormat("{0} = null,", conViewIdGCVariableRela.DsTabId); //数据源表ID
                    }
                }
                ...
                if (objViewIdGCVariableRelaEN.IsUpdated(conViewIdGCVariableRela.ErrMsg))
                {
                    ...
                    {
                        var strErrMsg = objViewIdGCVariableRelaEN.ErrMsg.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
                        sbSQL.AppendFormat("{1} = '{0}',", strErrMsg, conViewIdGCVariableRela.ErrMsg); //错误信息
                    }
                    else
                    {
                        sbSQL.AppendFormat("{0} = null,", conViewIdGCVariableRela.ErrMsg); //错误信息
                    }
                }
            ...
            ArrayList values = new ArrayList()
{
 ...
 strViewId,
        ...
        public void CheckPropertyNew(clsViewIdGCVariableRelaEN objViewIdGCVariableRelaEN)
        {
            ...
            clsCheckSql.CheckFieldLen(objViewIdGCVariableRelaEN.InitValue, 1000, conViewIdGCVariableRela.InitValue);
            clsCheckSql.CheckFieldLen(objViewIdGCVariableRelaEN.DsTabId, 8, conViewIdGCVariableRela.DsTabId);
            clsCheckSql.CheckFieldLen(objViewIdGCVariableRelaEN.ErrMsg, 2000, conViewIdGCVariableRela.ErrMsg);
        ...
        public void CheckProperty4Condition(clsViewIdGCVariableRelaEN objViewIdGCVariableRelaEN)
        {
            ...
            clsCheckSql.CheckSqlInjection4Field(objViewIdGCVariableRelaEN.InitValue, conViewIdGCVariableRela.InitValue);
            clsCheckSql.CheckSqlInjection4Field(objViewIdGCVariableRelaEN.DsTabId, conViewIdGCVariableRela.DsTabId);
            clsCheckSql.CheckSqlInjection4Field(objViewIdGCVariableRelaEN.ErrMsg, conViewIdGCVariableRela.ErrMsg);
