...
strSQL = $"Select Top {intPageSize} ValueGivingMode.* " + 
$"from ValueGivingMode " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and ValueGivingMode.ValueGivingModeId not in " + 
$"(Select top {intTop_In} ValueGivingMode.ValueGivingModeId from ValueGivingMode " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
