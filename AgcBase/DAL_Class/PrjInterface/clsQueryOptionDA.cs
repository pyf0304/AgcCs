...
strSQL = $"Select Top {intPageSize} QueryOption.* " + 
$"from QueryOption " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and QueryOption.QueryOptionId not in " + 
$"(Select top {intTop_In} QueryOption.QueryOptionId from QueryOption " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
