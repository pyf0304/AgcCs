...
strSQL = $"Select Top {intPageSize} DnPathFuncMapRela.* " + 
$"from DnPathFuncMapRela " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and DnPathFuncMapRela.mId not in " + 
$"(Select top {intTop_In} DnPathFuncMapRela.mId from DnPathFuncMapRela " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
