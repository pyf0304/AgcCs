...
strSQL = $"Select Top {intPageSize} vFuncInOutRela.* " + 
$"from vFuncInOutRela " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and vFuncInOutRela.mId not in " + 
$"(Select top {intTop_In} vFuncInOutRela.mId from vFuncInOutRela " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
