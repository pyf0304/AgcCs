...
strSQL = $"Select Top {intPageSize} CheckStyle.* " + 
$"from CheckStyle " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and CheckStyle.CheckStyleId not in " + 
$"(Select top {intTop_In} CheckStyle.CheckStyleId from CheckStyle " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
