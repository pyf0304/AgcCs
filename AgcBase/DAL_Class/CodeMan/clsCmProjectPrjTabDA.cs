...
strSQL = $"Select Top {intPageSize} CmProjectPrjTab.* " + 
$"from CmProjectPrjTab " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and CmProjectPrjTab.mId not in " + 
$"(Select top {intTop_In} CmProjectPrjTab.mId from CmProjectPrjTab " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
