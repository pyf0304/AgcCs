...
strSQL = $"Select Top {intPageSize} vCMFeatureRequirement.* " + 
$"from vCMFeatureRequirement " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and vCMFeatureRequirement.mId not in " + 
$"(Select top {intTop_In} vCMFeatureRequirement.mId from vCMFeatureRequirement " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
