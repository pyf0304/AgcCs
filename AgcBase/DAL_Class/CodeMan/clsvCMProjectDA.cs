...
strSQL = $"Select Top {intPageSize} vCMProject.* " + 
$"from vCMProject " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and vCMProject.CmPrjId not in " + 
$"(Select top {intTop_In} vCMProject.CmPrjId from vCMProject " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
