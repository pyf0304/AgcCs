...
strSQL = $"Select Top {intPageSize} vCMFunctionKeyWord.* " + 
$"from vCMFunctionKeyWord " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and vCMFunctionKeyWord.mId not in " + 
$"(Select top {intTop_In} vCMFunctionKeyWord.mId from vCMFunctionKeyWord " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
