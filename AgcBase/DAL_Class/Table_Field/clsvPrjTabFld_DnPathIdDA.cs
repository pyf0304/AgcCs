...
strSQL = $"Select Top {intPageSize} vPrjTabFld_DnPathId.* " + 
$"from vPrjTabFld_DnPathId " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and vPrjTabFld_DnPathId.TabId not in " + 
$"(Select top {intTop_In} vPrjTabFld_DnPathId.TabId from vPrjTabFld_DnPathId " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
