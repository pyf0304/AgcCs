...
strSQL = $"Select Top {intPageSize} vPrjTabKeyFld.* " + 
$"from vPrjTabKeyFld " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and vPrjTabKeyFld.TabId not in " + 
$"(Select top {intTop_In} vPrjTabKeyFld.TabId from vPrjTabKeyFld " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
