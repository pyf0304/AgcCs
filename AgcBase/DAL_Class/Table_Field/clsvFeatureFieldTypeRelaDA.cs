...
strSQL = $"Select Top {intPageSize} vFeatureFieldTypeRela.* " + 
$"from vFeatureFieldTypeRela " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and vFeatureFieldTypeRela.mId not in " + 
$"(Select top {intTop_In} vFeatureFieldTypeRela.mId from vFeatureFieldTypeRela " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
