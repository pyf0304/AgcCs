...
strSQL = $"Select Top {intPageSize} vFieldTab_Sim.* " + 
$"from vFieldTab_Sim " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and vFieldTab_Sim.FldId not in " + 
$"(Select top {intTop_In} vFieldTab_Sim.FldId from vFieldTab_Sim " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
