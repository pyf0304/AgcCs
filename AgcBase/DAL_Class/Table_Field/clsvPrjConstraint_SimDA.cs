...
strSQL = string.Format("Select Top {0} vPrjConstraint_Sim.* from vPrjConstraint_Sim Left Join {1} on {2} where {3} and vPrjConstraint_Sim.PrjConstraintId not in (Select top {5} vPrjConstraint_Sim.PrjConstraintId from vPrjConstraint_Sim Left Join {1} on {2} where {3} order by {4} {6}) order by {4} {6} ",
