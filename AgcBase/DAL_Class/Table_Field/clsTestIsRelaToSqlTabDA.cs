...
strSQL = $"Select Top {intPageSize} TestIsRelaToSqlTab.* " + 
$"from TestIsRelaToSqlTab " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and TestIsRelaToSqlTab.mId not in " + 
$"(Select top {intTop_In} TestIsRelaToSqlTab.mId from TestIsRelaToSqlTab " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
