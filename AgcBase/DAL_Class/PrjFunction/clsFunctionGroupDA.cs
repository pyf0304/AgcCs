...
strSQL = $"Select Top {intPageSize} FunctionGroup.* " + 
$"from FunctionGroup " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and FunctionGroup.FunctionGroupId not in " + 
$"(Select top {intTop_In} FunctionGroup.FunctionGroupId from FunctionGroup " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
