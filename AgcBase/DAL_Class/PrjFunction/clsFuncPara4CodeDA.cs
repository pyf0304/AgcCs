...
strSQL = $"Select Top {intPageSize} FuncPara4Code.* " + 
$"from FuncPara4Code " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and FuncPara4Code.FuncParaId4Code not in " + 
$"(Select top {intTop_In} FuncPara4Code.FuncParaId4Code from FuncPara4Code " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
