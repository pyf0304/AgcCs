...
strSQL = string.Format("Select Top {0} vPrjFeatureSim.* from vPrjFeatureSim Left Join {1} on {2} where {3} and vPrjFeatureSim.FeatureId not in (Select top {5} vPrjFeatureSim.FeatureId from vPrjFeatureSim Left Join {1} on {2} where {3} order by {4} {6}) order by {4} {6} ",
