...
strSQL = $"Select Top {intPageSize} vFunctionGroupRela.* " + 
$"from vFunctionGroupRela " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and vFunctionGroupRela.mId not in " + 
$"(Select top {intTop_In} vFunctionGroupRela.mId from vFunctionGroupRela " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
