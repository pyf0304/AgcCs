...
strSQL = $"Select Top {intPageSize} PrjProcess.* " + 
$"from PrjProcess " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and PrjProcess.PrjProcessId not in " + 
$"(Select top {intTop_In} PrjProcess.PrjProcessId from PrjProcess " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
