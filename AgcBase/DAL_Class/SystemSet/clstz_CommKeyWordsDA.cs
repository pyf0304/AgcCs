...
strSQL = $"Select Top {intPageSize} tz_CommKeyWords.* " + 
$"from tz_CommKeyWords " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and tz_CommKeyWords.KeyId not in " + 
$"(Select top {intTop_In} tz_CommKeyWords.KeyId from tz_CommKeyWords " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
