...
strSQL = $"Select Top {intPageSize} vCacheUseState.* " + 
$"from vCacheUseState " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and vCacheUseState.mId not in " + 
$"(Select top {intTop_In} vCacheUseState.mId from vCacheUseState " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
