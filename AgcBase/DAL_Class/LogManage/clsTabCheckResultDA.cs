...
strSQL = $"Select Top {intPageSize} TabCheckResult.* " + 
$"from TabCheckResult " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and TabCheckResult.mId not in " + 
$"(Select top {intTop_In} TabCheckResult.mId from TabCheckResult " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
