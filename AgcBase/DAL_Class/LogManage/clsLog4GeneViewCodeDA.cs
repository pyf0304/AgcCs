...
strSQL = $"Select Top {intPageSize} Log4GeneViewCode.* " + 
$"from Log4GeneViewCode " + 
$"{strLeftLinkStr} " + 
$"where {strCondition} and Log4GeneViewCode.mId not in " + 
$"(Select top {intTop_In} Log4GeneViewCode.mId from Log4GeneViewCode " + 
$"{strLeftLinkStr} " +
$" where {strCondition} " + 
