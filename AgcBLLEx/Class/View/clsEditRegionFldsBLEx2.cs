...
namespace AGC.BusinessLogicEx
{
    ...
    public partial class clsEditRegionFldsBLEx
    {
        ...
        public static bool ReplaceField(string strPrjId, string strSourceFldId, string strTargetFldId)
        {
            clsSpecSQLforSql objSQL = new clsSpecSQLforSql();
            string strSQL;
            strSQL = $"Update EditRegionFlds Set {conEditRegionFlds.FldId} = '{strTargetFldId}' where {conEditRegionFlds.PrjId} = '{strPrjId}' And {conEditRegionFlds.FldId} = '{strSourceFldId}'";
