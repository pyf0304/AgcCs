...
{
    public partial class clsCtlTypeBLEx : clsCtlTypeBL
    {
        public const string
        BUTTONTYPE = "01", //命令按钮
        CHECKBOXTYPE = "02", //检查框
        ...
        {
            clsCtlTypeEN objCtlTypeEN = GetObjByCtlTypeIdCache(strCtlTypeId);
            string mstrCtrlId = objCtlTypeEN.CtlTypeAbbr + strFldName;
            return mstrCtrlId;
        ...
        {
            List<clsCtlTypeEN> arrCtlType = GetObjLstCache();
            foreach(clsCtlTypeEN objInFor in arrCtlType)
            {
        ...
        public static List<clsCtlTypeEN> arrCtlTypeObjLst = null;
        //public const string 
        //    BUTTONTYPE                              = "01", //命令按钮
        //    CHECKBOXTYPE                            = "02", //检查框
        //    CHECKBOXLISTTYPE                        = "03", //检查框列表
        ...
        //    clsCtlTypeEN objCtlType;
        //    //初始化一个对象列表
        //    ArrayList CtlTypeList = new ArrayList();
        //    //插入第0项。在第0项中插入“请选择...”,为了方便用户,与WEB方式类似。
        //    objCtlType = new clsCtlTypeEN();
        //    objCtlType.CtlTypeId = "0";
        //    objCtlType.CtlTypeName = "请选择...";
        //    CtlTypeList.Add(objCtlType);
        //    //把DataTable中的所有项均加到对象列表中
        //    foreach(DataRow objRow in objDT.Rows)
        //    {
        //        objCtlType = new clsCtlTypeEN();
        //        objCtlType.CtlTypeId = objRow["CtlTypeId"].ToString();
        //        objCtlType.CtlTypeName = objRow["CtlTypeName"].ToString();
        //        CtlTypeList.Add(objCtlType);
        //    }
        //    //设置下拉框的数据源、以及设置值项、显示项
        //    objComboBox.DataSource = CtlTypeList;
        ...
        public static clsCtlTypeEN GetCtlTypeObjByCtlTypeId(string strCtlTypeId)
        {
            if (arrCtlTypeObjLst == null)
            {
                arrCtlTypeObjLst = clsCtlTypeBL.GetObjLst("1 = 1");
            }
            foreach (clsCtlTypeEN objCtlType in arrCtlTypeObjLst)
            {
                if (objCtlType.CtlTypeId == strCtlTypeId)
                {
                    return objCtlType;
                }
            }
        ...
        public static void BindDdl_CtlTypeIdCacheEx(System.Web.UI.WebControls.DropDownList objDDL)
        {
            //为下拉框专业设置内容	
            ListItem li = new ListItem("请选择...", "0");
            //System.Data.DataTable objDT = GetCtlTypeId();
            var arrCtlTypeENObjLst = clsCtlTypeBL.GetObjLstCache();
            arrCtlTypeENObjLst = arrCtlTypeENObjLst
                .OrderBy(x => x.OrderNum)
                .ToList();
            if (arrCtlTypeENObjLst.Count > 0)
            {
                objDDL.DataValueField = "CtlTypeId";
                objDDL.DataTextField = "CtlTypeName";
                objDDL.DataSource = arrCtlTypeENObjLst;
                objDDL.DataBind();
            }
            objDDL.Items.Insert(0, li);
            objDDL.SelectedIndex = 0;
        }
        public static void BindDdl_CtlTypeIdCacheEx(System.Web.UI.WebControls.DropDownList objDDL, bool bolIsForApple)
        {
            //为下拉框专业设置内容	
            ListItem li = new ListItem("请选择...", "0");
            //System.Data.DataTable objDT = GetCtlTypeId();
            var arrCtlTypeENObjLst = clsCtlTypeBL.GetObjLstCache()
                .Where(x=>x.IsForApple == bolIsForApple)
                .OrderBy(x=>x.OrderNum);
            if (arrCtlTypeENObjLst.Count() > 0)
            {
                objDDL.DataValueField = "CtlTypeId";
