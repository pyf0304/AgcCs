...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class WA_ViewScript_TS4Html : clsGeneCodeBase4View
    {
       ...
       : base(strViewId, "", "")
        ...
        public WA_ViewScript_TS4Html(string strViewId, string strPrjDataBaseId, string strPrjId)
  ...
  clsFuncPara4CodeBLEx.GetObjListByFuncId4CodeCacheEx(objFunction4GeneCodeEN.FuncId4Code, enumFunctionPurpose.GeneCode_01);
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            if (objViewInfoENEx.arrFeatureRegionFlds == null || objViewInfoENEx.arrFeatureRegionFlds.Count == 0)
            {
                StringBuilder sbMessage = new StringBuilder();
                string strViewName = objViewInfoENEx.ViewName;
                sbMessage.AppendFormat("当前所选界面名称:{0},在该界面中没有功能区域,或者功能区域没有相关功能。请检查!", strViewName);                
                throw new clsDbObjException(sbMessage.ToString());
            }
  ...
  objViewInfoENEx.LangType, objViewInfoENEx.CodeTypeId, objViewInfoENEx.SqlDsTypeId);
            ...
            try
            {
                ...
                else
                {
                    ...
                    strCodeForCs.AppendFormat("\r\n" + "ViewData[\"Title\"] = \"{0}维护\";", objViewInfoENEx.TabCnName);
        ...
        public string Gen_WApi_Cs4Ts_DefDiv4DetailRegion()
        {
            ...
            strCodeForCs.AppendFormat("\r\n" + " <button  id=\"btnOKUpd_{0}\" type=\"button\" class=\"btn btn-primary\" onclick=\"Submit_{0}()\">添加</button>", objViewInfoENEx.TabName_In);
            strCodeForCs.Append("\r\n" + " </div>");
            strCodeForCs.Append("\r\n" + " </div>");
            strCodeForCs.Append("\r\n" + " <!-- /.modal-content -->");
            strCodeForCs.Append("\r\n" + " </div>");
