...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class WebViewCode4Html : clsGeneCodeBase4View
    {
        ...
        public WebViewCode4Html(string strViewId)
       : base( strViewId, "", "")
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public WebViewCode4Html( string strViewId, string strPrjDataBaseId, string strPrjId)
        ...
        /// </summary>
        /// <returns></returns>
        public string GenUpdInsRecViewCode(clsViewInfoENEx objViewInfoENEx, ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            string strFuncName = "";
            StringBuilder strCodeForCs = new StringBuilder();  ///用来存放WebForm的代码;
            //			string strTemp ;     ///临时变量;
            ...
            objViewInfoENEx.WebFormName = "wfm" + objViewInfoENEx.TabName + "B_UI";
            objViewInfoENEx.WebFormFName = objViewInfoENEx.FolderName + "wfm" + objViewInfoENEx.TabName + "B_UI.aspx";
            ...
            try
            {
                  ...
                  || objViewInfoENEx.objViewTypeCodeTab.IsHaveUpdate)
                {
                    ...
                    strCodeForCs.Append("\r\n" + "<asp:Label id = \"lblMsg_Edit\" style = \"z-index: 105; left: 54px; position: relative; top: 1px; Width:208px;\" runat = \"server\" ");
                    strCodeForCs.Append("\r\n" + " CssClass = \"text-warning\" ></asp:Label>");

                    strCodeForCs.Append("\r\n" + "<asp:Button id = \"btnOKUpd\" style = \"z-index: 106; left: 68px; position: relative; top: 4px; Width:80px\" runat = \"server\" ");
                    strCodeForCs.Append("\r\n" + "Text = \"添加\" OnClick = \"btnOKUpd_Click\" CssClass = \"btn btn-primary btn-sm\"></asp:Button>");
                    if (objViewInfoENEx.objViewTypeCodeTab.IsHaveQuery)
                    {
                        strCodeForCs.AppendFormat("\r\n" + "<asp:LinkButton id = \"lbDisp{0}List\" style = \"z-index: 107; left: 90px; position: relative; top: 4px; Width:100px\"",
                          objViewInfoENEx.TabName);

                        strCodeForCs.AppendFormat("\r\n" + "runat = \"server\" CssClass = \"LinkButton_Defa\" OnClick = \"lbDisp{1}List_Click\" Text = \"显示{0}列表\"></asp:LinkButton>",
                          objViewInfoENEx.objInRelaTab.TabCnName,
                          objViewInfoENEx.TabName);
                    }
                    strCodeForCs.Append("\r\n" + "</div>");
        ...
        public string GeneCode4FeatureRegion()
        {
            StringBuilder strCodeForCs = new StringBuilder();  ///用来存放WebForm的代码;
            //			string strTemp ;     ///临时变量;
            strCodeForCs.Append("\r\n" + "<%-- 功能区 --%>");
        ...
        public string GeneCode4QueryRegion()
        {
            StringBuilder strCodeForCs = new StringBuilder();  ///用来存放WebForm的代码;
            //			string strTemp ;     ///临时变量;
            strCodeForCs.Append("\r\n" + "<%-- 查询层 --%>");
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            objViewInfoENEx.WebFormFName = string.Format("{0}{1}.aspx", objViewInfoENEx.FolderName , this.ClsName);
            objViewInfoENEx.FileName = objViewInfoENEx.WebFormFName;
            objViewInfoENEx.ClsName = objViewInfoENEx.WebFormName;
            ...
            try
            {
                ...
                if (objViewInfoENEx.ApplicationTypeId2 == "04")
                {
                    strCodeForCs.AppendFormat("\r\n" + "<%@ Page language = \"c#\" AutoEventWireup = \"true\" CodeFile = \"{0}.aspx.cs\" Inherits = \"{1}.Webform.{0}\" %>",
                       objViewInfoENEx.WebFormName, objViewInfoENEx.NameSpace);
                }
                else
                {
                    strCodeForCs.AppendFormat("\r\n" + "<%@ Page language = \"c#\" AutoEventWireup = \"true\" CodeBehind = \"{0}.aspx.cs\" Inherits = \"{1}.Webform.{2}\" %>",
        ...
        public string GeneCode11(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            //        return GenUpdInsRecViewCode(objViewInfoENEx, ref strRe_ClsName, ref strRe_FileNameWithModuleName);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(WebViewCode4Html);
