...
namespace AutoGCLib
{
    ...
    partial class Vue_ViewScript_Detail4Html : clsGeneCodeBase4View
    {
        ...
        public Vue_ViewScript_Detail4Html(string strViewId)
       : base(strViewId, "", "")
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public Vue_ViewScript_Detail4Html(string strViewId, string strPrjDataBaseId, string strPrjId)
  ...
  objViewInfoENEx.LangType, objViewInfoENEx.CodeTypeId, objViewInfoENEx.SqlDsTypeId);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(Vue_ViewScript_Detail4Html);
