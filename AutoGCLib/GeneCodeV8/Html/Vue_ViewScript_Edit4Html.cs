...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class Vue_ViewScript_Edit4Html : clsGeneCodeBase4View
    {
        ...
        #region 构造函数
        public Vue_ViewScript_Edit4Html()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public Vue_ViewScript_Edit4Html(string strViewId)
       : base(strViewId, "", "")
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public Vue_ViewScript_Edit4Html(string strViewId, string strPrjDataBaseId, string strPrjId)
  ...
  clsFuncPara4CodeBLEx.GetObjListByFuncId4CodeCacheEx(objFunction4GeneCodeEN.FuncId4Code, enumFunctionPurpose.GeneCode_01);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(Vue_ViewScript_Edit4Html);
