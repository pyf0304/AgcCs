...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class WebCtlViewCode4Gv4Html : clsGeneCodeBase4View
    {
       ...
       : base(strViewId, "", "")
        ...
        public WebCtlViewCode4Gv4Html( string strViewId, string strPrjDataBaseId, string strPrjId)
...
//                                     strCodeForCs.Append("\r\n" + "<asp:LinkButton id = \"lbSelAll\" CommandName = \"lbSelAll\" runat = \"server\" CssClass = \"btn btn-link btn-sm text-nowrap\" Text = \"全选\"></asp:LinkButton>");
                ...
                List<clsDGRegionFldsENEx> arrDGRegionFldSet_Sel = objViewInfoENEx.arrListRegionFldSet
