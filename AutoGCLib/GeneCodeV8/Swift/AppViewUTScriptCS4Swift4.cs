...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class AppViewUTScriptCS4Swift4 : AppController4Swift4Base
    {


        #region 构造函数

        public AppViewUTScriptCS4Swift4(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            try
            {
                ...
                foreach (clsvFunction4GeneCodeEN objvFunction4GeneCodeEN in arrvFunction4GeneCodeObjLst)
                {
                    ...
                    //string strTemp = "";
                    if (strFuncName.IndexOf("Swift4_DeclareButton") > 0)
                    {
                ...
                foreach (clsvFunction4GeneCodeEN objvFunction4GeneCodeEN in arrvFunction4GeneCodeObjLst)
                {
                    strFuncName = objvFunction4GeneCodeEN.FuncName;
                    //string strTemp = "";
                    if ((strFuncName.IndexOf("Swift4_btnClick") > 0) || (strFuncName.IndexOf("Swift4_btn") > 0))
                    {
                        strTemp =  A_GeneFuncCode(objvFunction4GeneCodeEN, ref Re_objFunction4Code);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(AppViewUTScriptCS4Swift4);
