...
namespace AutoGCLib
{
    ...
    partial class AppController4Swift4Base : clsGeneCodeBase4Tab
    {
        ...
        public string Gen_Controller_Swift4_btnClickGetJSONObjByKey()
        {
        ...
        public string Gen_Controller_Swift4_btnClickGetFirstJSONObj()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的第一条记录的对象");
        ...
        public string Gen_Controller_Swift4_btnClickByCommonFunction(clsWebSrvFunctionsENEx objWebSrvFunctionsENEx)
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            ...
            strBuilder.AppendFormat("\r\n" + "@IBAction func btn{0}_Click(_ sender: Any) ",
                objWebSrvFunctionsENEx.FunctionName);
            strBuilder.Append("\r\n" + "{");
            strBuilder.AppendFormat("\r\n" + "let iobj{0}_{1} : icls{0}_{1}Ex = icls{0}_{1}Ex(pvcParent: self);",
                objWebSrvClassENEx.ClsName, objWebSrvFunctionsENEx.FunctionName);
            strBuilder.AppendFormat("\r\n" + "iobj{0}_{1}.main();",
                objWebSrvClassENEx.ClsName, objWebSrvFunctionsENEx.FunctionName);

            strBuilder.Append("\r\n" + "}");
            strBuilder.AppendFormat("\r\n" + "class icls{0}_{1}Ex : icls{0}_{1}",
                objWebSrvClassENEx.ClsName, objWebSrvFunctionsENEx.FunctionName);
            strBuilder.Append("\r\n" + "{");
            strBuilder.Append("\r\n" + "//定义一个本界面对象, 类型为本界面类名, 用于操作本界面的属性、函数");
        ...
        public string Gen_Controller_Swift4_btnClickGetJSONObjLst()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的对象列表");
        ...
        public string Gen_Controller_Swift4_btnClickGetTopJSONObjLst()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的顶部多条对象列表");
        ...
        public string Gen_Controller_Swift4_btnClickGetJSONObjLstByPager()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的顶部多条对象列表");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_Controller_Swift4_btnClickIsExistRecord()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 检查相应关键字的记录是否存在");
        ...
        ///// </summary>
        ///// <returns></returns>
        //public string Gen_Controller_Swift4_btnClickGetRecCountByCond()
        //{
        //    StringBuilder strBuilder = new StringBuilder();
        //    strBuilder.Append("\r\n /// <summary>");
        //    strBuilder.Append("\r\n /// 获取相应条件的记录数");
        ...
        //    strBuilder.AppendFormat("\r\n" + "class icls{0}_IsGetRecCountByCondEx : icls{0}GetRecCountByCond",
        //        objPrjTabENEx.TabName);
        //    strBuilder.Append("\r\n" + "{");
        //    strBuilder.Append("\r\n" + "//定义一个本界面对象, 类型为本界面类名, 用于操作本界面的属性、函数");
        //    strBuilder.AppendFormat("\r\n" + "const objParentView : vc{0}_UnitTest;//vc{0}_QUDI为本界面类名",
        ...
        //    strBuilder.AppendFormat("\r\n" + "let strInfo : String = \"根据条件：‘{0}='12'’的记录数: \\(returnInt)!\"",
        //        objKeyField.FldName);
        //    strBuilder.Append("\r\n" + "//显示信息框");
        //    strBuilder.Append("\r\n" + "clsPubFun.myAlert(strInfo: strInfo, vcObj: vcParent as! UIViewController);");
        ...
        public string Gen_Controller_Swift4_btnClickDelRecord()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 删除记录");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_Controller_Swift4_btnClickAddNewRecord()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 添加新记录");
        ...
        public string Gen_Controller_Swift4_btnClickAddNewRecord4GetMaxStrId()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 添加新记录");
        ...
        public string Gen_Controller_Swift4_btnClickGetMaxStrId()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
        ...
        public string Gen_Controller_Swift4_btnClickGetMaxStrIdByPrefix()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
        ...
        public string Gen_Controller_Swift4_btnClickUpdateRecord()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 修改记录");
        ...
        public string A_GeneFuncCode_Swift4_btnClick(string strFuncName)
        {
            try
            {
                switch (strFuncName)
                {
                    ...
                    case "Gen_Controller_Swift4_btnClickGetFirstJSONObj":
                    case "Gen_Controller_Swift4_btnClickGetFirstJSONObj_Click4tvc":
                        return Gen_Controller_Swift4_btnClickGetFirstJSONObj();

                    case "Gen_Controller_Swift4_btnClickGetJSONObjByKey":
                    case "Gen_Controller_Swift4_btnClickGetJSONObjByKey_Click4tvc":
                        return Gen_Controller_Swift4_btnClickGetJSONObjByKey();


                    case "Gen_Controller_Swift4_btnClickDelRecord":
                    case "Gen_Controller_Swift4_btnClickDelRecord_Click4tvc":
                        return Gen_Controller_Swift4_btnClickDelRecord();


                    case "Gen_Controller_Swift4_btnClickAddNewRecord":
                    case "Gen_Controller_Swift4_btnClickAddNewRecord_Click4tvc":
                        return Gen_Controller_Swift4_btnClickAddNewRecord();


                    case "Gen_Controller_Swift4_btnClickAddNewRecord4GetMaxStrId":
                    case "Gen_Controller_Swift4_btnClickAddNewRecord4GetMaxStrId_Click4tvc":
                        return Gen_Controller_Swift4_btnClickAddNewRecord4GetMaxStrId();
                    case "Gen_Controller_Swift4_btnClickGetMaxStrId":
                    case "Gen_Controller_Swift4_btnClickGetMaxStrId_Click4tvc":
                        return Gen_Controller_Swift4_btnClickGetMaxStrId();
                    case "Gen_Controller_Swift4_btnClickGetMaxStrIdByPrefix":
                    case "Gen_Controller_Swift4_btnClickGetMaxStrIdByPrefix_Click4tvc":
                        return Gen_Controller_Swift4_btnClickGetMaxStrIdByPrefix();


                    case "Gen_Controller_Swift4_btnClickUpdateRecord":
                    case "Gen_Controller_Swift4_btnClickUpdateRecord_Click4tvc":
                        return Gen_Controller_Swift4_btnClickUpdateRecord();

                    case "Gen_Controller_Swift4_btnClickIsExistRecord":
                    case "Gen_Controller_Swift4_btnClickIsExistRecord_Click4tvc":
                        return Gen_Controller_Swift4_btnClickIsExistRecord();

                    case "Gen_Controller_Swift4_btnClickGetRecCountByCond":
                        return Gen_Controller_Swift4_btnClickGetRecCountByCond();

                    case "Gen_Controller_Swift4_btnClickGetJSONObjLst":
                    case "Gen_Controller_Swift4_btnClickGetJSONObjLst_Click4tvc":
                        return Gen_Controller_Swift4_btnClickGetJSONObjLst();
                    case "Gen_Controller_Swift4_btnClickGetTopJSONObjLst":
                    case "Gen_Controller_Swift4_btnClickGetTopJSONObjLst_Click4tvc":
                        return Gen_Controller_Swift4_btnClickGetTopJSONObjLst();
                    case "Gen_Controller_Swift4_btnClickGetJSONObjLstByPager":
                        return Gen_Controller_Swift4_btnClickGetJSONObjLstByPager();
