...
namespace AutoGCLib
{
    ...
    partial class AppController4Swift4Base : clsGeneCodeBase4Tab    
    {
        ...
        public string Gen_Controller_Swift4_iclsGetJSONObjByKey()
        {
            ...
            strBuilder.Append("\r\n" + "clsPubFun.myAlert(strInfo: objResponseData.faultString, vcObj: vcParent as! UIViewController);");
        ...
        public string Gen_Controller_Swift4_iclsGetFirstJSONObj()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的第一条记录的对象");
        ...
        public string Gen_Controller_Swift4_iclsByCommonFunction(clsWebSrvFunctionsENEx objWebSrvFunctionsENEx)
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
        ...
        public string Gen_Controller_Swift4_iclsGetJSONObjLst()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的对象列表");
        ...
        public string Gen_Controller_Swift4_iclsGetTopJSONObjLst()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的顶部多条对象列表");
        ...
        public string Gen_Controller_Swift4_iclsGetJSONObjLstByPager()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的分页多条对象列表");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_Controller_Swift4_iclsIsExistRecord()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 检查相应关键字的记录是否存在");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_Controller_Swift4_iclsGetRecCountByCond()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取表中相应的记录数");
        ...
        public string Gen_Controller_Swift4_iclsDelRecord()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 删除记录");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_Controller_Swift4_iclsAddNewRecord()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 添加新记录");
        ...
        public string Gen_Controller_Swift4_iclsAddNewRecord4GetMaxStrId()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 添加新记录");
        ...
        public string Gen_Controller_Swift4_iclsGetMaxStrId()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
        ...
        public string Gen_Controller_Swift4_iclsGetMaxStrIdByPrefix()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
        ...
        public string Gen_Controller_Swift4_iclsUpdateRecord()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 修改记录");
        ...
        public string A_GeneFuncCode_Swift4_icls(string strFuncName)
        {
            try
            {
                switch (strFuncName)
                {
                    case "Gen_Controller_Swift4_iclsGetFirstJSONObj":
                    case "Gen_Controller_Swift4_iclsGetFirstJSONObj_Click4tvc":
                        return Gen_Controller_Swift4_iclsGetFirstJSONObj();

                    case "Gen_Controller_Swift4_iclsGetJSONObjByKey":
                    case "Gen_Controller_Swift4_iclsGetJSONObjByKey_Click4tvc":
                        return Gen_Controller_Swift4_iclsGetJSONObjByKey();


                    case "Gen_Controller_Swift4_iclsDelRecord":
                    case "Gen_Controller_Swift4_iclsDelRecord_Click4tvc":
                        return Gen_Controller_Swift4_iclsDelRecord();


                    case "Gen_Controller_Swift4_iclsAddNewRecord":
                    case "Gen_Controller_Swift4_iclsAddNewRecord_Click4tvc":
                        return Gen_Controller_Swift4_iclsAddNewRecord();


                    case "Gen_Controller_Swift4_iclsAddNewRecord4GetMaxStrId":
                    case "Gen_Controller_Swift4_iclsAddNewRecord4GetMaxStrId_Click4tvc":
                        return Gen_Controller_Swift4_iclsAddNewRecord4GetMaxStrId();
                    case "Gen_Controller_Swift4_iclsGetMaxStrId":
                    case "Gen_Controller_Swift4_iclsGetMaxStrId_Click4tvc":
                        return Gen_Controller_Swift4_iclsGetMaxStrId();
                    case "Gen_Controller_Swift4_iclsGetMaxStrIdByPrefix":
                    case "Gen_Controller_Swift4_iclsGetMaxStrIdByPrefix_Click4tvc":
                        return Gen_Controller_Swift4_iclsGetMaxStrIdByPrefix();


                    case "Gen_Controller_Swift4_iclsUpdateRecord":
                    case "Gen_Controller_Swift4_iclsUpdateRecord_Click4tvc":
                        return Gen_Controller_Swift4_iclsUpdateRecord();

                    case "Gen_Controller_Swift4_iclsIsExistRecord":
                    case "Gen_Controller_Swift4_iclsIsExistRecord_Click4tvc":
                        return Gen_Controller_Swift4_iclsIsExistRecord();

                    case "Gen_Controller_Swift4_iclsGetRecCountByCond":
                        return Gen_Controller_Swift4_iclsGetRecCountByCond();

                    case "Gen_Controller_Swift4_iclsGetJSONObjLst":
                    case "Gen_Controller_Swift4_iclsGetJSONObjLst_Click4tvc":
                        return Gen_Controller_Swift4_iclsGetJSONObjLst();
                    case "Gen_Controller_Swift4_iclsGetTopJSONObjLst":
                    case "Gen_Controller_Swift4_iclsGetTopJSONObjLst_Click4tvc":
                        return Gen_Controller_Swift4_iclsGetTopJSONObjLst();

                    case "Gen_Controller_Swift4_iclsGetJSONObjLstByPager":
                        return Gen_Controller_Swift4_iclsGetJSONObjLstByPager();
