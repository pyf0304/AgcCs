...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class Mvc_View_QueryAjax4CSharp : clsGeneCodeBase4View
    {
        clsBiDimDistribute objBiDimDistribue4Qry = null;

        //		private objViewInfoENEx.FileName;		//生成的文件名；
        #region 构造函数
        public Mvc_View_QueryAjax4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public Mvc_View_QueryAjax4CSharp(string strViewId)
       : base(strViewId, "", "")
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public Mvc_View_QueryAjax4CSharp( string strViewId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            objViewInfoENEx.WebFormName = string.Format("{0}QueryAjax", objViewInfoENEx.TabName_Out);
        ...
        public string Gen_MvcView_EditRegionSpa()
        {
            ...
            try
            {
                ...
                strCodeForCs.Append("\r\n" + "                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">×</span></button>");
                strCodeForCs.AppendFormat("\r\n" + "          <h4 class=\"modal-title\" id=\"lblDialogTitle_{1}\">{0}编辑</h4>", 
                    objViewInfoENEx.TabCnName, objViewInfoENEx.TabName_In);
                strCodeForCs.Append("\r\n" + "                @Html.ValidationSummary(true, \"\", new { @class = \"text-danger\" })");
                strCodeForCs.Append("\r\n" + "            </div>");
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(Mvc_View_QueryAjax4CSharp);
        ...
        {
            this.ClsName = string.Format("{0}QueryAjax", objViewInfoENEx.TabName_Out);
