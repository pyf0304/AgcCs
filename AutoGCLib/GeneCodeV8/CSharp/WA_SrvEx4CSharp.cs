...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class WA_SrvEx4CSharp : clsGeneCodeBase4Tab
    {

        #region 构造函数

        public WA_SrvEx4CSharp(string strTabId,  string strPrjDataBaseId, string strPrjId)
        ...
        public string Gen_WAEx_EditRecordEx()
        {
            StringBuilder strBuilder = new StringBuilder();
            string strFuncName = "";
            try
            {
                ...
                strBuilder.AppendFormat("\r\n" + "public ActionResult EditRecordEx([FromBody]cls{0}EN obj{0})",
                ...
                strBuilder.AppendFormat("\r\n" + "bool bolResult =true;//如果要使用,解除注释---- obj{0}.EditRecordEx();", objPrjTabENEx.TabName);
