...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class Mvc_Model_List4CSharp : clsGeneCodeBase4View
    {
        //int intZIndex;      ///控件焦点序号
        //float intCurrLeft;  ///控件的左边空;
        //float intCurrTop;  ///控件的顶面空;
        #region 构造函数
        public Mvc_Model_List4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public Mvc_Model_List4CSharp(string strViewId)
       : base(strViewId, "", "")
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public Mvc_Model_List4CSharp( string strViewId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            //string strFolder;
            //string strTemp;
            objViewInfoENEx.MvcModelExName = string.Format("LstModel4{0}", objViewInfoENEx.TabName_Out);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(Mvc_Model_List4CSharp);
        ...
        {
            this.ClsName = string.Format("LstModel4{0}", objViewInfoENEx.TabName);
