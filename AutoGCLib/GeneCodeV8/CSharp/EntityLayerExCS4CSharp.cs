...
namespace AutoGCLib
{
    ...
    /// </summary>
    class EntityLayerExCS4CSharp : clsGeneCodeBase4Tab
    {


        #region 构造函数

        public EntityLayerExCS4CSharp(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(EntityLayerExCS4CSharp);
