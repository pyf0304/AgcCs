...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class RelaWA_Access4CSharp : clsGeneCodeBase4Tab
    {
        private string strKeyFldName_ObjName = "";

        #region 构造函数

        public RelaWA_Access4CSharp(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(RelaWA_Access4CSharp);
...
objPrjTabENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_GetRelationProperty4Object()
        {
            StringBuilder strBuilder = new StringBuilder();
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_DelRelation()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据关键字删除记录");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_DelMultiRelation()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据关键字列表删除记录");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_DelRelations()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据关键字列表删除记录");
            ...
            strBuilder.Append("\r\n /// </summary>");
            strBuilder.Append("\r\n /// <returns>实际删除记录的个数</returns>");
            strBuilder.AppendFormat("\r\n" + "public static int DelRelations(string strKeyIdLst)",
            objPrjTabENEx.TabName, objKeyField.FldName);
            strBuilder.Append("\r\n" + "{");
            strBuilder.AppendFormat("\r\n" + "string strAction = \"DelRelations\";", objPrjTabENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_DelMultiRelationByCond()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件删除记录");
        ...
        public string Gen_4WA_AddNewRelationWithMaxId()
        {
            ...
            strBuilder.Append("\r\n /// </summary>");
            strBuilder.Append("\r\n /// <returns>是否成功?</returns>");
            strBuilder.AppendFormat("\r\n" + "public static bool AddNewRelationWithMaxId(cls{0}EN obj{0}EN)",
            objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
            strBuilder.Append("\r\n" + "string strAction = \"AddNewRelationWithMaxId\";");
        ...
        public string Gen_4WA_AddNewRelation()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 添加记录");
            ...
            objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
            strBuilder.Append("\r\n" + "string strAction = \"AddNewRelation\";");
        ...
        public string Gen_4WA_DefineObjCommFun4BL()
        {
            ...
            //strBuilder.Append("\r\n" + "public static event OnAddNewRelation onAddNewRelation;");
            //strBuilder.Append("\r\n" + "public static event OnUpdateRelation onUpdateRelation;");
            //strBuilder.Append("\r\n" + "public static event OnDeleteRelation onDelRelation;");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "CopyTo", "Copy表:{0} 对象数据出错!", "生成代码");
        ...
        public string Gen_4WA_ToDataTable()
        {
            ...
            strBuilder.AppendFormat("\r\n" + "if (cls{0}EN._AttributeName.Length == 0)", objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
            strBuilder.Append("\r\n" + "result = dataTable;");
            strBuilder.Append("\r\n" + "return result;");
            strBuilder.Append("\r\n" + "}");
            ...
            strBuilder.Append("\r\n" + "{");
            strBuilder.Append("\r\n" + "//Columns");
            strBuilder.AppendFormat("\r\n" + "foreach (string strAttrName in cls{0}EN._AttributeName)", objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
        ...
        public string Gen_4WA_UpdateRelation()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 修改记录");
            ...
            strBuilder.Append("\r\n" + "string strAction = \"UpdateRelation\";");
        ...
        public string Gen_4WA_IsExistRelation()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件判断是否存在记录");
            ...
            strBuilder.Append("\r\n" + "{");
            strBuilder.Append("\r\n" + "//检测记录是否存在");
            strBuilder.Append("\r\n" + "string strAction = \"IsExistRelation\";");
            ...
            //strBuilder.AppendFormat("\r\n" + "{0}ServiceSoapClient obj{0}Service = Get{0}ServiceSoapClient();",
            //objPrjTabENEx.TabName);
            //strBuilder.AppendFormat("\r\n" + "bool bolIsExist = obj{0}Service.IsExistRelation(strWhereCond);",
            //objPrjTabENEx.TabName);
            //strBuilder.Append("\r\n" + "return bolIsExist;");
            strBuilder.Append("\r\n" + "}");
            return strBuilder.ToString();
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_AddNewRelationWithReturnKey()
        {
            ...
            strBuilder.AppendFormat("\r\n" + "public static string AddNewRelationWithReturnKey(cls{0}EN obj{0}EN)",
            objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
            strBuilder.Append("\r\n" + "string strAction = \"AddNewRelation\";");
        ...
        public string Gen_4WA_InitListCache()
        {
            ...
            //{
            //    List<string> arrTabId = clsPrjTabBLEx.GetRelaParentRelationByTabId(objPrjTabENEx.TabId, objPrjTabENEx.PrjId);
        ...
        public string Gen_4WA_GetObjByKeyCache()
        {
            ...
            if (objPrjTabENEx.IsUseCache_TS() == false) return $"//该表没有使用Cache,不需要生成[GetObjBy{objKeyField.FldName}Cache()]函数;(in {clsStackTrace.GetCurrClassFunction()})";
        ...
        public string Gen_4WA_Static_UpdateRelation()
        {
            StringBuilder strBuilder = new StringBuilder();
            string strErrId = clsErrorIdManageBLEx.GetMaxErrIdWithAddRecAndCheckDuplicate(objPrjTabENEx.CodeTypeId,
                objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "UpdateRelation_Static", "修改记录时关键字不能为空!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "bool bolResult = {0}_UpdateRelation(obj{0}EN);",
            objPrjTabENEx.TabName);
            //strBuilder.Append("\r\n" + "  //引发修改记录的事件");
            //strBuilder.Append("\r\n" + "try");
            //strBuilder.Append("\r\n" + "{");
            ...
            strErrId = clsErrorIdManageBLEx.GetMaxErrIdWithAddRecAndCheckDuplicate(objPrjTabENEx.CodeTypeId,
                objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "UpdateRelation_Static", "修改结点出错!", "生成代码");
        ...
        public string Gen_4WA_Static_AddNewRelation()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            ...
            strBuilder.AppendFormat("\r\n" + "bool bolResult = {0}_AddNewRelation(obj{0}EN);",
            objPrjTabENEx.TabName);
            //strBuilder.Append("\r\n" + "  //引发添加新记录的事件");
            //strBuilder.Append("\r\n" + "try");
            //strBuilder.Append("\r\n" + "{");
            //strBuilder.AppendFormat("\r\n" + "    onAddNewRelation?.Invoke(obj{0}EN);", TabName);
            //strBuilder.Append("\r\n" + "}");
            //strBuilder.Append("\r\n" + "catch (Exception objException)");
            //strBuilder.Append("\r\n" + "{");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "AddNewRelation_Static", "纯静态添加记录出错!", "生成代码");
            ...
            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"(errid:{22})添加记录出错!({1}:AddNewRelationBySql2)\\r\\n\" + objException.Message);",
            //  objPrjTabENEx.TabName, objPrjTabENEx.ClsName, strErrId);

            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"添加记录出错!({1}: AddNewRelationBySQL2)\\r\\n\" + objException.Message);",
            //   objPrjTabENEx.TabName, objPrjTabENEx.ClsName);
            strBuilder.Append("\r\n" + "}");
        ...
        public string Gen_4WA_Static_AddNewRelationWithMaxId()
        {
            if (objKeyField.ObjFieldTabENEx.objDataTypeAbbrEN.CsType != "string") return "";
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
