...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class CommFun4WA4CSharp : clsGeneCodeBase4Tab
    {

        #region 构造函数

        public CommFun4WA4CSharp()
        {
        }

        public CommFun4WA4CSharp(string strTabId,  string strPrjDataBaseId, string strPrjId)
        ...
        public string GeneCode_This(clsPrjTabENEx objPrjTabENEx, string strCmPrjId)
        {
            ...
            string strCodeTypeENName = "CommFun4WA";
            string strProgLangTypeId = enumProgLangType.CSharp_01;
            clsCodeTypeEN objCodeType_CommFun4WA = arrCodeTypeCache.Find(x => x.ProgLangTypeId == strProgLangTypeId
            ...
            IEnumerable<clsvFunction4GeneCodeEN> arrvFunction4GeneCodeObjLst =
                         ...
                         objPrjTabENEx.LangType, objCodeType_CommFun4WA.CodeTypeId, objPrjTabENEx.SqlDsTypeId)
                .OrderBy(x => x.OrderNum);
            if (arrvFunction4GeneCodeObjLst.Count() == 0)
            {
                string strMsg = string.Format("表名:{4}({5}), 语言类型:{0}, 代码类型:{1}, Sql类型：{2}({3})==>没有可以生成的函数4GC!",
                    objPrjTabENEx.LangType, clsCodeTypeBL.GetNameByCodeTypeIdCache(objCodeType_CommFun4WA.CodeTypeId),
                    clsSQLDSTypeBL.GetNameBySqlDsTypeIdCache(objPrjTabENEx.SqlDsTypeId), objPrjTabENEx.SqlDsTypeId,
                    objPrjTabENEx.TabName, objPrjTabENEx.TabId);
                return strMsg;
            }
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(CommFun4WA4CSharp);
        ...
        public string Gen_4BL_ReFreshCache()
        {
            ...
            strCodeForCs.Append("\r\n" + "return;");
            strCodeForCs.Append("\r\n" + "}");
            strCodeForCs.AppendFormat("\r\n" + "if (cls{0}WApi.objCommFun4BL != null) ",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "{");
            ...
            strCodeForCs.AppendFormat("\r\n" + "arr{0}ObjLstCache = null;",
                   objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "cls{0}WApi.objCommFun4BL.ReFreshCache();",
                objPrjTabENEx.TabName);
