...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class Mvc_View4CSharp : clsGeneCodeBase4View
    {
        ...
        public Mvc_View4CSharp(string strViewId)
       : base(strViewId, "", "")
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public Mvc_View4CSharp( string strViewId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            objViewInfoENEx.WebFormName = string.Format("{0}CRUD", objViewInfoENEx.TabName);
            ...
            strCodeForCs.Append("\r\n" + "    }");
            strCodeForCs.Append("\r\n" + "}");
            strCodeForCs.AppendFormat("\r\n" + "<h2>{0}</h2>", objViewInfoENEx.ViewCnName);
        ...
        public string A_GenMvcViewLstAjax(clsViewInfoENEx objViewInfoENEx, ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            string strFuncName = "";
            this.objViewInfoENEx = objViewInfoENEx;
            //让用户设置属性;
        ...
        public string Gen_MvcView_Partial_EditRegion()
        {
            ...
            {
                ///生成插入记录的界面代码;
                strCodeForCs.AppendFormat("\r\n" + "@Html.Partial(\"{0}Edit\")", objViewInfoENEx.TabName_In);
            }
            catch (Exception ex)
            {
                clsEntityBase.LogErrorS(ex, "");
        ...
        public string Gen_MvcView_Partial_QueryRegion()
        {
            ...
            {
                ///生成插入记录的界面代码;
                strCodeForCs.AppendFormat("\r\n" + "@Html.Partial(\"{0}Query\")", objViewInfoENEx.TabName_Out);
            }
            catch (Exception ex)
            {
                clsEntityBase.LogErrorS(ex, "");
        ...
        public string Gen_MvcView_ListRegion()
        {
            ...
            if (objViewInfoENEx.arrListRegionFldSet == null)
            {
                StringBuilder sbMessage = new StringBuilder();
                string strViewName = objViewInfoENEx.ViewName;
            ...
            try
            {
                ...
                strCodeForCs.AppendFormat("\r\n" + "@using (Html.BeginForm(\"Command4List\", \"{0}\", FormMethod.Post))",
                    objMainPrjTab.TabName);
                strCodeForCs.Append("\r\n" + "        {");
                ...
                strCodeForCs.Append("\r\n" + "            </div>");
                strCodeForCs.Append("\r\n" + GenFunctionRegion());
                //    strCodeForCs.Append("\r\n" + "<input id=\"btnCreate\" name=\"action: Create\" value=\"添加\" type=\"submit\" class=\"btn btn-default\" />");
                //strCodeForCs.Append("\r\n" + "<input id=\"btnUpdate\" name=\"action: Update\" value=\"修改\" type=\"submit\" class=\"btn btn-default\" />");
                //strCodeForCs.Append("\r\n" + "<input id=\"btnDelRecords\" name=\"action: DelRecords\" value=\"删除\" type=\"submit\" class=\"btn btn-default\" />");

                //strCodeForCs.Append("\r\n" + "            <div class=\"panel-footer\">");
                //strCodeForCs.AppendFormat("\r\n" + "                @Html.ActionLink(\"添加一个新的{0}\", \"Create\", null,",
                //    objViewInfoENEx.TabCnName);
        ...
        {
            string strFuncName = clsStackTrace.GetCurrFunction();
            StringBuilder strCodeForCs = new StringBuilder();  ///用来存放WebForm的代码;
            ...
            try
            {
                ...
                if (objViewInfoENEx.objViewRegion_List.IsHaveUpdBtn() == true)   //在DG中是否有修改按钮
                {
                    ...
                    strCodeForCs.AppendFormat("\r\n" + "      @Html.ActionLink(\"修改\", \"UpdateInTab\", \"{0}\", new {{ {1} = @item.{1} }}, new {{ @class = \"btn btn-default\" }})",
                ...
                if (objViewInfoENEx.objViewRegion_List.IsJumpPage() == true)
                {
                    ...
                    intCurrTop += objViewInfoENEx.objViewRegion_List.Height ?? 0 + 5;
                    intCurrLeft = 10;
                }
                else
                {
        ...
        public string GenFunctionRegion()
        {
            StringBuilder strCodeForCs = new StringBuilder();  ///用来存放WebForm的代码;
            //int iDGHeight;      //DataGrid的高度
            ...
            try
            {
                ...
                ASPDivEx objASPNETDivENEx = clsASPDivBLEx.GetEmptyDiv();
                objASPNETDivENEx.Class = "panel-footer";
                if (objViewInfoENEx.objViewRegion_List.IsCheck() == true || objViewInfoENEx.objViewRegion_List.IsRadio() == true)
                {
                    ...
                    {
                        ASPButtonEx objASPNETButtonENEx = clsASPButtonBLEx.GetbtnAddNewRec4Gv(true);
                        objASPNETDivENEx.arrSubAspControlLst2.Add(objASPNETButtonENEx);
                    }
                    if (objViewInfoENEx.arrFeatureId.Contains("0141") == true)//复制记录
                    {
                        ASPButtonEx objASPNETButtonENEx = clsASPButtonBLEx.GetbtnClone(true);
                        objASPNETDivENEx.arrSubAspControlLst2.Add(objASPNETButtonENEx);

                    }
                    if (objViewInfoENEx.objViewTypeCodeTab.IsHaveDel == true)
                    {
                        ASPButtonEx objASPNETButtonENEx = clsASPButtonBLEx.GetbtnDelete4Gv(true);
                        objASPNETDivENEx.arrSubAspControlLst2.Add(objASPNETButtonENEx);
                    ...
                    if (objViewInfoENEx.objViewTypeCodeTab.IsHaveUpdate == true)
                    {
                        ...
                        ASPButtonEx objASPNETButtonENEx = clsASPButtonBLEx.GetbtnUpdate4Gv(true);
                        objASPNETDivENEx.arrSubAspControlLst2.Add(objASPNETButtonENEx);
                    }
                    ...
                    {
                        ASPButtonEx objASPNETButtonENEx = clsASPButtonBLEx.GetbtnDetail4Gv(true);
                        objASPNETDivENEx.arrSubAspControlLst2.Add(objASPNETButtonENEx);
                    }
                    if (objViewInfoENEx.arrFeatureId.Contains("0142") == true)//调整 次序
                    {
                        //List<ASPButtonEx> arrAspNetButton4AdjustOrderNum = new List<ASPButtonEx>();
                        ASPButtonEx objASPNETButtonENEx = clsASPButtonBLEx.GetbtnGoTop(true);
                        objASPNETDivENEx.arrSubAspControlLst2.Add(objASPNETButtonENEx);

                        objASPNETButtonENEx = clsASPButtonBLEx.GetbtnUpMove(true);
                        objASPNETDivENEx.arrSubAspControlLst2.Add(objASPNETButtonENEx);

                        objASPNETButtonENEx = clsASPButtonBLEx.GetbtnDownMove(true);
                        objASPNETDivENEx.arrSubAspControlLst2.Add(objASPNETButtonENEx);

                        objASPNETButtonENEx = clsASPButtonBLEx.GetbtnGoBottum(true);
                        objASPNETDivENEx.arrSubAspControlLst2.Add(objASPNETButtonENEx);

                        objASPNETButtonENEx = clsASPButtonBLEx.GetbtnReOrder(true);
                        objASPNETDivENEx.arrSubAspControlLst2.Add(objASPNETButtonENEx);

                    }
                    if (objViewInfoENEx.objViewTypeCodeTab.IsHaveExcelExport == true)
                    {
                        ASPButtonEx objASPNETButtonENEx = clsASPButtonBLEx.GetbtnExportExcel4Gv(true);
                        objASPNETDivENEx.arrSubAspControlLst2.Add(objASPNETButtonENEx);
                    }
                    if (objViewInfoENEx.IsNeedSetExportFld == true &&
                          objViewInfoENEx.objViewTypeCodeTab.IsHaveSetExportExcel == true)
                    {
                        ASPButtonEx objASPNETButtonENEx = clsASPButtonBLEx.GetbtnSetExportExcel4User(true);
                        objASPNETDivENEx.arrSubAspControlLst2.Add(objASPNETButtonENEx);
                    }
        ...
        {
            this.ClsName = string.Format("{0}CRUD", objViewInfoENEx.TabName);
