...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class WA_AccessEx4CSharp : clsGeneCodeBase4Tab
    {

        #region 构造函数

      
        public WA_AccessEx4CSharp(string strTabId,  string strPrjDataBaseId, string strPrjId)
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(WA_AccessEx4CSharp);
...
/// <summary>
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "CopyToEx_Static", "静态Copy表:{0} 对象数据出错!", "生成代码");
        ...
        public string Gen_4WAEx_EditRecordEx()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 修改记录");
        ...
        public string Gen_4WAEx_Static_EditRecordEx()
        {
            StringBuilder strBuilder = new StringBuilder();
            string strErrId = clsErrorIdManageBLEx.GetMaxErrIdWithAddRecAndCheckDuplicate(objPrjTabENEx.CodeTypeId,
                objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "EditRecordEx_Static", "编辑记录时关键字不能为空!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "public static bool EditRecordEx(this cls{0}EN obj{0}EN)",
            objPrjTabENEx.TabName);
            ...
            strBuilder.AppendFormat("\r\n" + "bool bolResult = cls{0}ExWApi.EditRecordEx(obj{0}EN);",
            objPrjTabENEx.TabName);
            //strBuilder.Append("\r\n" + "  //引发修改记录的事件");
            //strBuilder.Append("\r\n" + "try");
            //strBuilder.Append("\r\n" + "{");
            ...
            {
                strBuilder.AppendFormat("\r\n" + "cls{0}WApi.ReFreshCache(obj{0}EN.{1});", objPrjTabENEx.TabName, objPrjTabENEx.objCacheClassifyFld.FldName);
            ...
            strErrId = clsErrorIdManageBLEx.GetMaxErrIdWithAddRecAndCheckDuplicate(objPrjTabENEx.CodeTypeId,
                objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "EditRecordEx_Static", "编辑记录出错!", "生成代码");
