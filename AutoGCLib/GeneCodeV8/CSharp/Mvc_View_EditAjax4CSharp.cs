...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class Mvc_View_EditAjax4CSharp : clsGeneCodeBase4View
    {

        //		private objViewInfoENEx.FileName;		//生成的文件名；
        #region 构造函数
        public Mvc_View_EditAjax4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public Mvc_View_EditAjax4CSharp(string strViewId)
       : base(strViewId, "", "")
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public Mvc_View_EditAjax4CSharp( string strViewId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            objViewInfoENEx.WebFormName = string.Format("{0}EditAjax", objViewInfoENEx.TabName_In);
            ...
            strCodeForCs.AppendFormat("\r\n" + "@model {0}Mvc.Models.EditModel4{1}", objProjectsENEx.PrjDomain, objMainPrjTab.TabName);
            strCodeForCs.Append("\r\n" + "@{");
            ...
            try
            {
                ...
                strCodeForCs.Append("\r\n" + " var strUpdateTargetId = \"\";");
                strCodeForCs.Append("\r\n" + " if (strOperate == \"Update\" || strOperate == \"Add\")");
                strCodeForCs.Append("\r\n" + " {");
                strCodeForCs.Append("\r\n" + " strUpdateTargetId = \"UpdateTargetId:Edit\";");
                strCodeForCs.Append("\r\n" + " }");
                strCodeForCs.Append("\r\n" + "if (strOperate == \"Add\")");
                strCodeForCs.Append("\r\n" + "{");
                strCodeForCs.Append("\r\n" + "ShowEditDialog();");
        ...
        public string Gen_MvcView_EditRegionAjax()
        {
            ...
            //    @using(Ajax.BeginForm("SaveAjax", "Student", new AjaxOptions { UpdateTargetId = "divLstTab_vStudent" }))
            //{
                    strCodeForCs.AppendFormat("\r\n" + "      @using (Ajax.BeginForm(\"SaveAjax\", \"{0}\", new AjaxOptions {{ UpdateTargetId = \"divLstTab_{1}\" }}))",
                ...
                strCodeForCs.Append("\r\n" + "                @Html.ValidationSummary(true, \"\", new { @class = \"text-danger\" })");
                strCodeForCs.Append("\r\n" + "                <span id=\"spnEditErr\" class=\"text-danger\"></span>");
                strCodeForCs.Append("\r\n" + "            </div>");
                ...
                strCodeForCs.Append("\r\n" + "                     <ul class=\"nav\">");
                strCodeForCs.Append("\r\n" + "                         <li class=\"nav-item\">");
                strCodeForCs.Append("\r\n" + "                             <input type=\"submit\" value=\"@btnSaveName\" class=\"btn btn-outline-info\" name=\"btnSave\" id=\"btnSave\" />");
                strCodeForCs.Append("\r\n" + "                         </li>");
                strCodeForCs.Append("\r\n" + "                         <li class=\"nav-item ml-2\">");
                strCodeForCs.Append("\r\n" + "                             <button class=\"btn btn-outline-info\" data-dismiss=\"modal\">取消</button>");
                strCodeForCs.Append("\r\n" + "                         </li>");
                strCodeForCs.Append("\r\n" + "                     </ul>");
                strCodeForCs.Append("\r\n" + "                </div>");
                strCodeForCs.Append("\r\n" + "            }");
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(Mvc_View_EditAjax4CSharp);
        ...
        {
            this.ClsName = string.Format("{0}EditAjax", objViewInfoENEx.TabName_In);
