...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class NodeWA_Srv4CSharp : clsGeneCodeBase4Tab
    {
        ...
        public NodeWA_Srv4CSharp(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(NodeWA_Srv4CSharp);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_GetNodeProperty(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            clsFunction4GeneCodeEN objFunction4GeneCodeEN = clsFunction4GeneCodeBL.GetObjByFuncId4GCCache(objvFunction4GeneCodeEN.FuncId4GC);
    ...
    objPrjTabENEx.objCacheClassifyFld2.CsType, objPrjTabENEx.objCacheClassifyFld2.PrivFuncName);
        ...
        public string Gen_DelNodeBySign(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            clsFunction4GeneCodeEN objFunction4GeneCodeEN = clsFunction4GeneCodeBL.GetObjByFuncId4GCCache(objvFunction4GeneCodeEN.FuncId4GC);
            ...
            strBuilder.Append("\r\n /// 根据标志删除关键字列表");
            string strQueryString4ParaLst = clsFuncPara4CodeBLEx.GC_GetQueryStringLst4FuncPara(objFunction4GeneCodeEN.FuncId4Code);
            strBuilder.AppendFormat("\r\n /// 调用方法: POST /api/{0}api/DelNodeBySign",
              objPrjTabENEx.TabName,
            objKeyField.FldName_FstUcase);
            ...
            strBuilder.Append("\r\n" + "[HttpPost]");
            strBuilder.AppendFormat("\r\n" + "public ActionResult DelNodeBySign([FromBody]string[] arr{1})",
                    objPrjTabENEx.TabName,
                    objKeyField.FldName_FstUcase);
            strBuilder.Append("\r\n" + "{");
            ...
            strBuilder.Append("\r\n try");
            strBuilder.Append("\r\n {");
            strBuilder.AppendFormat("\r\n" + "int intRecNum = cls{0}BL.DelNodeBySign(lst{1});",
            objPrjTabENEx.TabName, objKeyField.FldName_FstUcase);
        ...
        public string Gen_UnDelNodeBySign(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            clsFunction4GeneCodeEN objFunction4GeneCodeEN = clsFunction4GeneCodeBL.GetObjByFuncId4GCCache(objvFunction4GeneCodeEN.FuncId4GC);
            ...
            strBuilder.Append("\r\n /// 根据标志恢复删除的记录列表");
            string strQueryString4ParaLst = clsFuncPara4CodeBLEx.GC_GetQueryStringLst4FuncPara(objFunction4GeneCodeEN.FuncId4Code);
            strBuilder.AppendFormat("\r\n /// 调用方法: POST /api/{0}api/UnDelNodeBySign",
              objPrjTabENEx.TabName,
            objKeyField.FldName_FstUcase);
            ...
            strBuilder.Append("\r\n" + "[HttpPost]");
            strBuilder.AppendFormat("\r\n" + "public ActionResult UnDelNodeBySign([FromBody]string[] arr{1})",
                    objPrjTabENEx.TabName,
                    objKeyField.FldName_FstUcase);
            strBuilder.Append("\r\n" + "{");
            ...
            strBuilder.Append("\r\n try");
            strBuilder.Append("\r\n {");
            strBuilder.AppendFormat("\r\n" + "int intRecNum = cls{0}BL.UnDelNodeBySign(lst{1});",
            objPrjTabENEx.TabName, objKeyField.FldName_FstUcase);
            //strBuilder.AppendFormat("\r\n" + "return intRecNum;");
            strBuilder.Append("\r\n" + "return Json(new { errorId = 0, errorMsg = \"\", returnInt = intRecNum });");
        ...
        public string Gen_GetNodePropertyV(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            clsFunction4GeneCodeEN objFunction4GeneCodeEN = clsFunction4GeneCodeBL.GetObjByFuncId4GCCache(objvFunction4GeneCodeEN.FuncId4GC);
        ...
        public string Gen_IsExistNodeByCond(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            clsFunction4GeneCodeEN objFunction4GeneCodeEN = clsFunction4GeneCodeBL.GetObjByFuncId4GCCache(objvFunction4GeneCodeEN.FuncId4GC);
            ...
            strBuilder.Append("\r\n" + "[HttpGet]");
            strBuilder.AppendFormat("\r\n" + "public ActionResult IsExistNode(string strWhereCond)",
                    objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
            ...
            strBuilder.Append("\r\n try");
            strBuilder.Append("\r\n {");
            strBuilder.AppendFormat("\r\n" + "bool bolIsExist = cls{0}BL.IsExistNode(strWhereCond);",
                    objPrjTabENEx.TabName);
        ...
        public string Gen_AddNewNode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            clsFunction4GeneCodeEN objFunction4GeneCodeEN = clsFunction4GeneCodeBL.GetObjByFuncId4GCCache(objvFunction4GeneCodeEN.FuncId4GC);
            ...
            strBuilder.Append("\r\n /// <returns>是否成功</returns>");
            strBuilder.Append("\r\n" + "[HttpPost]");
            strBuilder.AppendFormat("\r\n" + "public ActionResult AddNewNode([FromBody]cls{0}EN obj{0}EN)",
                    objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
            ...
            strBuilder.AppendFormat("\r\n" + "bool bolResult = obj{0}EN.AddNewNode();",
            objPrjTabENEx.TabName);
            //strBuilder.Append("\r\n" + "return bolResult;");
            strBuilder.Append("\r\n" + "return Json(new { errorId = 0, errorMsg = \"\", returnBool = bolResult });");
        ...
        public string Gen_AddNewNodeWithMaxId(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            ...
            strBuilder.Append("\r\n /// <returns>是否成功</returns>");
            strBuilder.Append("\r\n" + "[HttpPost]");
            strBuilder.AppendFormat("\r\n" + "public ActionResult AddNewNodeWithMaxId([FromBody]cls{0}EN obj{0}EN)",
                    objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
        ...
        public string Gen_UpdateNode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            clsFunction4GeneCodeEN objFunction4GeneCodeEN = clsFunction4GeneCodeBL.GetObjByFuncId4GCCache(objvFunction4GeneCodeEN.FuncId4GC);
            ...
            strBuilder.Append("\r\n /// <returns>是否成功</returns>");
            strBuilder.Append("\r\n" + "[HttpPost]");
            strBuilder.AppendFormat("\r\n" + "public ActionResult UpdateNode([FromBody]cls{0}EN obj{0}EN)",
                    objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
            ...
            strBuilder.AppendFormat("\r\n" + "bool bolResult = obj{0}EN.UpdateNode();",
            objPrjTabENEx.TabName);
            //strBuilder.Append("\r\n" + "return bolResult;");
            strBuilder.Append("\r\n" + "return Json(new { errorId = 0, errorMsg = \"\", returnBool = bolResult });");
        ...
        public string Gen_DelNode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            clsFunction4GeneCodeEN objFunction4GeneCodeEN = clsFunction4GeneCodeBL.GetObjByFuncId4GCCache(objvFunction4GeneCodeEN.FuncId4GC);
            ...
            strBuilder.Append("\r\n" + "[HttpDelete]");
            strBuilder.AppendFormat("\r\n" + "public ActionResult DelNode({1} Id)",
            ...
            strBuilder.Append("\r\n try");
            strBuilder.Append("\r\n {");
            strBuilder.AppendFormat("\r\n" + "int intRecNum = cls{0}BL.DelNode({1});",
        ...
        public string Gen_DelNodeBySP(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            clsFunction4GeneCodeEN objFunction4GeneCodeEN = clsFunction4GeneCodeBL.GetObjByFuncId4GCCache(objvFunction4GeneCodeEN.FuncId4GC);
            ...
            strBuilder.Append("\r\n" + "[HttpGet]");
            strBuilder.AppendFormat("\r\n" + "public ActionResult DelNodeBySP({1})",
            objPrjTabENEx.TabName, objPrjTabENEx.KeyVarDefineLstStr);
            strBuilder.Append("\r\n" + "{");
            ...
            strBuilder.AppendFormat("\r\n" + "bool bolResult = cls{0}BL.DelNodeBySP({1});",
            objPrjTabENEx.TabName, objPrjTabENEx.KeyPrivFuncFldNameLstStr);
            //strBuilder.Append("\r\n" + "return bolResult;");
            strBuilder.Append("\r\n" + "return Json(new { errorId = 0, errorMsg = \"\", returnBool = bolResult });");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_DelMultiNode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            clsFunction4GeneCodeEN objFunction4GeneCodeEN = clsFunction4GeneCodeBL.GetObjByFuncId4GCCache(objvFunction4GeneCodeEN.FuncId4GC);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_DelNodes(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            clsFunction4GeneCodeEN objFunction4GeneCodeEN = clsFunction4GeneCodeBL.GetObjByFuncId4GCCache(objvFunction4GeneCodeEN.FuncId4GC);
            ...
            strBuilder.Append("\r\n /// <returns>返回删除的记录数</returns>");
            strBuilder.Append("\r\n" + "[HttpPost]");
            strBuilder.AppendFormat("\r\n" + "public ActionResult DelNodes([FromBody]string strKeyIdLst)",
                 objPrjTabENEx.TabName, objKeyField.FldName);
            strBuilder.Append("\r\n" + "{");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_DelMultiNodeByCond(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            clsFunction4GeneCodeEN objFunction4GeneCodeEN = clsFunction4GeneCodeBL.GetObjByFuncId4GCCache(objvFunction4GeneCodeEN.FuncId4GC);
            ...
            foreach (clsPrjTabFldENEx objField in objPrjTabENEx.arrFldSet)
            {
                ...
                if (objField.IsTabUnique == true && objField.FieldTypeId != enumFieldType.KeyField_02)
                {
                  ...
                  + objField.ObjFieldTabENEx.FldName + " = '{1}'\", " + objKeyField.PrivFuncName + ", " + objField.ObjFieldTabENEx.PrivFuncName + ");");
                    strBuilder.AppendFormat("\r\nif (new cls{0}BL.IsExistNode(sbCondition.ToString()) == true)",
                    objPrjTabENEx.TabName);
                    strBuilder.Append("\r\n{");
                    strBuilder.Append("\r\nreturn false;");
                    strBuilder.Append("\r\n}");
        ...
        public string Gen_AddNewNodeWithReturnKey(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            clsFunction4GeneCodeEN objFunction4GeneCodeEN = clsFunction4GeneCodeBL.GetObjByFuncId4GCCache(objvFunction4GeneCodeEN.FuncId4GC);
            ...
            strBuilder.Append("\r\n" + "[HttpPost]");
            strBuilder.AppendFormat("\r\n" + "public ActionResult AddNewNodeWithReturnKey(cls{0}EN obj{0}EN)",
            objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
            ...
            strBuilder.Append("\r\n" + "try");
            strBuilder.Append("\r\n" + "{");
            strBuilder.AppendFormat("\r\n" + "string strKey = cls{0}BL.AddNewNodeBySql2WithReturnKey(obj{0}EN);",
            objPrjTabENEx.TabName);
