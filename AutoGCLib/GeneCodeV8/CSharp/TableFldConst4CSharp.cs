...
namespace AutoGCLib
{
    ...
    /// </summary>
    class TableFldConst4CSharp : clsGeneCodeBase4Tab
    {
        ...
        public TableFldConst4CSharp(string strTabId,  string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            try
            {
                ...
                strCodeForCs.Append("\r\n" + "public static class " + objPrjTabENEx.ClsName );
        ...
        public string GeneCode_This(clsPrjTabENEx objPrjTabENEx, string strCmPrjId)
        {
            ...
            IEnumerable<clsvFunction4GeneCodeEN> arrvFunction4GeneCodeObjLst =
                         ...
                         objPrjTabENEx.LangType, objCodeType_TableFldConst.CodeTypeId, objPrjTabENEx.SqlDsTypeId);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(TableFldConst4CSharp);
