...
namespace AutoGCLib
{
    ...
    /// </summary>
    class EntityLayerCS4CSharp : clsGeneCodeBase4Tab
    {


        #region 构造函数

        public EntityLayerCS4CSharp(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            try
            {
                ...
                string strConstCode = new TableFldConst4CSharp(this.TabId, this.PrjDataBaseId, this.PrjId).GeneCode_This(objPrjTabENEx, this.CmPrjId);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(EntityLayerCS4CSharp);
        ...
        public string GenClsProperty()
        {
            ...
            foreach (clsPrjTabFldENEx objField in objPrjTabENEx.arrFldSet)
            {
                string strTemp = clsPrjTabFldBLEx.ToString2(objField, objPrjTabENEx.LangType, false);
                if (string.IsNullOrEmpty(strTemp) == false)
                {
                    strBuilder.Append("\r\n" + strTemp);
                }
