...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class BusinessLogicEx4CSharp : clsGeneCodeBase4Tab
    {
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            try
            {
                ...
                strCodeForCs.Append("\r\n" + "{");
                strTemp = A_GeneFuncCodeByFuncName("Gen_4BLEx_Class_RelatedActionsEx");
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(BusinessLogicEx4CSharp);
        ...
        public string Gen_4BLEx_DefineUniqueInstance4DALEx()
        {
            StringBuilder strCodeForCs = new StringBuilder();
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetDataTableVByRange", "获取表视图带范围数据出错!(同时检查是否含有SQL攻击)", "生成代码");
        ...
        public string Gen_4BLEx_GetObjExLst()
        {
            StringBuilder strBuilder = new StringBuilder();
            //获取某一条件值的记录集-----------------------------;
            strBuilder.Append("\r\n /// <summary>");
            ...
            strBuilder.AppendFormat("\r\n" + "public static List<cls{0}ENEx> GetObjExLst(string strCondition)",
            objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
        ...
        public string Gen_4BLEx_Static_CopyToEx()
        {
            StringBuilder strBuilder = new StringBuilder();
            //获取某一条件值的记录集-----------------------------;
            strBuilder.Append("\r\n /// <summary>");
            ...
            strBuilder.Append("\r\n" + "{");
            string strErrId = "000";
            // lsErrorIdManageBLEx.GetMaxErrIdWithAddRecAndCheckDuplicate(objPrjTabENEx.CodeTypeId,
      //objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "CopyToEx_Static0", "静态CopyEx表,对象数据出错!", "生成代码");
        ...
        public string Gen_4BLEx_CopyToEx()
        {
            StringBuilder strBuilder = new StringBuilder();
            //获取某一条件值的记录集-----------------------------;
            strBuilder.Append("\r\n /// <summary>");
            ...
            strBuilder.Append("\r\n" + "{");
            string strErrId = clsErrorIdManageBLEx.GetMaxErrIdWithAddRecAndCheckDuplicate(objPrjTabENEx.CodeTypeId,
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "CopyToEx_StaticEx", "Copy表Ex对象数据出错!", "生成代码");
        ...
        public string Gen_4BLEx_Static_CopyTo()
        {
            StringBuilder strBuilder = new StringBuilder();
            //获取某一条件值的记录集-----------------------------;
            strBuilder.Append("\r\n /// <summary>");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "CopyTo__Static", "静态Copy表:{0} 对象数据出错!", "生成代码");
        ...
        public string Gen_4BLEx_GetObjExByKey()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.AppendFormat("\r\n /// <summary>");
            ...
            if (objPrjTabENEx.arrKeyFldSet.Count > 1)
            {
                ...
                strBuilder.AppendFormat("\r\n" + "public static cls{0}ENEx GetObjExByKeyLst({1})",
                objPrjTabENEx.TabName, objPrjTabENEx.KeyVarDefineLstStr, objKeyField.FldName);
                strBuilder.Append("\r\n" + "{");
    ...
    objPrjTabENEx.TabName, strValueFieldName, "{", "}");
        ...
        public string Gen_4BLEx_Class_RelatedActionsEx()
        {
            ...
            strBuilder.AppendFormat("\r\n /// ({0})", clsStackTrace.GetCurrClassFunction());
            strBuilder.Append("\r\n /// </summary>");
            strBuilder.AppendFormat("\r\n" + " public class RelatedActions_{0}Ex: RelatedActions_{0}", objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
            strBuilder.AppendFormat("\r\n" + "public override bool UpdRelaTabDate({0}, string strOpUser)", objPrjTabENEx.KeyVarDefineLstStr);
            strBuilder.Append("\r\n" + "{");
