...
namespace AutoGCLib
{
    ...
    /// </summary>
    class EntityLayer4CSharp_MySql : clsGeneCodeBase4Tab
    {
       
        #region 构造函数

        public EntityLayer4CSharp_MySql(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(EntityLayer4CSharp_MySql);
        ...
        public string GenAddnewRecBySP()
        {
            ...
            string strTemp = string.Format("public bool Addnew{0}BySP(cls{0}EN obj{0})",
            objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + strTemp);
            strBuilder.Append("\r\n{");
            strBuilder.Append("\r\n//通过存储过程来");
