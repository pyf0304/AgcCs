...
namespace AutoGCLib
{
    ...
    /// </summary>
    class CondEntityLayer4CSharp : clsGeneCodeBase4Tab  
    {


        #region 构造函数

        public CondEntityLayer4CSharp(string strTabId,  string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            objPrjTabENEx.ClsName = "clsCond_" + objPrjTabENEx.TabName + "EN";
            ...
            try
            {
                ...
                strCodeForCs.Append("\r\n" + "public Dictionary<string, string> dicFldComparisonOp;//条件对象的字段比较运算符");
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(CondEntityLayer4CSharp);
        ...
        {
            this.ClsName = string.Format("clsCond_{0}EN", objPrjTabENEx.TabName);
