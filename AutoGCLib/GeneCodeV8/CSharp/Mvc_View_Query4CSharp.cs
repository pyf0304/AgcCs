...
namespace AutoGCLib
{
    ...
    public class Mvc_View_Query4CSharp : clsGeneCodeBase4View
    {
        ...
        public Mvc_View_Query4CSharp(string strViewId)
       : base(strViewId, "", "")
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public Mvc_View_Query4CSharp(string strViewId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            objViewInfoENEx.WebFormName = string.Format("{0}Query", objViewInfoENEx.TabName_Out);
        ...
        public string Gen_MvcView_EditRegion()
        {
            ...
            try
            {
                ...
                strCodeForCs.AppendFormat("\r\n" + "@* 生成的针对Mvc View 的编辑区域 *@");
                strCodeForCs.AppendFormat("\r\n" + "@* 生成函数:{0} *@", clsStackTrace.GetCurrClassFunction());
                strCodeForCs.AppendFormat("\r\n" + "<div class=\"modal fade\" id=\"divEdit_{0}\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"lblDialogTitle_{0}\" aria-hidden=\"true\">",
        ...
        public string GenInsRecViewCode(clsViewInfoENEx objViewInfoENEx, ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            try
            {
                ...
                if (objViewInfoENEx.objViewTypeCodeTab.IsHaveQuery == true)
                {
                    ...
                    strCodeForCs.Append("\r\n" + "<%-- 列表层 --%>");
                    strCodeForCs.Append("\r\n" + GenFunctionRegion(objViewInfoENEx.objViewRegion_List, objViewInfoENEx));
            ...
            try
            {
                ...
                strCodeForCs.AppendFormat("\r\n" + "@Html.EditorFor(model => model.qryModel4{0}.{1}, new {{ htmlAttributes = new {{ @class = \"easyui -textbox\" }} }})",
                    ...
                    case "DropDownList":
                        ...
                        {
                            strCodeForCs.AppendFormat("\r\n" + "@Html.DropDownListFor(model => model.qryModel4{0}.{1}, ViewData[\"TrueAndFalseList\"] as List<SelectListItem>, new {{ @class = \"form-control\", id=\"{2}\", style = \"width:300px; \", onchange = \"{2}Selected()\" }})",
                                objViewInfoENEx.TabName_Out, strFldName, strCtlId);
                        }
                        else
                        {
                            clsPrjTabEN objPrjTab = clsPrjTabBL.GetObjByTabIdCache(strDsTabId, objProjectsENEx.PrjId);
                            strCodeForCs.AppendFormat("\r\n" + "@Html.DropDownListFor(model => model.qryModel4{0}.{1}, ViewData[\"{2}List\"] as List<SelectListItem>, new {{ @class = \"form-control\", id=\"{3}\", style = \"width:300px; \", onchange = \"{3}Selected()\" }})", 
                                objViewInfoENEx.TabName_Out, strFldName, objPrjTab.TabName, strCtlId);
                        }
                        break;
                    default:
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(Mvc_View_Query4CSharp);
        ...
        {
            this.ClsName = string.Format("{0}Query", objViewInfoENEx.TabName_Out);
