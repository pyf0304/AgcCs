...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class NodeWA_AccessEx4CSharp : clsGeneCodeBase4Tab  
    {

        #region 构造函数

     
        public NodeWA_AccessEx4CSharp(string strTabId,  string strPrjDataBaseId, string strPrjId)
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(NodeWA_AccessEx4CSharp);
...
/// <summary>
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "CopyToEx_Static", "静态Copy表:{0} 对象数据出错!", "生成代码");
        ...
        public string Gen_4WAEx_EditNodeEx()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 修改记录");
            ...
            strBuilder.AppendFormat("\r\n" + "public static bool EditNodeEx(cls{0}EN obj{0}EN)",
            objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
        ...
        public string Gen_4WAEx_UpdateNodeEx()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 修改记录");
            ...
            strBuilder.Append("\r\n /// </summary>");
            strBuilder.Append("\r\n /// <returns>是否成功?</returns>");
            strBuilder.AppendFormat("\r\n" + "public static bool UpdateNodeEx(cls{0}EN obj{0}EN)",
            objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
            strBuilder.AppendFormat("\r\n" + "if (string.IsNullOrEmpty(obj{0}EN.sfUpdFldSetStr) == true)", objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
        ...
        public string Gen_4WAEx_AddNodeEx()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 修改记录");
            ...
            strBuilder.Append("\r\n /// </summary>");
            strBuilder.Append("\r\n /// <returns>是否成功?</returns>");
            strBuilder.AppendFormat("\r\n" + "public static bool AddNodeEx(cls{0}EN obj{0}EN)",
            objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
        

            strBuilder.Append("\r\n" + "string strAction = \"AddNodeEx\";");
        ...
        public string Gen_4WAEx_Static_EditNodeEx()
        {
            StringBuilder strBuilder = new StringBuilder();
            string strErrId = clsErrorIdManageBLEx.GetMaxErrIdWithAddRecAndCheckDuplicate(objPrjTabENEx.CodeTypeId,
                objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "EditNodeEx_Static", "编辑记录时关键字不能为空!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "public static bool EditNodeEx(this cls{0}EN obj{0}EN)",
            objPrjTabENEx.TabName);
            ...
            strBuilder.AppendFormat("\r\n" + "bool bolResult = cls{0}ExWApi.EditNodeEx(obj{0}EN);",
            objPrjTabENEx.TabName);
            //strBuilder.Append("\r\n" + "  //引发修改记录的事件");
            //strBuilder.Append("\r\n" + "try");
            //strBuilder.Append("\r\n" + "{");
            ...
            strErrId = clsErrorIdManageBLEx.GetMaxErrIdWithAddRecAndCheckDuplicate(objPrjTabENEx.CodeTypeId,
                objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "EditNodeEx_Static", "编辑记录出错!", "生成代码");
        ...
        public string Gen_4WAEx_Static_AddNodeEx()
        {
            string strFuncName = "";
            ...
            try
            {
                ...
                strCodeForCs.Append("\r\n" + "try");
                strCodeForCs.Append("\r\n" + "{");
                strCodeForCs.AppendFormat("\r\n" + "bool bolResult = cls{0}ExWApi.AddNodeEx(obj{0}EN);",
                         objPrjTabENEx.TabName);
                strCodeForCs.Append("\r\n" + "// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用");
                strCodeForCs.AppendFormat("\r\n" + "{0}_ReFreshCache();", objPrjTabENEx.TabName);
                strCodeForCs.Append("\r\n" + "return bolResult;");
                ...
                strErrId = clsErrorIdManageBLEx.GetMaxErrIdWithAddRecAndCheckDuplicate(objPrjTabENEx.CodeTypeId,
                    objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "Add{0}NodeSave", "添加记录不成功!", "生成代码");
        ...
        public string Gen_4WAEx_Static_UpdateNodeEx()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            string strFuncName = "";
            try
            {
                ...
                strCodeForCs.AppendFormat("\r\n" + "bool bolResult = cls{0}ExWApi.UpdateNodeEx(obj{0}EN);",
                    objPrjTabENEx.TabName);
                strCodeForCs.Append("\r\n" + "// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用");
                strCodeForCs.AppendFormat("\r\n" + "{0}_ReFreshCache();", objPrjTabENEx.TabName);
                strCodeForCs.Append("\r\n" + "return bolResult;");
