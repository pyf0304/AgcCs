...
namespace AutoGCLib
{
    ...
    partial class BusinessLogic4Mvc4CSharp : clsGeneCodeBase4Tab
    {
        ...
        public BusinessLogic4Mvc4CSharp(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            objPrjTabENEx.ClsName = "cls" + objPrjTabENEx.TabName + "BL4Mvc";
            ...
            try
            {
                ...
                //objvFunction4GeneCodeEN1 = clsvFunction4GeneCodeBLEx.GetObjByFuncNameCacheEx("Gen_4BL_GeneEnumConstList4Field");
                ...
                StringBuilder strCodeForCs4Func = new StringBuilder(); ///用来存放与WebForm相关的类文件代码;
                ...
                if (strCodeForCs4Func.ToString().Length<=10)
                {
                    return "";
                }
                strCodeForCs.Append(strCodeForCs4Func.ToString());
                strCodeForCs.Append("\r\n" + "}");
                strCodeForCs.Append("\r\n" + "}");
            }
            catch (Exception ex)
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(BusinessLogic4Mvc4CSharp);
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetDataTable_{0}(string strWhereCond)", "获取表数据出错_{0}!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取表数据出错!(strWhereCond = {{2}})({{0}}->{{1}})\\r\\n{{3}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "strWhereCond,");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetDataTable(strWhereCond, lstExclude)", "获取表数据出错!(排除的检查字符串列表)", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取表数据出错!(排除的检查字符串列表)(strWhereCond = {{2}})({{0}}->{{1}})\\r\\n{{3}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "strWhereCond,");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetDataTable(string strWhereCond, bool bolIsCheckSQLAttack)", "获取表数据出错!(是否检查SQL攻击)", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取表数据出错!(是否检查SQL攻击)({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetDataTable_Top", "获取表顶数据出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取表顶数据出错!(strWhereCond = {{2}})({{0}}->{{1}})\\r\\n{{3}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "strWhereCond,");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetDataTable_Top", "获取表顶数据出错!(排除的检查字符串列表)", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取表顶数据出错!(排除的检查字符串列表)(strWhereCond = {{2}})({{0}}->{{1}})\\r\\n{{3}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "strWhereCond,");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetDataTable_Top", "获取表顶数据出错!(是否检查SQL攻击)", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取表顶数据出错!(是否检查SQL攻击)({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetDataTableByPager", "获取分页表顶数据出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取分页表顶数据出错!(strWhereCond = {{2}})({{0}}->{{1}})\\r\\n{{3}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "strWhereCond,");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetDataTableByPager", "获取分页表顶数据出错!(排除的检查字符串列表)", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取分页表顶数据出错!(排除的检查字符串列表)(strWhereCond = {{2}})({{0}}->{{1}})\\r\\n{{3}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "strWhereCond,");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetDataTableByPager", "获取分页表顶数据出错!(是否检查SQL攻击)", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取分页表顶数据出错!(是否检查SQL攻击)({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetDataTableByRange", "获取表带范围数据出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取表带范围数据出错!(strWhereCond = {{2}})({{0}}->{{1}})\\r\\n{{3}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "strWhereCond,");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
        ...
        public string Gen_4BL_GetDataTableByRange_Exclude()
        {
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取表带范围数据出错!(同时可以排除一些关键字不检查)(strWhereCond = {{2}})({{0}}->{{1}})\\r\\n{{3}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "strWhereCond,");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetDataTableByRange", "获取表带范围数据出错!(同时检查是否含有SQL攻击)", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取表带范围数据出错!(同时检查是否含有SQL攻击)(strWhereCond = {{2}})({{0}}->{{1}})\\r\\n{{3}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "strWhereCond,");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetDataSetV", "获取表视图数据出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取表视图数据出错!(strWhereCond = {{2}})({{0}}->{{1}})\\r\\n{{3}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "strWhereCond,");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetDataSetVByRange", "获取表视图带范围数据出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取表视图带范围数据出错!(strWhereCond = {{2}})({{0}}->{{1}})\\r\\n{{3}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "strWhereCond,");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetDataTableV", "获取表视图数据出错!(同时可以排除一些关键字不检查)", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取表视图数据出错!(同时可以排除一些关键字不检查)(strWhereCond = {{2}})({{0}}->{{1}})\\r\\n{{3}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "strWhereCond,");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetDataTableVByRange", "获取表视图带范围数据出错!(同时可以排除一些关键字不检查)", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取表视图带范围数据出错!(同时可以排除一些关键字不检查)(strWhereCond = {{2}})({{0}}->{{1}})\\r\\n{{3}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "strWhereCond,");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetDataTableVByRange", "获取表视图带范围数据出错!(同时检查是否含有SQL攻击)", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取表视图带范围数据出错!(同时检查是否含有SQL攻击)(strWhereCond = {{2}})({{0}}->{{1}})\\r\\n{{3}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "strWhereCond,");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
        ...
        public string Gen_4BL_GetObjByKey()
        {
            ...
            if (objKeyField.ObjFieldTabENEx.objDataTypeAbbrEN.CsType == "string" && objPrjTabENEx.arrKeyFldSet.Count == 1)
            {
                ...
                strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})在表中,关键字[{3}]不能为空!({{0}}->{{1}})\",", strErrId, "{", "}", objPrjTabENEx.KeyPrivFuncFldNameLstStr);
                strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
                strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction()); ");
                strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "CopyTo", "Copy表:{0} 对象数据出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})Copy表对象数据出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "CopyObjToSimObj", "Copy表:{0} 对象到简单对象数据出错!", "生成代码");
        ...
        public string Gen_4BL_CopyObjFromSimObj4Upd_S()
        {
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})Copy表对象数据(针对修改)出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");
        ...
        public string Gen_4BL_SetUpdFlag_S()
        {
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})设置表的修改标志出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "DelRecord", "根据关键字删除记录出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})根据关键字删除记录出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "DelRecord", "根据关键字删除记录出错!(使用事务)", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})根据关键字删除记录出错!(使用事务)({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");
        ...
        public string Gen_4BL_DelRecordBySP_S()
        {
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})通过存储过程删除记录出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "Del{0}s", "删除多关键字记录出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})删除多关键字记录出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "Del{0}sByCond", "删除带条件表记录出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})删除带条件表记录出错!(strWhereCond = {{2}})({{0}}->{{1}})\\r\\n{{3}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "strWhereCond,");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
        ...
        public string Gen_4BL_DelMultiRecordByCondWithTransaction()
        {
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})删除带条件表记录出错!(同时处理事务)(strWhereCond = {{2}})({{0}}->{{1}})\\r\\n{{3}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "strWhereCond,");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "AddNewRecordBySql2", "添加记录出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})添加记录出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "AddNewRecordBySql2", "添加记录出错!(带事务处理)", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})添加记录出错!(带事务处理)({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "AddNewRecordBySql2WithReturnKey", "带返回值的添加记录出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})带返回值的添加记录出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");

            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"(errid:{22})带返回值的添加记录出错!({1}:AddNewRecordBySql2WithReturnKey)\\r\\n\" + objException.Message);",
            //  objPrjTabENEx.TabName, objPrjTabENEx.ClsName, strErrId);
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "AddNewRecordBySql2WithReturnKey", "带返回值的添加记录出错!(带事务处理)", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})带返回值的添加记录出错!(带事务处理)({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");

            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"(errid:{22})带返回值的添加记录出错!(带事务处理)({1}:AddNewRecordBySql2WithReturnKey)\\r\\n\" + objException.Message);",
            //  objPrjTabENEx.TabName, objPrjTabENEx.ClsName, strErrId);
        ...
        public string Gen_4BL_AddNewRecordBySql_XML()
        {
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})添加记录出错!(使用XML)({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");

            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"(errid:{22})添加记录出错!(使用XML)({1}: AddNewRecordBySql_XML)\\r\\n\" + objException.Message);",
            //     objPrjTabENEx.TabName,
            //     objPrjTabENEx.ClsName,
            //     strErrId);
            strBuilder.Append("\r\n" + "}");
        ...
        public string Gen_4BL_Update()
        {
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})修改记录出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");

            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"12:(errid:{21})修改记录出错!({1}: Update)\\r\\n\" + objException.Message);",
            //  objPrjTabENEx.TabName, objPrjTabENEx.ClsName, strErrId);
            strBuilder.Append("\r\n" + "}");
            strBuilder.Append("\r\n" + "}");
            return strBuilder.ToString();
        ...
        public string Gen_4BL_UpdateBySql2()
        {
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})修改记录时关键字不能为空!({{0}}->{{1}})\\r\\n\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction()); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");
            strBuilder.Append("\r\n" + " }");
            ...
            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"12:(errid:{22})修改记录出错!({1}: UpdateBySql2)\\r\\n\" + objException.Message);",
            //  objPrjTabENEx.TabName, objPrjTabENEx.ClsName, strErrId);
            strBuilder.Append("\r\n" + "}");
            strBuilder.Append("\r\n" + "}");
            return strBuilder.ToString();
        ...
        public string Gen_4BL_UpdateBySql2WithTransaction_S()
        {
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})修改记录时关键字不能为空!(带事务处理)({{0}}->{{1}})\\r\\n\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction()); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");
            strBuilder.Append("\r\n" + " }");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})修改记录出错!(带事务处理)({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");

            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"12:(errid:{22})修改记录出错!(带事务处理)({1}: UpdateBySql2)\\r\\n\" + objException.Message);",
            //  objPrjTabENEx.TabName, objPrjTabENEx.ClsName, strErrId);
        ...
        objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "UpdateBySqlWithCondition", "根据条件修改记录出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})根据条件修改记录出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");

            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"13:(errid:{22})根据条件修改记录出错!({1}: UpdateBySql2)\\r\\n\" + objException.Message);",
            //  objPrjTabENEx.TabName, objPrjTabENEx.ClsName, strErrId);

            //strBuilder.Append("\r\n" + "throw new Exception(\"根据条件修改记录出错!\\r\\n\" + objException.Message);");
            strBuilder.Append("\r\n" + "}");
            strBuilder.Append("\r\n" + "}");
            return strBuilder.ToString();
        }
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "UpdateBySqlWithConditionTransaction", "根据条件修改记录出错!(带事务处理)", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})根据条件修改记录出错!(带事务处理)({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");

            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"13:(errid:{22})根据条件修改记录出错!({1}: UpdateBySqlWithConditionTransaction)\\r\\n\" + objException.Message);",
            //  objPrjTabENEx.TabName, objPrjTabENEx.ClsName, strErrId);
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "UpdateBySql_XML", "修改记录(UpdateBySql_XML)出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})修改记录(UpdateBySql_XML)出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");

            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"(errid:{22})修改记录(UpdateBySql_XML)出错!({1}: UpdateBySql_XML)\\r\\n\" + objException.Message);",
            //  objPrjTabENEx.TabName, objPrjTabENEx.ClsName, strErrId);
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetFirstID_S", "获取First关键字出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取First关键字出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");

            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"(errid:{22})获取First关键字出错!({1}: GetFirstID_S)\\r\\n\" + objException.Message);",
            //  objPrjTabENEx.TabName, objPrjTabENEx.ClsName, strErrId);
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetPrimaryKeyID_S", "获取关键字列表出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取关键字列表出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");

            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"(errid:{22})获取关键字列表出错!({1}: GetPrimaryKeyID_S)\\r\\n\" + objException.Message);",
            //  objPrjTabENEx.TabName, objPrjTabENEx.ClsName, strErrId);
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "GetMaxStrId_S", "获取最大关键字值(GetMaxStrId)出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取最大关键字值(GetMaxStrId)出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");

            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"(errid:{22})获取最大关键字值(GetMaxStrId)出错!({1}: GetMaxStrId_S)\\r\\n\" + objException.Message);",
            //  objPrjTabENEx.TabName, objPrjTabENEx.ClsName, strErrId);
        ...
        public string Gen_4BL_GetMaxStrIDByPrefix_S()
        {
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})根据前缀获取最大关键字值(GetMaxStrIdByPrefix_S)出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");

            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"(errid:{22})根据前缀获取最大关键字值(GetMaxStrIdByPrefix_S)出错!({1}: GetMaxStrIdByPrefix_S)\\r\\n\" + objException.Message);",
            //  objPrjTabENEx.TabName, objPrjTabENEx.ClsName, strErrId);
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "IsExistTable", "检查是否存在当前表(IsExistTable)出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})检查是否存在当前表(IsExistTable)出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");

            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"(errid:{22})检查是否存在当前表(IsExistTable)出错!({1}: IsExistTable)\\r\\n\" + objException.Message);",
            //  objPrjTabENEx.TabName, objPrjTabENEx.ClsName, strErrId);
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "IsExistTable", "检查是否存在指定表(IsExistTable)出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})检查是否存在指定表(IsExistTable)出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");

            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"(errid:{22})检查是否存在指定表(IsExistTable)出错!({1}: IsExistTable)\\r\\n\" + objException.Message);",
            //  objPrjTabENEx.TabName, objPrjTabENEx.ClsName, strErrId);
        ...
        public string Gen_4BL_GetFirstObject_S()
        {
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})获取当前表满足条件的第一条记录数据出错!(strWhereCond = {{2}})({{0}}->{{1}})\\r\\n{{3}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "strWhereCond,");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            ...
            //strBuilder.AppendFormat("\r\n throw new Exception(string.Format(\"07:(errid:{22})获取当前表满足条件的第一条记录数据出错!(strWhereCond = {{0}})({1}: GetFirst{0})\\r\\n 错误信息:{{1}}\", strWhereCond, objException.Message));",
            //      objPrjTabENEx.TabName, objPrjTabENEx.ClsName, strErrId, "{", "}");
            strBuilder.Append("\r\n }");
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "getObjByDataRow_S", "根据DataRow记录获取对象出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})根据DataRow记录获取对象出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");

            //strBuilder.AppendFormat("\r\n" + "throw new Exception(\"(errid:{22})通过DataRow记录对象出错!({1}: GetObjByDataRow_S)\\r\\n\" + objException.Message);",
            //  objPrjTabENEx.TabName, objPrjTabENEx.ClsName, strErrId);
      ...
      objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "getObjByDataRow_S", "根据DataRowView记录获取对象出错!", "生成代码");
            ...
            strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"(errid:{0})通过DataRowView记录对象出错!({{0}}->{{1}})\\r\\n{{2}}\",", strErrId, "{", "}");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunctionByLevel(2),");
            strBuilder.AppendFormat("\r\n" + "clsStackTrace.GetCurrClassFunction(),");
            strBuilder.AppendFormat("\r\n" + "objException.Message); ");
            strBuilder.AppendFormat("\r\n" + "throw new Exception(strMsg); ");
    ...
    objPrjTabENEx.TabName, strValueFieldName, "{", "}");
        ...
        public string Gen_4BL4Mvc_GetObjLst4SelectListItem()
        {
            ...
            try
            {
                ...
                if (strValueFieldName != "" && strTextFieldName != "")
                {
                    ...
                    //strCodeForCs.AppendFormat("\r\n" + "System.Data.DataTable objDT = new cls{1}DA().Get{0}();",
                    //strValueFieldName, objPrjTabENEx.TabName);
                    strCodeForCs.AppendFormat("\r\n" + "List<cls{0}EN> arrObjLst = cls{0}BL.GetObjLst(strWhereCond); ",
                              objPrjTabENEx.TabName);
                    ...
                    strCodeForCs.Append("\r\n" + "{");
                    strCodeForCs.AppendFormat("\r\n" + "{0}List.Add(new SelectListItem {{ Text = objInFor.{1}, Value = objInFor.{2}.ToString() }});",
        ...
        public string Gen_4BL_InitListCache()
        {
            ...
            if (objPrjTabENEx.IsUseCache == false) return string.Format("//该表没有使用Cache,不需要生成[InitListCache]函数;",
objKeyField.FldName);
            StringBuilder strBuilder = new StringBuilder();
            //初始化列表缓存.-----------------------------;
            ...
            if (objPrjTabENEx.SqlDsTypeId == clsSQLDSTypeBLEx.SQLTAB)
            {
                ...
                strBuilder.Append("\r\n" + "{");
                strBuilder.AppendFormat("\r\n" + "strMsg = string.Format(\"类cls{2}BL没有刷新缓存机制(cls{2}BL.objCommFun4BL == null), 请联系程序员!({{1}}->{{0}})\", clsStackTrace.GetCurrClassFunction(),clsStackTrace.GetCurrClassFunctionByLevel(2));",
                    "{", "}", objPrjTabENEx.TabName);
                strBuilder.Append("\r\n" + "throw new Exception(strMsg);");
                strBuilder.Append("\r\n" + "}");
            }
...
objKeyField.FldName);
        ...
        {            
            if (objPrjTabENEx.IsUseCache == false) return string.Format("//该表没有使用Cache,不需要生成[GetObjBy{1}Cache]函数;",
objKeyField.FldName);
            StringBuilder strBuilder = new StringBuilder();
            //根据关键字获取相关对象, 从缓存的对象列表中获取.-----------------------------;
        ...
        public string Gen_4BL_AdjustOrderNum()
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(objAdjustOrderNum.ClassificationFieldValue) == true)
                {
                    ...
                    strCodeForCs.Append("\r\n" + "if (intOrderNum <= 1)");
                    strCodeForCs.Append("\r\n" + "{");
                    strCodeForCs.AppendFormat("\r\n" + "strMsg = string.Format(\"已经是第一条记录,不能再上移!({{0}})\", clsStackTrace.GetCurrClassFunction());", 
                        objPrjTabENEx.TabName, "{", "}");
                    strCodeForCs.Append("\r\n" + "throw new Exception(strMsg);");
                    strCodeForCs.Append("\r\n" + "}");
                    ...
                    strCodeForCs.Append("\r\n" + "{");
                    strCodeForCs.AppendFormat("\r\n" + "strMsg = string.Format(\"获取上一条记录的关键字出错!({{0}})\", clsStackTrace.GetCurrClassFunction());",
                        objPrjTabENEx.TabName, "{", "}");
                    strCodeForCs.Append("\r\n" + "throw new Exception(strMsg);");
                    strCodeForCs.Append("\r\n" + "}");
                    ...
                    strCodeForCs.Append("\r\n" + "{");
                    strCodeForCs.AppendFormat("\r\n" + "strMsg = string.Format(\"已经是最后一条记录,不能再下移!({{0}})\", clsStackTrace.GetCurrClassFunction());",
                        objPrjTabENEx.TabName, "{", "}");
                    strCodeForCs.Append("\r\n" + "                            throw new Exception(strMsg);");
                    strCodeForCs.Append("\r\n" + "}");
                    strCodeForCs.Append("\r\n" + "");
                    ...
                    strCodeForCs.Append("\r\n" + "{");
                    strCodeForCs.AppendFormat("\r\n" + "strMsg = string.Format(\"获取下一条记录的关键字出错!({{0}})\", clsStackTrace.GetCurrClassFunction());",
                        objPrjTabENEx.TabName, "{", "}");
                    strCodeForCs.Append("\r\n" + "");
                    strCodeForCs.Append("\r\n" + "throw new Exception(strMsg);");
                    strCodeForCs.Append("\r\n" + "}");
        ...
        {
            this.ClsName = string.Format("cls{0}BL4Mvc", objPrjTabENEx.TabName);
