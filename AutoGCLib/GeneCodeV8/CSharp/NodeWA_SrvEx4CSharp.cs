...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class NodeWA_SrvEx4CSharp : clsGeneCodeBase4Tab
    {

        #region 构造函数

        public NodeWA_SrvEx4CSharp(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        public string Gen_WAEx_EditNodeEx()
        {
            StringBuilder strBuilder = new StringBuilder();
            string strFuncName = "";
            try
            {
                ...
                strBuilder.Append("\r\n" + "[HttpPost]");
                strBuilder.AppendFormat("\r\n" + "public ActionResult EditNodeEx([FromBody]cls{0}EN obj{0})",
                ...
                strBuilder.Append("\r\n {");
                                ...
                                strBuilder.AppendFormat("\r\n" + "bool bolResult = obj{0}.EditNodeEx();", objPrjTabENEx.TabName);
        ...
        public string Gen_WAEx_AddNodeEx()
        {
            StringBuilder strBuilder = new StringBuilder();
            string strFuncName = "";
            try
            {
                ...
                strBuilder.Append("\r\n /// <returns>修改是否成功？</returns>");
                strBuilder.Append("\r\n" + "[HttpPost]");
                strBuilder.AppendFormat("\r\n" + "public ActionResult AddNodeEx([FromBody]cls{0}EN obj{0})",
                objPrjTabENEx.TabName);
                strBuilder.Append("\r\n" + "{");
                ...
                strBuilder.AppendFormat("\r\n" + "bool bolResult = obj{0}.AddNodeEx();", objPrjTabENEx.TabName);
        ...
        public string Gen_WAEx_UpdateNodeEx()
        {
            StringBuilder strBuilder = new StringBuilder();
            string strFuncName = "";
            try
            {
                ...
                strBuilder.Append("\r\n /// <returns>修改是否成功？</returns>");
                strBuilder.Append("\r\n" + "[HttpPost]");
                strBuilder.AppendFormat("\r\n" + "public ActionResult UpdateNodeEx([FromBody]cls{0}EN obj{0})",
                objPrjTabENEx.TabName);
                strBuilder.Append("\r\n" + "{");
                ...
                strBuilder.AppendFormat("\r\n" + "bool bolResult = obj{0}.UpdateNodeEx();", objPrjTabENEx.TabName);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(NodeWA_SrvEx4CSharp);
