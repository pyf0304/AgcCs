...
namespace AutoGCLib
{
    ...
    /// </summary>
    class EntityLayerEx4CSharp_MySql : clsGeneCodeBase4Tab
    {
       
        #region 构造函数

    
        public EntityLayerEx4CSharp_MySql(string strTabId,  string strPrjDataBaseId, string strPrjId)
        ...
        public override string A_GenGeneralLogicCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            try
            {
                ...
                //与属性名称相关的代码
                strCodeForCs.AppendFormat("\r\n" + "protected const int _AttributeCount = {0};",
                ...
                strTemp += "}";
                strCodeForCs.AppendFormat("\r\n" + "public static string[] _AttributeName = new string[] {0};",
                strTemp);
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            strClsNameEx = objPrjTabENEx.ClsName + "Ex";
            strClassFName = objPrjTabENEx.FolderName + strClsNameEx + ".cs";
            objPrjTabENEx.FileName = strClassFName;
            clsProjectsEN objProject = clsProjectsBL.GetObjByPrjIdCache(objPrjTabENEx.PrjId); //
            try
            {
                ...
                strCodeForCs.Append("\r\n" + "public class " + strClsNameEx + " : " + objPrjTabENEx.ClsName);
                strCodeForCs.Append("\r\n" + "{");
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(EntityLayerEx4CSharp_MySql);
        ...
        public string gfunAddNewRecord()
        {
            ...
            foreach (clsPrjTabFldENEx objField in objPrjTabENEx.arrFldSet)
            {
                string  strTemp = objField.ObjFieldTabENEx.objDataTypeAbbrEN.JavaObjType;
        ...
        public  string GenUpdateBySP()
        {
            ...
            string strTemp = string.Format("public bool Update{0}BySP(cls{0}EN obj{0})",
            objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + strTemp);
            strBuilder.Append("\r\n{");
            strBuilder.Append("\r\n//通过存储过程来");
        ...
        public  string GenDelRecordBySP()
        {
            StringBuilder strBuilder = new StringBuilder();
            ///public bool Addnew {TabName}BySP()--------------------------;
            string strTemp = string.Format("public bool DelRecordBySP() ", objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + strTemp);
            strBuilder.Append("\r\n{");
            strBuilder.Append("\r\n//通过存储过程来");
            strBuilder.Append("\r\n//直接使用");
        ...
        public  string GenDelRecordBySP_S()
        {
            StringBuilder strBuilder = new StringBuilder();
            ///public bool Addnew {TabName}BySP()--------------------------;
            string strTemp = string.Format("public static bool DelRecordBySP({0}) ", objPrjTabENEx.KeyVarDefineLstStr);
            strBuilder.Append("\r\n" + strTemp);
            strBuilder.Append("\r\n{");
            strBuilder.Append("\r\n//通过存储过程来");
            strBuilder.Append("\r\n//直接使用");
        ...
        public  string GenAddnewMultiRec()
        {
            ...
            strBuilder.Append("\r\n /// <returns></returns>");
            string strTemp = string.Format("public bool Addnew{0}s(System.Data.DataTable oDT, ref string strResult) ", objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + strTemp);
            strBuilder.Append("\r\n{");
            strBuilder.Append("\r\nstring strSQL;");
            strBuilder.Append("\r\nMySql.Data.MySqlClient.MySqlDataAdapter objDA;");
