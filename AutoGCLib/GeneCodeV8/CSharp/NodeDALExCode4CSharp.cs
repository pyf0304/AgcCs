...
namespace AutoGCLib
{
    ...
    /// </summary>
    class NodeDALExCode4CSharp : clsGeneCodeBase4Tab
    {


        #region 构造函数

        public NodeDALExCode4CSharp(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_DAEx_ClassConstructor1()
        {
            StringBuilder strBuilder = new StringBuilder();
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(NodeDALExCode4CSharp);
        ...
        {
            this.ClsName = string.Format("cls{0}DAEx", objPrjTabENEx.TabName);
