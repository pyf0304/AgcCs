...
namespace AutoGCLib
{
    ...
    /// </summary>
    class RelaEntityLayerEx4CSharp : clsGeneCodeBase4Tab
    {
        ...
        public RelaEntityLayerEx4CSharp(string strTabId,  string strPrjDataBaseId, string strPrjId)
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(RelaEntityLayerEx4CSharp);
