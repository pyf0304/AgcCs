...
namespace AutoGCLib
{
    ...
    /// </summary>
    class RelaDALExCode4CSharp : clsGeneCodeBase4Tab
    {


        #region 构造函数

        public RelaDALExCode4CSharp(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(RelaDALExCode4CSharp);
