...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class RelaBusinessLogicEx4CSharp : clsGeneCodeBase4Tab
    {
        private string strKeyFldName_ObjName = "";

        #region 构造函数

        public RelaBusinessLogicEx4CSharp(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(RelaBusinessLogicEx4CSharp);
        ...
        public string Gen_Neo4JBLEx_DelRelationEx()
        {
            ...
            {
                strCodeForCs.AppendFormat("\r\n" + "public static bool DelRelationEx({0} {1})",
                objKeyField.ObjFieldTabENEx.objDataTypeAbbrEN.CsType,
                objKeyField.PrivFuncName);
            }
            else
            {
                strCodeForCs.AppendFormat("\r\n" + "public static bool DelRelationEx({0} {1}, {2} {3})",
                objKeyField.ObjFieldTabENEx.objDataTypeAbbrEN.CsType,
                objKeyField.PrivFuncName,
            ...
            if (objPrjTabENEx.objCacheClassifyFld == null)
            {
                strCodeForCs.AppendFormat("\r\n" + "cls{0}BL.DelRelation({1}, objConnection, objSqlTransaction);",
                objPrjTabENEx.TabName, objKeyField.PrivFuncName);
            }
            else
            {
                strCodeForCs.AppendFormat("\r\n" + "cls{0}BL.DelRelation({1}, {2}, objConnection, objSqlTransaction);",
            ...
            strCodeForCs.AppendFormat("\r\n" + "ErrorInformationBL.AddInformation(\"cls{0}BLEx\", \"DelRelationEx\", objException.Message, clsSysParaEN.strUserId);",
                objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName, strValueFieldName, "{", "}");
        ...
        public string Gen_Neo4JBLEx_Static_AddRelationEx()
        {
            string strFuncName = "";
            StringBuilder strCodeForCs = new StringBuilder();
            try
            {
                ...
                if (objKeyField.PrimaryTypeId != clsPrimaryTypeNameENEx.IDENTITY_PRIMARYKEY)
                {
                    ...
                    if (objKeyField.PrimaryTypeId == enumPrimaryType.StringAutoAddPrimaryKey_03)
                    {
                        ...
                        strCodeForCs.Append("\r\n" + "//{");
                        strErrId = clsErrorIdManageBLEx.GetMaxErrIdWithAddRecAndCheckDuplicate(objPrjTabENEx.CodeTypeId,
                            objPrjTabENEx.PrjId, objPrjTabENEx.ClsName, "AddRelationEx", "关键字字段已有相同的值", "生成代码");
                ...
                strCodeForCs.Append("\r\n" + "//6、把数据实体层的数据存贮到数据库中");
                strCodeForCs.AppendFormat("\r\n" + "obj{0}EN.AddNewRelation();", objPrjTabENEx.TabName);
                strCodeForCs.Append("\r\n" + "}");
                strCodeForCs.Append("\r\n" + "catch(Exception objException)");
                strCodeForCs.Append("\r\n" + "{");
        ...
        public string Gen_Neo4JBLEx_Static_UpdateRelationEx()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            string strFuncName = "";
            try
            {
                ...
                strCodeForCs.Append("\r\n" + "//4、把数据实体层的数据存贮到数据库中");
                strCodeForCs.AppendFormat("\r\n" + "obj{0}EN.UpdateRelation();", objPrjTabENEx.TabName);
                strCodeForCs.Append("\r\n" + "}");
                strCodeForCs.Append("\r\n" + "catch(Exception objException)");
                strCodeForCs.Append("\r\n" + "{");
        ...
        public string Gen_Neo4JBLEx_Static_EditRelationEx()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            string strFuncName = "";
            try
            {
                ...
                strCodeForCs.Append("\r\n /// <returns>修改是否成功？</returns>");
                strCodeForCs.AppendFormat("\r\n" + "public static bool EditRelationEx(this cls{0}EN obj{0})",
                objPrjTabENEx.TabName);
                strCodeForCs.Append("\r\n" + "{");
                strCodeForCs.Append("\r\n" + "//操作步骤:");
                strCodeForCs.Append("\r\n" + "//1、检查传进去的对象属性是否合法");
                ...
                strCodeForCs.AppendFormat("\r\n" + "obj{0}._IsCheckProperty = true;",
                    objPrjTabENEx.TabName);
                strCodeForCs.AppendFormat("\r\n" + "bool bolIsExist = cls{0}BL.IsExistRelation(strCondition);",
                    objPrjTabENEx.TabName);
                ...
                strCodeForCs.Append("\r\n" + "{");
                    ...
                    strCodeForCs.AppendFormat("\r\n" + "obj{0}.AddNewRelation();", objPrjTabENEx.TabName);
                strCodeForCs.Append("\r\n" + "}");
