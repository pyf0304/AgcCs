...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class Vue_ViewScript_Detail_TS4TypeScript : WA_ViewScript_DetailCS_TS4TypeScript
    {
        ...
        #region 构造函数
        public Vue_ViewScript_Detail_TS4TypeScript()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public Vue_ViewScript_Detail_TS4TypeScript(string strViewId)
       : base( strViewId, "", "")
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public Vue_ViewScript_Detail_TS4TypeScript( string strViewId, string strPrjDataBaseId, string strPrjId)
    ...
    clsvFunction4GeneCodeBLEx.GetObjLstByViewInfoEx(objViewInfoENEx, this.FunctionTemplateId);
        ...
        public string Gen_Vue_Ts_btnDetailRecord_Click(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            ...
            if (thisDetailTabProp_TS.KeyFldCount > 1) strFuncPara = thisDetailTabProp_TS.KeyVarDefineLstStr;
       ...
       objViewInfoENEx.TabName_In, objKeyField.FldName);
        ...
        public string Gen_Vue_TS_ShowDialog(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            ...
            strFuncName = $"ShowDialog_{TabName_Out4DetailRegion}";
