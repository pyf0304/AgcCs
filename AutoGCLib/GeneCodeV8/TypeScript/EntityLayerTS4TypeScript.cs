...
namespace AutoGCLib
{
    ...
    class EntityLayerTS4TypeScript : clsGeneCodeBase4Tab
    {
        ...
        public EntityLayerTS4TypeScript(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            try
            {
                ...
                clsPubFun4GC.AddCodeElement_Property(objCodeElement_Class, new CodeElement
                {
                    ...
                    ElementType = CodeElementType.StaticVar,
                    CodeContent = $"public static _CacheAddiCondition = \"\"; //缓存附加条件,作为向后台调取数据的附加条件",
                });
        ...
        public string A_GeneFuncCodeByFuncName(string strFuncName)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(EntityLayerTS4TypeScript);
