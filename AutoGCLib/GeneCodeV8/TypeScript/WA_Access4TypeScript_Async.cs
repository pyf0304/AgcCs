...
StringBuilder strCodeForCs = new StringBuilder();
        ...
        public string Gen_4WA_Ts_ReFreshCache()
        {
            ...
            {
                strCodeForCs.AppendFormat("\r\n" + "export  function " + this.tabNameHead + $"ReFreshCache({thisCacheClassify_TS.PriVarName}: {thisCacheClassify_TS.TypeScriptType}):void");
   ...
   thisCacheClassify_TS.DataTypeId == enumDataTypeAbbr.char_04 ? true : false, this, this.strBaseUrl));
                Re_objFunction4Code.FuncName4Code = string.Format("export  function " + this.tabNameHead + $"ReFreshCache({thisCacheClassify_TS.PriVarName}: {thisCacheClassify_TS.TypeScriptType}):void");
            }
            else
            {
