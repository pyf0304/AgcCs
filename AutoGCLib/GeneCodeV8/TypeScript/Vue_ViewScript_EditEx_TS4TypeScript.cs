...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class Vue_ViewScript_EditEx_TS4TypeScript : clsGeneCodeBase4View
    {
        //private string objPrjTabENEx = "";


        public Vue_ViewScript_EditEx_TS4TypeScript()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public Vue_ViewScript_EditEx_TS4TypeScript(string strViewId)
       : base( strViewId, "", "")
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public Vue_ViewScript_EditEx_TS4TypeScript( string strViewId, string strPrjDataBaseId, string strPrjId)
 ...
 this.TabName_In4Edit4GC)
        ...
        {
            return A_GeneFuncCodeBase(objvFunction4GeneCodeEN, typeof(Vue_ViewScript_EditEx_TS4TypeScript));
        }
