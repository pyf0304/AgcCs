      ...
      objKeyField.FldName);
        ...
        public string Gen_4WA_Ts_IsExistRecordCache()
        {
          ...
          objKeyField.ObjFieldTabENEx.objDataTypeAbbrEN.TypeScriptType);
            ...
            if (thisCacheClassify_TS.IsHasCacheClassfyFld == false)
            {
                strCodeForCs.AppendFormat("\r\n" + "export  async function " + this.tabNameHead + "IsExistRecordCache({1}: ConditionCollection) {{",
          ...
          objKeyField.ObjFieldTabENEx.objDataTypeAbbrEN.TypeScriptType);
            ...
            {
                strCodeForCs.AppendFormat("\r\n" + "export  async function " + this.tabNameHead + "IsExistRecordCache({1}: ConditionCollection,{4}: {5}) {{",
                    ThisClsName4EN, ThisObjName4Cond,
            objKeyField.FldName,
            objKeyField.ObjFieldTabENEx.objDataTypeAbbrEN.TypeScriptType, thisCacheClassify_TS.PriVarName,
                thisCacheClassify_TS.TypeScriptType);
                strFuncName = $"{this.tabNameHead}IsExistRecordCache";
                Re_objFunction4Code.FuncName4Code = string.Format("export  async function " + this.tabNameHead + "IsExistRecordCache({1}: ConditionCollection,{3}: {4}) {{",
                    ThisClsName4EN, ThisObjName4Cond,
            objKeyField.ObjFieldTabENEx.objDataTypeAbbrEN.TypeScriptType, thisCacheClassify_TS.PriVarName,
                thisCacheClassify_TS.TypeScriptType);
            }
            ...
            {
                strCodeForCs.AppendFormat("\r\n" + "export  async function " + this.tabNameHead + "IsExistRecordCache({1}: ConditionCollection,{3}: {4}, {5}:{6}) {{",
                 ThisClsName4EN, ThisObjName4Cond,
            objKeyField.ObjFieldTabENEx.objDataTypeAbbrEN.TypeScriptType,
            thisCacheClassify_TS.PriVarName,
                thisCacheClassify_TS.TypeScriptType,
            thisCacheClassify_TS.PriVarName2,
                thisCacheClassify_TS.TypeScriptType2);
                strFuncName = $"{this.tabNameHead}IsExistRecordCache";
                Re_objFunction4Code.FuncName4Code = string.Format("export  async function " + this.tabNameHead + "IsExistRecordCache({1}: ConditionCollection,{3}: {4}, {5}:{6}) {{",
                    ThisClsName4EN, ThisObjName4Cond,
            objKeyField.ObjFieldTabENEx.objDataTypeAbbrEN.TypeScriptType,
            thisCacheClassify_TS.PriVarName,
                thisCacheClassify_TS.TypeScriptType,
