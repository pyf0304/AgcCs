...
namespace AutoGCLib
{
    ...
    class EntityLayer4TypeScript : clsGeneCodeBase4Tab
    {
        ...
        public EntityLayer4TypeScript(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            string strPrimaryTypeId = clsPrjTabBLEx.GetPrimaryTypeId(objPrjTabENEx.TabId, objPrjTabENEx.PrjId);
            //让用户设置属性;
            //string strFolder;
            ...
            objPrjTabENEx.ClsName = "cls" + ThisTabName4GC + "EN";
            ...
            try
            {
                ...
                if (objPrjTabENEx.SqlDsTypeId == enumSQLDSType.SqlView_02)
                {
                    ...
                    clsPubFun4GC.AddCodeElement_Import(objCodeElement_Imports, new CodeElement
                    {
                        Name = "clsGeneralTabV",
                        ElementType = CodeElementType.Import,
                        CodeContent = "import { clsGeneralTabV } from '../../PubFun/clsGeneralTabV.js';",
                        From = "../../PubFun/clsGeneralTabV.js"
                    });
                }
                else
                {
                    ...
                    clsPubFun4GC.AddCodeElement_Import(objCodeElement_Imports, new CodeElement
                    {
                        Name = "clsGeneralTab",
                        ElementType = CodeElementType.Import,
                        CodeContent = "import { clsGeneralTabV } from '../../PubFun/clsGeneralTab.js';",
                        From = "../../PubFun/clsGeneralTab.js"
                    });
                }
                ...
                {
                    strCodeForCs.AppendFormat("\r\n" + "export class  {0} extends clsGeneralTab",
                    ThisClsName4EN,
                    this.objKeyField.PrivFuncName);
                }
                strCodeForCs.Append("\r\n" + "{");
                ...
                {
                    Name = $"_RefreshTimeLst",
                    ElementType = CodeElementType.StaticVar,
                    CodeContent = $"public static _RefreshTimeLst = new Array<string>();",
                });
                strCodeForCs.Append("\r\n" + "public static _CacheAddiCondition: string = \"\";//缓存附加条件,作为向后台调取数据的附加条件");
                clsPubFun4GC.AddCodeElement_Property(objCodeElement_Class, new CodeElement
                {
                    Name = $"_CacheAddiCondition",
                    ElementType = CodeElementType.StaticVar,
                    CodeContent = $"public static _CacheAddiCondition: string = \"\"; //缓存附加条件,作为向后台调取数据的附加条件",
                });
                strCodeForCs.Append("\r\n" + $"public static readonly _{conPrjTab.CacheModeId}: string = \"{objPrjTabENEx.CacheModeId}\"; //{clsCacheModeBL.GetNameByCacheModeIdCache(objPrjTabENEx.CacheModeId)}");
                clsPubFun4GC.AddCodeElement_Property(objCodeElement_Class, new CodeElement
                {
                    Name = $"_{conPrjTab.CacheModeId}",
                    ElementType = CodeElementType.Constant,
                    CodeContent = $"public static readonly _{conPrjTab.CacheModeId}: string = \"{objPrjTabENEx.CacheModeId}\"; //{clsCacheModeBL.GetNameByCacheModeIdCache(objPrjTabENEx.CacheModeId)}",
                });


                string strPrimaryTypeName = clsPrimaryTypeBL.GetNameByPrimaryTypeIdCache(strPrimaryTypeId);
                strCodeForCs.Append("\r\n" + $"public static readonly _{conPrjTabFld.PrimaryTypeId}: string = \"{strPrimaryTypeId}\"; //{strPrimaryTypeName}");
                clsPubFun4GC.AddCodeElement_Property(objCodeElement_Class, new CodeElement
                {
                    Name = $"_{conPrjTabFld.PrimaryTypeId}",
                    ElementType = CodeElementType.Constant,
                    CodeContent = $"public static readonly _{conPrjTabFld.PrimaryTypeId}: string = \"{strPrimaryTypeId}\"; //{strPrimaryTypeName}",
                });

                string strIsUseDelSign = objPrjTabENEx.IsUseDelSign ? "true" : "false";
                strCodeForCs.AppendFormat("\r\n" + "public static readonly _IsUseDelSign = {0}; //使用删除标志,记录不能删除,仅设置删除标志",
                        strIsUseDelSign);
                ...
                clsPubFun4GC.AddCodeElement_Property(objCodeElement_Class, new CodeElement
                {
                    Name = "_IsUseDelSign",
                    ElementType = CodeElementType.Constant,
                    CodeContent = $"public static readonly _IsUseDelSign = {strIsUseDelSign}; //使用删除标志,记录不能删除,仅设置删除标志",
                });
                strCodeForCs.Append("\r\n" + $"public static readonly _{conPrjTab.WhereFormat} = \"{objPrjTabENEx.WhereFormat}\"; //条件格式串");
                clsPubFun4GC.AddCodeElement_Property(objCodeElement_Class, new CodeElement
                {
                    Name = $"_{conPrjTab.WhereFormat}", 
                    ElementType = CodeElementType.Constant,
                    CodeContent = $"public static readonly _{conPrjTab.WhereFormat} = \"{objPrjTabENEx.WhereFormat}\"; //条件格式串",
                });

                strCodeForCs.AppendFormat("\r\n" + "public static readonly _CurrTabName: string = \"{0}\"; //当前表名,与该类相关的表名", ThisTabName4GC);
                clsPubFun4GC.AddCodeElement_Property(objCodeElement_Class, new CodeElement
                {
                    Name = "_CurrTabName",
                    ElementType = CodeElementType.Constant,
                    CodeContent = $"public static readonly _CurrTabName: string = \"{ThisTabName4GC}\"; //当前表名,与该类相关的表名",
                });

                strCodeForCs.Append("\r\n" + $"public static readonly _KeyFldName: string = \"{objPrjTabENEx.KeyFldNameLstStr}\"; //当前表中的关键字名称,与该类相关的表中关键字名");
                clsPubFun4GC.AddCodeElement_Property(objCodeElement_Class, new CodeElement
                {
                    Name = "_KeyFldName",
                    ElementType = CodeElementType.Constant,
                    CodeContent = $"public static readonly _KeyFldName: string = \"{objPrjTabENEx.KeyFldNameLstStr}\"; //当前表中的关键字名称,与该类相关的表中关键字名",
        ...
        public string A_GeneFuncCodeByFuncName(string strFuncName)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(EntityLayer4TypeScript);
        ...
        public string Gen_EN_ClsProperty()
        {
            ...
            foreach (clsPrjTabFldENEx objField in objPrjTabENEx.arrFldSet)
            {
                ...
                sbTempFun.AppendFormat("\r\n public Set{0} (value: {1})",
                        objField.ObjFieldTabENEx.FldName,
                         objField.ObjFieldTabENEx.objDataTypeAbbrEN.TypeScriptType);
                strFuncName = $"Set{objField.ObjFieldTabENEx.FldName}";
                sbTempFun.Append("\r\n{");
                sbTempFun.AppendFormat("\r\nif (value  != undefined)");
                sbTempFun.Append("\r\n{");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_EN_GetFldValue()
        {
            string strFuncName = "";
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.AppendFormat("\r\n/**");
...
objKeyField.FldName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_EN_ClsPublicVar()
        {
            string strFuncName = "";
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.AppendFormat("\r\n/**");
        ...
        public string Gen_EN_hasProperty()
        {
            string strFuncName = "";
            StringBuilder strCodeForCs = new StringBuilder();
            ///定义类中私有属性
            ...
            strFuncName = "hasProperty";
            strCodeForCs.Append("\r\n" + $"//return propName in new {ThisClsName4EN}();");
            strCodeForCs.Append("\r\n" + $"const instance = new {ThisClsName4EN}();");
