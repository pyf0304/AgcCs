...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class WA_ViewScript_DetailCSEx_TS4TypeScript : clsGeneCodeBase4View
    {
    
        public WA_ViewScript_DetailCSEx_TS4TypeScript()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public WA_ViewScript_DetailCSEx_TS4TypeScript(string strViewId)
       : base( strViewId, "", "")
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public WA_ViewScript_DetailCSEx_TS4TypeScript( string strViewId, string strPrjDataBaseId, string strPrjId)
        ...
        {
            return A_GeneFuncCodeBase(objvFunction4GeneCodeEN, typeof(WA_ViewScript_DetailCSEx_TS4TypeScript));
            //string strFuncName = objvFunction4GeneCodeEN.FuncName;
            //try
            //{
            //    string strCode = "";
            //    Type t = typeof(WA_ViewScript_DetailCSEx_TS4TypeScript);
        ...
        public string Gen_WApi_TS_btnDetail_Click(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            ...
            strCodeForCs.AppendFormat("\r\n ({0})", clsStackTrace.GetCurrClassFunction());
            strCodeForCs.Append("\r\n **/");
            strCodeForCs.AppendFormat("\r\n" + "public static btnDetail_Click(strCommandName: string, strKeyId: string) {{", objViewInfoENEx.ClsName);
            ...
            strCodeForCs.AppendFormat("\r\n" + "//{0}objPage.btnAddNewRecordWithMaxId_Click();", arrButtonName.Contains("AddNewRecordWithMaxId") ? "" : "//");
            strCodeForCs.Append("\r\n" + "break;");
