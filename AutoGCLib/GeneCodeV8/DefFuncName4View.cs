        ...
        public string thisWA_F_InEdit(WA_F objFuncName)
        {
            switch (objFuncName)
            {
                ...
                case WA_F.EditRecordExAsync:
                    ImportClass objImportClass6 = AddImportClass(TabId_In4Edit, TabName_In4Edit4GC, "EditRecordExAsync", enumImportObjType.WApiClassFunc, this.strBaseUrl);
                ...
                case WA_F.CheckPropertyNew:
                    ImportClass objImportClass7 = AddImportClass(TabId_In4Edit, TabName_In4Edit4GC, "CheckPropertyNew", enumImportObjType.WApiClassFunc, this.strBaseUrl);
                ...
                case WA_F.CheckProperty4Update:
                    ImportClass objImportClass8 = AddImportClass(TabId_In4Edit, TabName_In4Edit4GC, "CheckProperty4Update", enumImportObjType.WApiClassFunc, this.strBaseUrl);
                ...
                case WA_F.AddNewRecordWithMaxIdAsync:
                    ImportClass objImportClass9 = AddImportClass(TabId_In4Edit, TabName_In4Edit4GC, "AddNewRecordWithMaxIdAsync", enumImportObjType.WApiClassFunc, this.strBaseUrl);
                ...
                case WA_F.AddNewRecordWithReturnKeyAsync:
                    ImportClass objImportClassA = AddImportClass(TabId_In4Edit, TabName_In4Edit4GC, "AddNewRecordWithReturnKeyAsync", enumImportObjType.WApiClassFunc, this.strBaseUrl);
                ...
                case WA_F.IsExistRecordAsync:
                    ImportClass objImportClassB = AddImportClass(TabId_In4Edit, TabName_In4Edit4GC, "IsExistRecordAsync", enumImportObjType.WApiClassFunc, this.strBaseUrl);
                ...
                case WA_F.IsExistAsync:
                    ImportClass objImportClassC = AddImportClass(TabId_In4Edit, TabName_In4Edit4GC, "IsExistAsync", enumImportObjType.WApiClassFunc, this.strBaseUrl);
        ...
        public string thisWA_F_InList(WA_F objFuncName)
        {
            ...
            switch (objFuncName)
            {
                ...
                case WA_F.FuncMapByFldName:
                    ImportClass objImportClassB = AddImportClass(TabId_Out4ListRegion, TabName_Out4ListRegion4GC, "FuncMapByFldName", enumImportObjType.WApiClassFunc, this.strBaseUrl);

                    CodeElement objCodeElement_ImportB = clsPubFun4GC.GetCodeElementByImportClass(objImportClassB);
                    clsPubFun4GC.AddCodeElement_Import(this.objCodeElement_Imports, objCodeElement_ImportB);

                    return string.Format($"{TabName_Out4ListRegion4GC}_FuncMapByFldName");
                case WA_F.GetMaxStrIdAsync:
                ...
                case WA_F.GetObjExLstByPagerCache://在本类中定义的分页函数,返回扩展对象列表,Cache
                    ImportClass objImportClassI = AddImportClass(TabId_Out4ListRegion, TabName_Out4ListRegion4GC, string.Format($"GetObjExLstByPagerCache"), enumImportObjType.WApiClassFunc, this.strBaseUrl);
                    ...
                    return string.Format($"{TabName_Out4ListRegion4GC}_GetObjExLstByPagerCache");
