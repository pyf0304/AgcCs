...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class WA_AppViewUTScriptCS4JAVA : WA_AppController4JAVABase
    {

        #region 构造函数
        public WA_AppViewUTScriptCS4JAVA(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        public string A_GenController_Java_DdlBind(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            try
            {
                ...
                strCodeForCs.AppendFormat("\r\n" + "import {0}.GC.L4_Controller4WA.{2}.cls{1}WA4Controller;",
                    objProjectsENEx.JavaPackageName,
                      objPrjTabENEx.TabName, objFuncModule.FuncModuleEnName4GC()); //
                strCodeForCs.AppendFormat("\r\n" + "import {0}.GC.L5_WA_Controller.{2}.cls{1}_WA_Controller.;",
                    objProjectsENEx.JavaPackageName,
                      objPrjTabENEx.TabName, objFuncModule.FuncModuleEnName4GC()); //
                ...
                strCodeForCs.AppendFormat("\r\n" + "return mobjDdlAdapter{0};",
                    objPrjTabENEx.TabName);
                strCodeForCs.Append("\r\n" + "}");
                strCodeForCs.Append("\r\n" + Gen_WA_Controller_Java_BindDdl(objPrjTabENEx.TabName, strValueFieldName, strTextFieldName));

                strCodeForCs.Append("\r\n" + Gen_WA_Controller_Java_GetObjLst4DdlBind(objPrjTabENEx.TabName, strValueFieldName, strTextFieldName));
              //  strCodeForCs.Append("\r\n" + Gen_WA_Controller_Java_SendMessage(objPrjTabENEx.TabName, strValueFieldName, strTextFieldName));
        ...
        /// </summary>
        /// <returns></returns>
        public string A_GenController_Java_SelfDefWA4UnitTest(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            string strResult = "";
            ...
            try
            {
                ...
                strCodeForCs.AppendFormat("\r\n" + "import {0}.GC.L5_WA_Controller.{2}.cls{1}4SD_Controller;",
                    objProjectsENEx.JavaPackageName,
                      objWebSrvClassENEx.ClsName, objFuncModule.FuncModuleEnName4GC()); //
                strCodeForCs.AppendFormat("\r\n" + "import {0}.GC.L4_Controller4WA.{2}.{1}WA4SDController;",
                    objProjectsENEx.JavaPackageName,
                      objWebSrvClassENEx.ClsName, objFuncModule.FuncModuleEnName4GC()); //
                ...
                foreach (clsWebSrvFunctionsENEx objWebSrvFunctionsENEx in objWebSrvClassENEx.arrWebSrvFunctionsENExObjLst)
                {
                    ...
                    try
                    {
                        strTemp = Gen_WA_Controller_Java_btnClickByCommonFunction(objWebSrvFunctionsENEx);
                        if (string.IsNullOrEmpty(strTemp) == false)
                        {
                            strCodeForCs.Append("\r\n" + strTemp);
                ...
                //    {
                //        strTemp = A_GeneFuncCode_Java_btnClick(strFuncName);
                //    }
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            objPrjTabENEx.ClsName = "ac" + objPrjTabENEx.TabName + "_WA_UTScript";
            string strXmlFileName = "ac_" + objPrjTabENEx.TabName + "_WA_UTScript";
            ...
            strRe_ClsName = objPrjTabENEx.ClsName;
            clsFuncModule_AgcEN objFuncModule = clsFuncModule_AgcBL.GetObjByFuncModuleAgcIdCache(objPrjTabENEx.FuncModuleAgcId, objPrjTabENEx.PrjId);
            strRe_FileNameWithModuleName = string.Format("UT_{0}\\{1}", objFuncModule.FuncModuleEnName4GC(), objPrjTabENEx.SimpleFileName);
            strClassFName = objPrjTabENEx.FolderName + objPrjTabENEx.ClsName + ".java";
            ...
            try
            {
                ...
                {
                    string strFuncName = objvFunction4GeneCodeEN.FuncName;
                    if (strFuncName.IndexOf("Java_DeclareButton") <= 0) continue;
                ...
                foreach (clsvFunction4GeneCodeEN objvFunction4GeneCodeEN in arrvFunction4GeneCodeObjLst)
                {
                    string strFuncName = objvFunction4GeneCodeEN.FuncName;
                    //string strTemp = "";
                    if (strFuncName.IndexOf("Java_BindButton") <= 0) continue;
                    strCodeForCs.AppendFormat("\r\n" + "tabHost.addTab(tabHost.newTabSpec(\"tab{0}\").setIndicator(\"{1}\").setContent(R.id.tab{0}));",
                        objvFunction4GeneCodeEN.FuncName4Code,
                        objvFunction4GeneCodeEN.FuncCHName4Code);
                }
                //为函数的参数输入控件进行绑定
                ...
                foreach (clsvFunction4GeneCodeEN objvFunction4GeneCodeEN in arrvFunction4GeneCodeObjLst)
                {
                    ...
                    try
                    {
                        strTemp = GC_BindCtrlVar4FuncPara(objvFunction4GeneCodeEN, arrValueLst);
                        if (string.IsNullOrEmpty(strTemp) == false)
                        {
                            strCodeForCs.AppendFormat("\r\n" + "//为函数[{0}、{1}]参数定义的输入控件进行绑定：",
                                intIndex,
                                objvFunction4GeneCodeEN.FuncName4Code);
                            strCodeForCs.Append(strTemp + "\r\n");
                        }
                ...
                //    string strFuncName = objvFunction4GeneCodeEN.FuncName;
                //    //string strTemp = "";
                //    if (strFuncName.IndexOf("Java_BindButton") > 0)
                //    {
                ...
                //    string strFuncName = objvFunction4GeneCodeEN.FuncName;
                //    //string strTemp = "";
                //    if (strFuncName.IndexOf("Java_DefBtnClickEvent") > 0)
                //    {
                //        strTemp = A_GeneFuncCode(objvFunction4GeneCodeEN, ref Re_objFunction4Code);
                //    }
                //    else
                ...
                foreach (clsvFunction4GeneCodeEN objvFunction4GeneCodeEN in arrvFunction4GeneCodeObjLst)
                {
                    ...
                    if (strFuncName.IndexOf("Java_btnClick") > 0)
                    {
                        ...
                        //{
                        strTemp = A_GeneFuncCode(objvFunction4GeneCodeEN, ref Re_objFunction4Code);
                        string strSource = string.Format("ac{0}_WA_UT", objPrjTabENEx.TabName);
                        string strTarget = string.Format("ac{0}_WA_UTScript", objPrjTabENEx.TabName);

                        strTemp = strTemp.Replace(strSource, strTarget);
                        //}
                        //else
                        //{
                        //    strTemp = Gen_WA_Controller_Java_btnClickByCommonFunction(objvFunction4GeneCodeEN);
        ...
        /// </summary>
        /// <returns></returns>
        public string A_GenController_Java_SelfDefWA4UTScriptCS(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            string strResult = "";
            if (objWebSrvClassENEx.arrWebSrvFunctionsENExObjLst.Count == 0)
            {
            ...
            try
            {
                ...
                //    try
                //    {
                //        strTemp = Gen_WA_Controller_Java_DeclareButtonByCommonFunction(objWebSrvFunctionsENEx);
                //        if (string.IsNullOrEmpty(strTemp) == false)
                //        {
                //            strCodeForCs.Append("\r\n" + strTemp);
                //            clsWebSrvFunctionsBLEx.SetGeneCode(objWebSrvFunctionsENEx.WebSrvFunctionId, true);
                ...
                //    string strFuncName = objvFunction4GeneCodeEN.FuncName;
                //    //string strTemp = "";
                //    if (strFuncName.IndexOf("Java_DeclareButton") > 0)
                //    {
                //        strTemp = A_GeneFuncCode(objvFunction4GeneCodeEN, ref Re_objFunction4Code);
                //    }
                //    else
                ...
                //    try
                //    {
                //        strTemp = Gen_WA_Controller_Java_BindButtonByCommonFunction(objWebSrvFunctionsENEx);
                //        if (string.IsNullOrEmpty(strTemp) == false)
                //        {
                //            strCodeForCs.Append("\r\n" + strTemp);
                //            clsWebSrvFunctionsBLEx.SetGeneCode(objWebSrvFunctionsENEx.WebSrvFunctionId, true);
                ...
                //    try
                //    {
                //        strTemp = Gen_WA_Controller_Java_DefBtnClickEventByCommonFunction(objWebSrvFunctionsENEx);
                //        if (string.IsNullOrEmpty(strTemp) == false)
                //        {
                //            strCodeForCs.Append("\r\n" + strTemp);
                //            clsWebSrvFunctionsBLEx.SetGeneCode(objWebSrvFunctionsENEx.WebSrvFunctionId, true);
                ...
                //    {
                //        strTemp = A_GeneFuncCode_Java_btnClick(strFuncName);
                //        string strSource = string.Format("ac{0}_UnitTest", objWebSrvClassENEx.TabName);
                //        string strTarget = string.Format("ac{0}_UTScript", objWebSrvClassENEx.TabName);
        ...
        /// <summary>
        /// 生成自定义WA界面后台代码,通过TabHost
        /// </summary>
        /// <returns></returns>
        public string A_GenController_Java_SelfDefWA4UTScriptCSByTabHost(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            string strResult = "";
            if (objWebSrvClassENEx.arrWebSrvFunctionsENExObjLst.Count == 0)
            {
        ...
        private AndroidLinearLayoutEx GetLinearLayout4Function4SelfDefWA1(clsWebSrvFunctionsENEx objWebSrvFunctionsENEx)
        {
            AndroidLinearLayoutEx objAndroidLinearLayoutENEx = new AndroidLinearLayoutEx();
            objAndroidLinearLayoutENEx.CtrlId = string.Format("tab{0}",
                objWebSrvFunctionsENEx.FunctionName);
        ...
        private AndroidConstraintLayoutEx GetConstraintLayout4Function4SelfDefWA(clsWebSrvFunctionsENEx objWebSrvFunctionsENEx,
            List<string> arrValueLst)
        {
            AndroidConstraintLayoutEx objAndroidConstraintLayoutENEx = new AndroidConstraintLayoutEx();
            objAndroidConstraintLayoutENEx.CtrlId = string.Format("tab{0}",
    ...
    List<string> arrValueLst)
            ...
            if (arrFuncPara4CodeObjLst != null)
            {
                foreach (clsFuncPara4CodeEN objFuncPara4CodeEN in arrFuncPara4CodeObjLst)
                {
                    ...
                    else
                    {
                        ...
                        if (string.IsNullOrEmpty(objFuncPara4CodeEN._StrTag))
                        {
                            strParaName_New = objFuncPara4CodeEN.ParaName;
                        }
                        //string strParaName_New = clsString.GetUniqueStrValue_S(objWebSrvFuncParaEN.ParaName, arrValueLst);
                        //arrValueLst.Add(strParaName_New);
                        //objWebSrvFuncParaEN._StrTag = strParaName_New;
        ...
        /// </summary>
        /// <returns></returns>
        public string A_GenController_Java_SelfDefWA4UTScriptByTabHost(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            try
            {
                ...
                foreach (clsWebSrvFunctionsENEx objWebSrvFunctionsENEx in objWebSrvClassENEx.arrWebSrvFunctionsENExObjLst)
                {
                    ...
                    try
                    {
                        //strTemp = Gen_WA_Controller_Java_DefButtonByCommonFunction(objWebSrvFunctionsENEx);
                        AndroidConstraintLayoutEx objAndroidConstraintLayoutENEx1 =
                           GetConstraintLayout4Function4SelfDefWA(objWebSrvFunctionsENEx, arrValueLst);
                ...
                objAndroidConstraintLayoutENEx.arrSubAndroidControlLst2.Add(objAndroidTextViewENEx);
                objAndroidConstraintLayoutENEx.GeneCode(enumApplicationType.AndroidApp_5, strCodeForCs);
            }
            catch (Exception ex)
            {
                clsEntityBase.LogErrorS(ex, "");
        ...
        /// </summary>
        /// <returns></returns>
        public string A_GenController_Java_SelfDefWA(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            if (objWebSrvClassENEx.arrWebSrvFunctionsENExObjLst.Count == 0)
            {
            ...
            try
            {
                ...
                strCodeForCs.Append("\r\n" + "import com.taishsoft.util.clsResponseData;"); //
                strCodeForCs.Append("\r\n" + "import com.taishsoft.commdb.clsTableObjWA4ControllerDelegate;"); //
                strCodeForCs.AppendFormat("\r\n" + "import {0}.GC.L4_Controller4WA.{1}.{2}WA4SDController;",
                    objProjectsENEx.JavaPackageName,
                ...
                foreach (clsWebSrvFunctionsENEx objWebSrvFunctionsENEx in objWebSrvClassENEx.arrWebSrvFunctionsENExObjLst)
                {
                    ...
                    try
                    {
                        strTemp = Gen_WA_Controller_Java_ByCommonFunction(objWebSrvFunctionsENEx);
                        if (string.IsNullOrEmpty(strTemp) == false)
                        {
                            strCodeForCs.Append("\r\n" + strTemp);
                            clsWebSrvFunctionsBLEx.SetGeneCode(objWebSrvFunctionsENEx.WebSrvFunctionId, true);
                ...
                //strTemp = A_GeneFuncCode_Java("Gen_4WA4Controller_Java_SelfDefWA_handleMessage");
                //strCodeForCs.Append("\r\n" + strTemp);
                //foreach (clsvFunction4GeneCodeEN objvFunction4GeneCodeEN in arrvFunction4GeneCodeObjLst)
                //{
                //    string strFuncName = objvFunction4GeneCodeEN.FuncName;
        ...
        public string A_GeneFuncCode_Java(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            ...
            try
            {
                switch (strFuncName)
                {
                    ...
                    //case "Gen_4WA_GetObjByKey_S_Java":
                    //    return Gen_4WA_GetObjByKey_S_Java();
                    //case "btnGetFirstObj_Click":
                    //    return btnGetFirstObj_Click();

                    case "Gen_WA_Controller_Java_btnGetFirstObj_Click":
                        return Gen_WA_Controller_Java_btnGetFirstObj_Click(strFuncId4GC);

                    case "Gen_WA_Controller_Java_btnGetObjByKey_Click":
                        return Gen_WA_Controller_Java_btnGetObjByKey_Click();
                        
                    case "Gen_4WA4Controller_Java_GetFirstObj":
                        return Gen_4WA4Controller_Java_GetFirstObj();
                    case "Gen_4WA4Controller_Java_GetObjByKey":
                        return Gen_4WA4Controller_Java_GetObjByKey();

                    //case "IsFinished4WebService":
                    //    return IsFinished4WebService();

                    case "Gen_4WA4Controller_Java_handleMessage":
                        return Gen_4WA4Controller_Java_handleMessage();
                    case "Gen_4WA4Controller_Java_SelfDefWA_handleMessage":
                        return Gen_4WA4Controller_Java_SelfDefWA_handleMessage();


                    //case "btnDelRecord_Click":
                    //    return btnDelRecord_Click();

                    case "Gen_WA_Controller_Java_btnDelRecord_Click":
                        return Gen_WA_Controller_Java_btnDelRecord_Click();
                    case "Gen_WA_Controller_Java_btnDelRecordsByJSON_Click":
                        return Gen_WA_Controller_Java_btnDelRecordsByJSON_Click();

                    case "Gen_4WA4Controller_Java_DelRecord":
                        return Gen_4WA4Controller_Java_DelRecord();

                    case "Gen_4WA4Controller_Java_DelRecordsByJSON":
                        return Gen_4WA4Controller_Java_DelRecordsByJSON();
                    ...
                    case "Gen_WA_Controller_Java_btnAddNewRecord_Click":
                        return Gen_WA_Controller_Java_btnAddNewRecord_Click();

                    case "Gen_WA_Controller_Java_btnAddNewRecord4GetMaxStrId_Click":
                        return Gen_WA_Controller_Java_btnAddNewRecord4GetMaxStrId_Click();
                    case "Gen_WA_Controller_Java_btnGetMaxStrId_Click":
                        return Gen_WA_Controller_Java_btnGetMaxStrId_Click();
                    case "Gen_WA_Controller_Java_btnGetMaxStrIdByPrefix_Click":
                        return Gen_WA_Controller_Java_btnGetMaxStrIdByPrefix_Click();

                    case "Gen_4WA4Controller_Java_AddNewRecord":
                        return Gen_4WA4Controller_Java_AddNewRecord();

                    case "Gen_WA_Controller_Java_btnUpdateRecord_Click":
                        return Gen_WA_Controller_Java_btnUpdateRecord_Click();

                    case "Gen_4WA4Controller_Java_UpdateRecord":
                        return Gen_4WA4Controller_Java_UpdateRecord();

                    case "Gen_WA_Controller_Java_btnIsExistRecord_Click":
                        return Gen_WA_Controller_Java_btnIsExistRecord_Click(strFuncId4GC);

                    case "Gen_WA_Controller_Java_GetRecCountByCond_Click":
                        return Gen_WA_Controller_Java_GetRecCountByCond_Click(strFuncId4GC);

                    //case "btnIsExistRecord_Click":
                    //    return btnIsExistRecord_Click();

                    case "Gen_4WA4Controller_Java_IsExistRecord":
                        return Gen_4WA4Controller_Java_IsExistRecord();

                    case "Gen_4WA4Controller_Java_GetRecCountByCond":
                        return Gen_4WA4Controller_Java_GetRecCountByCond();

                    case "Gen_4WA4Controller_Java_GetMaxStrId":
                        return Gen_4WA4Controller_Java_GetMaxStrId();

                    case "Gen_4WA4Controller_Java_GetMaxStrIdByPrefix":
                        return Gen_4WA4Controller_Java_GetMaxStrIdByPrefix();

                    //case "btnGetObjLst_Click":
                    //    return btnGetObjLst_Click();

                    case "Gen_WA_Controller_Java_btnGetObjLst_Click":
                        return Gen_WA_Controller_Java_btnGetObjLst_Click();

                    case "Gen_WA_Controller_Java_btnGetTopObjLst_Click":
                        return Gen_WA_Controller_Java_btnGetTopObjLst_Click();

                    case "Gen_WA_Controller_Java_btnGetObjLstByPager_Click":
                        return Gen_WA_Controller_Java_btnGetObjLstByPager_Click();
                        
                    case "Gen_4WA4Controller_Java_GetObjLst":
                        return Gen_4WA4Controller_Java_GetObjLst();

                    case "Gen_4WA4Controller_Java_GetTopObjLst":
                        return Gen_4WA4Controller_Java_GetTopObjLst();

                    case "Gen_4WA4Controller_Java_GetObjLstByPager":
                        return Gen_4WA4Controller_Java_GetObjLstByPager();

                    case "Gen_4WA4Controller_Java_GetObjLstByRange":
                        return Gen_4WA4Controller_Java_GetObjLstByRange();
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA4Controller_Java_GetObjByKey()
        {
            ...
            strCodeForCs.AppendFormat("\r\n" + "cls{0}EN obj{0}EN = new cls{0}EN();",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "cls{0}WA obj{0}WA = new cls{0}WA(mHandler, \"GetObjBy{1}\",",
                objPrjTabENEx.TabName,
                objKeyField.FldName);
            strCodeForCs.Append("\r\n" + "mapParam,");
            strCodeForCs.AppendFormat("obj{0}EN);",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "Thread mThread = new Thread(obj{0}WA);",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "mThread.start();");
            strCodeForCs.Append("\r\n" + "}");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA4Controller_Java_ByCommonFunction(clsWebSrvFunctionsENEx objWebSrvFunctionsENEx)
        {
            string strMsg = "";
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            ...
            strCodeForCs.AppendFormat("\r\n" + "{0}WA4SD obj{0}WA4SD = new {0}WA4SD(mHandler, \"{1}\",",
                objWebSrvClassENEx.ClsName,
                objWebSrvFunctionsENEx.FunctionName);
            strCodeForCs.Append("\r\n" + "mapParam);");
            //strCodeForCs.AppendFormat("obj{0}EN);",
            //    objWebSrvFunctionsENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "Thread mThread = new Thread(obj{0}WA4SD);",
                objWebSrvClassENEx.ClsName);
            strCodeForCs.Append("\r\n" + "mThread.start();");
            strCodeForCs.Append("\r\n" + "}");
        ...
        public string Gen_4WA4Controller_Java_GetFirstObj()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 根据条件获取相应的第一条记录的对象");
            ...
            strCodeForCs.AppendFormat("\r\n" + "public void GetFirstObj(String strWhereCond)",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.Append("\r\n" + "Map<String, String> mapParam = new HashMap<String, String>();");
            ...
            strCodeForCs.AppendFormat("\r\n" + "cls{0}EN obj{0}EN = new cls{0}EN();",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "cls{0}WA obj{0}WA = new cls{0}WA(mHandler, \"GetFirstObj\",",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "mapParam,");
            strCodeForCs.AppendFormat("obj{0}EN);",
                objPrjTabENEx.TabName);
        ...
        public string Gen_WA_Controller_Java_btnGetObjByKey_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 根据关键字获取相应的记录的对象");
            ...
            strCodeForCs.AppendFormat("\r\n" + "class icls{0}GetObjBy{1} extends clsTableObjWA4ControllerDelegate",
                objPrjTabENEx.TabName,
                objKeyField.FldName);
            strCodeForCs.Append("\r\n" + "{");
            ...
            strCodeForCs.Append("\r\n" + "//通过WebService执行GetObjByKey,返回的事件函数,可能需要处理执行错误。");
            strCodeForCs.Append("\r\n" + "@Override");
            ...
            strCodeForCs.Append("\r\n" + "//通过WebService执行GetObjByKey,返回的事件函数,这是正确返回,不需要处理执行错误。");
            strCodeForCs.Append("\r\n" + "@Override");
        ...
        public string Gen_WA_Controller_Java_btnGetFirstObj_Click(string strFuncId4GC)
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 根据条件获取相应的第一条记录的对象");
            ...
            strCodeForCs.AppendFormat("\r\n" + "icls{0}GetFirstObj iobj{0}GetFirstObj = new icls{0}GetFirstObj();",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "iobj{0}GetFirstObj.main();",
                objPrjTabENEx.TabName);

            strCodeForCs.Append("\r\n" + "}");
            strCodeForCs.AppendFormat("\r\n" + "class icls{0}GetFirstObj extends clsTableObjWA4ControllerDelegate",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "{");
            ...
            strCodeForCs.AppendFormat("\r\n" + "obj{0}WA4Controller.GetFirst{0}(strWhereCond);",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "}");
    ...
    objPrjTabENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA4Controller_Java_GetObjLst()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 根据条件获取相应的记录对象列表");
            ...
            strCodeForCs.AppendFormat("\r\n" + "cls{0}EN obj{0}EN = new cls{0}EN();",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "cls{0}WA obj{0}WA = new cls{0}WA(mHandler, \"GetObjLst\",",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "mapParam,");
            strCodeForCs.AppendFormat("obj{0}EN);",
                objPrjTabENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA4Controller_Java_GetTopObjLst()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 根据条件获取相应的记录对象列表");
            ...
            strCodeForCs.Append("\r\n /// <returns>获取相应的记录的对象</returns>");
            strCodeForCs.AppendFormat("\r\n" + "public void GetTopObjLst(Integer intTopSize, String strWhereCond)",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + "Map<String, String> mapParam = new HashMap<String, String>();");
            ...
            strCodeForCs.AppendFormat("\r\n" + "cls{0}EN obj{0}EN = new cls{0}EN();",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "cls{0}WA obj{0}WA = new cls{0}WA(mHandler, \"GetTopObjLst\",",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "mapParam,");
            strCodeForCs.AppendFormat("obj{0}EN);",
                objPrjTabENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA4Controller_Java_GetObjLstByPager()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 根据条件获取相应的记录对象列表");
            ...
            strCodeForCs.Append("\r\n /// <returns>获取相应的记录的对象</returns>");
            strCodeForCs.AppendFormat("\r\n" + "public void GetObjLstByPager(Integer intPageIndex, Integer intPageSize, String strWhereCond, String strOrderBy)",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + "Map<String, String> mapParam = new HashMap<String, String>();");
            ...
            strCodeForCs.AppendFormat("\r\n" + "cls{0}EN obj{0}EN = new cls{0}EN();",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "cls{0}WA obj{0}WA = new cls{0}WA(mHandler, \"GetObjLstByPager\",",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "mapParam,");
            strCodeForCs.AppendFormat("obj{0}EN);",
                objPrjTabENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA4Controller_Java_GetObjLstByRange()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 根据条件获取相应的记录对象列表");
            ...
            strCodeForCs.Append("\r\n /// <param name = \"strOrderBy\">排序方式</param>");
            strCodeForCs.Append("\r\n /// <returns>获取相应的记录的对象</returns>");
            strCodeForCs.AppendFormat("\r\n" + "public void GetObjLstByRange(String strWhereCond, String strOrderBy, Integer intMinNum, Integer intMaxNum)",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + "Map<String, String> mapParam = new HashMap<String, String>();");
            strCodeForCs.AppendFormat("\r\n" + "mapParam.put(\"strWhereCond\", strWhereCond);");
            ...
            strCodeForCs.AppendFormat("\r\n" + "cls{0}EN obj{0}EN = new cls{0}EN();",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "cls{0}WA obj{0}WA = new cls{0}WA(mHandler, \"GetObjLstByRange\",",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "mapParam,");
            strCodeForCs.AppendFormat("obj{0}EN);",
                objPrjTabENEx.TabName);
        ...
        public string Gen_WA_Controller_Java_btnGetObjLst_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 根据条件获取相应的对象列表");
            ...
            strCodeForCs.AppendFormat("\r\n" + "public void btnGetObjLst_Click(View myView) ",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + "icls{0}GetObjLst iobj{0}GetObjLst = new icls{0}GetObjLst();",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "iobj{0}GetObjLst.main();",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "}");
            strCodeForCs.AppendFormat("\r\n" + "class icls{0}GetObjLst extends clsTableObjWA4ControllerDelegate",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "{");
        ...
        public string Gen_WA_Controller_Java_btnGetTopObjLst_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 根据条件获取相应的顶部对象列表");
            ...
            strCodeForCs.AppendFormat("\r\n" + "public void btnGetTopObjLst_Click(View myView) ",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + "icls{0}GetTopObjLst iobj{0}GetTopObjLst = new icls{0}GetTopObjLst();",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "iobj{0}GetTopObjLst.main();",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "}");
            strCodeForCs.AppendFormat("\r\n" + "class icls{0}GetTopObjLst extends clsTableObjWA4ControllerDelegate",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "{");
        ...
        public string Gen_WA_Controller_Java_btnGetObjLstByPager_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 根据条件获取相应的分页对象列表");
            ...
            strCodeForCs.AppendFormat("\r\n" + "public void btnGetObjLstByPager_Click(View myView) ",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + "icls{0}GetObjLstByPager iobj{0}GetObjLstByPager = new icls{0}GetObjLstByPager();",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "iobj{0}GetObjLstByPager.main();",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "}");
            strCodeForCs.AppendFormat("\r\n" + "class icls{0}GetObjLstByPager extends clsTableObjWA4ControllerDelegate",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "{");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_WA_Controller_Java_btnIsExistRecord_Click(string strFuncId4GC)
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 检查相应关键字的记录是否存在");
            ...
            strCodeForCs.Append("\r\n" + "class iclsIsExistRecord extends clsTableObjWA4ControllerDelegate");
            strCodeForCs.Append("\r\n" + "{");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_WA_Controller_Java_GetRecCountByCond_Click(string strFuncId4GC)
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 检查相应关键字的记录是否存在");
            ...
            strCodeForCs.Append("\r\n" + "class iclsGetRecCountByCond extends clsTableObjWA4ControllerDelegate");
            strCodeForCs.Append("\r\n" + "{");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA4Controller_Java_IsExistRecord()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 根据条件在表中检查是否满足条件的记录");
            ...
            strCodeForCs.AppendFormat("\r\n" + "cls{0}EN obj{0}EN = new cls{0}EN();",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "cls{0}WA obj{0}WA = new cls{0}WA(mHandler, \"IsExistRecord\",",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "mapParam,");
            strCodeForCs.AppendFormat("obj{0}EN);",
                objPrjTabENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA4Controller_Java_GetRecCountByCond()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 根据条件在表中获取记录数");
            ...
            strCodeForCs.AppendFormat("\r\n" + "cls{0}EN obj{0}EN = new cls{0}EN();",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "cls{0}WA obj{0}WA = new cls{0}WA(mHandler, \"GetRecCountByCond\",",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "mapParam,");
            strCodeForCs.AppendFormat("obj{0}EN);",
                objPrjTabENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA4Controller_Java_GetMaxStrId()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 根据前缀获取当前表关键字值的最大值,再加1,避免重复");
            ...
            strCodeForCs.AppendFormat("\r\n" + "cls{0}EN obj{0}EN = new cls{0}EN();",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "cls{0}WA obj{0}WA = new cls{0}WA(mHandler, \"GetMaxStrId\",",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "mapParam,");
            strCodeForCs.AppendFormat("obj{0}EN);",
                objPrjTabENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA4Controller_Java_GetMaxStrIdByPrefix()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 根据前缀获取当前表关键字值的最大值,再加1,避免重复");
            ...
            strCodeForCs.AppendFormat("\r\n" + "cls{0}EN obj{0}EN = new cls{0}EN();",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "cls{0}WA obj{0}WA = new cls{0}WA(mHandler, \"GetMaxStrIdByPrefix\",",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "mapParam,");
            strCodeForCs.AppendFormat("obj{0}EN);",
                objPrjTabENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA4Controller_Java_handleMessage()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 调用WebService是否完成函数");
            ...
            strCodeForCs.AppendFormat("\r\n" + "cls{0}EN obj{0}EN;",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "clsResponseData objResponseData = cls{0}WA.objResponseData;",
                objPrjTabENEx.TabName);
            ...
            strCodeForCs.AppendFormat("\r\n" + " if (cls{0}WA.objResponseData.errorId >= 2)",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + " objTableObjWA4ControllerDelegate.{1}(objResponseData, \"cls{0}WA4Controller\");",
                objPrjTabENEx.TabName,
                clsDict4GCBLEx.GetDictValueByKeyCache(enumDict4GC_DictKey1.conGetObjByKey,
                enumDict4GC_DictKey2.conFinished));
            ...
            strCodeForCs.Append("\r\n" + "return;");
            strCodeForCs.Append("\r\n" + "}");
            strCodeForCs.AppendFormat("\r\n" + "else if (cls{0}WA.objResponseData.errorId == 1)",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + "String strInfo = String.format(\"获取对象不成功!调用GetObjBy{1}函数出错。%s\", cls{0}WA.objResponseData.faultString);",
                objPrjTabENEx.TabName,
                objKeyField.FldName);
            ...
            strCodeForCs.AppendFormat("\r\n" + "objResponseData.returnObject = obj{0}EN;",
                objPrjTabENEx.TabName);
            //strCodeForCs.AppendFormat("\r\n" + "objTableObjWA4ControllerDelegate.{1}(objResponseData, \"{0}\");",
            //    objPrjTabENEx.ClsName,
            //    clsDict4GCBLEx.GetDictValueByKeyCache(enumDict4GC_DictKey1.conGetObjByKey,
            //    enumDict4GC_DictKey2.conFinished));

            strCodeForCs.AppendFormat("\r\n" + "objTableObjWA4ControllerDelegate.{2}(obj{0}EN, \"{1}\");",
                 objPrjTabENEx.TabName,
                 objPrjTabENEx.ClsName,
                clsDict4GCBLEx.GetDictValueByKeyCache(enumDict4GC_DictKey1.conGetObjByKey,
                enumDict4GC_DictKey2.conCorrectFinished));
      ...
      objPrjTabENEx.TabName);
            ...
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + "String strInfo = String.format(\"获取对象列表不成功!调用GetObjLst函数出错。%s\", cls{0}WA.objResponseData.faultString);",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "objResponseData.faultString = strInfo;");
            strCodeForCs.AppendFormat("\r\n" + " objTableObjWA4ControllerDelegate.{1}(objResponseData, \"cls{0}WA4Controller\");",
                objPrjTabENEx.TabName,
            ...
            strCodeForCs.AppendFormat("\r\n" + "objTableObjWA4ControllerDelegate.{2}(arr{0}ObjLst, \"{1}\");",
                    objPrjTabENEx.TabName,
                 objPrjTabENEx.ClsName,
                 clsDict4GCBLEx.GetDictValueByKeyCache(enumDict4GC_DictKey1.conGetObjLst,
                enumDict4GC_DictKey2.conCorrectFinished));
         ...
         objPrjTabENEx.TabName);
            ...
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.Append("\r\n" + "");
            strCodeForCs.AppendFormat("\r\n" + "String strInfo = String.format(\"添加不成功,调用AddNewRecord函数出错。%s\", cls{0}WA.objResponseData.faultString);",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "objResponseData.faultString = strInfo;");
            strCodeForCs.AppendFormat("\r\n" + " objTableObjWA4ControllerDelegate.{1}(objResponseData, \"cls{0}WA4Controller\");",
                objPrjTabENEx.TabName,
            ...
            strCodeForCs.AppendFormat("\r\n" + "objTableObjWA4ControllerDelegate.{1}(bolResult, \"{0}\");",
                objPrjTabENEx.ClsName,
                clsDict4GCBLEx.GetDictValueByKeyCache(enumDict4GC_DictKey1.conAddNewRecord,
                enumDict4GC_DictKey2.conCorrectFinished));
          ...
          objPrjTabENEx.TabName);
            ...
            strCodeForCs.AppendFormat("\r\n" + "String strInfo = String.format(\"修改不成功!调用UpdateRecord函数出错。%s\", cls{0}WA.objResponseData.faultString);",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "objResponseData.faultString = strInfo;");
            strCodeForCs.AppendFormat("\r\n" + " objTableObjWA4ControllerDelegate.{1}(objResponseData, \"cls{0}WA4Controller\");",
                objPrjTabENEx.TabName,
      ...
      objPrjTabENEx.TabName);
            ...
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + "String strInfo = String.format(\"删除不成功!调用DelRecord函数出错。%s\", cls{0}WA.objResponseData.faultString);",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "objResponseData.faultString = strInfo;");
            strCodeForCs.AppendFormat("\r\n" + " objTableObjWA4ControllerDelegate.{1}(objResponseData, \"cls{0}WA4Controller\");",
                objPrjTabENEx.TabName,
            ...
            strCodeForCs.AppendFormat("\r\n" + "objTableObjWA4ControllerDelegate.{1}(intResult, \"{0}\");",
                objPrjTabENEx.ClsName,
                clsDict4GCBLEx.GetDictValueByKeyCache(enumDict4GC_DictKey1.conDelRecord,
                enumDict4GC_DictKey2.conCorrectFinished));
         ...
         objPrjTabENEx.TabName);
            ...
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + "String strInfo = String.format(\"获取第一条记录不成功!调用GetFirst{0}函数出错。%s\", cls{0}WA.objResponseData.faultString);",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "objResponseData.faultString = strInfo;");
            strCodeForCs.AppendFormat("\r\n" + " objTableObjWA4ControllerDelegate.{1}(objResponseData, \"cls{0}WA4Controller\");",
                objPrjTabENEx.TabName,
        ...
        objPrjTabENEx.TabName);
            ...
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + "String strInfo = String.format(\"调用IsExistRecord函数出错。%s\", cls{0}WA.objResponseData.faultString);",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "objResponseData.faultString = strInfo;");
            strCodeForCs.AppendFormat("\r\n" + " objTableObjWA4ControllerDelegate.{1}(objResponseData, \"cls{0}WA4Controller\");",
                objPrjTabENEx.TabName,
       ...
       objPrjTabENEx.TabName);
            ...
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + "String strInfo = String.format(\"调用GetMaxStrId函数出错。%s\", cls{0}WA.objResponseData.faultString);",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "objResponseData.faultString = strInfo;");
            strCodeForCs.AppendFormat("\r\n" + " objTableObjWA4ControllerDelegate.{1}(objResponseData, \"cls{0}WA4Controller\");",
                objPrjTabENEx.TabName,
            ...
            //    clsDict4GCBLEx.GetDictValueByKeyCache(enumDict4GC_DictKey1.conGetMaxStrId,
            //    enumDict4GC_DictKey2.conFinished));
            strCodeForCs.AppendFormat("\r\n" + "objTableObjWA4ControllerDelegate.{1}(strResultValue, \"{0}\");",
                objPrjTabENEx.ClsName,
                clsDict4GCBLEx.GetDictValueByKeyCache(enumDict4GC_DictKey1.conGetMaxStrId,
                enumDict4GC_DictKey2.conCorrectFinished));
        ...
        objPrjTabENEx.TabName);
            ...
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + "String strInfo = String.format(\"调用GetMaxStrIdByPrefix函数出错。%s\", cls{0}WA.objResponseData.faultString);",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "objResponseData.faultString = strInfo;");
            strCodeForCs.AppendFormat("\r\n" + " objTableObjWA4ControllerDelegate.{1}(objResponseData, \"cls{0}WA4Controller\");",
                objPrjTabENEx.TabName,
    ...
    objPrjTabENEx.TabName);
      ...
      objPrjTabENEx.TabName);
            ...
            strCodeForCs.AppendFormat("\r\n" + "String strInfo = String.format(\"获取顶对象列表不成功!调用GetTopQx{0}ObjLst函数出错。%s\",",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "cls{0}WA.objResponseData.faultString);",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "objResponseData.faultString = strInfo;");
            strCodeForCs.AppendFormat("\r\n" + " objTableObjWA4ControllerDelegate.{1}(objResponseData, \"cls{0}WA4Controller\");",
                objPrjTabENEx.TabName,
            ...
            strCodeForCs.AppendFormat("\r\n" + "objResponseData.returnObjectList = arr{0}ObjLst;",
                objPrjTabENEx.TabName);
            //strCodeForCs.AppendFormat("\r\n" + "objTableObjWA4ControllerDelegate.{0}(objResponseData, \"clsQx{0}WA4Controller\");",
            //    clsDict4GCBLEx.GetDictValueByKeyCache(enumDict4GC_DictKey1.conGetTopObjLst,
            //    enumDict4GC_DictKey2.conFinished));

            strCodeForCs.AppendFormat("\r\n" + "objTableObjWA4ControllerDelegate.{1}(arr{0}ObjLst, \"cls{0}WA4Controller\");",
                objPrjTabENEx.TabName,
                clsDict4GCBLEx.GetDictValueByKeyCache(enumDict4GC_DictKey1.conGetTopObjLst,
                enumDict4GC_DictKey2.conCorrectFinished));
            strCodeForCs.Append("\r\n" + "return;");
 ...
 objPrjTabENEx.TabName);
      ...
      objPrjTabENEx.TabName);
        ...
        objPrjTabENEx.TabName);
            ...
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + "String strInfo = String.format(\"调用GetRecCountByCond函数出错。%s\", cls{0}WA.objResponseData.faultString);",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "objResponseData.faultString = strInfo;");
            strCodeForCs.AppendFormat("\r\n" + " objTableObjWA4ControllerDelegate.{1}(objResponseData, \"cls{0}WA4Controller\");",
                objPrjTabENEx.TabName,
            ...
            strCodeForCs.Append("\r\n" + "intResult = data.getInt(\"intResult\");");
            strCodeForCs.Append("\r\n" + "objResponseData.returnInt = intResult;");
            //         strCodeForCs.Append("\r\n" + "objTableObjWA4ControllerDelegate.GetRecCountByCondCorrectFinished(intResult, "cls{0}WA4Controller");");
      ...
      objPrjTabENEx.TabName);
            ...
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + "String strInfo = String.format(\"删除不成功!调用DelRecordsByJSON函数出错。%s\", cls{0}WA.objResponseData.faultString);",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "objResponseData.faultString = strInfo;");
            strCodeForCs.AppendFormat("\r\n" + " objTableObjWA4ControllerDelegate.{1}(objResponseData, \"cls{0}WA4Controller\");",
                objPrjTabENEx.TabName,
 ...
 objPrjTabENEx.TabName);
      ...
      objPrjTabENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA4Controller_Java_SelfDefWA_handleMessage()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 调用WebService是否完成函数");
            ...
            //strCodeForCs.AppendFormat("\r\n" + "cls{0}EN obj{0}EN;",
            //    objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "clsResponseData objResponseData = {0}WA4SD.objResponseData;",
                objWebSrvClassENEx.ClsName);
            ...
            foreach (clsWebSrvFunctionsENEx objWebSrvFunctionsENEx in objWebSrvClassENEx.arrWebSrvFunctionsENExObjLst)
            {
                ...
                //                    int count = data.getInt("COUNT");
                strCodeForCs.Append("\r\n" + "strResultValue = data.getString(\"strResultValue\");");
                strCodeForCs.AppendFormat("\r\n" + " if ({0}WA4SD.objResponseData.errorId >= 2)",
                        objWebSrvClassENEx.ClsName);
                strCodeForCs.Append("\r\n" + "{");
                strCodeForCs.AppendFormat("\r\n" + " objTableObjWA4ControllerDelegate.{1}(objResponseData, \"cls{0}WA4Controller\", \"{2}\");",
                    objWebSrvClassENEx.ClsName,
                ...
                strCodeForCs.AppendFormat("\r\n" + "else if ({0}WA4SD.objResponseData.errorId == 1)",
                    objWebSrvClassENEx.ClsName);
                strCodeForCs.Append("\r\n" + "{");
                strCodeForCs.AppendFormat("\r\n" + "String strInfo = String.format(\"调用{0}函数出错。%s\", {0}WA4SD.objResponseData.faultString);",
                    objWebSrvClassENEx.ClsName);
                strCodeForCs.Append("\r\n" + "objResponseData.faultString = strInfo;");
                strCodeForCs.AppendFormat("\r\n" + " objTableObjWA4ControllerDelegate.{1}(objResponseData, \"{0}WA4Controller\", \"{2}\");",
                     objWebSrvClassENEx.ClsName,
                    clsDict4GCBLEx.GetDictValueByKeyCache(enumDict4GC_DictKey1.conSelfDefFunc,
                    enumDict4GC_DictKey2.conFinished),
                    objWebSrvFunctionsENEx.FunctionName);
                ...
                //    objPrjTabENEx.TabName);
                strCodeForCs.AppendFormat("\r\n" + "objResponseData.returnString = strResultValue;");
                //strCodeForCs.AppendFormat("\r\n" + "objTableObjWA4ControllerDelegate.{2}(objResponseData, \"{0}\", \"{1}\");",
                //    objWebSrvClassENEx.ClsName, objWebSrvFunctionsENEx.FunctionName,
                //clsDict4GCBLEx.GetDictValueByKeyCache(enumDict4GC_DictKey1.conSelfDefFunc,
                //enumDict4GC_DictKey2.conFinished));

                strCodeForCs.AppendFormat("\r\n" + "objTableObjWA4ControllerDelegate.{2}(strResultValue, \"{0}\", \"{1}\");",
                     objWebSrvClassENEx.ClsName, objWebSrvFunctionsENEx.FunctionName,
                     clsDict4GCBLEx.GetDictValueByKeyCache(enumDict4GC_DictKey1.conSelfDefFunc,
                     enumDict4GC_DictKey2.conCorrectFinished));
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA4Controller_Java_DelRecord()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 通用的调用WebService函数");
            ...
            strCodeForCs.AppendFormat("\r\n" + "cls{0}EN obj{0}EN = new cls{0}EN();",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "cls{0}WA obj{0}WA = new cls{0}WA(mHandler, \"DelRecord\",",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "mapParam,");
            strCodeForCs.AppendFormat("obj{0}EN);",
                objPrjTabENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA4Controller_Java_DelRecordsByJSON()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 通用的调用WebService函数");
            ...
            strCodeForCs.AppendFormat("\r\n" + "cls{0}EN obj{0}EN = new cls{0}EN();",
                objPrjTabENEx.TabName);
            strCodeForCs.AppendFormat("\r\n" + "cls{0}WA obj{0}WA = new cls{0}WA(mHandler, \"DelRecordsByJSON\",",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "mapParam,");
            strCodeForCs.AppendFormat("obj{0}EN);",
                objPrjTabENEx.TabName);
        ...
        public string Gen_WA_Controller_Java_btnDelRecord_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 删除记录");
            ...
            strCodeForCs.Append("\r\n" + "iobjDelRecord.main();");
            strCodeForCs.Append("\r\n" + "}");
            strCodeForCs.Append("\r\n" + "class iclsDelRecord extends clsTableObjWA4ControllerDelegate");
            strCodeForCs.Append("\r\n" + "{");
    ...
    objPrjTabENEx.TabName);
        ...
        public string Gen_WA_Controller_Java_btnDelRecordsByJSON_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 删除记录");
            ...
            strCodeForCs.Append("\r\n" + "}");
            strCodeForCs.Append("\r\n" + "class iclsDelRecordsByJSON extends clsTableObjWA4ControllerDelegate");
            strCodeForCs.Append("\r\n" + "{");
            ...
            if (objKeyField.ObjFieldTabENEx.objDataTypeAbbrEN.IsNeedQuote == true)
            {
                strCodeForCs.AppendFormat("\r\n" + "obj{0}WA4Controller.DelRecordsByJSON(\"{1}\");",
                    objPrjTabENEx.TabName,
                    objKeyField.ObjFieldTabENEx.DefaultValue4Test_Java);
            }
            else
    ...
    objPrjTabENEx.TabName);
        ...
        public string Gen_WA_Controller_Java_ByCommonFunction(clsWebSrvFunctionsENEx objWebSrvFunctionsENEx)
        {
            string strMsg = "";
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            ...
            strCodeForCs.AppendFormat("\r\n" + "iobj{0}_{1}.main();",
                objWebSrvClassENEx.ClsName, objWebSrvFunctionsENEx.FunctionName);
            strCodeForCs.Append("\r\n" + "}");
            strCodeForCs.AppendFormat("\r\n" + "public static class icls{0}_{1} extends clsTableObjWA4ControllerDelegate",
                objWebSrvClassENEx.ClsName, objWebSrvFunctionsENEx.FunctionName);
            strCodeForCs.Append("\r\n" + "{");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_WA_Controller_Java_btnAddNewRecord_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 添加新记录");
            ...
            strCodeForCs.Append("\r\n" + "class iclsAddNewRecord extends clsTableObjWA4ControllerDelegate");
            strCodeForCs.Append("\r\n" + "{");
        ...
        public string Gen_WA_Controller_Java_btnAddNewRecord4GetMaxStrId_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 添加新记录");
            ...
            strCodeForCs.Append("\r\n" + "class iclsAddNewRecord4GetMaxStrId extends clsTableObjWA4ControllerDelegate");
            strCodeForCs.Append("\r\n" + "{");
    ...
    objPrjTabENEx.TabName);
        ...
        public string Gen_WA_Controller_Java_btnGetMaxStrId_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            ...
            strCodeForCs.Append("\r\n" + "class iclsGetMaxStrId extends clsTableObjWA4ControllerDelegate");
            strCodeForCs.Append("\r\n" + "{");
        ...
        public string Gen_WA_Controller_Java_btnGetMaxStrIdByPrefix_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 根据前缀获取当前表关键字值的最大值,再加1,避免重复");
            ...
            strCodeForCs.Append("\r\n" + "class iclsGetMaxStrIdByPrefix extends clsTableObjWA4ControllerDelegate");
            strCodeForCs.Append("\r\n" + "{");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA4Controller_Java_AddNewRecord()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 添加新记录");
            ...
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.Append("\r\n" + "Map<String, String> mapParam = new HashMap<String, String>();");
            strCodeForCs.AppendFormat("\r\n" + "cls{0}WA obj{0}WA = new cls{0}WA(mHandler, \"AddNewRecord\",",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "mapParam,");
            strCodeForCs.AppendFormat("obj{0}EN);",
                objPrjTabENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA4Controller_Java_UpdateRecord()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 修改记录");
    ...
    objPrjTabENEx.TabName);
            ...
            strCodeForCs.AppendFormat("\r\n" + "cls{0}WA obj{0}WA = new cls{0}WA(mHandler, \"UpdateRecord\",",
                objPrjTabENEx.TabName);
            strCodeForCs.Append("\r\n" + "mapParam,");
            strCodeForCs.AppendFormat("obj{0}EN);",
                objPrjTabENEx.TabName);
        ...
        public string Gen_WA_Controller_Java_btnUpdateRecord_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 修改记录");
            ...
            strCodeForCs.Append("\r\n" + "}");
            strCodeForCs.Append("\r\n" + "class iclsUpdateRecord extends clsTableObjWA4ControllerDelegate");
            strCodeForCs.Append("\r\n" + "{");
        ...
        public string A_GenCode4Function_Controller(string strFuncId4GC)
        {
            StringBuilder strCodeForCs = new StringBuilder(); ///用来存放与WebForm相关的类文件代码;
            string strTemp; //临时变量;
            string strFuncName = "";
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(WA_AppViewUTScriptCS4JAVA);
        ...
        {
            this.ClsName = string.Format("ac{0}_WA_UTScript", objPrjTabENEx.TabName);
