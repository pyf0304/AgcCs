...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class WA_AppViewUTScript4JAVA : clsGeneCodeBase4Tab
    {

        #region 构造函数
        public WA_AppViewUTScript4JAVA(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        /// <summary>
        /// 生成AndroidApp界面层-界面脚本-通过Tab主机的方式
        /// </summary>
        /// <returns></returns>
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            objPrjTabENEx.ClsName = "ac_" + objPrjTabENEx.TabName + "_WA_UTScript";
            objPrjTabENEx.ClsName = objPrjTabENEx.ClsName.ToLower();
            //objPrjTabENEx1.ProgLevelTypeId = clsProgLevelTypeENEx.WebServiceTransferLevel;

            objPrjTabENEx.SimpleFileName = objPrjTabENEx.ClsName + ".xml";
            strRe_ClsName = objPrjTabENEx.ClsName;
            clsFuncModule_AgcEN objFuncModule = clsFuncModule_AgcBL.GetObjByFuncModuleAgcIdCache(objPrjTabENEx.FuncModuleAgcId, objPrjTabENEx.PrjId);
            strRe_FileNameWithModuleName = string.Format("UT_{0}\\{1}", objFuncModule.FuncModuleEnName4GC(), objPrjTabENEx.SimpleFileName);
            strClassFName = objPrjTabENEx.FolderName + objPrjTabENEx.ClsName + ".xml";
            ...
            try
            {
                ...
                foreach (clsvFunction4GeneCodeEN objvFunction4GeneCodeEN in arrvFunction4GeneCodeObjLst)
                {
                    ...
                    if (strFuncName.IndexOf("Java_DefButton") > 0)
                    {
                        try
                        {
                            AndroidConstraintLayoutEx pobjAndroidConstraintLayoutENEx =
                                GetConstraintLayout4Function(objvFunction4GeneCodeEN, arrValueLst);
                            objAndroidFrameLayoutENEx.arrSubAndroidControlLst2.Add(pobjAndroidConstraintLayoutENEx);
                            //                        strTemp = A_GeneFuncCode(objvFunction4GeneCodeEN, ref Re_objFunction4Code);
                        }
                        catch (Exception objException)
                        {
                ...
                objAndroidConstraintLayoutENEx.GeneCode((enumApplicationType)objPrjTabENEx.ApplicationTypeId, strCodeForCs);
            }
            catch (Exception ex)
            {
                clsEntityBase.LogErrorS(ex, "");
 ...
 objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(WA_AppViewUTScript4JAVA);
        ...
        {
            this.ClsName = string.Format("ac_{0}_WA_UTScript", objPrjTabENEx.TabName);
