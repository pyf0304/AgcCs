...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class AppViewLvItemScript4JAVA : clsGeneCodeBase4View
    {
        ...
        #region 构造函数
        public AppViewLvItemScript4JAVA()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public AppViewLvItemScript4JAVA(string strViewId)
       : base(strViewId, "", "")
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public AppViewLvItemScript4JAVA( string strViewId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            objViewInfoENEx.WebUserCtlFName = objViewInfoENEx.FolderName + "uc_" + objViewInfoENEx.TabName_Out + "_lvitem.xml";
...
//                objAndroidCheckBoxENEx.objDGRegionFldsENEx = objDGRegionFldsEx;
       ...
       // app: srcCompat = "@android:drawable/ic_dialog_email" />
        ...
        public string A_GeneFuncCode(string strFuncName)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(AppViewLvItemScript4JAVA);
...
//            strCodeForCs.Append("\r\n" + "String strWhereCond = mstrWhereCond;");
    ...
    strTabName);
        ...
        {
            this.ClsName = string.Format("uc_{0}_lvitem", objViewInfoENEx.TabName_Out);
