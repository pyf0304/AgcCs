...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class AppViewLvHeadScript4JAVA : clsGeneCodeBase4View
    {
        ...
        #region 构造函数
        public AppViewLvHeadScript4JAVA()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public AppViewLvHeadScript4JAVA(string strViewId)
       : base( strViewId, "", "")
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public AppViewLvHeadScript4JAVA( string strViewId, string strPrjDataBaseId, string strPrjId)
...
//                objAndroidCheckBoxENEx.objDGRegionFldsENEx = objDGRegionFldsEx;
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            objViewInfoENEx.WebUserCtlFName = objViewInfoENEx.FolderName + "uc_" + objViewInfoENEx.TabName + "_lvhead.xml";
            objViewInfoENEx.FileName = objViewInfoENEx.WebUserCtlFName;
            objViewInfoENEx.ClsName = objViewInfoENEx.WebUserCtlFName;
       ...
       // app: srcCompat = "@android:drawable/ic_dialog_email" />
        ...
        public string A_GeneFuncCode(string strFuncName)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(AppViewLvHeadScript4JAVA);
...
//            strCodeForCs.Append("\r\n" + "String strWhereCond = mstrWhereCond;");
    ...
    strTabName);
        ...
        {
            this.ClsName = string.Format("uc_{0}_lvhead", objViewInfoENEx.TabName);
