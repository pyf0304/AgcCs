...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class WA_AppViewUT4JAVA : WA_AppController4JAVABase
    {

        #region 构造函数
        public WA_AppViewUT4JAVA(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            objPrjTabENEx.ClsName = "ac" + objPrjTabENEx.TabName + "_WA_UT";
            ...
            try
            {
                ...
                strCodeForCs.AppendFormat("\r\n" + "package {0}.GC.L6_WA_AppViewUT.{1};",
                ...
                strCodeForCs.Append("\r\n" + "*/");
                strCodeForCs.AppendFormat("\r\n" + "public class ac{0}_WA_UT extends Activity",
                    objPrjTabENEx.TabName);
                strCodeForCs.Append("\r\n" + "{");
 ...
 objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(WA_AppViewUT4JAVA);
        ...
        {
            this.ClsName = string.Format("ac{0}_WA_UT", objPrjTabENEx.TabName);
