...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class AppViewDdlBind4JAVA : clsGeneCodeBase4Tab
    {
        ...
        public AppViewDdlBind4JAVA(string strTabId,  string strPrjDataBaseId, string strPrjId)
 ...
 objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(AppViewDdlBind4JAVA);
        ...
        {
            this.ClsName = string.Format("ddlBind{0}", objPrjTabENEx.TabName);
