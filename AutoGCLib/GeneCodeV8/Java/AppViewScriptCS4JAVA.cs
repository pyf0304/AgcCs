...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class AppViewScriptCS4JAVA : clsGeneCodeBase4View
    {
        ...
        public AppViewScriptCS4JAVA(string strViewId)
       : base(strViewId, "", "")
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public AppViewScriptCS4JAVA( string strViewId, string strPrjDataBaseId, string strPrjId)
        ...
        public string A_GenAppViewUC_QryScript(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
        ...
        public string A_GenAppViewLvItemScript(string strTabName, ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            //''该功能主要生成与表相关的控件代码,包括两个文件,;
            //一个是控件的界面文件, ;
            //另一个与之相关的界面类文件;
...
//                objAndroidCheckBoxENEx.objDGRegionFldsENEx = objDGRegionFldsEx;
        ...
        public string A_GenAppViewLvHeadScript(string strTabName, ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            //''该功能主要生成与表相关的控件代码,包括两个文件,;
            //一个是控件的界面文件, ;
            //另一个与之相关的界面类文件;
        ...
        public string A_GenAppViewUCEdtScript(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            //''该功能主要生成与表相关的控件代码,包括两个文件,;
            //一个是控件的界面文件, ;
            //另一个与之相关的界面类文件;
        ...
        public string A_GenAppViewEdtScript(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            //''该功能主要生成与表相关的控件代码,包括两个文件,;
            //一个是控件的界面文件, ;
            //另一个与之相关的界面类文件;
       ...
       // app: srcCompat = "@android:drawable/ic_dialog_email" />
        ...
        public string GeneCode22(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            //让用户设置属性;
            if (objViewInfoENEx.arrEditRegionFldSet4InUse == null || objViewInfoENEx.arrEditRegionFldSet4InUse.Count == 0)
            {
            ...
            try
            {
                ...
                //  app: layout_constraintTop_toBottomOf = "@+id/clFunction" >
                //   < include layout = "@layout/uc_exam1type_edit" />
                //</ LinearLayout >
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            try
            {
                ...
                arrDdlBindTableLst = GetDdlBindTableLst();
                List<string> arrTabId4Ddl = clsViewInfoBLEx.getRelaTabId4Ddl_AllRegion2(objViewInfoENEx.ViewId, this.IsFstLcase , objViewInfoENEx.PrjId);
                ...
                //为编辑区域、查询区域绑定下拉框
                Gen_AppView_Java_DefDdlBindObj(strCodeForCs, arrDdlBindObjLst);
...
//                    List<clsvFunction4CodeEN> arrvFunction4CodeObjLst4Feature = clsvFunction4CodeBLEx.GetObjLstByFeatureId(objvPrjFeatureEN.FeatureId);
                ...
                foreach (clsvFunction4GeneCodeEN objvFunction4GeneCodeEN_In in arrvFunction4GeneCodeObjLst4CurrView)
                {
                    ...
                    try
                    {
                        strCodeForCs.Append("\r\n" + A_GeneFuncCode(objvFunction4GeneCodeEN_In.FuncName));
                    }
                    catch(Exception objException)
                    {
                        string strSS = objException.Message;
        ...
        public string A_GenAppViewListViewAdapter(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            //让用户设置属性;
            if (objViewInfoENEx.arrEditRegionFldSet4InUse == null || objViewInfoENEx.arrEditRegionFldSet4InUse.Count == 0)
            {
            ...
            try
            {
                ...
                strCodeForCs.Append("\r\n" + Gen_AppView_Java_FieldVarDef4ListView());
                ...
                strCodeForCs.Append("\r\n" + Gen_AppView_Java_FieldVarBind4ListView());
                
                strCodeForCs.Append("\r\n" + "Button btnUpdate = (Button)view.findViewById(R.id.btnUpdate);");
                //Gen_FieldVarBind4List(strCodeForCs);
                strCodeForCs.AppendFormat("\r\n" + "//fruitImage.setImageResource(obj{0}ENEx.getImageId());",
                    objViewInfoENEx.TabName_Out);
                strCodeForCs.Append("\r\n" + Gen_AppView_Java_LvFieldAssignment4List());
        ...
        public string A_GenViewCode_Web(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            //switch ((enumViewTypeCodeTab)objViewInfoENEx.ViewTypeCode)
            //{
            //    case enumViewTypeCodeTab.Table_QUDI_4:// "0004":    //单表的QUDI
            //        return GeneCode22(ref strRe_ClsName, ref strRe_FileNameWithModuleName);
        ...
        public string A_GeneFuncCode(string strFuncName)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(AppViewScriptCS4JAVA);
        ...
        public string Gen_AppView_Java_FieldVarDef4Query()
        {
        ...
        public string Gen_AppView_Java_FieldVarDef4Edit()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            if (arrCtrlLst4Edit == null)
            {
        ...
        public string Gen_AppView_Java_BindDdl()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            if (arrCtrlLst4Edit == null)
            {
        ...
        public string Gen_AppView_Java_BindDdlInTaskQueue()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            if (arrCtrlLst4Edit == null)
            {
        ...
        public string Gen_AppView_Java_DefDdlBindObj(StringBuilder strCodeForCs, List<string> arrDdlBindObjLst)
        {
            if (arrCtrlLst4Edit == null)
            {
                InitEditRegion();
        ...
        public List<string> GetDdlBindTableLst()
        {            
...
//            strCodeForCs.Append("\r\n" + "//绑定查询区域中的下拉框控件:");
        ...
        public string Gen_AppView_Java_FieldVarDef4List()
        {
            StringBuilder strCodeForCs = new StringBuilder();
        ...
        public string Gen_AppView_Java_FieldVarDef4ListView()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            if (objViewInfoENEx.arrDGRegionFldSet == null || objViewInfoENEx.arrDGRegionFldSet.Count == 0)
            {
        ...
        public string Gen_AppView_Java_FieldVarBind4Edit()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            if (arrCtrlLst4Edit == null || arrCtrlLst4Edit.Count == 0)
            {
        ...
        public string Gen_AppView_Java_FieldVarBind4Query()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            if (arrCtrlLst4Query == null)
            {
        ...
        public string Gen_AppView_Java_LvFieldAssignment4List()
        {
            StringBuilder strCodeForCs = new StringBuilder();
        ...
        public string Gen_AppView_Java_GetRecCountAndBindLv()
        {
            StringBuilder strCodeForCs = new StringBuilder();
        ...
        public string Gen_AppView_Java_onCreate()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            ...
            //为查询区域生成字段变量绑定的代码
            strCodeForCs.Append("\r\n" + Gen_AppView_Java_FieldVarBind4Query());
            //为编辑区域生成字段变量绑定的代码
            strCodeForCs.Append("\r\n" + Gen_AppView_Java_FieldVarBind4Edit());

            //为列表区域生成字段变量绑定的代码
            strCodeForCs.Append("\r\n" + Gen_AppView_Java_FieldVarBind4List());
        ...
        public string Gen_AppView_Java_btnQuery_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 查询记录单击事件");
        ...
        public string Gen_AppView_Java_btnAddNewRecord_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 添加记录单击事件");
        ...
        public string Gen_AppView_Java_btnCancel_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 取消编辑单击事件");
        ...
        public string Gen_AppView_Java_btnCancelQuery_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 取消编辑单击事件");
        ...
        public string Gen_AppView_Java_btnPageIndexChanged_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 取消编辑单击事件");
        ...
        public string Gen_AppView_Java_btnDelRecordsByJSON_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n" + "/// <summary>");
            strCodeForCs.Append("\r\n" + "/// 删除记录");
            ...
            strCodeForCs.AppendFormat("\r\n" + "{0}.icls{1}_DelRecordsByJSONEx iobj{1}_DelRecordsByJSON = new {0}.icls{1}_DelRecordsByJSONEx({0}.this);",
                objViewInfoENEx.WebFormName, objViewInfoENEx.TabName_In);
            strCodeForCs.AppendFormat("\r\n" + "iobj{0}_DelRecordsByJSON.main();",
                objViewInfoENEx.TabName);
            strCodeForCs.Append("\r\n" + "}");
            return strCodeForCs.ToString();
        }
        public string Gen_AppView_Java_Class4DelRecordsByJSONEx()
        {
            StringBuilder strCodeForCs = new StringBuilder();
    ...
    objViewInfoENEx.TabName);
            ...
            //绑定下拉框
            strCodeForCs.Append("\r\n" + Gen_AppView_Java_GetRecCountAndBindLv());
        ...
        public string Gen_AppView_Java_btnShowQuery_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 显示查询区域单击事件");
        ...
        public string Gen_AppView_Java_ShowQueryRegion()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 显示查询区域以及相关操作");
        ...
        public string Gen_AppView_Java_HideQueryRegion()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 隐藏查询区域以及相关操作");
        ...
        public string Gen_AppView_Java_AddTask()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 向任务队列中添加任务");
        ...
        public string Gen_AppView_Java_HideEditRegion()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 隐藏编辑区域以及相关操作");
        ...
        public string Gen_AppView_Java_HideListViewRegion()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 隐藏ListView区域以及相关操作");
            ...
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + " clListView.setVisibility(View.GONE);", objViewInfoENEx.TabName_Out);
            strCodeForCs.Append("\r\n" + "}");
        ...
        public string Gen_AppView_Java_ShowEditRegion()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 显示编辑区域以及相关操作");
        ...
        public string Gen_AppView_Java_ShowListViewRegion()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 显示编辑区域以及相关操作");
            ...
            strCodeForCs.Append("\r\n" + "{");
            strCodeForCs.AppendFormat("\r\n" + " clListView.setVisibility(View.VISIBLE);", objViewInfoENEx.TabName_Out);
            strCodeForCs.Append("\r\n" + "}");

            return strCodeForCs.ToString();
        }

        public string Gen_AppView_Java_AddNewRecord()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 添加记录的初始化函数");
        ...
        public string Gen_AppView_Java_Class4AddNewRecord4GetMaxStrIdEx()
        {
            StringBuilder strCodeForCs = new StringBuilder();
    ...
    objViewInfoENEx.TabName);
        ...
        public string Gen_AppView_Java_GetDataFromClass()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 把类对象的属性内容显示到界面上");
        ...
        public string Gen_AppView_Java_ClearEditRegion()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 清空编辑区的控件内容");
        ...
        public string Gen_AppView_Java_PutDataToClass()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 把界面上的属性数据传到类对象中");
        ...
        public string Gen_AppView_Java_SetMsg()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 设置用于显示信息的控件");
        ...
        public string Gen_AppView_Java_UpdateRecord()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
        ...
        public string Gen_AppView_Java_btnGetJSONObjByKey_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 根据关键字获取相应的记录的对象");
        ...
        public string Gen_AppView_Java_Class4GetObjByKeyIdEx()
        {
            StringBuilder strCodeForCs = new StringBuilder();
    ...
    objViewInfoENEx.TabName,
        ...
        public string Gen_AppView_Java_btnOkUpd_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 添加、修改的确认的事件函数");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_AppView_Java_Class4AddNewRecordEx()
        {
            StringBuilder strCodeForCs = new StringBuilder();
    ...
    objViewInfoENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_AppView_Java_Class4ExecTaskEx()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            ...
            strCodeForCs.Append("\r\n" + "break;");
            strCodeForCs.Append("\r\n" + Gen_AppView_Java_BindDdlInTaskQueue());
        ...
        public string Gen_AppView_Java_Class4UpdateRecordEx()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 修改记录的相关扩展类");
    ...
    objViewInfoENEx.TabName);
        ...
        public string Gen_AppView_Java_CombineCondition()
        {
            StringBuilder strCodeForCs = new StringBuilder();
        ...
        public string Gen_AppView_Java_btnGetJSONObjLst_Click()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n" + "/// <summary>");
            strCodeForCs.Append("\r\n" + "/// 根据条件获取相应的对象列表");
            ...
            strCodeForCs.AppendFormat("\r\n" + "{0}.icls{1}GetJSONObjLstEx iobj{1}GetJSONObjLst = new {0}.icls{1}GetJSONObjLstEx({0}.this);",
                objViewInfoENEx.WebFormName, objViewInfoENEx.TabName_Out);
        ...
        public string Gen_AppView_Java_Class4GetJSONObjLstEx(StringBuilder strCodeForCs, string strTabName)
        {
    ...
    strTabName);
        ...
        public string Gen_AppView_Java_BindLv_TabName()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n" + "/// <summary>");
            strCodeForCs.Append("\r\n" + "/// 根据条件,绑定列表");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_AppView_Java_FieldProperty4Query()
        {
            StringBuilder strCodeForCs = new StringBuilder();
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_AppView_Java_FieldProperty4List()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            AndroidControlEx objAndroidControlENEx = null;
            ///定义类属性
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_AppView_Java_FieldProperty4Edit()
        {
            StringBuilder strCodeForCs = new StringBuilder();
...
//                    string strSS = objException.Message;
        ...
        public string Gen_AppView_Java_Class4GetJSONObjLstByPagerEx()
        {
            StringBuilder strCodeForCs = new StringBuilder();
            ...
            strCodeForCs.AppendFormat("\r\n" + "icls{0}GetJSONObjLstByPagerEx iobj{0}GetJSONObjLstByPager = new icls{0}GetJSONObjLstByPagerEx({1}.this);",
              objViewInfoENEx.TabName_Out, objViewInfoENEx.WebFormName);
            strCodeForCs.AppendFormat("\r\n" + "iobj{0}GetJSONObjLstByPager.main();",
                objViewInfoENEx.TabName_Out);
            strCodeForCs.Append("\r\n" + "}");
            ...
            strCodeForCs.AppendFormat("\r\n" + "String strWhereCond = Combine{0}Condition();", objViewInfoENEx.TabName_Out);
...
//            strCodeForCs.Append("\r\n" + "String strWhereCond = mstrWhereCond;");
            ...
            strCodeForCs.AppendFormat("\r\n" + "lv{1}Adapter adapter4ListView = new lv{1}Adapter({0}.this,",
                 objViewInfoENEx.WebFormName, objViewInfoENEx.TabName_Out);
            strCodeForCs.AppendFormat("\r\n" + "R.layout.uc_{1}_lvitem, arr{0}ObjLst);",
                objViewInfoENEx.TabName_Out, objViewInfoENEx.TabName_Out.ToLower());
        ...
        public string Gen_AppView_Java_Class4GetMaxStrIdEx(StringBuilder strCodeForCs, string strTabName)
        {
            strCodeForCs.Append("\r\n /// <summary>");
    ...
    strTabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_AppView_Java_Class4GetRecCountByCondEx(StringBuilder strCodeForCs, string strTabName)
        {   
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 检查相应关键字的记录是否存在");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_AppView_Java_GetRecCountByCond(StringBuilder strCodeForCs, string strTabName)
        {
            strCodeForCs.Append("\r\n /// <summary>");
            strCodeForCs.Append("\r\n /// 检查相应关键字的记录是否存在");
        ...
        {
            this.ClsName = string.Format("ac{0}_QUDI", objViewInfoENEx.TabName);
