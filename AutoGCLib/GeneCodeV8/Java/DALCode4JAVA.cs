...
namespace AutoGCLib
{
    ...
    /// </summary>
    class DALCode4JAVA : clsGeneCodeBase4Tab
    {
        ...
        public DALCode4JAVA(string strTabId, string strPrjDataBaseId, string strPrjId)
                ...
                foreach (clsPrjTabFldENEx objField in objPrjTabENEx.arrFldSet)
                {
                    if (objField.ObjFieldTabENEx.IsIdentity == false)
                    {
                        if (bolIsFirst == true)
                        {
                            ...
                            strValueLsd.AppendFormat("{0}", objField.ObjFieldTabENEx.PropertyName(this.IsFstLcase));
        ...
        public string gfunAddnewRecBySP()
        {
            ...
            foreach (clsPrjTabFldENEx objField in objPrjTabENEx.arrFldSet)
            {
                ...
                {
                    strBuilder.Append("\r\nvalues.add(" + objField.ObjFieldTabENEx.PropertyName(this.IsFstLcase) + ");");
                }
            }
                ...
                foreach (clsPrjTabFldENEx objField in objPrjTabENEx.arrFldSet)
                {
                    if (objField.ObjFieldTab4CodeConv() != null)
                    {
                        ...
                        if (bolIsSelfLink == true)
                        {
                            ...
                            objField.ObjFieldTabENEx.CodeTabName, objField.ObjFieldTabENEx.CodeTabName,
                            objField.ObjFieldTabENEx.CodeTabName, objField.ObjFieldTabENEx.CodeTabName);
