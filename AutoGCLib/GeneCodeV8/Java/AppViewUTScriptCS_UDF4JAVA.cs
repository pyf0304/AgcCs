...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class AppViewUTScriptCS_UDF4JAVA : clsGeneCodeBase4Tab
    {        

        #region 构造函数

        public AppViewUTScriptCS_UDF4JAVA(string strTabId, string strPrjDataBaseId, string strPrjId)
 ...
 objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(AppViewUTScriptCS_UDF4JAVA);
