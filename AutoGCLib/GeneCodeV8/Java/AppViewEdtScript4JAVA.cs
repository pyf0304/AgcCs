...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class AppViewEdtScript4JAVA : clsGeneCodeBase4View
    {
        ...
        public AppViewEdtScript4JAVA(string strViewId)
       : base(strViewId, "", "")
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public AppViewEdtScript4JAVA(string strViewId, string strPrjDataBaseId, string strPrjId)
...
//                objAndroidCheckBoxENEx.objDGRegionFldsENEx = objDGRegionFldsEx;
       ...
       // app: srcCompat = "@android:drawable/ic_dialog_email" />
        ...
        public string A_GeneFuncCode(string strFuncName)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(AppViewEdtScript4JAVA);
...
//            strCodeForCs.Append("\r\n" + "String strWhereCond = mstrWhereCond;");
    ...
    strTabName);
        ...
        {
            this.ClsName = string.Format("uc_{0}_edit", objViewInfoENEx.TabName);
