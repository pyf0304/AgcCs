...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class WA_AccessHigh4JAVA : clsGeneCodeBase4Tab
    {

        #region 构造函数
        public WA_AccessHigh4JAVA(string strTabId, string strPrjDataBaseId, string strPrjId)
    ...
    List<string> arrValueLst)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            objPrjTabENEx.ClsName = string.Format("cls{0}WA4Controller", objPrjTabENEx.TabName);
            //objPrjTabENEx1.ProgLevelTypeId = clsProgLevelTypeENEx.WebServiceTransferLevel;
            ...
            try
            {
                ...
                strCodeForCs.AppendFormat("\r\n" + "package {0}.GC.L4_Controller4WA.{1};",
               objProject.JavaPackageName, objFuncModule.FuncModuleEnName4GC());
                ...
                strCodeForCs.AppendFormat("\r\n" + "import {0}.GC.L2_Business.{2}.cls{1}BL;",
                      objProjectsENEx.JavaPackageName,
                      objPrjTabENEx.TabName, objFuncModule.FuncModuleEnName4GC());
                strCodeForCs.AppendFormat("\r\n" + "import {0}.GC.L3_ForWA.{2}.cls{1}WA;",
                    objProjectsENEx.JavaPackageName,
                     objPrjTabENEx.TabName, objFuncModule.FuncModuleEnName4GC());
                strCodeForCs.Append("\r\n" + "import com.taishsoft.util.clsResponseData;");
                strCodeForCs.Append("\r\n" + "import com.taishsoft.commdb.clsTableObjWA4ControllerDelegate;");
                ...
                strCodeForCs.Append("\r\n" + "public clsTableObjWA4ControllerDelegate objTableObjWA4ControllerDelegate;");

                strCodeForCs.AppendFormat("\r\n" + "public {0}()", objPrjTabENEx.ClsName);
                strCodeForCs.Append("\r\n" + "{");
        ...
        /// </summary>
        /// <returns></returns>
        public string A_GenTableObjWAController_Java_SelfDefWA(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            string strFuncName = "";
            string strResult = "";
            if (objWebSrvClassENEx.arrWebSrvFunctionsENExObjLst.Count == 0)
            ...
            objWebSrvClassENEx.ClsName = string.Format("{0}WA4SDController", objWebSrvClassENEx.ClsName);
            //objWebSrvClassENEx1.ProgLevelTypeId = clsProgLevelTypeENEx.WebServiceTransferLevel;
            ...
            try
            {
                ...
                strCodeForCs.Append("\r\n" + "import com.taishsoft.util.clsResponseData;");
                strCodeForCs.Append("\r\n" + "import com.taishsoft.commdb.clsTableObjWA4ControllerDelegate;");
                strCodeForCs.AppendFormat("\r\n" + "import {0}.GC.L3_ForWA.{1}.{2}WA4SD;",
                   objProjectsENEx.JavaPackageName,
                ...
                foreach (clsWebSrvFunctionsENEx objWebSrvFunctionsENEx in objWebSrvClassENEx.arrWebSrvFunctionsENExObjLst)
                {
                    ...
                    try
                    {
                        strTemp = Gen_4WA4Controller_Java_ByCommonFunction(objWebSrvFunctionsENEx);
                        if (string.IsNullOrEmpty(strTemp) == false)
                        {
                            strCodeForCs.Append("\r\n" + strTemp);
                            clsWebSrvFunctionsBLEx.SetGeneCode(objWebSrvFunctionsENEx.WebSrvFunctionId, true);
                ...
                strTemp = Gen_4WA4Controller_Java_SelfDefWA_handleMessage();
                strCodeForCs.Append("\r\n" + strTemp);
 ...
 objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(WA_AccessHigh4JAVA);
        ...
        {
            this.ClsName = string.Format("cls{0}WA4Controller", objPrjTabENEx.TabName);
