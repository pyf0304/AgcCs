...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class AppViewUTScript4JAVA : clsGeneCodeBase4Tab
    {        

        #region 构造函数

        public AppViewUTScript4JAVA(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            objPrjTabENEx.ClsName = "ac_" + objPrjTabENEx.TabName + "_UTScript";
 ...
 objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(AppViewUTScript4JAVA);
        ...
        {
            this.ClsName = string.Format("ac_{0}_UTScript", objPrjTabENEx.TabName);
