...
namespace AutoGCLib
{
    ...
    /// </summary>
    class EntityLayer4JAVA : clsGeneCodeBase4Tab
    {
        ...
        public EntityLayer4JAVA(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            try
            {
                ...
                {
                    strCodeForCs.Append("\r\n" + "public class " + objPrjTabENEx.ClsName + " extends clsGeneralTab");
                }
                else
                {
                ...
                //与属性名称相关的代码
                strCodeForCs.AppendFormat("\r\n" + "protected final int _AttributeCount = {0};",
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(EntityLayer4JAVA);
