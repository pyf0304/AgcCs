...
namespace AutoGCLib
{
    ...
    /// </summary>
    abstract partial class AppController4JAVABase : clsGeneCodeBase4Tab
    {

        #region 构造函数

        public AppController4JAVABase(string strTabId, string strPrjDataBaseId, string strPrjId)
    ...
    List<string> arrValueLst)
        ...
        /// </summary>
        /// <returns></returns>
        public string A_GenTableObjWSController_Java(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            string strFuncName = "";
            string strResult = "";
            if (objPrjTabENEx.TabFldNum() == 0)
        ...
        public string Gen_Controller_Java_btnGetFirstJSONObj_Click(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
    ...
    objPrjTabENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_Controller_Java_btnIsExistRecord_Click(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            string strFuncId4GC = objvFunction4GeneCodeEN.FuncId4GC;
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_Controller_Java_GetRecCountByCond_Click(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            string strFuncId4GC = objvFunction4GeneCodeEN.FuncId4GC;
            StringBuilder strCodeForCs = new StringBuilder();
            strCodeForCs.Append("\r\n /// <summary>");
