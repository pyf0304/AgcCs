...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class AppViewDdlAdapter4JAVA : clsGeneCodeBase4Tab
    {        

        #region 构造函数

       
        public AppViewDdlAdapter4JAVA(string strTabId,  string strPrjDataBaseId, string strPrjId)
 ...
 objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(AppViewDdlAdapter4JAVA);
        ...
        {
            this.ClsName = string.Format("ddlAdapter{0}", objPrjTabENEx.TabName);
