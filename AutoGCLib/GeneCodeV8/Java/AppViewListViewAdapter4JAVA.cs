...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class AppViewListViewAdapter4JAVA : clsGeneCodeBase4View
    {
        ...
        #region 构造函数
        public AppViewListViewAdapter4JAVA()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public AppViewListViewAdapter4JAVA(string strViewId)
       : base(strViewId, "", "")
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public AppViewListViewAdapter4JAVA( string strViewId, string strPrjDataBaseId, string strPrjId)
...
//                objAndroidCheckBoxENEx.objDGRegionFldsENEx = objDGRegionFldsEx;
       ...
       // app: srcCompat = "@android:drawable/ic_dialog_email" />
        ...
        public string A_GeneFuncCode(string strFuncName)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(AppViewListViewAdapter4JAVA);
...
//            strCodeForCs.Append("\r\n" + "String strWhereCond = mstrWhereCond;");
    ...
    strTabName);
        ...
        {
            this.ClsName = string.Format("lv{0}Adapter", objViewInfoENEx.TabName_Out);
