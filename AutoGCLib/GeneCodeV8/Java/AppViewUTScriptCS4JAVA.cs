...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class AppViewUTScriptCS4JAVA : AppController4JAVABase
    {        

        #region 构造函数

        //public AppViewUTScriptCS4JAVA()
        //{
        //    // 
        //    // TODO: 在此处添加构造函数逻辑
        //    //
        //}
        public AppViewUTScriptCS4JAVA(string strTabId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            objPrjTabENEx.ClsName = "ac" + objPrjTabENEx.TabName + "_UTScript";
            string strXmlFileName = "ac_" + objPrjTabENEx.TabName + "_UTScript";
            ...
            try
            {
                ...
                foreach (clsvFunction4GeneCodeEN objvFunction4GeneCodeEN in arrvFunction4GeneCodeObjLst)
                {
                    ...
                    if (strFuncName.IndexOf("Java_btnClick") > 0)
                    {
                        ...
                        //    || strFuncName4Code.Contains("GetJSONObjByKey") == true)
                        //{
    ...
    objPrjTabENEx.TabName);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(AppViewUTScriptCS4JAVA);
        ...
        {
            this.ClsName = string.Format("ac{0}_UTScript", objPrjTabENEx.TabName);
