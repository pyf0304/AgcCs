...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class WS_AccessHigh_UDF4JAVA : clsGeneCodeBase4Tab
    {
        ...
        public WS_AccessHigh_UDF4JAVA(string strTabId,  string strPrjDataBaseId, string strPrjId)
        ...
        /// </summary>
        /// <returns></returns>
        public string A_GenController_Java_UnitTest(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            string strResult = "";
        ...
        /// </summary>
        /// <returns></returns>
        public string A_GenController_Java_SelfDefWs4UnitTest(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            string strResult = "";
        ...
        public string A_GenController_Java_SelfDefWs4UTScriptCS(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            try
            {
                ...
                //    try
                //    {
                //        strTemp = Gen_Controller_Java_DeclareButtonByCommonFunction(objWebSrvFunctionsENEx);
                //        if (string.IsNullOrEmpty(strTemp) == false)
                //        {
                //            strCodeForCs.Append("\r\n" + strTemp);
                //            clsWebSrvFunctionsBLEx.SetGeneCode(objWebSrvFunctionsENEx.WebSrvFunctionId, true);
                ...
                //    try
                //    {
                //        strTemp = Gen_Controller_Java_BindButtonByCommonFunction(objWebSrvFunctionsENEx);
                //        if (string.IsNullOrEmpty(strTemp) == false)
                //        {
                //            strCodeForCs.Append("\r\n" + strTemp);
                //            clsWebSrvFunctionsBLEx.SetGeneCode(objWebSrvFunctionsENEx.WebSrvFunctionId, true);
                ...
                //    try
                //    {
                //        strTemp = Gen_Controller_Java_DefBtnClickEventByCommonFunction(objWebSrvFunctionsENEx);
                //        if (string.IsNullOrEmpty(strTemp) == false)
                //        {
                //            strCodeForCs.Append("\r\n" + strTemp);
                //            clsWebSrvFunctionsBLEx.SetGeneCode(objWebSrvFunctionsENEx.WebSrvFunctionId, true);
 ...
 objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(WS_AccessHigh_UDF4JAVA);
        ...
        {
            this.ClsName = string.Format("{0}WS4SDController", objWebSrvClassENEx.ClsName);
