...
/*-- -- -- -- -- -- -- -- -- -- --
类名:vPrjTabKeyFldV2ExApiController
表名:vPrjTabKeyFldV2(00050612)
生成代码版本:2022.11.02.1
生成日期:2022/11/02 23:24:50
生成者:pyf
生成服务器IP:
工程名称:AGC(0005)
...
{
    /// <summary>
    /// vPrjTabKeyFldV2ExApiController 的摘要说明
    /// (AutoGCLib.WA_SrvEx4CSharp:GeneCode)
    /// </summary>
    [ApiController]
    [Route("[controller]")]
    public class vPrjTabKeyFldV2ExApiController : ControllerBase
    {
        ...
        public ActionResult GetObjLstByCmPrjId(string strCmPrjId, string strCondition)
        {
            ...
            try
            {
                List<clsvPrjTabKeyFldV2EN> arrvPrjTabKeyFldV2ObjLst = clsvPrjTabKeyFldV2BLEx.GetObjLstByCmPrjId(strCmPrjId, strCondition);
