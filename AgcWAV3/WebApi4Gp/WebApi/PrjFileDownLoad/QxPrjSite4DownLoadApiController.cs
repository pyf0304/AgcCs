...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/QxPrjSite4DownLoadApi/GetObjByKey_Cache?PrjSiteId=value
 /// (AutoGCLib.WA_Srv4CSharp:Gen_GetObjByKeyId_Cache)
 /// </summary>
 /// <param name = "strPrjSiteId">表关键字</param>
 /// <returns>表对象</returns>
[HttpGet("GetObjByPrjSiteId_Cache")]
public ActionResult GetObjByPrjSiteIdCache(string strPrjSiteId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
clsQxPrjSite4DownLoadEN objQxPrjSite4DownLoadEN = clsQxPrjSite4DownLoadBL.GetObjByPrjSiteIdCache(strPrjSiteId);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objQxPrjSite4DownLoadEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/QxPrjSite4DownLoadApi/GetSubObjLst_Cache?objTabName_Cond=v1&
 /// (AutoGCLib.WA_Srv4CSharp:Gen_GetSubObjLst_Cache)
 /// </summary>
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
 [HttpPost("GetSubObjLst_Cache")]
 public ActionResult GetSubObjLstCache([FromBody]clsQxPrjSite4DownLoadEN objQxPrjSite4DownLoad_Cond)
 {
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strQxPrjSite4DownLoadJSONObj = clsJSON.GetJsonFromObj(objQxPrjSite4DownLoad_Cond);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
if (objQxPrjSite4DownLoad_Cond.sfFldComparisonOp == null)
{
objQxPrjSite4DownLoad_Cond.dicFldComparisonOp = null;
}
else
{
objQxPrjSite4DownLoad_Cond.dicFldComparisonOp = JsonConvert.DeserializeObject<Dictionary<string, string>>(objQxPrjSite4DownLoad_Cond.sfFldComparisonOp);
}
clsQxPrjSite4DownLoadBL.SetUpdFlag(objQxPrjSite4DownLoad_Cond);
 arrQxPrjSite4DownLoadObjLst = clsQxPrjSite4DownLoadBL.GetSubObjLstCache(objQxPrjSite4DownLoad_Cond);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <param name = "arrPrjSiteIdLst">所给的关键字</param>
 /// <returns>根据关键字获取的对象</returns>
[HttpPost("GetObjLstByPrjSiteIdLst_Cache")]
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
clsQxPrjSite4DownLoadEN objQxPrjSite4DownLoad_Cond = new();
string strCondition = objQxPrjSite4DownLoad_Cond
