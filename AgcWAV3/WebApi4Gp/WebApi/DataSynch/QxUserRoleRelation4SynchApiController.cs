...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/QxUserRoleRelation4SynchApi/GetObjByKey_Cache?mId=value
 /// (AutoGCLib.WA_Srv4CSharp:Gen_GetObjByKeyId_Cache)
 /// </summary>
 /// <param name = "lngmId">表关键字</param>
 /// <returns>表对象</returns>
[HttpGet("GetObjBymId_Cache")]
public ActionResult GetObjBymIdCache(long lngmId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
clsQxUserRoleRelation4SynchEN objQxUserRoleRelation4SynchEN = clsQxUserRoleRelation4SynchBL.GetObjBymIdCache(lngmId);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objQxUserRoleRelation4SynchEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/QxUserRoleRelation4SynchApi/GetSubObjLst_Cache?objTabName_Cond=v1&
 /// (AutoGCLib.WA_Srv4CSharp:Gen_GetSubObjLst_Cache)
 /// </summary>
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
 [HttpPost("GetSubObjLst_Cache")]
 public ActionResult GetSubObjLstCache([FromBody]clsQxUserRoleRelation4SynchEN objQxUserRoleRelation4Synch_Cond)
 {
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strQxUserRoleRelation4SynchJSONObj = clsJSON.GetJsonFromObj(objQxUserRoleRelation4Synch_Cond);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
if (objQxUserRoleRelation4Synch_Cond.sfFldComparisonOp == null)
{
objQxUserRoleRelation4Synch_Cond.dicFldComparisonOp = null;
}
else
{
objQxUserRoleRelation4Synch_Cond.dicFldComparisonOp = JsonConvert.DeserializeObject<Dictionary<string, string>>(objQxUserRoleRelation4Synch_Cond.sfFldComparisonOp);
}
clsQxUserRoleRelation4SynchBL.SetUpdFlag(objQxUserRoleRelation4Synch_Cond);
 arrQxUserRoleRelation4SynchObjLst = clsQxUserRoleRelation4SynchBL.GetSubObjLstCache(objQxUserRoleRelation4Synch_Cond);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <param name = "arrMIdLst">所给的关键字</param>
 /// <returns>根据关键字获取的对象</returns>
[HttpPost("GetObjLstByMIdLst_Cache")]
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
clsQxUserRoleRelation4SynchEN objQxUserRoleRelation4Synch_Cond = new();
string strCondition = objQxUserRoleRelation4Synch_Cond
