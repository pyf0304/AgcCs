...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/QxUsers4SynchApi/GetObjByKey_Cache?mId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
clsQxUsers4SynchEN objQxUsers4SynchEN = clsQxUsers4SynchBL.GetObjBymIdCache(lngmId);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objQxUsers4SynchEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/QxUsers4SynchApi/GetSubObjLst_Cache?objTabName_Cond=v1&
 /// (AutoGCLib.WA_Srv4CSharp:Gen_GetSubObjLst_Cache)
 /// </summary>
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
 [HttpPost("GetSubObjLst_Cache")]
 public ActionResult GetSubObjLstCache([FromBody]clsQxUsers4SynchEN objQxUsers4Synch_Cond)
 {
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strQxUsers4SynchJSONObj = clsJSON.GetJsonFromObj(objQxUsers4Synch_Cond);
dictParam.Add("strQxUsers4SynchJSONObj", strQxUsers4SynchJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 IEnumerable<clsQxUsers4SynchEN> arrQxUsers4SynchObjLst;
 try
 {
if (objQxUsers4Synch_Cond.sfFldComparisonOp == null)
{
objQxUsers4Synch_Cond.dicFldComparisonOp = null;
}
else
{
objQxUsers4Synch_Cond.dicFldComparisonOp = JsonConvert.DeserializeObject<Dictionary<string, string>>(objQxUsers4Synch_Cond.sfFldComparisonOp);
}
clsQxUsers4SynchBL.SetUpdFlag(objQxUsers4Synch_Cond);
 arrQxUsers4SynchObjLst = clsQxUsers4SynchBL.GetSubObjLstCache(objQxUsers4Synch_Cond);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
clsQxUsers4SynchEN objQxUsers4Synch_Cond = new();
string strCondition = objQxUsers4Synch_Cond
