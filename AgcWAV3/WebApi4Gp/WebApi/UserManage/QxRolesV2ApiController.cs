...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/QxRolesV2Api/GetObjByKey_Cache?RId=value
 /// (AutoGCLib.WA_Srv4CSharp:Gen_GetObjByKeyId_Cache)
 /// </summary>
 /// <param name = "intRId">表关键字</param>
 /// <returns>表对象</returns>
[HttpGet("GetObjByRId_Cache")]
public ActionResult GetObjByRIdCache(int intRId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
clsQxRolesV2EN objQxRolesV2EN = clsQxRolesV2BL.GetObjByRIdCache(intRId);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objQxRolesV2EN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/QxRolesV2Api/GetSubObjLst_Cache?objTabName_Cond=v1&
 /// (AutoGCLib.WA_Srv4CSharp:Gen_GetSubObjLst_Cache)
 /// </summary>
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
 [HttpPost("GetSubObjLst_Cache")]
 public ActionResult GetSubObjLstCache([FromBody]clsQxRolesV2EN objQxRolesV2_Cond)
 {
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strQxRolesV2JSONObj = clsJSON.GetJsonFromObj(objQxRolesV2_Cond);
dictParam.Add("strQxRolesV2JSONObj", strQxRolesV2JSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 IEnumerable<clsQxRolesV2EN> arrQxRolesV2ObjLst;
 try
 {
if (objQxRolesV2_Cond.sfFldComparisonOp == null)
{
objQxRolesV2_Cond.dicFldComparisonOp = null;
}
else
{
objQxRolesV2_Cond.dicFldComparisonOp = JsonConvert.DeserializeObject<Dictionary<string, string>>(objQxRolesV2_Cond.sfFldComparisonOp);
}
clsQxRolesV2BL.SetUpdFlag(objQxRolesV2_Cond);
 arrQxRolesV2ObjLst = clsQxRolesV2BL.GetSubObjLstCache(objQxRolesV2_Cond);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <param name = "arrRIdLst">所给的关键字</param>
 /// <returns>根据关键字获取的对象</returns>
[HttpPost("GetObjLstByRIdLst_Cache")]
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
clsQxRolesV2EN objQxRolesV2_Cond = new();
string strCondition = objQxRolesV2_Cond
