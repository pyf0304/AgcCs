 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:GCVariablePrjIdRelaApiController
 表名:GCVariablePrjIdRela(00050617)
 * 版本:2025.06.13.1(服务器:WIN-SRV103-116)
 日期:2025/06/17 16:56:01
 生成者:pyf
 生成服务器IP:
 工程名称:AGC(0005)
...
{
 /// <summary>
 /// GCVariablePrjIdRelaController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  GCVariablePrjIdRelaApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/GCVariablePrjIdRelaApi/GetObjByVarId?VarId=value
...
public ActionResult GetObjByKeyLst(string strVarId,string strPrjId)
{
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objGCVariablePrjIdRelaEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/GCVariablePrjIdRelaApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsGCVariablePrjIdRelaEN> arrGCVariablePrjIdRelaObjLst = clsGCVariablePrjIdRelaBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrGCVariablePrjIdRelaObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/GCVariablePrjIdRelaApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsGCVariablePrjIdRelaEN> arrGCVariablePrjIdRelaObjLst = clsGCVariablePrjIdRelaBL.GetObjLstCache(strPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrGCVariablePrjIdRelaObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/GCVariablePrjIdRelaapi/GetObjLstByVarIdLst
...
IEnumerable<clsGCVariablePrjIdRelaEN> arrGCVariablePrjIdRelaObjLst = clsGCVariablePrjIdRelaBL.GetObjLstByKeyLstsCache(lstKeyLst, PrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrGCVariablePrjIdRelaObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/GCVariablePrjIdRelaApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsGCVariablePrjIdRelaEN> arrGCVariablePrjIdRelaObjLst = clsGCVariablePrjIdRelaBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrGCVariablePrjIdRelaObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/GCVariablePrjIdRelaApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strVarId = clsGCVariablePrjIdRelaBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/GCVariablePrjIdRelaApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsGCVariablePrjIdRelaEN objGCVariablePrjIdRelaEN = clsGCVariablePrjIdRelaBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objGCVariablePrjIdRelaEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/GCVariablePrjIdRelaApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsGCVariablePrjIdRelaEN> arrGCVariablePrjIdRelaObjLst;
 try
 {
 arrGCVariablePrjIdRelaObjLst = clsGCVariablePrjIdRelaBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrGCVariablePrjIdRelaObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/GCVariablePrjIdRelaApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsGCVariablePrjIdRelaBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/GCVariablePrjIdRelaApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsGCVariablePrjIdRelaBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/GCVariablePrjIdRelaApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clsGCVariablePrjIdRelaBL.SetFldValue(clsGCVariablePrjIdRelaEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/GCVariablePrjIdRelaApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsGCVariablePrjIdRelaBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/GCVariablePrjIdRelaApi/IsExist?VarId=value
 /// (AutoGCLib.WA_Srv4CSharp:Gen_IsExist)
 /// </summary>
 /// <param name = "strVarId">给定的关键字值</param>
 /// <returns>返回是否存在?</returns>
[HttpGet("IsExist")]
public ActionResult IsExist(string strVarId,string strPrjId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsGCVariablePrjIdRelaBL.IsExist(strVarId,strPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/GCVariablePrjIdRelaApi/AddNewRecord
 /// 在Body区传输objGCVariablePrjIdRelaEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objGCVariablePrjIdRelaEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clsGCVariablePrjIdRelaEN objGCVariablePrjIdRelaEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strGCVariablePrjIdRelaJSONObj = clsJSON.GetJsonFromObj(objGCVariablePrjIdRelaEN);
dictParam.Add("strGCVariablePrjIdRelaJSONObj", strGCVariablePrjIdRelaJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 {
string strMsg = string.Format("添加记录时,关键字:[{0}]已经存在!({1})", objGCVariablePrjIdRelaEN.VarId, clsStackTrace.GetCurrClassFunction());
return Ok(new { errorId = 1, errorMsg = strMsg });
 }
 try
 {
    clsGCVariablePrjIdRelaBL.AccessFldValueNull(objGCVariablePrjIdRelaEN);
bool bolResult = objGCVariablePrjIdRelaEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/GCVariablePrjIdRelaApi/AddNewRecordWithReturnKey
 /// 在Body区传输objGCVariablePrjIdRelaEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecordWithReturnKey)
 /// </summary>
 /// <param name = "objGCVariablePrjIdRelaEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
[HttpPost("AddNewRecordWithReturnKey")]
public ActionResult AddNewRecordWithReturnKey(clsGCVariablePrjIdRelaEN objGCVariablePrjIdRelaEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objGCVariablePrjIdRelaEN", JsonConvert.SerializeObject(objGCVariablePrjIdRelaEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clsGCVariablePrjIdRelaBL.AccessFldValueNull(objGCVariablePrjIdRelaEN);
string strKey = clsGCVariablePrjIdRelaBL.AddNewRecordBySql2WithReturnKey(objGCVariablePrjIdRelaEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/GCVariablePrjIdRelaApi/UpdateRecord
 /// 在Body区传输objGCVariablePrjIdRelaEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strGCVariablePrjIdRelaJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clsGCVariablePrjIdRelaEN objGCVariablePrjIdRelaEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strGCVariablePrjIdRelaJSONObj = clsJSON.GetJsonFromObj(objGCVariablePrjIdRelaEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clsGCVariablePrjIdRelaBL.SetUpdFlag(objGCVariablePrjIdRelaEN);
    clsGCVariablePrjIdRelaBL.AccessFldValueNull(objGCVariablePrjIdRelaEN);
bool bolResult = objGCVariablePrjIdRelaEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/GCVariablePrjIdRelaApi/UpdateWithCondition
 /// 在Body区传输objGCVariablePrjIdRelaEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clsGCVariablePrjIdRelaEN objGCVariablePrjIdRelaEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clsGCVariablePrjIdRelaBL.AccessFldValueNull(objGCVariablePrjIdRelaEN);
bool bolResult = objGCVariablePrjIdRelaEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/GCVariablePrjIdRelaApi/DelRecord/Id
...
public ActionResult DelRecKeyLst(string strVarId,string strPrjId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsGCVariablePrjIdRelaBL.DelRecord(strVarId,strPrjId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/GCVariablePrjIdRelaApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsGCVariablePrjIdRelaBL.DelRecKeyLsts(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/GCVariablePrjIdRelaApi/DelGCVariablePrjIdRelasByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("DelGCVariablePrjIdRelasByCond")]
public ActionResult DelGCVariablePrjIdRelasByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsGCVariablePrjIdRelaBL.DelGCVariablePrjIdRelasByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
