 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:CTCodeTypeGroupRelaApiController
 表名:CTCodeTypeGroupRela(00050647)
 * 版本:2026.05.30(服务器:PYF-AI)
 日期:2026/06/06 13:45:56
 生成者:pyf
 生成服务器IP:
 工程名称:AGC(0005)
...
{
 /// <summary>
 /// CTCodeTypeGroupRelaController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  CTCodeTypeGroupRelaApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/CTCodeTypeGroupRelaApi/GetObjByCtGroupId?CtGroupId=value
...
public ActionResult GetObjByKeyLst(string strCtGroupId,string strCodeTypeId)
{
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objCTCodeTypeGroupRelaEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/CTCodeTypeGroupRelaApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsCTCodeTypeGroupRelaEN> arrCTCodeTypeGroupRelaObjLst = clsCTCodeTypeGroupRelaBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrCTCodeTypeGroupRelaObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/CTCodeTypeGroupRelaApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsCTCodeTypeGroupRelaEN> arrCTCodeTypeGroupRelaObjLst = clsCTCodeTypeGroupRelaBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrCTCodeTypeGroupRelaObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/CTCodeTypeGroupRelaapi/GetObjLstByCtGroupIdLst
...
IEnumerable<clsCTCodeTypeGroupRelaEN> arrCTCodeTypeGroupRelaObjLst = clsCTCodeTypeGroupRelaBL.GetObjLstByKeyLstsCache(lstKeyLst);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrCTCodeTypeGroupRelaObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/CTCodeTypeGroupRelaApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsCTCodeTypeGroupRelaEN> arrCTCodeTypeGroupRelaObjLst = clsCTCodeTypeGroupRelaBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrCTCodeTypeGroupRelaObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/CTCodeTypeGroupRelaApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strCtGroupId = clsCTCodeTypeGroupRelaBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/CTCodeTypeGroupRelaApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsCTCodeTypeGroupRelaEN objCTCodeTypeGroupRelaEN = clsCTCodeTypeGroupRelaBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objCTCodeTypeGroupRelaEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/CTCodeTypeGroupRelaApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsCTCodeTypeGroupRelaEN> arrCTCodeTypeGroupRelaObjLst;
 try
 {
 arrCTCodeTypeGroupRelaObjLst = clsCTCodeTypeGroupRelaBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrCTCodeTypeGroupRelaObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/CTCodeTypeGroupRelaApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsCTCodeTypeGroupRelaBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/CTCodeTypeGroupRelaApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsCTCodeTypeGroupRelaBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/CTCodeTypeGroupRelaApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clsCTCodeTypeGroupRelaBL.SetFldValue(clsCTCodeTypeGroupRelaEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/CTCodeTypeGroupRelaApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsCTCodeTypeGroupRelaBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/CTCodeTypeGroupRelaApi/IsExist?CtGroupId=value
 /// (AutoGCLib.WA_Srv4CSharp:Gen_IsExist)
 /// </summary>
 /// <param name = "strCtGroupId">给定的关键字值</param>
 /// <returns>返回是否存在?</returns>
[HttpGet("IsExist")]
public ActionResult IsExist(string strCtGroupId,string strCodeTypeId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsCTCodeTypeGroupRelaBL.IsExist(strCtGroupId,strCodeTypeId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/CTCodeTypeGroupRelaApi/AddNewRecord
 /// 在Body区传输objCTCodeTypeGroupRelaEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objCTCodeTypeGroupRelaEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clsCTCodeTypeGroupRelaEN objCTCodeTypeGroupRelaEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strCTCodeTypeGroupRelaJSONObj = clsJSON.GetJsonFromObj(objCTCodeTypeGroupRelaEN);
dictParam.Add("strCTCodeTypeGroupRelaJSONObj", strCTCodeTypeGroupRelaJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 {
string strMsg = string.Format("添加记录时,关键字:[{0}]已经存在!({1})", objCTCodeTypeGroupRelaEN.CtGroupId, clsStackTrace.GetCurrClassFunction());
return Ok(new { errorId = 1, errorMsg = strMsg });
 }
 try
 {
    clsCTCodeTypeGroupRelaBL.AccessFldValueNull(objCTCodeTypeGroupRelaEN);
bool bolResult = objCTCodeTypeGroupRelaEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/CTCodeTypeGroupRelaApi/AddNewRecordWithReturnKey
 /// 在Body区传输objCTCodeTypeGroupRelaEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecordWithReturnKey)
 /// </summary>
 /// <param name = "objCTCodeTypeGroupRelaEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
[HttpPost("AddNewRecordWithReturnKey")]
public ActionResult AddNewRecordWithReturnKey(clsCTCodeTypeGroupRelaEN objCTCodeTypeGroupRelaEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objCTCodeTypeGroupRelaEN", JsonConvert.SerializeObject(objCTCodeTypeGroupRelaEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clsCTCodeTypeGroupRelaBL.AccessFldValueNull(objCTCodeTypeGroupRelaEN);
string strKey = clsCTCodeTypeGroupRelaBL.AddNewRecordBySql2WithReturnKey(objCTCodeTypeGroupRelaEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/CTCodeTypeGroupRelaApi/UpdateRecord
 /// 在Body区传输objCTCodeTypeGroupRelaEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strCTCodeTypeGroupRelaJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clsCTCodeTypeGroupRelaEN objCTCodeTypeGroupRelaEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strCTCodeTypeGroupRelaJSONObj = clsJSON.GetJsonFromObj(objCTCodeTypeGroupRelaEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clsCTCodeTypeGroupRelaBL.SetUpdFlag(objCTCodeTypeGroupRelaEN);
    clsCTCodeTypeGroupRelaBL.AccessFldValueNull(objCTCodeTypeGroupRelaEN);
bool bolResult = objCTCodeTypeGroupRelaEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/CTCodeTypeGroupRelaApi/UpdateWithCondition
 /// 在Body区传输objCTCodeTypeGroupRelaEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clsCTCodeTypeGroupRelaEN objCTCodeTypeGroupRelaEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clsCTCodeTypeGroupRelaBL.AccessFldValueNull(objCTCodeTypeGroupRelaEN);
bool bolResult = objCTCodeTypeGroupRelaEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/CTCodeTypeGroupRelaApi/DelRecord/Id
...
public ActionResult DelRecKeyLst(string strCtGroupId,string strCodeTypeId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
["CtGroupId"] = strCtGroupId,
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsCTCodeTypeGroupRelaBL.DelRecord(strCtGroupId,strCodeTypeId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/CTCodeTypeGroupRelaApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsCTCodeTypeGroupRelaBL.DelRecKeyLsts(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/CTCodeTypeGroupRelaApi/DelCTCodeTypeGroupRelasByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("DelCTCodeTypeGroupRelasByCond")]
public ActionResult DelCTCodeTypeGroupRelasByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsCTCodeTypeGroupRelaBL.DelCTCodeTypeGroupRelasByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
