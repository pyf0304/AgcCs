 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:PrjFileStateApiController
 表名:PrjFileState(00050525)
 * 版本:2023.08.19.1(服务器:WIN-SRV103-116)
 日期:2023/08/23 10:14:58
 生成者:pyf
 生成服务器IP:
 工程名称:AGC(0005)
...
{
 /// <summary>
 /// PrjFileStateController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  PrjFileStateApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/PrjFileStateApi/GetObjByPrjFileStateId?PrjFileStateId=value
 /// (AutoGCLib.WA_Srv4CSharp:Gen_GetObjByKeyId)
 /// </summary>
 /// <param name = "strPrjFileStateId">表关键字</param>
 /// <returns>表对象</returns>
[HttpGet("GetObjByPrjFileStateId")]
public ActionResult GetObjByPrjFileStateId(string strPrjFileStateId)
{
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objPrjFileStateEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/PrjFileStateApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsPrjFileStateEN> arrPrjFileStateObjLst = clsPrjFileStateBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPrjFileStateObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/PrjFileStateApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsPrjFileStateEN> arrPrjFileStateObjLst = clsPrjFileStateBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPrjFileStateObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/PrjFileStateapi/GetObjLstByPrjFileStateIdLst
 /// (AutoGCLib.WA_Srv4CSharp:Gen_GetObjLstByKeyLst)
 /// </summary>
 /// <param name = "arrPrjFileStateIdLst">所给的关键字</param>
 /// <returns>根据关键字获取的对象</returns>
[HttpPost("GetObjLstByPrjFileStateIdLst")]
public ActionResult GetObjLstByPrjFileStateIdLst([FromBody]string[] arrPrjFileStateId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrPrjFileStateId);
dictParam.Add("arrPrjFileStateId", clsArray.GetSqlInStrByArray(arrLst, true));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
if (arrPrjFileStateId.Length == 0)
{
string strMsg = string.Format("根据关键字列表串获取对象列表时,给定的关键字值列表的JSON串不能为空!({0})", clsStackTrace.GetCurrClassFunction());
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
return Ok(new { errorId = 1, errorMsg = strMsg });
}
List<string> lstPrjFileStateId = new(arrPrjFileStateId);
 try
 {
List<clsPrjFileStateEN> arrPrjFileStateObjLst = clsPrjFileStateBL.GetObjLstByPrjFileStateIdLst(lstPrjFileStateId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPrjFileStateObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <param name = "arrPrjFileStateIdLst">所给的关键字</param>
 /// <returns>根据关键字获取的对象</returns>
[HttpPost("GetObjLstByPrjFileStateIdLstCache")]
public ActionResult GetObjLstByPrjFileStateIdLstCache([FromBody]string[] arrPrjFileStateId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrPrjFileStateId);
...
List<string> lstPrjFileStateId = new(arrPrjFileStateId);
 try
 {
IEnumerable<clsPrjFileStateEN> arrPrjFileStateObjLst = clsPrjFileStateBL.GetObjLstByPrjFileStateIdLstCache(lstPrjFileStateId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPrjFileStateObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/PrjFileStateApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsPrjFileStateEN> arrPrjFileStateObjLst = clsPrjFileStateBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPrjFileStateObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/PrjFileStateApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strPrjFileStateId = clsPrjFileStateBL.GetFirstID_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnStr = strPrjFileStateId });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/PrjFileStateApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsPrjFileStateEN objPrjFileStateEN = clsPrjFileStateBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objPrjFileStateEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/PrjFileStateApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsPrjFileStateEN> arrPrjFileStateObjLst;
 try
 {
 arrPrjFileStateObjLst = clsPrjFileStateBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPrjFileStateObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/PrjFileStateApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsPrjFileStateBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/PrjFileStateApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsPrjFileStateBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/PrjFileStateApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clsPrjFileStateBL.SetFldValue(clsPrjFileStateEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/PrjFileStateApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsPrjFileStateBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/PrjFileStateApi/IsExist?PrjFileStateId=value
 /// (AutoGCLib.WA_Srv4CSharp:Gen_IsExist)
 /// </summary>
 /// <param name = "strPrjFileStateId">给定的关键字值</param>
 /// <returns>返回是否存在?</returns>
[HttpGet("IsExist")]
public ActionResult IsExist(string strPrjFileStateId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsPrjFileStateBL.IsExist(strPrjFileStateId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/PrjFileStateApi/GetMaxStrId?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
string strMaxstrPrjFileStateId = clsPrjFileStateBL.GetMaxStrId_S();
return Ok(new { errorId = 0, errorMsg = "", returnStr =  strMaxstrPrjFileStateId });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/PrjFileStateApi/AddNewRecord
 /// 在Body区传输objPrjFileStateEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objPrjFileStateEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clsPrjFileStateEN objPrjFileStateEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strPrjFileStateJSONObj = clsJSON.GetJsonFromObj(objPrjFileStateEN);
dictParam.Add("strPrjFileStateJSONObj", strPrjFileStateJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
clsPrjFileStateEN objPrjFileStateCond = new();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 if (string.IsNullOrEmpty(objPrjFileStateEN.PrjFileStateId) == true || clsPrjFileStateBL.IsExist(objPrjFileStateEN.PrjFileStateId) == true)
 {
    ...
    clsPrjFileStateBL.AccessFldValueNull(objPrjFileStateEN);
bool bolResult = objPrjFileStateEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/PrjFileStateApi/AddNewRecordWithMaxId
 /// 在Body区传输objPrjFileStateEN的JSON对象
...
public ActionResult AddNewRecordWithMaxId([FromBody]clsPrjFileStateEN objPrjFileStateEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strPrjFileStateJSONObj = clsJSON.GetJsonFromObj(objPrjFileStateEN);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 ...
 {
    clsPrjFileStateBL.AccessFldValueNull(objPrjFileStateEN);
string strPrjFileStateId = objPrjFileStateEN.AddNewRecordWithMaxId();
return Ok(new { errorId = 0, errorMsg = "", returnStr =  strPrjFileStateId });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/PrjFileStateApi/AddNewRecordWithReturnKey
 /// 在Body区传输objPrjFileStateEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecordWithReturnKey)
 /// </summary>
 /// <param name = "objPrjFileStateEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
[HttpPost("AddNewRecordWithReturnKey")]
public ActionResult AddNewRecordWithReturnKey(clsPrjFileStateEN objPrjFileStateEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objPrjFileStateEN", JsonConvert.SerializeObject(objPrjFileStateEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clsPrjFileStateBL.AccessFldValueNull(objPrjFileStateEN);
string strKey = clsPrjFileStateBL.AddNewRecordBySql2WithReturnKey(objPrjFileStateEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/PrjFileStateApi/UpdateRecord
 /// 在Body区传输objPrjFileStateEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strPrjFileStateJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clsPrjFileStateEN objPrjFileStateEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strPrjFileStateJSONObj = clsJSON.GetJsonFromObj(objPrjFileStateEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clsPrjFileStateBL.SetUpdFlag(objPrjFileStateEN);
    clsPrjFileStateBL.AccessFldValueNull(objPrjFileStateEN);
bool bolResult = objPrjFileStateEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移顶
 /// 调用方法: POST /api/PrjFileStateApi/GoTop
...
List<string> lstPrjFileStateId = new(objOrderByData.KeyIdLst);
try
{
bool bolResult = clsPrjFileStateBL.GoTop(lstPrjFileStateId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录上移
 /// 调用方法: POST /api/PrjFileStateApi/UpMove
 /// 在Body区传输clsOrderByData的JSON对象
...
try
{
foreach(var x in lstPrjFileStateId)
{
clsPrjFileStateBL.AdjustOrderNum("UP", x);
}
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录下移
 /// 调用方法: POST /api/PrjFileStateApi/DownMove
 /// 在Body区传输clsOrderByData的JSON对象
...
List<string> lstPrjFileStateId = new(objOrderByData.KeyIdLst);
lstPrjFileStateId.Reverse();
try
{
foreach(var x in lstPrjFileStateId)
{
clsPrjFileStateBL.AdjustOrderNum("DOWN", x);
}
return Ok(new { errorId = 0, errorMsg = "", returnBool = true });
}
 catch (Exception objException)
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移底
 /// 调用方法: POST /api/PrjFileStateApi/GoBottom
 /// 在Body区传输clsOrderByData的JSON对象
...
try
{
bool bolResult = clsPrjFileStateBL.GoBottom(lstPrjFileStateId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移底
 /// 调用方法: POST /api/PrjFileStateApi/ReOrder
 /// 在Body区传输clsOrderByData的JSON对象
...
try
{
bool bolResult = clsPrjFileStateBL.ReOrder();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/PrjFileStateApi/UpdateWithCondition
 /// 在Body区传输objPrjFileStateEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clsPrjFileStateEN objPrjFileStateEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clsPrjFileStateBL.AccessFldValueNull(objPrjFileStateEN);
bool bolResult = objPrjFileStateEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/PrjFileStateApi/DelRecord/Id
...
{
string strPrjFileStateId = Id;
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
["Id"] = strPrjFileStateId
 };
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 if (string.IsNullOrEmpty(strPrjFileStateId) == true)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsPrjFileStateBL.DelRecord(strPrjFileStateId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/PrjFileStateApi/DelPrjFileStates
 /// 在Body区传输arrPrjFileStateId(关键字值列表)的JSON串
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecord)
 /// </summary>
 /// <param name = "arrPrjFileStateId">给定的关键字值列表</param>
 /// <returns>返回删除的记录数</returns>
[HttpPost("DelPrjFileStates")]
public ActionResult DelPrjFileStates([FromBody]string[] arrPrjFileStateId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrPrjFileStateId);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
int intRecNum = clsPrjFileStateBL.DelPrjFileStates(arrLst);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/PrjFileStateApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsPrjFileStateBL.DelPrjFileStates(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/PrjFileStateApi/DelPrjFileStatesByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("DelPrjFileStatesByCond")]
public ActionResult DelPrjFileStatesByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsPrjFileStateBL.DelPrjFileStatesByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
