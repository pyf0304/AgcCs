 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:vwf_StepPointRelaApiController
...
{
 /// <summary>
 /// vwf_StepPointRelaController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  vwf_StepPointRelaApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/vwf_StepPointRelaApi/GetObjByWorkFlowStepPointRelaId?WorkFlowStepPointRelaId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvwf_StepPointRelaEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vwf_StepPointRelaApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsvwf_StepPointRelaEN> arrvwf_StepPointRelaObjLst = clsvwf_StepPointRelaBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvwf_StepPointRelaObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vwf_StepPointRelaApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsvwf_StepPointRelaEN> arrvwf_StepPointRelaObjLst = clsvwf_StepPointRelaBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvwf_StepPointRelaObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/vwf_StepPointRelaapi/GetObjLstByWorkFlowStepPointRelaIdLst
...
List<long> lstWorkFlowStepPointRelaId = lstWorkFlowStepPointRelaId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
List<clsvwf_StepPointRelaEN> arrvwf_StepPointRelaObjLst = clsvwf_StepPointRelaBL.GetObjLstByWorkFlowStepPointRelaIdLst(lstWorkFlowStepPointRelaId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvwf_StepPointRelaObjLst });
 }
 catch (Exception objException)
 {
...
List<long> lstWorkFlowStepPointRelaId = lstWorkFlowStepPointRelaId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
IEnumerable<clsvwf_StepPointRelaEN> arrvwf_StepPointRelaObjLst = clsvwf_StepPointRelaBL.GetObjLstByWorkFlowStepPointRelaIdLstCache(lstWorkFlowStepPointRelaId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvwf_StepPointRelaObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/vwf_StepPointRelaApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsvwf_StepPointRelaEN> arrvwf_StepPointRelaObjLst = clsvwf_StepPointRelaBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvwf_StepPointRelaObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vwf_StepPointRelaApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 lngWorkFlowStepPointRelaId = clsvwf_StepPointRelaBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/vwf_StepPointRelaApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsvwf_StepPointRelaEN objvwf_StepPointRelaEN = clsvwf_StepPointRelaBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvwf_StepPointRelaEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/vwf_StepPointRelaApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsvwf_StepPointRelaEN> arrvwf_StepPointRelaObjLst;
 try
 {
 arrvwf_StepPointRelaObjLst = clsvwf_StepPointRelaBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvwf_StepPointRelaObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/vwf_StepPointRelaApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsvwf_StepPointRelaBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vwf_StepPointRelaApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsvwf_StepPointRelaBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/vwf_StepPointRelaApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvwf_StepPointRelaBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/vwf_StepPointRelaApi/IsExist?WorkFlowStepPointRelaId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvwf_StepPointRelaBL.IsExist(lngWorkFlowStepPointRelaId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
