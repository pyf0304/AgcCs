 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:vFeatureFuncRela_GroupByTtlApiController
 表名:vFeatureFuncRela_GroupByTtl(00050537)
 * 版本:2023.08.19.1(服务器:WIN-SRV103-116)
 日期:2023/08/23 10:15:34
 生成者:pyf
 生成服务器IP:
 工程名称:AGC(0005)
...
{
 /// <summary>
 /// vFeatureFuncRela_GroupByTtlController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  vFeatureFuncRela_GroupByTtlApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/vFeatureFuncRela_GroupByTtlApi/GetObjByFeatureId?FeatureId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvFeatureFuncRela_GroupByTtlEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vFeatureFuncRela_GroupByTtlApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsvFeatureFuncRela_GroupByTtlEN> arrvFeatureFuncRela_GroupByTtlObjLst = clsvFeatureFuncRela_GroupByTtlBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFeatureFuncRela_GroupByTtlObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vFeatureFuncRela_GroupByTtlApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsvFeatureFuncRela_GroupByTtlEN> arrvFeatureFuncRela_GroupByTtlObjLst = clsvFeatureFuncRela_GroupByTtlBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFeatureFuncRela_GroupByTtlObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/vFeatureFuncRela_GroupByTtlapi/GetObjLstByFeatureIdLst
...
List<string> lstFeatureId = new(arrFeatureId);
 try
 {
List<clsvFeatureFuncRela_GroupByTtlEN> arrvFeatureFuncRela_GroupByTtlObjLst = clsvFeatureFuncRela_GroupByTtlBL.GetObjLstByFeatureIdLst(lstFeatureId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFeatureFuncRela_GroupByTtlObjLst });
 }
 catch (Exception objException)
 {
...
List<string> lstFeatureId = new(arrFeatureId);
 try
 {
IEnumerable<clsvFeatureFuncRela_GroupByTtlEN> arrvFeatureFuncRela_GroupByTtlObjLst = clsvFeatureFuncRela_GroupByTtlBL.GetObjLstByFeatureIdLstCache(lstFeatureId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFeatureFuncRela_GroupByTtlObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/vFeatureFuncRela_GroupByTtlApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsvFeatureFuncRela_GroupByTtlEN> arrvFeatureFuncRela_GroupByTtlObjLst = clsvFeatureFuncRela_GroupByTtlBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFeatureFuncRela_GroupByTtlObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vFeatureFuncRela_GroupByTtlApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strFeatureId = clsvFeatureFuncRela_GroupByTtlBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/vFeatureFuncRela_GroupByTtlApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsvFeatureFuncRela_GroupByTtlEN objvFeatureFuncRela_GroupByTtlEN = clsvFeatureFuncRela_GroupByTtlBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvFeatureFuncRela_GroupByTtlEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/vFeatureFuncRela_GroupByTtlApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsvFeatureFuncRela_GroupByTtlEN> arrvFeatureFuncRela_GroupByTtlObjLst;
 try
 {
 arrvFeatureFuncRela_GroupByTtlObjLst = clsvFeatureFuncRela_GroupByTtlBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFeatureFuncRela_GroupByTtlObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/vFeatureFuncRela_GroupByTtlApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsvFeatureFuncRela_GroupByTtlBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vFeatureFuncRela_GroupByTtlApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsvFeatureFuncRela_GroupByTtlBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/vFeatureFuncRela_GroupByTtlApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvFeatureFuncRela_GroupByTtlBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/vFeatureFuncRela_GroupByTtlApi/IsExist?FeatureId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvFeatureFuncRela_GroupByTtlBL.IsExist(strFeatureId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
