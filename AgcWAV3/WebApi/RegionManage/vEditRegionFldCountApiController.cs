 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:vEditRegionFldCountApiController
...
{
 /// <summary>
 /// vEditRegionFldCountController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  vEditRegionFldCountApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/vEditRegionFldCountApi/GetObjByRegionId?RegionId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
clsvEditRegionFldCountEN objvEditRegionFldCountEN = clsvEditRegionFldCountBL.GetObjByRegionId(strRegionId);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvEditRegionFldCountEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vEditRegionFldCountApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsvEditRegionFldCountEN> arrvEditRegionFldCountObjLst = clsvEditRegionFldCountBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvEditRegionFldCountObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vEditRegionFldCountApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsvEditRegionFldCountEN> arrvEditRegionFldCountObjLst = clsvEditRegionFldCountBL.GetObjLstCache(strPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvEditRegionFldCountObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/vEditRegionFldCountapi/GetObjLstByRegionIdLst
...
List<string> lstRegionId = new(arrRegionId);
 try
 {
List<clsvEditRegionFldCountEN> arrvEditRegionFldCountObjLst = clsvEditRegionFldCountBL.GetObjLstByRegionIdLst(lstRegionId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvEditRegionFldCountObjLst });
 }
 catch (Exception objException)
 {
...
List<string> lstRegionId = new(arrRegionId);
 try
 {
IEnumerable<clsvEditRegionFldCountEN> arrvEditRegionFldCountObjLst = clsvEditRegionFldCountBL.GetObjLstByRegionIdLstCache(lstRegionId, PrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvEditRegionFldCountObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/vEditRegionFldCountApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsvEditRegionFldCountEN> arrvEditRegionFldCountObjLst = clsvEditRegionFldCountBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvEditRegionFldCountObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vEditRegionFldCountApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strRegionId = clsvEditRegionFldCountBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/vEditRegionFldCountApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsvEditRegionFldCountEN objvEditRegionFldCountEN = clsvEditRegionFldCountBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvEditRegionFldCountEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/vEditRegionFldCountApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsvEditRegionFldCountEN> arrvEditRegionFldCountObjLst;
 try
 {
 arrvEditRegionFldCountObjLst = clsvEditRegionFldCountBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvEditRegionFldCountObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/vEditRegionFldCountApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsvEditRegionFldCountBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vEditRegionFldCountApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsvEditRegionFldCountBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/vEditRegionFldCountApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvEditRegionFldCountBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/vEditRegionFldCountApi/IsExist?RegionId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvEditRegionFldCountBL.IsExist(strRegionId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
