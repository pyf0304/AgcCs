 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:vFeatureRegionFlds_TtlApiController
...
{
 /// <summary>
 /// vFeatureRegionFlds_TtlController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  vFeatureRegionFlds_TtlApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/vFeatureRegionFlds_TtlApi/GetObjByViewFeatureId?ViewFeatureId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvFeatureRegionFlds_TtlEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vFeatureRegionFlds_TtlApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsvFeatureRegionFlds_TtlEN> arrvFeatureRegionFlds_TtlObjLst = clsvFeatureRegionFlds_TtlBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFeatureRegionFlds_TtlObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vFeatureRegionFlds_TtlApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsvFeatureRegionFlds_TtlEN> arrvFeatureRegionFlds_TtlObjLst = clsvFeatureRegionFlds_TtlBL.GetObjLstCache(strPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFeatureRegionFlds_TtlObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/vFeatureRegionFlds_Ttlapi/GetObjLstByViewFeatureIdLst
...
List<string> lstViewFeatureId = new(arrViewFeatureId);
 try
 {
List<clsvFeatureRegionFlds_TtlEN> arrvFeatureRegionFlds_TtlObjLst = clsvFeatureRegionFlds_TtlBL.GetObjLstByViewFeatureIdLst(lstViewFeatureId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFeatureRegionFlds_TtlObjLst });
 }
 catch (Exception objException)
 {
...
List<string> lstViewFeatureId = new(arrViewFeatureId);
 try
 {
IEnumerable<clsvFeatureRegionFlds_TtlEN> arrvFeatureRegionFlds_TtlObjLst = clsvFeatureRegionFlds_TtlBL.GetObjLstByViewFeatureIdLstCache(lstViewFeatureId, PrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFeatureRegionFlds_TtlObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/vFeatureRegionFlds_TtlApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsvFeatureRegionFlds_TtlEN> arrvFeatureRegionFlds_TtlObjLst = clsvFeatureRegionFlds_TtlBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFeatureRegionFlds_TtlObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vFeatureRegionFlds_TtlApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strViewFeatureId = clsvFeatureRegionFlds_TtlBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/vFeatureRegionFlds_TtlApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsvFeatureRegionFlds_TtlEN objvFeatureRegionFlds_TtlEN = clsvFeatureRegionFlds_TtlBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvFeatureRegionFlds_TtlEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/vFeatureRegionFlds_TtlApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsvFeatureRegionFlds_TtlEN> arrvFeatureRegionFlds_TtlObjLst;
 try
 {
 arrvFeatureRegionFlds_TtlObjLst = clsvFeatureRegionFlds_TtlBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFeatureRegionFlds_TtlObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/vFeatureRegionFlds_TtlApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsvFeatureRegionFlds_TtlBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vFeatureRegionFlds_TtlApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsvFeatureRegionFlds_TtlBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/vFeatureRegionFlds_TtlApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvFeatureRegionFlds_TtlBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/vFeatureRegionFlds_TtlApi/IsExist?ViewFeatureId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvFeatureRegionFlds_TtlBL.IsExist(strViewFeatureId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
