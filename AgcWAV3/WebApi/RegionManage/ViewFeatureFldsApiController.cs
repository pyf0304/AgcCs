 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:ViewFeatureFldsApiController
 表名:ViewFeatureFlds(00050453)
 * 版本:2024.10.15.1(服务器:WIN-SRV103-116)
 日期:2024/10/16 09:50:10
 生成者:pyf
 生成服务器IP:
 工程名称:AGC(0005)
...
{
 /// <summary>
 /// ViewFeatureFldsController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  ViewFeatureFldsApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/ViewFeatureFldsApi/GetObjBymId?mId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objViewFeatureFldsEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/ViewFeatureFldsApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsViewFeatureFldsEN> arrViewFeatureFldsObjLst = clsViewFeatureFldsBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrViewFeatureFldsObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/ViewFeatureFldsApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsViewFeatureFldsEN> arrViewFeatureFldsObjLst = clsViewFeatureFldsBL.GetObjLstCache(strPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrViewFeatureFldsObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/ViewFeatureFldsapi/GetObjLstByMIdLst
...
List<long> lstMId = lstMId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
List<clsViewFeatureFldsEN> arrViewFeatureFldsObjLst = clsViewFeatureFldsBL.GetObjLstByMIdLst(lstMId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrViewFeatureFldsObjLst });
 }
 catch (Exception objException)
 {
...
List<long> lstMId = lstMId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
IEnumerable<clsViewFeatureFldsEN> arrViewFeatureFldsObjLst = clsViewFeatureFldsBL.GetObjLstByMIdLstCache(lstMId, PrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrViewFeatureFldsObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/ViewFeatureFldsApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsViewFeatureFldsEN> arrViewFeatureFldsObjLst = clsViewFeatureFldsBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrViewFeatureFldsObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/ViewFeatureFldsApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 lngmId = clsViewFeatureFldsBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/ViewFeatureFldsApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsViewFeatureFldsEN objViewFeatureFldsEN = clsViewFeatureFldsBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objViewFeatureFldsEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/ViewFeatureFldsApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsViewFeatureFldsEN> arrViewFeatureFldsObjLst;
 try
 {
 arrViewFeatureFldsObjLst = clsViewFeatureFldsBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrViewFeatureFldsObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/ViewFeatureFldsApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsViewFeatureFldsBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/ViewFeatureFldsApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsViewFeatureFldsBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/ViewFeatureFldsApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clsViewFeatureFldsBL.SetFldValue(clsViewFeatureFldsEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/ViewFeatureFldsApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsViewFeatureFldsBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/ViewFeatureFldsApi/IsExist?mId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsViewFeatureFldsBL.IsExist(lngmId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/ViewFeatureFldsApi/AddNewRecord
 /// 在Body区传输objViewFeatureFldsEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objViewFeatureFldsEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clsViewFeatureFldsEN objViewFeatureFldsEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strViewFeatureFldsJSONObj = clsJSON.GetJsonFromObj(objViewFeatureFldsEN);
dictParam.Add("strViewFeatureFldsJSONObj", strViewFeatureFldsJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
clsViewFeatureFldsEN objViewFeatureFldsCond = new();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
    ...
    clsViewFeatureFldsBL.AccessFldValueNull(objViewFeatureFldsEN);
bool bolResult = objViewFeatureFldsEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/ViewFeatureFldsApi/AddNewRecordWithReturnKey
 /// 在Body区传输objViewFeatureFldsEN的JSON对象
...
public ActionResult AddNewRecordWithReturnKey(clsViewFeatureFldsEN objViewFeatureFldsEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objViewFeatureFldsEN", JsonConvert.SerializeObject(objViewFeatureFldsEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clsViewFeatureFldsBL.AccessFldValueNull(objViewFeatureFldsEN);
string strKey = clsViewFeatureFldsBL.AddNewRecordBySql2WithReturnKey(objViewFeatureFldsEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/ViewFeatureFldsApi/UpdateRecord
 /// 在Body区传输objViewFeatureFldsEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strViewFeatureFldsJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clsViewFeatureFldsEN objViewFeatureFldsEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strViewFeatureFldsJSONObj = clsJSON.GetJsonFromObj(objViewFeatureFldsEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clsViewFeatureFldsBL.SetUpdFlag(objViewFeatureFldsEN);
    clsViewFeatureFldsBL.AccessFldValueNull(objViewFeatureFldsEN);
bool bolResult = objViewFeatureFldsEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移顶
 /// 调用方法: POST /api/ViewFeatureFldsApi/GoTop
...
if (jobjOrderByData.ContainsKey("viewFeatureId"))
{
strViewFeatureId = jobjOrderByData["viewFeatureId"].ToString();
}
else if (jobjOrderByData.ContainsKey("viewfeatureid"))
{
strViewFeatureId = jobjOrderByData["viewfeatureid"].ToString();
}
else
{
string strMsg = string.Format("在从前台传来的OrderByData的数据中不存在关键字:[viewFeatureId]的数据,请检查!", "viewFeatureId|viewfeatureid");
return Ok(new { errorId = 1, errorMsg = strMsg });
}
bool bolResult = clsViewFeatureFldsBL.GoTop(lstmId, strViewFeatureId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录上移
 /// 调用方法: POST /api/ViewFeatureFldsApi/UpMove
 /// 在Body区传输clsOrderByData的JSON对象
...
clsViewFeatureFldsBL.AdjustOrderNum("UP", x, strViewFeatureId);
}
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录下移
 /// 调用方法: POST /api/ViewFeatureFldsApi/DownMove
 /// 在Body区传输clsOrderByData的JSON对象
...
clsViewFeatureFldsBL.AdjustOrderNum("DOWN", x, strViewFeatureId);
}
return Ok(new { errorId = 0, errorMsg = "", returnBool = true });
}
 catch (Exception objException)
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移底
 /// 调用方法: POST /api/ViewFeatureFldsApi/GoBottom
 /// 在Body区传输clsOrderByData的JSON对象
...
bool bolResult = clsViewFeatureFldsBL.GoBottom(lstmId, strViewFeatureId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移底
 /// 调用方法: POST /api/ViewFeatureFldsApi/ReOrder
 /// 在Body区传输clsOrderByData的JSON对象
...
bool bolResult = clsViewFeatureFldsBL.ReOrder(strViewFeatureId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/ViewFeatureFldsApi/UpdateWithCondition
 /// 在Body区传输objViewFeatureFldsEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clsViewFeatureFldsEN objViewFeatureFldsEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clsViewFeatureFldsBL.AccessFldValueNull(objViewFeatureFldsEN);
bool bolResult = objViewFeatureFldsEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/ViewFeatureFldsApi/DelRecord/Id
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsViewFeatureFldsBL.DelRecord(lngmId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/ViewFeatureFldsApi/DelViewFeatureFldss
 /// 在Body区传输arrmId(关键字值列表)的JSON串
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecord)
 /// </summary>
 /// <param name = "arrmId">给定的关键字值列表</param>
 /// <returns>返回删除的记录数</returns>
[HttpPost("DelViewFeatureFldss")]
public ActionResult DelViewFeatureFldss([FromBody]string[] arrmId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrmId);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
int intRecNum = clsViewFeatureFldsBL.DelViewFeatureFldss(arrLst);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/ViewFeatureFldsApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsViewFeatureFldsBL.DelViewFeatureFldss(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/ViewFeatureFldsApi/DelViewFeatureFldssByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("DelViewFeatureFldssByCond")]
public ActionResult DelViewFeatureFldssByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsViewFeatureFldsBL.DelViewFeatureFldssByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
