 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:vFuncModuleTabNumApiController
...
{
 /// <summary>
 /// vFuncModuleTabNumController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  vFuncModuleTabNumApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/vFuncModuleTabNumApi/GetObjByFuncModuleAgcId?FuncModuleAgcId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
clsvFuncModuleTabNumEN objvFuncModuleTabNumEN = clsvFuncModuleTabNumBL.GetObjByFuncModuleAgcId(strFuncModuleAgcId);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvFuncModuleTabNumEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vFuncModuleTabNumApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsvFuncModuleTabNumEN> arrvFuncModuleTabNumObjLst = clsvFuncModuleTabNumBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFuncModuleTabNumObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vFuncModuleTabNumApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsvFuncModuleTabNumEN> arrvFuncModuleTabNumObjLst = clsvFuncModuleTabNumBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFuncModuleTabNumObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/vFuncModuleTabNumapi/GetObjLstByFuncModuleAgcIdLst
...
List<string> lstFuncModuleAgcId = new(arrFuncModuleAgcId);
 try
 {
List<clsvFuncModuleTabNumEN> arrvFuncModuleTabNumObjLst = clsvFuncModuleTabNumBL.GetObjLstByFuncModuleAgcIdLst(lstFuncModuleAgcId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFuncModuleTabNumObjLst });
 }
 catch (Exception objException)
 {
...
List<string> lstFuncModuleAgcId = new(arrFuncModuleAgcId);
 try
 {
IEnumerable<clsvFuncModuleTabNumEN> arrvFuncModuleTabNumObjLst = clsvFuncModuleTabNumBL.GetObjLstByFuncModuleAgcIdLstCache(lstFuncModuleAgcId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFuncModuleTabNumObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/vFuncModuleTabNumApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsvFuncModuleTabNumEN> arrvFuncModuleTabNumObjLst = clsvFuncModuleTabNumBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFuncModuleTabNumObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vFuncModuleTabNumApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strFuncModuleAgcId = clsvFuncModuleTabNumBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/vFuncModuleTabNumApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsvFuncModuleTabNumEN objvFuncModuleTabNumEN = clsvFuncModuleTabNumBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvFuncModuleTabNumEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/vFuncModuleTabNumApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsvFuncModuleTabNumEN> arrvFuncModuleTabNumObjLst;
 try
 {
 arrvFuncModuleTabNumObjLst = clsvFuncModuleTabNumBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFuncModuleTabNumObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/vFuncModuleTabNumApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsvFuncModuleTabNumBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vFuncModuleTabNumApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsvFuncModuleTabNumBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/vFuncModuleTabNumApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvFuncModuleTabNumBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/vFuncModuleTabNumApi/IsExist?FuncModuleAgcId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvFuncModuleTabNumBL.IsExist(strFuncModuleAgcId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
