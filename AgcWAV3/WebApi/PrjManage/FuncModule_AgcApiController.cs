 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:FuncModule_AgcApiController
 表名:FuncModule_Agc(00050015)
 * 版本:2023.08.19.1(服务器:WIN-SRV103-116)
 日期:2023/08/23 10:14:56
 生成者:pyf
 生成服务器IP:
 工程名称:AGC(0005)
...
{
 /// <summary>
 /// FuncModule_AgcController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  FuncModule_AgcApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/FuncModule_AgcApi/GetObjByFuncModuleAgcId?FuncModuleAgcId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objFuncModule_AgcEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/FuncModule_AgcApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsFuncModule_AgcEN> arrFuncModule_AgcObjLst = clsFuncModule_AgcBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrFuncModule_AgcObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/FuncModule_AgcApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsFuncModule_AgcEN> arrFuncModule_AgcObjLst = clsFuncModule_AgcBL.GetObjLstCache(strPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrFuncModule_AgcObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/FuncModule_Agcapi/GetObjLstByFuncModuleAgcIdLst
...
List<string> lstFuncModuleAgcId = new(arrFuncModuleAgcId);
 try
 {
List<clsFuncModule_AgcEN> arrFuncModule_AgcObjLst = clsFuncModule_AgcBL.GetObjLstByFuncModuleAgcIdLst(lstFuncModuleAgcId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrFuncModule_AgcObjLst });
 }
 catch (Exception objException)
 {
...
public ActionResult GetObjLstByFuncModuleAgcIdLstCache([FromBody]string[] arrFuncModuleAgcId, string PrjId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrFuncModuleAgcId);
...
List<string> lstFuncModuleAgcId = new(arrFuncModuleAgcId);
 try
 {
IEnumerable<clsFuncModule_AgcEN> arrFuncModule_AgcObjLst = clsFuncModule_AgcBL.GetObjLstByFuncModuleAgcIdLstCache(lstFuncModuleAgcId, PrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrFuncModule_AgcObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/FuncModule_AgcApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsFuncModule_AgcEN> arrFuncModule_AgcObjLst = clsFuncModule_AgcBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrFuncModule_AgcObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/FuncModule_AgcApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strFuncModuleAgcId = clsFuncModule_AgcBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/FuncModule_AgcApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsFuncModule_AgcEN objFuncModule_AgcEN = clsFuncModule_AgcBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objFuncModule_AgcEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/FuncModule_AgcApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsFuncModule_AgcEN> arrFuncModule_AgcObjLst;
 try
 {
 arrFuncModule_AgcObjLst = clsFuncModule_AgcBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrFuncModule_AgcObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/FuncModule_AgcApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsFuncModule_AgcBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/FuncModule_AgcApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsFuncModule_AgcBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/FuncModule_AgcApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clsFuncModule_AgcBL.SetFldValue(clsFuncModule_AgcEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/FuncModule_AgcApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsFuncModule_AgcBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/FuncModule_AgcApi/IsExist?FuncModuleAgcId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsFuncModule_AgcBL.IsExist(strFuncModuleAgcId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/FuncModule_AgcApi/GetMaxStrIdByPrefix?strPrefix=v1&
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
string strMaxstrFuncModuleAgcId = clsFuncModule_AgcBL.GetMaxStrIdByPrefix_S(strPrefix);
return Ok(new { errorId = 0, errorMsg = "", returnStr =  strMaxstrFuncModuleAgcId });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/FuncModule_AgcApi/AddNewRecord
 /// 在Body区传输objFuncModule_AgcEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objFuncModule_AgcEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clsFuncModule_AgcEN objFuncModule_AgcEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strFuncModule_AgcJSONObj = clsJSON.GetJsonFromObj(objFuncModule_AgcEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 {
string strMsg = string.Format("添加记录时,关键字:[{0}]已经存在!({1})", objFuncModule_AgcEN.FuncModuleAgcId, clsStackTrace.GetCurrClassFunction());
return Ok(new { errorId = 1, errorMsg = strMsg });
 }
 try
 {
clsFuncModule_AgcEN objFuncModule_AgcCond = new();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
    ...
    clsFuncModule_AgcBL.AccessFldValueNull(objFuncModule_AgcEN);
bool bolResult = objFuncModule_AgcEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/FuncModule_AgcApi/AddNewRecordWithMaxId
 /// 在Body区传输objFuncModule_AgcEN的JSON对象
...
public ActionResult AddNewRecordWithMaxId([FromBody]clsFuncModule_AgcEN objFuncModule_AgcEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strFuncModule_AgcJSONObj = clsJSON.GetJsonFromObj(objFuncModule_AgcEN);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 ...
 {
    clsFuncModule_AgcBL.AccessFldValueNull(objFuncModule_AgcEN);
string strFuncModuleAgcId = objFuncModule_AgcEN.AddNewRecordWithMaxId();
return Ok(new { errorId = 0, errorMsg = "", returnStr =  strFuncModuleAgcId });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/FuncModule_AgcApi/AddNewRecordWithReturnKey
 /// 在Body区传输objFuncModule_AgcEN的JSON对象
...
public ActionResult AddNewRecordWithReturnKey(clsFuncModule_AgcEN objFuncModule_AgcEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objFuncModule_AgcEN", JsonConvert.SerializeObject(objFuncModule_AgcEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clsFuncModule_AgcBL.AccessFldValueNull(objFuncModule_AgcEN);
string strKey = clsFuncModule_AgcBL.AddNewRecordBySql2WithReturnKey(objFuncModule_AgcEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/FuncModule_AgcApi/UpdateRecord
 /// 在Body区传输objFuncModule_AgcEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strFuncModule_AgcJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clsFuncModule_AgcEN objFuncModule_AgcEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strFuncModule_AgcJSONObj = clsJSON.GetJsonFromObj(objFuncModule_AgcEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clsFuncModule_AgcBL.SetUpdFlag(objFuncModule_AgcEN);
    clsFuncModule_AgcBL.AccessFldValueNull(objFuncModule_AgcEN);
bool bolResult = objFuncModule_AgcEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移顶
 /// 调用方法: POST /api/FuncModule_AgcApi/GoTop
...
string strPrjId = "";
if (jobjOrderByData.ContainsKey("prjId"))
{
strPrjId = jobjOrderByData["prjId"].ToString();
}
else if (jobjOrderByData.ContainsKey("prjid"))
{
strPrjId = jobjOrderByData["prjid"].ToString();
}
else
{
string strMsg = string.Format("在从前台传来的OrderByData的数据中不存在关键字:[prjId]的数据,请检查!", "prjId|prjid");
return Ok(new { errorId = 1, errorMsg = strMsg });
}
bool bolResult = clsFuncModule_AgcBL.GoTop(lstFuncModuleAgcId, strPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录上移
 /// 调用方法: POST /api/FuncModule_AgcApi/UpMove
 /// 在Body区传输clsOrderByData的JSON对象
...
clsFuncModule_AgcBL.AdjustOrderNum("UP", x, strPrjId);
}
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录下移
 /// 调用方法: POST /api/FuncModule_AgcApi/DownMove
 /// 在Body区传输clsOrderByData的JSON对象
...
clsFuncModule_AgcBL.AdjustOrderNum("DOWN", x, strPrjId);
}
return Ok(new { errorId = 0, errorMsg = "", returnBool = true });
}
 catch (Exception objException)
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移底
 /// 调用方法: POST /api/FuncModule_AgcApi/GoBottom
 /// 在Body区传输clsOrderByData的JSON对象
...
bool bolResult = clsFuncModule_AgcBL.GoBottom(lstFuncModuleAgcId, strPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移底
 /// 调用方法: POST /api/FuncModule_AgcApi/ReOrder
 /// 在Body区传输clsOrderByData的JSON对象
...
bool bolResult = clsFuncModule_AgcBL.ReOrder(strPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/FuncModule_AgcApi/UpdateWithCondition
 /// 在Body区传输objFuncModule_AgcEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clsFuncModule_AgcEN objFuncModule_AgcEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clsFuncModule_AgcBL.AccessFldValueNull(objFuncModule_AgcEN);
bool bolResult = objFuncModule_AgcEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/FuncModule_AgcApi/DelRecord/Id
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsFuncModule_AgcBL.DelRecord(strFuncModuleAgcId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/FuncModule_AgcApi/DelFuncModule_Agcs
 ...
 /// <returns>返回删除的记录数</returns>
[HttpPost("DelFuncModule_Agcs")]
public ActionResult DelFuncModule_Agcs([FromBody]string[] arrFuncModuleAgcId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrFuncModuleAgcId);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
int intRecNum = clsFuncModule_AgcBL.DelFuncModule_Agcs(arrLst);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/FuncModule_AgcApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsFuncModule_AgcBL.DelFuncModule_Agcs(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/FuncModule_AgcApi/DelFuncModule_AgcsByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("DelFuncModule_AgcsByCond")]
public ActionResult DelFuncModule_AgcsByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsFuncModule_AgcBL.DelFuncModule_AgcsByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
