 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:vFuncModulePrjViewNumApiController
...
{
 /// <summary>
 /// vFuncModulePrjViewNumController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  vFuncModulePrjViewNumApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/vFuncModulePrjViewNumApi/GetObjByFuncModuleAgcId?FuncModuleAgcId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
clsvFuncModulePrjViewNumEN objvFuncModulePrjViewNumEN = clsvFuncModulePrjViewNumBL.GetObjByFuncModuleAgcId(strFuncModuleAgcId);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvFuncModulePrjViewNumEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vFuncModulePrjViewNumApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsvFuncModulePrjViewNumEN> arrvFuncModulePrjViewNumObjLst = clsvFuncModulePrjViewNumBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFuncModulePrjViewNumObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vFuncModulePrjViewNumApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsvFuncModulePrjViewNumEN> arrvFuncModulePrjViewNumObjLst = clsvFuncModulePrjViewNumBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFuncModulePrjViewNumObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/vFuncModulePrjViewNumapi/GetObjLstByFuncModuleAgcIdLst
...
List<string> lstFuncModuleAgcId = new(arrFuncModuleAgcId);
 try
 {
List<clsvFuncModulePrjViewNumEN> arrvFuncModulePrjViewNumObjLst = clsvFuncModulePrjViewNumBL.GetObjLstByFuncModuleAgcIdLst(lstFuncModuleAgcId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFuncModulePrjViewNumObjLst });
 }
 catch (Exception objException)
 {
...
List<string> lstFuncModuleAgcId = new(arrFuncModuleAgcId);
 try
 {
IEnumerable<clsvFuncModulePrjViewNumEN> arrvFuncModulePrjViewNumObjLst = clsvFuncModulePrjViewNumBL.GetObjLstByFuncModuleAgcIdLstCache(lstFuncModuleAgcId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFuncModulePrjViewNumObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/vFuncModulePrjViewNumApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsvFuncModulePrjViewNumEN> arrvFuncModulePrjViewNumObjLst = clsvFuncModulePrjViewNumBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFuncModulePrjViewNumObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vFuncModulePrjViewNumApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strFuncModuleAgcId = clsvFuncModulePrjViewNumBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/vFuncModulePrjViewNumApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsvFuncModulePrjViewNumEN objvFuncModulePrjViewNumEN = clsvFuncModulePrjViewNumBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvFuncModulePrjViewNumEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/vFuncModulePrjViewNumApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsvFuncModulePrjViewNumEN> arrvFuncModulePrjViewNumObjLst;
 try
 {
 arrvFuncModulePrjViewNumObjLst = clsvFuncModulePrjViewNumBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvFuncModulePrjViewNumObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/vFuncModulePrjViewNumApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsvFuncModulePrjViewNumBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vFuncModulePrjViewNumApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsvFuncModulePrjViewNumBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/vFuncModulePrjViewNumApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvFuncModulePrjViewNumBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/vFuncModulePrjViewNumApi/IsExist?FuncModuleAgcId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvFuncModulePrjViewNumBL.IsExist(strFuncModuleAgcId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
