 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:Log4GC_WebSrvClassApiController
 表名:Log4GC_WebSrvClass(00050370)
 * 版本:2023.08.19.1(服务器:WIN-SRV103-116)
 日期:2023/08/23 10:15:01
 生成者:pyf
 生成服务器IP:
 工程名称:AGC(0005)
...
{
 /// <summary>
 /// Log4GC_WebSrvClassController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  Log4GC_WebSrvClassApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/Log4GC_WebSrvClassApi/GetObjBymId?mId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objLog4GC_WebSrvClassEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/Log4GC_WebSrvClassApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsLog4GC_WebSrvClassEN> arrLog4GC_WebSrvClassObjLst = clsLog4GC_WebSrvClassBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrLog4GC_WebSrvClassObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/Log4GC_WebSrvClassApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsLog4GC_WebSrvClassEN> arrLog4GC_WebSrvClassObjLst = clsLog4GC_WebSrvClassBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrLog4GC_WebSrvClassObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/Log4GC_WebSrvClassapi/GetObjLstByMIdLst
...
List<long> lstMId = lstMId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
List<clsLog4GC_WebSrvClassEN> arrLog4GC_WebSrvClassObjLst = clsLog4GC_WebSrvClassBL.GetObjLstByMIdLst(lstMId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrLog4GC_WebSrvClassObjLst });
 }
 catch (Exception objException)
 {
...
List<long> lstMId = lstMId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
IEnumerable<clsLog4GC_WebSrvClassEN> arrLog4GC_WebSrvClassObjLst = clsLog4GC_WebSrvClassBL.GetObjLstByMIdLstCache(lstMId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrLog4GC_WebSrvClassObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/Log4GC_WebSrvClassApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsLog4GC_WebSrvClassEN> arrLog4GC_WebSrvClassObjLst = clsLog4GC_WebSrvClassBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrLog4GC_WebSrvClassObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/Log4GC_WebSrvClassApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 lngmId = clsLog4GC_WebSrvClassBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/Log4GC_WebSrvClassApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsLog4GC_WebSrvClassEN objLog4GC_WebSrvClassEN = clsLog4GC_WebSrvClassBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objLog4GC_WebSrvClassEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/Log4GC_WebSrvClassApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsLog4GC_WebSrvClassEN> arrLog4GC_WebSrvClassObjLst;
 try
 {
 arrLog4GC_WebSrvClassObjLst = clsLog4GC_WebSrvClassBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrLog4GC_WebSrvClassObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/Log4GC_WebSrvClassApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsLog4GC_WebSrvClassBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/Log4GC_WebSrvClassApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsLog4GC_WebSrvClassBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/Log4GC_WebSrvClassApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clsLog4GC_WebSrvClassBL.SetFldValue(clsLog4GC_WebSrvClassEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/Log4GC_WebSrvClassApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsLog4GC_WebSrvClassBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/Log4GC_WebSrvClassApi/IsExist?mId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsLog4GC_WebSrvClassBL.IsExist(lngmId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/Log4GC_WebSrvClassApi/AddNewRecord
 /// 在Body区传输objLog4GC_WebSrvClassEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objLog4GC_WebSrvClassEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clsLog4GC_WebSrvClassEN objLog4GC_WebSrvClassEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strLog4GC_WebSrvClassJSONObj = clsJSON.GetJsonFromObj(objLog4GC_WebSrvClassEN);
dictParam.Add("strLog4GC_WebSrvClassJSONObj", strLog4GC_WebSrvClassJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
clsLog4GC_WebSrvClassEN objLog4GC_WebSrvClassCond = new();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
    ...
    clsLog4GC_WebSrvClassBL.AccessFldValueNull(objLog4GC_WebSrvClassEN);
bool bolResult = objLog4GC_WebSrvClassEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/Log4GC_WebSrvClassApi/AddNewRecordWithReturnKey
 /// 在Body区传输objLog4GC_WebSrvClassEN的JSON对象
...
public ActionResult AddNewRecordWithReturnKey(clsLog4GC_WebSrvClassEN objLog4GC_WebSrvClassEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objLog4GC_WebSrvClassEN", JsonConvert.SerializeObject(objLog4GC_WebSrvClassEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clsLog4GC_WebSrvClassBL.AccessFldValueNull(objLog4GC_WebSrvClassEN);
string strKey = clsLog4GC_WebSrvClassBL.AddNewRecordBySql2WithReturnKey(objLog4GC_WebSrvClassEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/Log4GC_WebSrvClassApi/UpdateRecord
 /// 在Body区传输objLog4GC_WebSrvClassEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strLog4GC_WebSrvClassJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clsLog4GC_WebSrvClassEN objLog4GC_WebSrvClassEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strLog4GC_WebSrvClassJSONObj = clsJSON.GetJsonFromObj(objLog4GC_WebSrvClassEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clsLog4GC_WebSrvClassBL.SetUpdFlag(objLog4GC_WebSrvClassEN);
    clsLog4GC_WebSrvClassBL.AccessFldValueNull(objLog4GC_WebSrvClassEN);
bool bolResult = objLog4GC_WebSrvClassEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/Log4GC_WebSrvClassApi/UpdateWithCondition
 /// 在Body区传输objLog4GC_WebSrvClassEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clsLog4GC_WebSrvClassEN objLog4GC_WebSrvClassEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clsLog4GC_WebSrvClassBL.AccessFldValueNull(objLog4GC_WebSrvClassEN);
bool bolResult = objLog4GC_WebSrvClassEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/Log4GC_WebSrvClassApi/DelRecord/Id
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsLog4GC_WebSrvClassBL.DelRecord(lngmId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/Log4GC_WebSrvClassApi/DelLog4GC_WebSrvClasss
 /// 在Body区传输arrmId(关键字值列表)的JSON串
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecord)
 /// </summary>
 /// <param name = "arrmId">给定的关键字值列表</param>
 /// <returns>返回删除的记录数</returns>
[HttpPost("DelLog4GC_WebSrvClasss")]
public ActionResult DelLog4GC_WebSrvClasss([FromBody]string[] arrmId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrmId);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
int intRecNum = clsLog4GC_WebSrvClassBL.DelLog4GC_WebSrvClasss(arrLst);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/Log4GC_WebSrvClassApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsLog4GC_WebSrvClassBL.DelLog4GC_WebSrvClasss(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/Log4GC_WebSrvClassApi/DelLog4GC_WebSrvClasssByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("DelLog4GC_WebSrvClasssByCond")]
public ActionResult DelLog4GC_WebSrvClasssByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsLog4GC_WebSrvClassBL.DelLog4GC_WebSrvClasssByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
