 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:tz_CommKeyWordsApiController
...
{
 /// <summary>
 /// tz_CommKeyWordsController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  tz_CommKeyWordsApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/tz_CommKeyWordsApi/GetObjByKeyId?KeyId=value
 /// (AutoGCLib.WA_Srv4CSharp:Gen_GetObjByKeyId)
 /// </summary>
 /// <param name = "strKeyId">表关键字</param>
 /// <returns>表对象</returns>
[HttpGet("GetObjByKeyId")]
public ActionResult GetObjByKeyId(string strKeyId)
{
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objtz_CommKeyWordsEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/tz_CommKeyWordsApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clstz_CommKeyWordsEN> arrtz_CommKeyWordsObjLst = clstz_CommKeyWordsBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrtz_CommKeyWordsObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/tz_CommKeyWordsApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clstz_CommKeyWordsEN> arrtz_CommKeyWordsObjLst = clstz_CommKeyWordsBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrtz_CommKeyWordsObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/tz_CommKeyWordsapi/GetObjLstByKeyIdLst
 /// (AutoGCLib.WA_Srv4CSharp:Gen_GetObjLstByKeyLst)
 /// </summary>
 /// <param name = "arrKeyIdLst">所给的关键字</param>
 /// <returns>根据关键字获取的对象</returns>
[HttpPost("GetObjLstByKeyIdLst")]
public ActionResult GetObjLstByKeyIdLst([FromBody]string[] arrKeyId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrKeyId);
dictParam.Add("arrKeyId", clsArray.GetSqlInStrByArray(arrLst, true));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
...
List<string> lstKeyId = new(arrKeyId);
 try
 {
List<clstz_CommKeyWordsEN> arrtz_CommKeyWordsObjLst = clstz_CommKeyWordsBL.GetObjLstByKeyIdLst(lstKeyId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrtz_CommKeyWordsObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <param name = "arrKeyIdLst">所给的关键字</param>
 /// <returns>根据关键字获取的对象</returns>
[HttpPost("GetObjLstByKeyIdLstCache")]
public ActionResult GetObjLstByKeyIdLstCache([FromBody]string[] arrKeyId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrKeyId);
...
List<string> lstKeyId = new(arrKeyId);
 try
 {
IEnumerable<clstz_CommKeyWordsEN> arrtz_CommKeyWordsObjLst = clstz_CommKeyWordsBL.GetObjLstByKeyIdLstCache(lstKeyId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrtz_CommKeyWordsObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/tz_CommKeyWordsApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clstz_CommKeyWordsEN> arrtz_CommKeyWordsObjLst = clstz_CommKeyWordsBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrtz_CommKeyWordsObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/tz_CommKeyWordsApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strKeyId = clstz_CommKeyWordsBL.GetFirstID_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnStr = strKeyId });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/tz_CommKeyWordsApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clstz_CommKeyWordsEN objtz_CommKeyWordsEN = clstz_CommKeyWordsBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objtz_CommKeyWordsEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/tz_CommKeyWordsApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clstz_CommKeyWordsEN> arrtz_CommKeyWordsObjLst;
 try
 {
 arrtz_CommKeyWordsObjLst = clstz_CommKeyWordsBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrtz_CommKeyWordsObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/tz_CommKeyWordsApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clstz_CommKeyWordsBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/tz_CommKeyWordsApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clstz_CommKeyWordsBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/tz_CommKeyWordsApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clstz_CommKeyWordsBL.SetFldValue(clstz_CommKeyWordsEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/tz_CommKeyWordsApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clstz_CommKeyWordsBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/tz_CommKeyWordsApi/IsExist?KeyId=value
 /// (AutoGCLib.WA_Srv4CSharp:Gen_IsExist)
 /// </summary>
 /// <param name = "strKeyId">给定的关键字值</param>
 /// <returns>返回是否存在?</returns>
[HttpGet("IsExist")]
public ActionResult IsExist(string strKeyId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clstz_CommKeyWordsBL.IsExist(strKeyId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/tz_CommKeyWordsApi/AddNewRecord
 /// 在Body区传输objtz_CommKeyWordsEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objtz_CommKeyWordsEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clstz_CommKeyWordsEN objtz_CommKeyWordsEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strtz_CommKeyWordsJSONObj = clsJSON.GetJsonFromObj(objtz_CommKeyWordsEN);
dictParam.Add("strtz_CommKeyWordsJSONObj", strtz_CommKeyWordsJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
clstz_CommKeyWordsEN objtz_CommKeyWordsCond = new();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
    ...
    clstz_CommKeyWordsBL.AccessFldValueNull(objtz_CommKeyWordsEN);
bool bolResult = objtz_CommKeyWordsEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/tz_CommKeyWordsApi/AddNewRecordWithReturnKey
 /// 在Body区传输objtz_CommKeyWordsEN的JSON对象
...
public ActionResult AddNewRecordWithReturnKey(clstz_CommKeyWordsEN objtz_CommKeyWordsEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objtz_CommKeyWordsEN", JsonConvert.SerializeObject(objtz_CommKeyWordsEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clstz_CommKeyWordsBL.AccessFldValueNull(objtz_CommKeyWordsEN);
string strKey = clstz_CommKeyWordsBL.AddNewRecordBySql2WithReturnKey(objtz_CommKeyWordsEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/tz_CommKeyWordsApi/UpdateRecord
 /// 在Body区传输objtz_CommKeyWordsEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strtz_CommKeyWordsJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clstz_CommKeyWordsEN objtz_CommKeyWordsEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strtz_CommKeyWordsJSONObj = clsJSON.GetJsonFromObj(objtz_CommKeyWordsEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clstz_CommKeyWordsBL.SetUpdFlag(objtz_CommKeyWordsEN);
    clstz_CommKeyWordsBL.AccessFldValueNull(objtz_CommKeyWordsEN);
bool bolResult = objtz_CommKeyWordsEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/tz_CommKeyWordsApi/UpdateWithCondition
 /// 在Body区传输objtz_CommKeyWordsEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clstz_CommKeyWordsEN objtz_CommKeyWordsEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clstz_CommKeyWordsBL.AccessFldValueNull(objtz_CommKeyWordsEN);
bool bolResult = objtz_CommKeyWordsEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/tz_CommKeyWordsApi/DelRecord/Id
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clstz_CommKeyWordsBL.DelRecord(strKeyId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/tz_CommKeyWordsApi/Deltz_CommKeyWordss
 /// 在Body区传输arrKeyId(关键字值列表)的JSON串
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecord)
 /// </summary>
 /// <param name = "arrKeyId">给定的关键字值列表</param>
 /// <returns>返回删除的记录数</returns>
[HttpPost("Deltz_CommKeyWordss")]
public ActionResult Deltz_CommKeyWordss([FromBody]string[] arrKeyId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrKeyId);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
int intRecNum = clstz_CommKeyWordsBL.Deltz_CommKeyWordss(arrLst);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/tz_CommKeyWordsApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clstz_CommKeyWordsBL.Deltz_CommKeyWordss(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/tz_CommKeyWordsApi/Deltz_CommKeyWordssByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("Deltz_CommKeyWordssByCond")]
public ActionResult Deltz_CommKeyWordssByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clstz_CommKeyWordsBL.Deltz_CommKeyWordssByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
