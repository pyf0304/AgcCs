 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:vPrjTab_SimApiController
 表名:vPrjTab_Sim(00050597)
 * 版本:2024.02.19.1(服务器:WIN-SRV103-116)
 日期:2024/03/11 02:49:12
 生成者:pyf
 生成服务器IP:
 工程名称:AGC(0005)
...
{
 /// <summary>
 /// vPrjTab_SimController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  vPrjTab_SimApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/vPrjTab_SimApi/GetObjByTabId?TabId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvPrjTab_SimEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vPrjTab_SimApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsvPrjTab_SimEN> arrvPrjTab_SimObjLst = clsvPrjTab_SimBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTab_SimObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vPrjTab_SimApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsvPrjTab_SimEN> arrvPrjTab_SimObjLst = clsvPrjTab_SimBL.GetObjLstCache(strCmPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTab_SimObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/vPrjTab_Simapi/GetObjLstByTabIdLst
...
List<string> lstTabId = new(arrTabId);
 try
 {
List<clsvPrjTab_SimEN> arrvPrjTab_SimObjLst = clsvPrjTab_SimBL.GetObjLstByTabIdLst(lstTabId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTab_SimObjLst });
 }
 catch (Exception objException)
 {
...
List<string> lstTabId = new(arrTabId);
 try
 {
IEnumerable<clsvPrjTab_SimEN> arrvPrjTab_SimObjLst = clsvPrjTab_SimBL.GetObjLstByTabIdLstCache(lstTabId, CmPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTab_SimObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/vPrjTab_SimApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsvPrjTab_SimEN> arrvPrjTab_SimObjLst = clsvPrjTab_SimBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTab_SimObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vPrjTab_SimApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strTabId = clsvPrjTab_SimBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/vPrjTab_SimApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsvPrjTab_SimEN objvPrjTab_SimEN = clsvPrjTab_SimBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvPrjTab_SimEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/vPrjTab_SimApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsvPrjTab_SimEN> arrvPrjTab_SimObjLst;
 try
 {
 arrvPrjTab_SimObjLst = clsvPrjTab_SimBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTab_SimObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/vPrjTab_SimApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsvPrjTab_SimBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vPrjTab_SimApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsvPrjTab_SimBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/vPrjTab_SimApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvPrjTab_SimBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/vPrjTab_SimApi/IsExist?TabId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvPrjTab_SimBL.IsExist(strTabId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
