 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:vPrjTabKeyFldV2ApiController
 表名:vPrjTabKeyFldV2(00050612)
 * 版本:2023.08.19.1(服务器:WIN-SRV103-116)
 日期:2023/08/23 10:15:47
 生成者:pyf
 生成服务器IP:
 工程名称:AGC(0005)
...
{
 /// <summary>
 /// vPrjTabKeyFldV2Controller 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  vPrjTabKeyFldV2ApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/vPrjTabKeyFldV2Api/GetObjByTabId?TabId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvPrjTabKeyFldV2EN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vPrjTabKeyFldV2Api/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsvPrjTabKeyFldV2EN> arrvPrjTabKeyFldV2ObjLst = clsvPrjTabKeyFldV2BL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTabKeyFldV2ObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vPrjTabKeyFldV2Api/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsvPrjTabKeyFldV2EN> arrvPrjTabKeyFldV2ObjLst = clsvPrjTabKeyFldV2BL.GetObjLstCache(strCmPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTabKeyFldV2ObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/vPrjTabKeyFldV2api/GetObjLstByTabIdLst
...
List<string> lstTabId = new(arrTabId);
 try
 {
List<clsvPrjTabKeyFldV2EN> arrvPrjTabKeyFldV2ObjLst = clsvPrjTabKeyFldV2BL.GetObjLstByTabIdLst(lstTabId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTabKeyFldV2ObjLst });
 }
 catch (Exception objException)
 {
...
public ActionResult GetObjLstByTabIdLstCache([FromBody]string[] arrTabId, string CmPrjId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrTabId);
...
List<string> lstTabId = new(arrTabId);
 try
 {
IEnumerable<clsvPrjTabKeyFldV2EN> arrvPrjTabKeyFldV2ObjLst = clsvPrjTabKeyFldV2BL.GetObjLstByTabIdLstCache(lstTabId, CmPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTabKeyFldV2ObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/vPrjTabKeyFldV2Api/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsvPrjTabKeyFldV2EN> arrvPrjTabKeyFldV2ObjLst = clsvPrjTabKeyFldV2BL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTabKeyFldV2ObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vPrjTabKeyFldV2Api/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strTabId = clsvPrjTabKeyFldV2BL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/vPrjTabKeyFldV2Api/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsvPrjTabKeyFldV2EN objvPrjTabKeyFldV2EN = clsvPrjTabKeyFldV2BL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvPrjTabKeyFldV2EN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/vPrjTabKeyFldV2Api/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsvPrjTabKeyFldV2EN> arrvPrjTabKeyFldV2ObjLst;
 try
 {
 arrvPrjTabKeyFldV2ObjLst = clsvPrjTabKeyFldV2BL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTabKeyFldV2ObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/vPrjTabKeyFldV2Api/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsvPrjTabKeyFldV2BL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vPrjTabKeyFldV2Api/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsvPrjTabKeyFldV2BL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/vPrjTabKeyFldV2Api/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvPrjTabKeyFldV2BL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/vPrjTabKeyFldV2Api/IsExist?TabId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvPrjTabKeyFldV2BL.IsExist(strTabId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
