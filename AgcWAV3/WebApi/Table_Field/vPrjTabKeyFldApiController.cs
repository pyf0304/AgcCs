 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:vPrjTabKeyFldApiController
 表名:vPrjTabKeyFld(00050286)
 * 版本:2023.08.19.1(服务器:WIN-SRV103-116)
 日期:2023/08/23 10:15:46
 生成者:pyf
 生成服务器IP:
 工程名称:AGC(0005)
...
{
 /// <summary>
 /// vPrjTabKeyFldController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  vPrjTabKeyFldApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/vPrjTabKeyFldApi/GetObjByTabId?TabId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
clsvPrjTabKeyFldEN objvPrjTabKeyFldEN = clsvPrjTabKeyFldBL.GetObjByTabId(strTabId);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvPrjTabKeyFldEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vPrjTabKeyFldApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsvPrjTabKeyFldEN> arrvPrjTabKeyFldObjLst = clsvPrjTabKeyFldBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTabKeyFldObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vPrjTabKeyFldApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsvPrjTabKeyFldEN> arrvPrjTabKeyFldObjLst = clsvPrjTabKeyFldBL.GetObjLstCache(strPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTabKeyFldObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/vPrjTabKeyFldapi/GetObjLstByTabIdLst
...
List<string> lstTabId = new(arrTabId);
 try
 {
List<clsvPrjTabKeyFldEN> arrvPrjTabKeyFldObjLst = clsvPrjTabKeyFldBL.GetObjLstByTabIdLst(lstTabId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTabKeyFldObjLst });
 }
 catch (Exception objException)
 {
...
List<string> lstTabId = new(arrTabId);
 try
 {
IEnumerable<clsvPrjTabKeyFldEN> arrvPrjTabKeyFldObjLst = clsvPrjTabKeyFldBL.GetObjLstByTabIdLstCache(lstTabId, PrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTabKeyFldObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/vPrjTabKeyFldApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsvPrjTabKeyFldEN> arrvPrjTabKeyFldObjLst = clsvPrjTabKeyFldBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTabKeyFldObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vPrjTabKeyFldApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strTabId = clsvPrjTabKeyFldBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/vPrjTabKeyFldApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsvPrjTabKeyFldEN objvPrjTabKeyFldEN = clsvPrjTabKeyFldBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvPrjTabKeyFldEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/vPrjTabKeyFldApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsvPrjTabKeyFldEN> arrvPrjTabKeyFldObjLst;
 try
 {
 arrvPrjTabKeyFldObjLst = clsvPrjTabKeyFldBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvPrjTabKeyFldObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/vPrjTabKeyFldApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsvPrjTabKeyFldBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vPrjTabKeyFldApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsvPrjTabKeyFldBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/vPrjTabKeyFldApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvPrjTabKeyFldBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/vPrjTabKeyFldApi/IsExist?TabId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvPrjTabKeyFldBL.IsExist(strTabId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
