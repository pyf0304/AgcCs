...
from objvPrjTab4DdlEN in arrvPrjTab4DdlObjLstCache
where objvPrjTab4DdlEN.TabId == strTabId 
select objvPrjTab4DdlEN;
if (arrvPrjTab4DdlObjLst_Sel.Count() == 0)
{
   clsvPrjTab4DdlEN obj = clsvPrjTab4DdlWApi.GetObjByTabId(strTabId);
   if (obj != null)
 {
...
if (arrvPrjTab4DdlObjLst_Sel.Count > 0)
{
return arrvPrjTab4DdlObjLst_Sel[0].TabName;
}
string strErrMsgForGetObjById = string.Format("在vPrjTab4Ddl对象缓存列表中,找不到记录[TabId = {0}](函数:{1})", strTabId, clsStackTrace.GetCurrFunction());
clsLog.LogErrorS2("clsvPrjTab4DdlBL", clsStackTrace.GetCurrClassFunction(), strErrMsgForGetObjById, "", "");
...
string strErrMsgForGetObjById = string.Format("在vPrjTab4Ddl对象缓存列表中,找不到记录的相关名称[TabId = {0}](函数:{1})", strTabId, clsStackTrace.GetCurrFunction());
clsLog.LogErrorS2("clsvPrjTab4DdlBL", clsStackTrace.GetCurrClassFunction(), strErrMsgForGetObjById, "", "");
throw new Exception(strErrMsgForGetObjById);
}
...
public static IEnumerable<clsvPrjTab4DdlEN> GetObjLstByTabIdLstCache(List<string> arrTabId, string strPrjId)
{
//初始化列表缓存
string strKey = string.Format("{0}_{1}", clsvPrjTab4DdlEN._CurrTabName, strPrjId);
List<clsvPrjTab4DdlEN> arrvPrjTab4DdlObjLstCache = GetObjLstCache(strPrjId);
IEnumerable <clsvPrjTab4DdlEN> arrvPrjTab4DdlObjLst_Sel =
from objvPrjTab4DdlEN in arrvPrjTab4DdlObjLstCache
where arrTabId.Contains(objvPrjTab4DdlEN.TabId)
select objvPrjTab4DdlEN;
...
if (clsvPrjTab4DdlEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
...
{
//Columns
foreach (string strAttrName in clsvPrjTab4DdlEN._AttributeName)
{
...
{
  var strMsg = string.Format("参数:[strPrjId]不能为空！(In clsvPrjTab4DdlWApi.ReFreshThisCache)");
 throw new Exception  (strMsg);
}
if (strPrjId.Length != 4)
{
var strMsg = string.Format("缓存分类变量:[strPrjId]的长度:[{0}]不正确！(clsvPrjTab4DdlWApi.ReFreshThisCache)", strPrjId.Length);
throw new Exception (strMsg);
}
string strMsg0;
...
if (string.IsNullOrEmpty(strPrjId) == true)
{
  var strMsg = string.Format("参数:[strPrjId]不能为空！(In clsvPrjTab4DdlWApi.GetObjLstCache)");
 throw new Exception  (strMsg);
}
if (strPrjId.Length != 4)
{
var strMsg = string.Format("缓存分类变量:[strPrjId]的长度:[{0}]不正确！(clsvPrjTab4DdlWApi.GetObjLstCache)", strPrjId.Length);
throw new Exception (strMsg);
}
//初始化列表缓存
var strWhereCond = "1=1";
if (string.IsNullOrEmpty(clsvPrjTab4DdlEN._WhereFormat) == false)
{
strWhereCond =string.Format(clsvPrjTab4DdlEN._WhereFormat, strPrjId);
}
else
{
strWhereCond = string.Format("{0}='{1}'",convPrjTab4Ddl.PrjId, strPrjId);
}
var strKey = string.Format("{0}_{1}", clsvPrjTab4DdlEN._CurrTabName, strPrjId);
List<clsvPrjTab4DdlEN> arrvPrjTab4DdlObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
return arrvPrjTab4DdlObjLstCache;
 ...
 /// </summary>
 /// <returns>从缓存中获取的所有对象列表</returns>
public static List<clsvPrjTab4DdlEN> GetObjLstCacheFromObjLst(string strPrjId,List<clsvPrjTab4DdlEN> arrObjLst_P)
{


if (string.IsNullOrEmpty(strPrjId) == true)
{
  var strMsg = string.Format("参数:[strPrjId]不能为空！(In clsvPrjTab4DdlWApi.GetObjLstCacheFromObjLst)");
 throw new Exception  (strMsg);
}
if (strPrjId.Length != 4)
{
var strMsg = string.Format("缓存分类变量:[strPrjId]的长度:[{0}]不正确！(clsvPrjTab4DdlWApi.GetObjLstCacheFromObjLst)", strPrjId.Length);
throw new Exception (strMsg);
}
var strKey = string.Format("{0}_{1}", clsvPrjTab4DdlEN._CurrTabName, strPrjId);
List<clsvPrjTab4DdlEN> arrvPrjTab4DdlObjLstCache = null;
if (CacheHelper.Exsits(strKey) == true)
{
arrvPrjTab4DdlObjLstCache = CacheHelper.Get<List<clsvPrjTab4DdlEN>>(strKey);
}
else
{
