...
/// 静态类
/// </summary>
public static class  clsTabMainTypeWApi_Static
{
...
return objTabMainTypeEN;
 ...
 /// </summary>
 /// <param name = "objTabMainTypeEN">需要设置字段值的实体对象</param>
 /// <param name = "strTabMainTypeENName">表主类型英文名</param>
 /// <param name = "strComparisonOp">比较运算符,如果有值,可用于组织条件串</param>
 /// <returns>返回对象,可以继续连写</returns>
...
clsTabMainTypeWApi.CheckPropertyNew(objTabMainTypeEN); 
bool bolResult = clsTabMainTypeWApi.UpdateRecord(objTabMainTypeEN);
...
public static bool AddNewRecord(this clsTabMainTypeEN objTabMainTypeEN)
{
 if (string.IsNullOrEmpty(objTabMainTypeEN.TabMainTypeId) == true)
 {
...
clsStackTrace.GetCurrClassFunction()); 
 ...
 if (clsTabMainTypeWApi.IsExist(objTabMainTypeEN.TabMainTypeId) == true)
 {
...
{
clsTabMainTypeWApi.CheckPropertyNew(objTabMainTypeEN); 
bool bolResult = clsTabMainTypeWApi.AddNewRecord(objTabMainTypeEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsTabMainTypeWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// <param name = "objTabMainTypeEN">需要添加的实体对象</param>
 /// <returns>如果插入成功则返回TRUE,否则为FALSE</returns>
public static string AddNewRecordWithMaxId(this clsTabMainTypeEN objTabMainTypeEN)
{
try
{
clsTabMainTypeWApi.CheckPropertyNew(objTabMainTypeEN); 
string strTabMainTypeId = clsTabMainTypeWApi.AddNewRecordWithMaxId(objTabMainTypeEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsTabMainTypeWApi.ReFreshCache();
...
{
clsTabMainTypeWApi.CheckPropertyNew(objTabMainTypeEN); 
bool bolResult = clsTabMainTypeWApi.UpdateWithCondition(objTabMainTypeEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsTabMainTypeWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class enumTabMainTypeWA
{
 /// <summary>
 /// 数据表
 /// </summary>
...
public const string NodeTab_0009 = "0009";
 ...
 /// </summary>
public class clsTabMainTypeWApi
{
private static readonly string mstrApiControllerName = "TabMainTypeApi";
...
List<clsTabMainTypeEN> arrObjLst = GetObjLst("1=1");
objDDL.DataValueField="TabMainTypeId";
objDDL.DataTextField="TabMainTypeName";
...
List<clsTabMainTypeEN> arrObjLst = clsTabMainTypeWApi.GetObjLst(strCondition);
//初始化一个对象列表
...
{
if (!Object.Equals(null, objTabMainTypeEN.TabMainTypeId) && GetStrLen(objTabMainTypeEN.TabMainTypeId) > 4)
{
 throw new Exception("字段[表主类型Id]的长度不能超过4!");
}
if (!Object.Equals(null, objTabMainTypeEN.TabMainTypeName) && GetStrLen(objTabMainTypeEN.TabMainTypeName) > 30)
{
 throw new Exception("字段[表主类型名]的长度不能超过30!");
}
if (!Object.Equals(null, objTabMainTypeEN.TabMainTypeENName) && GetStrLen(objTabMainTypeEN.TabMainTypeENName) > 30)
{
 throw new Exception("字段[表主类型英文名]的长度不能超过30!");
}
if (!Object.Equals(null, objTabMainTypeEN.Memo) && GetStrLen(objTabMainTypeEN.Memo) > 1000)
{
...
{
if (strTabMainTypeId == "") return null;
string strAction = "GetObjByTabMainTypeId";
clsTabMainTypeEN objTabMainTypeEN;
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strTabMainTypeId"] = strTabMainTypeId,
};
try
{
...
objTabMainTypeEN = JsonConvert.DeserializeObject<clsTabMainTypeEN>(strJson);
return objTabMainTypeEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsTabMainTypeEN GetFirstObj(string strWhereCond)
{
...
{
if (string.IsNullOrEmpty(strTabMainTypeId) == true) return null;
//初始化列表缓存
...
from objTabMainTypeEN in arrTabMainTypeObjLstCache
where objTabMainTypeEN.TabMainTypeId == strTabMainTypeId 
select objTabMainTypeEN;
if (arrTabMainTypeObjLst_Sel.Count() == 0)
{
   clsTabMainTypeEN obj = clsTabMainTypeWApi.GetObjByTabMainTypeId(strTabMainTypeId);
   if (obj != null)
 {
...
//初始化列表缓存
List<clsTabMainTypeEN> arrTabMainTypeObjLstCache = GetObjLstCache();
IEnumerable <clsTabMainTypeEN> arrTabMainTypeObjLst_Sel1 =
from objTabMainTypeEN in arrTabMainTypeObjLstCache
where objTabMainTypeEN.TabMainTypeId == strTabMainTypeId 
select objTabMainTypeEN;
List <clsTabMainTypeEN> arrTabMainTypeObjLst_Sel = new List<clsTabMainTypeEN>();
foreach (clsTabMainTypeEN obj in arrTabMainTypeObjLst_Sel1)
{
arrTabMainTypeObjLst_Sel.Add(obj);
}
if (arrTabMainTypeObjLst_Sel.Count > 0)
{
return arrTabMainTypeObjLst_Sel[0].TabMainTypeName;
}
string strErrMsgForGetObjById = string.Format("在TabMainType对象缓存列表中,找不到记录[TabMainTypeId = {0}](函数:{1})", strTabMainTypeId, clsStackTrace.GetCurrFunction());
clsLog.LogErrorS2("clsTabMainTypeBL", clsStackTrace.GetCurrClassFunction(), strErrMsgForGetObjById, "", "");
...
string strErrMsgForGetObjById = string.Format("在TabMainType对象缓存列表中,找不到记录的相关名称[TabMainTypeId = {0}](函数:{1})", strTabMainTypeId, clsStackTrace.GetCurrFunction());
clsLog.LogErrorS2("clsTabMainTypeBL", clsStackTrace.GetCurrClassFunction(), strErrMsgForGetObjById, "", "");
throw new Exception(strErrMsgForGetObjById);
}
...
{
 List<clsTabMainTypeEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsTabMainTypeEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// </summary>
 /// <param name = "arrTabMainTypeId">关键字列表</param>
 /// <returns>返回对象列表</returns>
public static List<clsTabMainTypeEN> GetObjLstByTabMainTypeIdLst(List<string> arrTabMainTypeId)
{
 List<clsTabMainTypeEN> arrObjLst; 
string strAction = "GetObjLstByTabMainTypeIdLst";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrTabMainTypeId);
...
throw new Exception(strMsg);
 ...
 /// </summary>
 /// <param name = "arrTabMainTypeId">所给的关键字列表</param>
 /// <returns>根据关键字列表获取的对象</returns>
public static IEnumerable<clsTabMainTypeEN> GetObjLstByTabMainTypeIdLstCache(List<string> arrTabMainTypeId)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsTabMainTypeEN._CurrTabName);
List<clsTabMainTypeEN> arrTabMainTypeObjLstCache = GetObjLstCache();
IEnumerable <clsTabMainTypeEN> arrTabMainTypeObjLst_Sel =
from objTabMainTypeEN in arrTabMainTypeObjLstCache
where arrTabMainTypeId.Contains(objTabMainTypeEN.TabMainTypeId)
select objTabMainTypeEN;
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsTabMainTypeEN> GetObjLstByRange(stuRangePara objRangePara)
{
 List<clsTabMainTypeEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsTabMainTypeEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsTabMainTypeEN> arrObjLst; 
...
try
{
 clsTabMainTypeEN objTabMainTypeEN = clsTabMainTypeWApi.GetObjByTabMainTypeId(strTabMainTypeId);
if (clsPubFun4WApi.Delete(mstrApiControllerName, strAction, strTabMainTypeId.ToString(), out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelTabMainTypes(List<string> arrTabMainTypeId)
{
string strAction = "DelTabMainTypes";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrTabMainTypeId);
...
{
string strAction = "DelTabMainTypesByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsTabMainTypeEN objTabMainTypeEN)
{
...
public static string AddNewRecordWithMaxId(clsTabMainTypeEN objTabMainTypeEN)
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsTabMainTypeWApi.ReFreshCache();
var strTabMainTypeId = (string)jobjReturn0["returnStr"];
return strTabMainTypeId;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsTabMainTypeEN objTabMainTypeEN)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsTabMainTypeEN objTabMainTypeEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objTabMainTypeEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsTabMainTypeEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsTabMainTypeEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsTabMainTypeEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsTabMainTypeEN._AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsTabMainTypeEN objInFor in arrObj)
{
//Rows
...
if (clsTabMainTypeWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsTabMainTypeEN._CurrTabName);
CacheHelper.Remove(strKey);
clsTabMainTypeWApi.objCommFun4WApi.ReFreshCache();
}
}
...
var strKey = clsTabMainTypeEN._CurrTabName;
List<clsTabMainTypeEN> arrTabMainTypeObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
...
public static DataTable GetDataTableByObjLst(List<clsTabMainTypeEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conTabMainType.TabMainTypeId, Type.GetType("System.String"));
objDT.Columns.Add(conTabMainType.TabMainTypeName, Type.GetType("System.String"));
objDT.Columns.Add(conTabMainType.TabMainTypeENName, Type.GetType("System.String"));
objDT.Columns.Add(conTabMainType.Memo, Type.GetType("System.String"));
foreach (clsTabMainTypeEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conTabMainType.TabMainTypeId] = objInFor[conTabMainType.TabMainTypeId];
objDR[conTabMainType.TabMainTypeName] = objInFor[conTabMainType.TabMainTypeName];
objDR[conTabMainType.TabMainTypeENName] = objInFor[conTabMainType.TabMainTypeENName];
objDR[conTabMainType.Memo] = objInFor[conTabMainType.Memo];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4TabMainType : clsCommFun4BL
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsTabMainTypeWApi.ReFreshThisCache();
}
}
