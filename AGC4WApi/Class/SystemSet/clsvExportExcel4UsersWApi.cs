...
from objvExportExcel4UsersEN in arrvExportExcel4UsersObjLstCache
...
public static IEnumerable<clsvExportExcel4UsersEN> GetObjLstByMIdLstCache(List<long> arrMId)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsvExportExcel4UsersEN._CurrTabName);
List<clsvExportExcel4UsersEN> arrvExportExcel4UsersObjLstCache = GetObjLstCache();
...
if (clsvExportExcel4UsersEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
...
{
//Columns
foreach (string strAttrName in clsvExportExcel4UsersEN._AttributeName)
{
...
var strKey = clsvExportExcel4UsersEN._CurrTabName;
List<clsvExportExcel4UsersEN> arrvExportExcel4UsersObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
