...
/// 静态类
/// </summary>
public static class  clsUserCodePathWApi_Static
{
...
clsUserCodePathWApi.CheckPropertyNew(objUserCodePathEN); 
bool bolResult = clsUserCodePathWApi.UpdateRecord(objUserCodePathEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsUserCodePathWApi.ReFreshCache(objUserCodePathEN.PrjId);
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsUserCodePathEN objUserCodePathEN)
{
//检测记录是否存在
...
public static bool AddNewRecord(this clsUserCodePathEN objUserCodePathEN)
{
try
{
clsUserCodePathWApi.CheckPropertyNew(objUserCodePathEN); 
bool bolResult = clsUserCodePathWApi.AddNewRecord(objUserCodePathEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsUserCodePathWApi.ReFreshCache(objUserCodePathEN.PrjId);
return bolResult;
}
...
{
clsUserCodePathWApi.CheckPropertyNew(objUserCodePathEN); 
bool bolResult = clsUserCodePathWApi.UpdateWithCondition(objUserCodePathEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsUserCodePathWApi.ReFreshCache(objUserCodePathEN.PrjId);
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsUserCodePathWApi
{
private static readonly string mstrApiControllerName = "UserCodePathApi";
...
{
if (!Object.Equals(null, objUserCodePathEN.CodeTypeId) && GetStrLen(objUserCodePathEN.CodeTypeId) > 4)
{
 throw new Exception("字段[代码类型Id]的长度不能超过4!");
}
if (!Object.Equals(null, objUserCodePathEN.TabMainTypeId) && GetStrLen(objUserCodePathEN.TabMainTypeId) > 4)
{
 throw new Exception("字段[表主类型Id]的长度不能超过4!");
}
if (!Object.Equals(null, objUserCodePathEN.ProjectFileName) && GetStrLen(objUserCodePathEN.ProjectFileName) > 200)
{
 throw new Exception("字段[工程文件名]的长度不能超过200!");
}
if (!Object.Equals(null, objUserCodePathEN.ProjectPath) && GetStrLen(objUserCodePathEN.ProjectPath) > 500)
{
 throw new Exception("字段[工程路径]的长度不能超过500!");
}
if (!Object.Equals(null, objUserCodePathEN.PrjFileStateId) && GetStrLen(objUserCodePathEN.PrjFileStateId) > 2)
{
 throw new Exception("字段[工程文件状态Id]的长度不能超过2!");
}
if (!Object.Equals(null, objUserCodePathEN.CodePath) && GetStrLen(objUserCodePathEN.CodePath) > 200)
{
 throw new Exception("字段[代码路径]的长度不能超过200!");
}
if (!Object.Equals(null, objUserCodePathEN.GcPathId) && GetStrLen(objUserCodePathEN.GcPathId) > 8)
{
 throw new Exception("字段[GC路径Id]的长度不能超过8!");
}
if (!Object.Equals(null, objUserCodePathEN.CodePathBackup) && GetStrLen(objUserCodePathEN.CodePathBackup) > 200)
{
 throw new Exception("字段[备份代码路径]的长度不能超过200!");
}
if (!Object.Equals(null, objUserCodePathEN.SuffixPath) && GetStrLen(objUserCodePathEN.SuffixPath) > 50)
{
 throw new Exception("字段[后缀路径]的长度不能超过50!");
}
if (!Object.Equals(null, objUserCodePathEN.PrjId) && GetStrLen(objUserCodePathEN.PrjId) > 4)
{
 throw new Exception("字段[工程Id]的长度不能超过4!");
}
if (!Object.Equals(null, objUserCodePathEN.UpdDate) && GetStrLen(objUserCodePathEN.UpdDate) > 20)
{
 throw new Exception("字段[修改日期]的长度不能超过20!");
}
if (!Object.Equals(null, objUserCodePathEN.UpdUserId) && GetStrLen(objUserCodePathEN.UpdUserId) > 20)
{
 throw new Exception("字段[修改用户Id]的长度不能超过20!");
}
if (!Object.Equals(null, objUserCodePathEN.Memo) && GetStrLen(objUserCodePathEN.Memo) > 1000)
{
...
objUserCodePathEN = JsonConvert.DeserializeObject<clsUserCodePathEN>(strJson);
return objUserCodePathEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsUserCodePathEN GetFirstObj(string strWhereCond)
{
...
from objUserCodePathEN in arrUserCodePathObjLstCache
where objUserCodePathEN.mId == lngmId 
select objUserCodePathEN;
...
{
 List<clsUserCodePathEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsUserCodePathEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsUserCodePathEN> GetObjLstByMIdLst(List<long> arrMId)
{
 List<clsUserCodePathEN> arrObjLst; 
...
public static IEnumerable<clsUserCodePathEN> GetObjLstByMIdLstCache(List<long> arrMId, string strPrjId)
{
//初始化列表缓存
string strKey = string.Format("{0}_{1}", clsUserCodePathEN._CurrTabName, strPrjId);
List<clsUserCodePathEN> arrUserCodePathObjLstCache = GetObjLstCache(strPrjId);
IEnumerable <clsUserCodePathEN> arrUserCodePathObjLst_Sel =
from objUserCodePathEN in arrUserCodePathObjLstCache
where arrMId.Contains(objUserCodePathEN.mId)
select objUserCodePathEN;
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsUserCodePathEN> GetObjLstByRange(stuRangePara objRangePara)
{
 List<clsUserCodePathEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsUserCodePathEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsUserCodePathEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelUserCodePaths(List<string> arrmId)
{
string strAction = "DelUserCodePaths";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrmId);
...
if ((int)jobjReturn0["errorId"] == 0)
{
 clsUserCodePathEN objUserCodePathEN = clsUserCodePathWApi.GetObjBymId(long.Parse(arrmId[0]));
clsUserCodePathWApi.ReFreshCache(objUserCodePathEN.PrjId);
var intReturnInt = (int)jobjReturn0["returnInt"];
return intReturnInt;
}
...
{
string strAction = "DelUserCodePathsByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsUserCodePathEN objUserCodePathEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJson = clsJSON.GetJsonFromObj<clsUserCodePathEN>(objUserCodePathEN);
if (clsPubFun4WApi.Post(mstrApiControllerName, strAction, dictParam, strJson, out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <param name = "objUserCodePathEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
public static string AddNewRecordWithReturnKey(clsUserCodePathEN objUserCodePathEN)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsUserCodePathEN objUserCodePathEN)
{
if (string.IsNullOrEmpty(objUserCodePathEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objUserCodePathEN.mId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsUserCodePathEN objUserCodePathEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objUserCodePathEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsUserCodePathEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsUserCodePathEN.AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsUserCodePathEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsUserCodePathEN.AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsUserCodePathEN objInFor in arrObj)
{
//Rows
...
{
  var strMsg = string.Format("参数:[strPrjId]不能为空！(In clsUserCodePathWApi.ReFreshThisCache)");
 throw new Exception  (strMsg);
}
if (strPrjId.Length != 4)
{
var strMsg = string.Format("缓存分类变量:[strPrjId]的长度:[{0}]不正确！(clsUserCodePathWApi.ReFreshThisCache)", strPrjId.Length);
throw new Exception (strMsg);
}
string strMsg0;
...
string strKey = string.Format("{0}_{1}", clsUserCodePathEN._CurrTabName, strPrjId);
CacheHelper.Remove(strKey);
clsUserCodePathWApi.objCommFun4WApi.ReFreshCache(strPrjId.ToString());
}
}
...
if (string.IsNullOrEmpty(strPrjId) == true)
{
  var strMsg = string.Format("参数:[strPrjId]不能为空！(In clsUserCodePathWApi.GetObjLstCache)");
 throw new Exception  (strMsg);
}
if (strPrjId.Length != 4)
{
var strMsg = string.Format("缓存分类变量:[strPrjId]的长度:[{0}]不正确！(clsUserCodePathWApi.GetObjLstCache)", strPrjId.Length);
throw new Exception (strMsg);
}
//初始化列表缓存
var strWhereCond = "1=1";
if (string.IsNullOrEmpty(clsUserCodePathEN._WhereFormat) == false)
{
strWhereCond =string.Format(clsUserCodePathEN._WhereFormat, strPrjId);
}
else
{
strWhereCond = string.Format("{0}='{1}'",conUserCodePath.PrjId, strPrjId);
}
var strKey = string.Format("{0}_{1}", clsUserCodePathEN._CurrTabName, strPrjId);
List<clsUserCodePathEN> arrUserCodePathObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
return arrUserCodePathObjLstCache;
 ...
 /// </summary>
 /// <returns>从缓存中获取的所有对象列表</returns>
public static List<clsUserCodePathEN> GetObjLstCacheFromObjLst(string strPrjId,List<clsUserCodePathEN> arrObjLst_P)
{


if (string.IsNullOrEmpty(strPrjId) == true)
{
  var strMsg = string.Format("参数:[strPrjId]不能为空！(In clsUserCodePathWApi.GetObjLstCacheFromObjLst)");
 throw new Exception  (strMsg);
}
if (strPrjId.Length != 4)
{
var strMsg = string.Format("缓存分类变量:[strPrjId]的长度:[{0}]不正确！(clsUserCodePathWApi.GetObjLstCacheFromObjLst)", strPrjId.Length);
throw new Exception (strMsg);
}
var strKey = string.Format("{0}_{1}", clsUserCodePathEN._CurrTabName, strPrjId);
List<clsUserCodePathEN> arrUserCodePathObjLstCache = null;
if (CacheHelper.Exsits(strKey) == true)
{
arrUserCodePathObjLstCache = CacheHelper.Get<List<clsUserCodePathEN>>(strKey);
}
else
{
...
public static DataTable GetDataTableByObjLst(List<clsUserCodePathEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conUserCodePath.mId, Type.GetType("System.Int64"));
objDT.Columns.Add(conUserCodePath.CMProjectAppRelaId, Type.GetType("System.Int64"));
objDT.Columns.Add(conUserCodePath.CodeTypeId, Type.GetType("System.String"));
objDT.Columns.Add(conUserCodePath.TabMainTypeId, Type.GetType("System.String"));
objDT.Columns.Add(conUserCodePath.IsGeneCode, Type.GetType("System.Boolean"));
objDT.Columns.Add(conUserCodePath.ProjectFileName, Type.GetType("System.String"));
objDT.Columns.Add(conUserCodePath.ProjectPath, Type.GetType("System.String"));
objDT.Columns.Add(conUserCodePath.PrjFileStateId, Type.GetType("System.String"));
objDT.Columns.Add(conUserCodePath.CodePath, Type.GetType("System.String"));
objDT.Columns.Add(conUserCodePath.GcPathId, Type.GetType("System.String"));
objDT.Columns.Add(conUserCodePath.CodePathBackup, Type.GetType("System.String"));
objDT.Columns.Add(conUserCodePath.SuffixPath, Type.GetType("System.String"));
objDT.Columns.Add(conUserCodePath.IsTemplate, Type.GetType("System.Boolean"));
objDT.Columns.Add(conUserCodePath.IsExistCodePath, Type.GetType("System.Boolean"));
objDT.Columns.Add(conUserCodePath.IsExistCodePathBackup, Type.GetType("System.Boolean"));
objDT.Columns.Add(conUserCodePath.PrjId, Type.GetType("System.String"));
objDT.Columns.Add(conUserCodePath.UpdDate, Type.GetType("System.String"));
objDT.Columns.Add(conUserCodePath.UpdUserId, Type.GetType("System.String"));
objDT.Columns.Add(conUserCodePath.Memo, Type.GetType("System.String"));
foreach (clsUserCodePathEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conUserCodePath.mId] = objInFor[conUserCodePath.mId];
objDR[conUserCodePath.CMProjectAppRelaId] = objInFor[conUserCodePath.CMProjectAppRelaId];
objDR[conUserCodePath.CodeTypeId] = objInFor[conUserCodePath.CodeTypeId];
objDR[conUserCodePath.TabMainTypeId] = objInFor[conUserCodePath.TabMainTypeId];
objDR[conUserCodePath.IsGeneCode] = objInFor[conUserCodePath.IsGeneCode];
objDR[conUserCodePath.ProjectFileName] = objInFor[conUserCodePath.ProjectFileName];
objDR[conUserCodePath.ProjectPath] = objInFor[conUserCodePath.ProjectPath];
objDR[conUserCodePath.PrjFileStateId] = objInFor[conUserCodePath.PrjFileStateId];
objDR[conUserCodePath.CodePath] = objInFor[conUserCodePath.CodePath];
objDR[conUserCodePath.GcPathId] = objInFor[conUserCodePath.GcPathId];
objDR[conUserCodePath.CodePathBackup] = objInFor[conUserCodePath.CodePathBackup];
objDR[conUserCodePath.SuffixPath] = objInFor[conUserCodePath.SuffixPath];
objDR[conUserCodePath.IsTemplate] = objInFor[conUserCodePath.IsTemplate];
objDR[conUserCodePath.IsExistCodePath] = objInFor[conUserCodePath.IsExistCodePath];
objDR[conUserCodePath.IsExistCodePathBackup] = objInFor[conUserCodePath.IsExistCodePathBackup];
objDR[conUserCodePath.PrjId] = objInFor[conUserCodePath.PrjId];
objDR[conUserCodePath.UpdDate] = objInFor[conUserCodePath.UpdDate];
objDR[conUserCodePath.UpdUserId] = objInFor[conUserCodePath.UpdUserId];
objDR[conUserCodePath.Memo] = objInFor[conUserCodePath.Memo];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4UserCodePath : clsCommFun4BLV2
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsUserCodePathWApi.ReFreshThisCache(strPrjId);
}
}
