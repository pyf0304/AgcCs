...
from objvFrontAndBack4AppTypeEN in arrvFrontAndBack4AppTypeObjLstCache
where objvFrontAndBack4AppTypeEN.mId == lngmId 
select objvFrontAndBack4AppTypeEN;
if (arrvFrontAndBack4AppTypeObjLst_Sel.Count() == 0)
{
   clsvFrontAndBack4AppTypeEN obj = clsvFrontAndBack4AppTypeWApi.GetObjBymId(lngmId);
   if (obj != null)
 {
...
public static IEnumerable<clsvFrontAndBack4AppTypeEN> GetObjLstByMIdLstCache(List<long> arrMId)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsvFrontAndBack4AppTypeEN._CurrTabName);
List<clsvFrontAndBack4AppTypeEN> arrvFrontAndBack4AppTypeObjLstCache = GetObjLstCache();
IEnumerable <clsvFrontAndBack4AppTypeEN> arrvFrontAndBack4AppTypeObjLst_Sel =
from objvFrontAndBack4AppTypeEN in arrvFrontAndBack4AppTypeObjLstCache
where arrMId.Contains(objvFrontAndBack4AppTypeEN.mId)
select objvFrontAndBack4AppTypeEN;
...
if (clsvFrontAndBack4AppTypeEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
...
{
//Columns
foreach (string strAttrName in clsvFrontAndBack4AppTypeEN._AttributeName)
{
...
var strKey = clsvFrontAndBack4AppTypeEN._CurrTabName;
List<clsvFrontAndBack4AppTypeEN> arrvFrontAndBack4AppTypeObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
