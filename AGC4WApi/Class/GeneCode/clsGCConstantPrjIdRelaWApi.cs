...
clsGCConstantPrjIdRelaWApi.ReFreshCache();
return bolResult;
}
...
from objGCConstantPrjIdRelaEN in arrGCConstantPrjIdRelaObjLstCache
where objGCConstantPrjIdRelaEN.ConstId == strConstId 
 && objGCConstantPrjIdRelaEN.PrjId == strPrjId 
select objGCConstantPrjIdRelaEN;
if (arrGCConstantPrjIdRelaObjLst_Sel.Count() == 0)
{
   clsGCConstantPrjIdRelaEN obj = clsGCConstantPrjIdRelaWApi.GetObjByKeyLst(strConstId,strPrjId);
   if (obj != null)
 {
...
public static IEnumerable<clsGCConstantPrjIdRelaEN> GetObjLstByKeyLstsCache(List<string> arrConstId)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsGCConstantPrjIdRelaEN._CurrTabName);
List<clsGCConstantPrjIdRelaEN> arrGCConstantPrjIdRelaObjLstCache = GetObjLstCache();
IEnumerable <clsGCConstantPrjIdRelaEN> arrGCConstantPrjIdRelaObjLst_Sel =
from objGCConstantPrjIdRelaEN in arrGCConstantPrjIdRelaObjLstCache
where arrConstId.Contains(objGCConstantPrjIdRelaEN.ConstId)
select objGCConstantPrjIdRelaEN;
...
var strKey = clsGCConstantPrjIdRelaEN._CurrTabName;
List<clsGCConstantPrjIdRelaEN> arrGCConstantPrjIdRelaObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
