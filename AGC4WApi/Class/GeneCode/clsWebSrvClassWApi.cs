...
/// 静态类
/// </summary>
public static class  clsWebSrvClassWApi_Static
{
...
try
{
objWebSrvClassEN.sfUpdFldSetStr = objWebSrvClassEN.getsfUpdFldSetStr();
clsWebSrvClassWApi.CheckPropertyNew(objWebSrvClassEN); 
bool bolResult = clsWebSrvClassWApi.UpdateRecord(objWebSrvClassEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsWebSrvClassWApi.ReFreshCache(objWebSrvClassEN.PrjId);
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsWebSrvClassEN objWebSrvClassEN)
{
//检测记录是否存在
...
public static bool AddNewRecord(this clsWebSrvClassEN objWebSrvClassEN)
{
try
{
 if (string.IsNullOrEmpty(objWebSrvClassEN.WebSrvClassId) == true || clsWebSrvClassWApi.IsExist(objWebSrvClassEN.WebSrvClassId) == true)
 {
     objWebSrvClassEN.WebSrvClassId = clsWebSrvClassWApi.GetMaxStrId();
 }
clsWebSrvClassWApi.CheckPropertyNew(objWebSrvClassEN); 
bool bolResult = clsWebSrvClassWApi.AddNewRecord(objWebSrvClassEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsWebSrvClassWApi.ReFreshCache(objWebSrvClassEN.PrjId);
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// <param name = "objWebSrvClassEN">需要添加的实体对象</param>
 /// <returns>如果插入成功则返回TRUE,否则为FALSE</returns>
public static string AddNewRecordWithMaxId(this clsWebSrvClassEN objWebSrvClassEN)
{
try
{
clsWebSrvClassWApi.CheckPropertyNew(objWebSrvClassEN); 
string strWebSrvClassId = clsWebSrvClassWApi.AddNewRecordWithMaxId(objWebSrvClassEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsWebSrvClassWApi.ReFreshCache(objWebSrvClassEN.PrjId);
...
{
clsWebSrvClassWApi.CheckPropertyNew(objWebSrvClassEN); 
bool bolResult = clsWebSrvClassWApi.UpdateWithCondition(objWebSrvClassEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsWebSrvClassWApi.ReFreshCache(objWebSrvClassEN.PrjId);
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsWebSrvClassWApi
{
private static readonly string mstrApiControllerName = "WebSrvClassApi";
...
List<clsWebSrvClassEN> arrObjLst = clsWebSrvClassWApi.GetObjLst(strCondition);
...
{
if (!Object.Equals(null, objWebSrvClassEN.WebSrvClassId) && GetStrLen(objWebSrvClassEN.WebSrvClassId) > 8)
{
 throw new Exception("字段[类Id]的长度不能超过8!");
}
if (!Object.Equals(null, objWebSrvClassEN.NameSpace) && GetStrLen(objWebSrvClassEN.NameSpace) > 50)
{
 throw new Exception("字段[域名]的长度不能超过50!");
}
if (!Object.Equals(null, objWebSrvClassEN.WebSrvUrl) && GetStrLen(objWebSrvClassEN.WebSrvUrl) > 300)
{
 throw new Exception("字段[WebSrv地址]的长度不能超过300!");
}
if (!Object.Equals(null, objWebSrvClassEN.PageName) && GetStrLen(objWebSrvClassEN.PageName) > 100)
{
 throw new Exception("字段[页面名称]的长度不能超过100!");
}
if (!Object.Equals(null, objWebSrvClassEN.FuncModuleAgcId) && GetStrLen(objWebSrvClassEN.FuncModuleAgcId) > 8)
{
 throw new Exception("字段[功能模块Id]的长度不能超过8!");
}
if (!Object.Equals(null, objWebSrvClassEN.PrjId) && GetStrLen(objWebSrvClassEN.PrjId) > 4)
{
 throw new Exception("字段[工程Id]的长度不能超过4!");
}
if (!Object.Equals(null, objWebSrvClassEN.UpdDate) && GetStrLen(objWebSrvClassEN.UpdDate) > 20)
{
 throw new Exception("字段[修改日期]的长度不能超过20!");
}
if (!Object.Equals(null, objWebSrvClassEN.UpdUser) && GetStrLen(objWebSrvClassEN.UpdUser) > 20)
{
 throw new Exception("字段[修改者]的长度不能超过20!");
}
if (!Object.Equals(null, objWebSrvClassEN.Memo) && GetStrLen(objWebSrvClassEN.Memo) > 1000)
{
 throw new Exception("字段[说明]的长度不能超过1000!");
}
if (!Object.Equals(null, objWebSrvClassEN.CodeTypeId) && GetStrLen(objWebSrvClassEN.CodeTypeId) > 4)
{
 throw new Exception("字段[代码类型Id]的长度不能超过4!");
}
if (!Object.Equals(null, objWebSrvClassEN.ClsName) && GetStrLen(objWebSrvClassEN.ClsName) > 100)
{
...
{
if (strWebSrvClassId == "") return null;
...
objWebSrvClassEN = JsonConvert.DeserializeObject<clsWebSrvClassEN>(strJson);
return objWebSrvClassEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsWebSrvClassEN GetFirstObj(string strWhereCond)
{
...
from objWebSrvClassEN in arrWebSrvClassObjLstCache
where objWebSrvClassEN.WebSrvClassId == strWebSrvClassId 
select objWebSrvClassEN;
if (arrWebSrvClassObjLst_Sel.Count() == 0)
{
   clsWebSrvClassEN obj = clsWebSrvClassWApi.GetObjByWebSrvClassId(strWebSrvClassId);
   if (obj != null)
 {
...
{
 List<clsWebSrvClassEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsWebSrvClassEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsWebSrvClassEN> GetObjLstByWebSrvClassIdLst(List<string> arrWebSrvClassId)
{
 List<clsWebSrvClassEN> arrObjLst; 
...
throw new Exception(strMsg);
 ...
 /// </summary>
 /// <param name = "arrWebSrvClassId">所给的关键字列表</param>
 /// <returns>根据关键字列表获取的对象</returns>
public static IEnumerable<clsWebSrvClassEN> GetObjLstByWebSrvClassIdLstCache(List<string> arrWebSrvClassId, string strPrjId)
{
//初始化列表缓存
string strKey = string.Format("{0}_{1}", clsWebSrvClassEN._CurrTabName, strPrjId);
List<clsWebSrvClassEN> arrWebSrvClassObjLstCache = GetObjLstCache(strPrjId);
IEnumerable <clsWebSrvClassEN> arrWebSrvClassObjLst_Sel =
from objWebSrvClassEN in arrWebSrvClassObjLstCache
where arrWebSrvClassId.Contains(objWebSrvClassEN.WebSrvClassId)
select objWebSrvClassEN;
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsWebSrvClassEN> GetObjLstByRange(stuRangePara objRangePara)
{
 List<clsWebSrvClassEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsWebSrvClassEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsWebSrvClassEN> arrObjLst; 
...
try
{
 clsWebSrvClassEN objWebSrvClassEN = clsWebSrvClassWApi.GetObjByWebSrvClassId(strWebSrvClassId);
if (clsPubFun4WApi.Delete(mstrApiControllerName, strAction, strWebSrvClassId.ToString(), out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelWebSrvClasss(List<string> arrWebSrvClassId)
{
string strAction = "DelWebSrvClasss";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrWebSrvClassId);
...
if ((int)jobjReturn0["errorId"] == 0)
{
 clsWebSrvClassEN objWebSrvClassEN = clsWebSrvClassWApi.GetObjByWebSrvClassId(arrWebSrvClassId[0]);
clsWebSrvClassWApi.ReFreshCache(objWebSrvClassEN.PrjId);
var intReturnInt = (int)jobjReturn0["returnInt"];
return intReturnInt;
}
...
{
string strAction = "DelWebSrvClasssByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsWebSrvClassEN objWebSrvClassEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJson = clsJSON.GetJsonFromObj<clsWebSrvClassEN>(objWebSrvClassEN);
if (clsPubFun4WApi.Post(mstrApiControllerName, strAction, dictParam, strJson, out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
...
public static string AddNewRecordWithMaxId(clsWebSrvClassEN objWebSrvClassEN)
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsWebSrvClassWApi.ReFreshCache(objWebSrvClassEN.PrjId);
var strWebSrvClassId = (string)jobjReturn0["returnStr"];
return strWebSrvClassId;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsWebSrvClassEN objWebSrvClassEN)
{
if (string.IsNullOrEmpty(objWebSrvClassEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objWebSrvClassEN.WebSrvClassId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsWebSrvClassEN objWebSrvClassEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objWebSrvClassEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsWebSrvClassEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsWebSrvClassEN.AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsWebSrvClassEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsWebSrvClassEN.AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsWebSrvClassEN objInFor in arrObj)
{
//Rows
...
{
  var strMsg = string.Format("参数:[strPrjId]不能为空！(In clsWebSrvClassWApi.ReFreshThisCache)");
 throw new Exception  (strMsg);
}
if (strPrjId.Length != 4)
{
var strMsg = string.Format("缓存分类变量:[strPrjId]的长度:[{0}]不正确！(clsWebSrvClassWApi.ReFreshThisCache)", strPrjId.Length);
throw new Exception (strMsg);
}
string strMsg0;
...
if (clsWebSrvClassWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}_{1}", clsWebSrvClassEN._CurrTabName, strPrjId);
CacheHelper.Remove(strKey);
clsWebSrvClassWApi.objCommFun4WApi.ReFreshCache(strPrjId.ToString());
}
}
...
if (string.IsNullOrEmpty(strPrjId) == true)
{
  var strMsg = string.Format("参数:[strPrjId]不能为空！(In clsWebSrvClassWApi.GetObjLstCache)");
 throw new Exception  (strMsg);
}
if (strPrjId.Length != 4)
{
var strMsg = string.Format("缓存分类变量:[strPrjId]的长度:[{0}]不正确！(clsWebSrvClassWApi.GetObjLstCache)", strPrjId.Length);
throw new Exception (strMsg);
}
//初始化列表缓存
var strWhereCond = "1=1";
if (string.IsNullOrEmpty(clsWebSrvClassEN._WhereFormat) == false)
{
strWhereCond =string.Format(clsWebSrvClassEN._WhereFormat, strPrjId);
}
else
{
strWhereCond = string.Format("{0}='{1}'",conWebSrvClass.PrjId, strPrjId);
}
var strKey = string.Format("{0}_{1}", clsWebSrvClassEN._CurrTabName, strPrjId);
List<clsWebSrvClassEN> arrWebSrvClassObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
return arrWebSrvClassObjLstCache;
 ...
 /// </summary>
 /// <returns>从缓存中获取的所有对象列表</returns>
public static List<clsWebSrvClassEN> GetObjLstCacheFromObjLst(string strPrjId,List<clsWebSrvClassEN> arrObjLst_P)
{


if (string.IsNullOrEmpty(strPrjId) == true)
{
  var strMsg = string.Format("参数:[strPrjId]不能为空！(In clsWebSrvClassWApi.GetObjLstCacheFromObjLst)");
 throw new Exception  (strMsg);
}
if (strPrjId.Length != 4)
{
var strMsg = string.Format("缓存分类变量:[strPrjId]的长度:[{0}]不正确！(clsWebSrvClassWApi.GetObjLstCacheFromObjLst)", strPrjId.Length);
throw new Exception (strMsg);
}
var strKey = string.Format("{0}_{1}", clsWebSrvClassEN._CurrTabName, strPrjId);
List<clsWebSrvClassEN> arrWebSrvClassObjLstCache = null;
if (CacheHelper.Exsits(strKey) == true)
{
arrWebSrvClassObjLstCache = CacheHelper.Get<List<clsWebSrvClassEN>>(strKey);
}
else
{
...
public static DataTable GetDataTableByObjLst(List<clsWebSrvClassEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conWebSrvClass.WebSrvClassId, Type.GetType("System.String"));
objDT.Columns.Add(conWebSrvClass.NameSpace, Type.GetType("System.String"));
objDT.Columns.Add(conWebSrvClass.WebSrvUrl, Type.GetType("System.String"));
objDT.Columns.Add(conWebSrvClass.PageName, Type.GetType("System.String"));
objDT.Columns.Add(conWebSrvClass.FuncModuleAgcId, Type.GetType("System.String"));
objDT.Columns.Add(conWebSrvClass.IsNeedGene, Type.GetType("System.Boolean"));
objDT.Columns.Add(conWebSrvClass.PrjId, Type.GetType("System.String"));
objDT.Columns.Add(conWebSrvClass.UpdDate, Type.GetType("System.String"));
objDT.Columns.Add(conWebSrvClass.UpdUser, Type.GetType("System.String"));
objDT.Columns.Add(conWebSrvClass.Memo, Type.GetType("System.String"));
objDT.Columns.Add(conWebSrvClass.CodeTypeId, Type.GetType("System.String"));
objDT.Columns.Add(conWebSrvClass.ClsName, Type.GetType("System.String"));
foreach (clsWebSrvClassEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conWebSrvClass.WebSrvClassId] = objInFor[conWebSrvClass.WebSrvClassId];
objDR[conWebSrvClass.NameSpace] = objInFor[conWebSrvClass.NameSpace];
objDR[conWebSrvClass.WebSrvUrl] = objInFor[conWebSrvClass.WebSrvUrl];
objDR[conWebSrvClass.PageName] = objInFor[conWebSrvClass.PageName];
objDR[conWebSrvClass.FuncModuleAgcId] = objInFor[conWebSrvClass.FuncModuleAgcId];
objDR[conWebSrvClass.IsNeedGene] = objInFor[conWebSrvClass.IsNeedGene];
objDR[conWebSrvClass.PrjId] = objInFor[conWebSrvClass.PrjId];
objDR[conWebSrvClass.UpdDate] = objInFor[conWebSrvClass.UpdDate];
objDR[conWebSrvClass.UpdUser] = objInFor[conWebSrvClass.UpdUser];
objDR[conWebSrvClass.Memo] = objInFor[conWebSrvClass.Memo];
objDR[conWebSrvClass.CodeTypeId] = objInFor[conWebSrvClass.CodeTypeId];
objDR[conWebSrvClass.ClsName] = objInFor[conWebSrvClass.ClsName];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4WebSrvClass : clsCommFun4BLV2
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsWebSrvClassWApi.ReFreshThisCache(strPrjId);
}
}
