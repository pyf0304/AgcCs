...
if (clsViewIdGCVariableRelaEN.AttributeName.Length == 0)
{
result = dataTable;
return result;
}
...
{
//Columns
foreach (string strAttrName in clsViewIdGCVariableRelaEN.AttributeName)
{
...
string strKey = string.Format("{0}", clsViewIdGCVariableRelaEN._CurrTabName);
CacheHelper.Remove(strKey);
clsViewIdGCVariableRelaWApi.objCommFun4WApi.ReFreshCache();
}
}
