...
/// 静态类
/// </summary>
public static class  clsFrontAndBack4AppTypeWApi_Static
{
...
try
{
objFrontAndBack4AppTypeEN.sfUpdFldSetStr = objFrontAndBack4AppTypeEN.getsfUpdFldSetStr();
clsFrontAndBack4AppTypeWApi.CheckPropertyNew(objFrontAndBack4AppTypeEN); 
bool bolResult = clsFrontAndBack4AppTypeWApi.UpdateRecord(objFrontAndBack4AppTypeEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFrontAndBack4AppTypeWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsFrontAndBack4AppTypeEN objFrontAndBack4AppTypeEN)
{
//检测记录是否存在
...
public static bool AddNewRecord(this clsFrontAndBack4AppTypeEN objFrontAndBack4AppTypeEN)
{
try
{
clsFrontAndBack4AppTypeWApi.CheckPropertyNew(objFrontAndBack4AppTypeEN); 
bool bolResult = clsFrontAndBack4AppTypeWApi.AddNewRecord(objFrontAndBack4AppTypeEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFrontAndBack4AppTypeWApi.ReFreshCache();
return bolResult;
}
...
{
clsFrontAndBack4AppTypeWApi.CheckPropertyNew(objFrontAndBack4AppTypeEN); 
bool bolResult = clsFrontAndBack4AppTypeWApi.UpdateWithCondition(objFrontAndBack4AppTypeEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFrontAndBack4AppTypeWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsFrontAndBack4AppTypeWApi
{
private static readonly string mstrApiControllerName = "FrontAndBack4AppTypeApi";
...
public static clsCommFun4BL objCommFun4WApi = null;
 ...
 public clsFrontAndBack4AppTypeWApi()
 {
 }
...
{
if (!Object.Equals(null, objFrontAndBack4AppTypeEN.UpdDate) && GetStrLen(objFrontAndBack4AppTypeEN.UpdDate) > 20)
{
 throw new Exception("字段[修改日期]的长度不能超过20!");
}
if (!Object.Equals(null, objFrontAndBack4AppTypeEN.UpdUser) && GetStrLen(objFrontAndBack4AppTypeEN.UpdUser) > 20)
{
 throw new Exception("字段[修改者]的长度不能超过20!");
}
if (!Object.Equals(null, objFrontAndBack4AppTypeEN.Memo) && GetStrLen(objFrontAndBack4AppTypeEN.Memo) > 1000)
{
...
objFrontAndBack4AppTypeEN = JsonConvert.DeserializeObject<clsFrontAndBack4AppTypeEN>(strJson);
return objFrontAndBack4AppTypeEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsFrontAndBack4AppTypeEN GetFirstObj(string strWhereCond)
{
...
from objFrontAndBack4AppTypeEN in arrFrontAndBack4AppTypeObjLstCache
where objFrontAndBack4AppTypeEN.mId == lngmId 
select objFrontAndBack4AppTypeEN;
if (arrFrontAndBack4AppTypeObjLst_Sel.Count() == 0)
{
   clsFrontAndBack4AppTypeEN obj = clsFrontAndBack4AppTypeWApi.GetObjBymId(lngmId);
   if (obj != null)
 {
...
{
 List<clsFrontAndBack4AppTypeEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsFrontAndBack4AppTypeEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsFrontAndBack4AppTypeEN> GetObjLstByMIdLst(List<long> arrMId)
{
 List<clsFrontAndBack4AppTypeEN> arrObjLst; 
...
public static IEnumerable<clsFrontAndBack4AppTypeEN> GetObjLstByMIdLstCache(List<long> arrMId)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsFrontAndBack4AppTypeEN._CurrTabName);
List<clsFrontAndBack4AppTypeEN> arrFrontAndBack4AppTypeObjLstCache = GetObjLstCache();
IEnumerable <clsFrontAndBack4AppTypeEN> arrFrontAndBack4AppTypeObjLst_Sel =
from objFrontAndBack4AppTypeEN in arrFrontAndBack4AppTypeObjLstCache
where arrMId.Contains(objFrontAndBack4AppTypeEN.mId)
select objFrontAndBack4AppTypeEN;
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsFrontAndBack4AppTypeEN> GetObjLstByRange(stuRangePara objRangePara)
{
 List<clsFrontAndBack4AppTypeEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsFrontAndBack4AppTypeEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsFrontAndBack4AppTypeEN> arrObjLst; 
...
try
{
 clsFrontAndBack4AppTypeEN objFrontAndBack4AppTypeEN = clsFrontAndBack4AppTypeWApi.GetObjBymId(lngmId);
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelFrontAndBack4AppTypes(List<string> arrmId)
{
string strAction = "DelFrontAndBack4AppTypes";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrmId);
...
{
string strAction = "DelFrontAndBack4AppTypesByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsFrontAndBack4AppTypeEN objFrontAndBack4AppTypeEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJson = clsJSON.GetJsonFromObj<clsFrontAndBack4AppTypeEN>(objFrontAndBack4AppTypeEN);
if (clsPubFun4WApi.Post(mstrApiControllerName, strAction, dictParam, strJson, out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
...
public static string AddNewRecordWithReturnKey(clsFrontAndBack4AppTypeEN objFrontAndBack4AppTypeEN)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsFrontAndBack4AppTypeEN objFrontAndBack4AppTypeEN)
{
if (string.IsNullOrEmpty(objFrontAndBack4AppTypeEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objFrontAndBack4AppTypeEN.mId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsFrontAndBack4AppTypeEN objFrontAndBack4AppTypeEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objFrontAndBack4AppTypeEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsFrontAndBack4AppTypeEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsFrontAndBack4AppTypeEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsFrontAndBack4AppTypeEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsFrontAndBack4AppTypeEN._AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsFrontAndBack4AppTypeEN objInFor in arrObj)
{
//Rows
...
if (clsFrontAndBack4AppTypeWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsFrontAndBack4AppTypeEN._CurrTabName);
CacheHelper.Remove(strKey);
clsFrontAndBack4AppTypeWApi.objCommFun4WApi.ReFreshCache();
}
}
...
var strKey = clsFrontAndBack4AppTypeEN._CurrTabName;
List<clsFrontAndBack4AppTypeEN> arrFrontAndBack4AppTypeObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
...
public static DataTable GetDataTableByObjLst(List<clsFrontAndBack4AppTypeEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conFrontAndBack4AppType.mId, Type.GetType("System.Int64"));
objDT.Columns.Add(conFrontAndBack4AppType.AppTypeId4Front, Type.GetType("System.Int32"));
objDT.Columns.Add(conFrontAndBack4AppType.AppTypeId4Back, Type.GetType("System.Int32"));
objDT.Columns.Add(conFrontAndBack4AppType.UpdDate, Type.GetType("System.String"));
objDT.Columns.Add(conFrontAndBack4AppType.UpdUser, Type.GetType("System.String"));
objDT.Columns.Add(conFrontAndBack4AppType.Memo, Type.GetType("System.String"));
foreach (clsFrontAndBack4AppTypeEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conFrontAndBack4AppType.mId] = objInFor[conFrontAndBack4AppType.mId];
objDR[conFrontAndBack4AppType.AppTypeId4Front] = objInFor[conFrontAndBack4AppType.AppTypeId4Front];
objDR[conFrontAndBack4AppType.AppTypeId4Back] = objInFor[conFrontAndBack4AppType.AppTypeId4Back];
objDR[conFrontAndBack4AppType.UpdDate] = objInFor[conFrontAndBack4AppType.UpdDate];
objDR[conFrontAndBack4AppType.UpdUser] = objInFor[conFrontAndBack4AppType.UpdUser];
objDR[conFrontAndBack4AppType.Memo] = objInFor[conFrontAndBack4AppType.Memo];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4FrontAndBack4AppType : clsCommFun4BL
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFrontAndBack4AppTypeWApi.ReFreshThisCache();
}
}
