 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsActionForwardWApi
 表名:ActionForward(00050143)
 * 版本:2025.08.02.1(服务器:PYF-THINKPAD)
 日期:2025/08/09 21:41:14
 生成者:pyf
 生成服务器IP:
 工程名称:AGC(0005)
...
/// 静态类
/// </summary>
public static class  clsActionForwardWApi_Static
{
 ...
 /// <param name = "lngActionForwardId">ActionForwardId</param>
...
return objActionForwardEN;
 ...
 /// </summary>
 /// <param name = "objActionForwardEN">需要设置字段值的实体对象</param>
 /// <param name = "strActionId">ActionId</param>
 /// <param name = "strComparisonOp">比较运算符,如果有值,可用于组织条件串</param>
 /// <returns>返回对象,可以继续连写</returns>
...
return objActionForwardEN;
 ...
 /// </summary>
 /// <param name = "objActionForwardEN">需要设置字段值的实体对象</param>
 /// <param name = "strForwardName">Forward名称</param>
 /// <param name = "strComparisonOp">比较运算符,如果有值,可用于组织条件串</param>
 /// <returns>返回对象,可以继续连写</returns>
...
return objActionForwardEN;
 ...
 /// </summary>
 /// <param name = "objActionForwardEN">需要设置字段值的实体对象</param>
 /// <param name = "strForwardPath">Forward路径</param>
 /// <param name = "strComparisonOp">比较运算符,如果有值,可用于组织条件串</param>
 /// <returns>返回对象,可以继续连写</returns>
...
try
{
objActionForwardEN.sfUpdFldSetStr = objActionForwardEN.getsfUpdFldSetStr();
clsActionForwardWApi.CheckPropertyNew(objActionForwardEN); 
bool bolResult = clsActionForwardWApi.UpdateRecord(objActionForwardEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsActionForwardWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// <summary>
 /// 获取唯一性条件串--ActionForward(ActionForward), 即由对象中唯一性条件字段关键字与值组成的条件串
 /// 唯一性条件:ActionId_ForwardName
 /// (AutoGCLib.WA_Access4CSharp:Gen_4WA_Static_GetConditionString4Constraint)
 /// </summary>
 /// <param name = "objActionForwardEN">要求唯一的对象</param>
 /// <returns></returns>
public static string GetUniConditionStr(this clsActionForwardEN objActionForwardEN)
{
//检测记录是否存在
...
{
clsActionForwardWApi.CheckPropertyNew(objActionForwardEN); 
bool bolResult = clsActionForwardWApi.AddNewRecord(objActionForwardEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsActionForwardWApi.ReFreshCache();
return bolResult;
}
...
{
clsActionForwardWApi.CheckPropertyNew(objActionForwardEN); 
bool bolResult = clsActionForwardWApi.UpdateWithCondition(objActionForwardEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsActionForwardWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsActionForwardWApi
{
private static readonly string mstrApiControllerName = "ActionForwardApi";
...
{
if (!Object.Equals(null, objActionForwardEN.ActionId) && GetStrLen(objActionForwardEN.ActionId) > 10)
{
 throw new Exception("字段[ActionId]的长度不能超过10!");
}
if (!Object.Equals(null, objActionForwardEN.ForwardName) && GetStrLen(objActionForwardEN.ForwardName) > 50)
{
 throw new Exception("字段[Forward名称]的长度不能超过50!");
}
if (!Object.Equals(null, objActionForwardEN.ForwardPath) && GetStrLen(objActionForwardEN.ForwardPath) > 50)
{
 throw new Exception("字段[Forward路径]的长度不能超过50!");
}
...
{
if (lngActionForwardId == 0) return null;
string strAction = "GetObjByActionForwardId";
clsActionForwardEN objActionForwardEN;
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["lngActionForwardId"] = lngActionForwardId.ToString(),
};
try
{
...
objActionForwardEN = JsonConvert.DeserializeObject<clsActionForwardEN>(strJson);
return objActionForwardEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsActionForwardEN GetFirstObj(string strWhereCond)
{
...
from objActionForwardEN in arrActionForwardObjLstCache
where objActionForwardEN.ActionForwardId == lngActionForwardId 
select objActionForwardEN;
if (arrActionForwardObjLst_Sel.Count() == 0)
{
   clsActionForwardEN obj = clsActionForwardWApi.GetObjByActionForwardId(lngActionForwardId);
   if (obj != null)
 {
...
{
 List<clsActionForwardEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsActionForwardEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// </summary>
 /// <param name = "arrActionForwardId">关键字列表</param>
 /// <returns>返回对象列表</returns>
public static List<clsActionForwardEN> GetObjLstByActionForwardIdLst(List<long> arrActionForwardId)
{
 List<clsActionForwardEN> arrObjLst; 
string strAction = "GetObjLstByActionForwardIdLst";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrActionForwardId);
...
throw new Exception(strMsg);
 ...
 /// </summary>
 /// <param name = "arrActionForwardId">所给的关键字列表</param>
 /// <returns>根据关键字列表获取的对象</returns>
public static IEnumerable<clsActionForwardEN> GetObjLstByActionForwardIdLstCache(List<long> arrActionForwardId)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsActionForwardEN._CurrTabName);
List<clsActionForwardEN> arrActionForwardObjLstCache = GetObjLstCache();
IEnumerable <clsActionForwardEN> arrActionForwardObjLst_Sel =
from objActionForwardEN in arrActionForwardObjLstCache
where arrActionForwardId.Contains(objActionForwardEN.ActionForwardId)
select objActionForwardEN;
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsActionForwardEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsActionForwardEN> arrObjLst; 
...
try
{
 clsActionForwardEN objActionForwardEN = clsActionForwardWApi.GetObjByActionForwardId(lngActionForwardId);
if (clsPubFun4WApi.Delete(mstrApiControllerName, strAction, lngActionForwardId.ToString(), out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelActionForwards(List<string> arrActionForwardId)
{
string strAction = "DelActionForwards";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrActionForwardId);
...
{
string strAction = "DelActionForwardsByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsActionForwardEN objActionForwardEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJson = clsJSON.GetJsonFromObj<clsActionForwardEN>(objActionForwardEN);
if (clsPubFun4WApi.Post(mstrApiControllerName, strAction, dictParam, strJson, out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <param name = "objActionForwardEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
public static string AddNewRecordWithReturnKey(clsActionForwardEN objActionForwardEN)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsActionForwardEN objActionForwardEN)
{
if (string.IsNullOrEmpty(objActionForwardEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objActionForwardEN.ActionForwardId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsActionForwardEN objActionForwardEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objActionForwardEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsActionForwardEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsActionForwardEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsActionForwardEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsActionForwardEN._AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsActionForwardEN objInFor in arrObj)
{
//Rows
...
if (clsActionForwardWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsActionForwardEN._CurrTabName);
CacheHelper.Remove(strKey);
clsActionForwardWApi.objCommFun4WApi.ReFreshCache();
}
}
...
var strKey = clsActionForwardEN._CurrTabName;
List<clsActionForwardEN> arrActionForwardObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
...
public static DataTable GetDataTableByObjLst(List<clsActionForwardEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conActionForward.ActionForwardId, Type.GetType("System.Int64"));
objDT.Columns.Add(conActionForward.ActionId, Type.GetType("System.String"));
objDT.Columns.Add(conActionForward.ForwardName, Type.GetType("System.String"));
objDT.Columns.Add(conActionForward.ForwardPath, Type.GetType("System.String"));
foreach (clsActionForwardEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conActionForward.ActionForwardId] = objInFor[conActionForward.ActionForwardId];
objDR[conActionForward.ActionId] = objInFor[conActionForward.ActionId];
objDR[conActionForward.ForwardName] = objInFor[conActionForward.ForwardName];
objDR[conActionForward.ForwardPath] = objInFor[conActionForward.ForwardPath];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4ActionForward : clsCommFun4BL
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsActionForwardWApi.ReFreshThisCache();
}
}
