...
/// 静态类
/// </summary>
public static class  clsDepartmentInfoWApi_Static
{
...
try
{
objDepartmentInfoEN.sfUpdFldSetStr = objDepartmentInfoEN.getsfUpdFldSetStr();
...
clsStackTrace.GetCurrClassFunction()); 
 ...
 if (clsDepartmentInfoWApi.IsExist(objDepartmentInfoEN.DepartmentId) == true)
 {
...
throw new Exception(strMsg); 
 ...
 /// <param name = "objDepartmentInfoEN">需要添加的实体对象</param>
 /// <returns>如果插入成功则返回TRUE,否则为FALSE</returns>
public static string AddNewRecordWithMaxId(this clsDepartmentInfoEN objDepartmentInfoEN)
{
try
{
clsDepartmentInfoWApi.CheckPropertyNew(objDepartmentInfoEN); 
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsDepartmentInfoWApi
{
private static readonly string mstrApiControllerName = "DepartmentInfoApi";
...
List<clsDepartmentInfoEN> arrObjLst = GetObjLst("1=1");
...
List<clsDepartmentInfoEN> arrObjLst = clsDepartmentInfoWApi.GetObjLst(strCondition);
//初始化一个对象列表
...
{
if (!Object.Equals(null, objDepartmentInfoEN.DepartmentId) && GetStrLen(objDepartmentInfoEN.DepartmentId) > 6)
{
 throw new Exception("字段[部门ID]的长度不能超过6!");
}
if (!Object.Equals(null, objDepartmentInfoEN.DepartmentName) && GetStrLen(objDepartmentInfoEN.DepartmentName) > 30)
{
 throw new Exception("字段[部门名称]的长度不能超过30!");
}
if (!Object.Equals(null, objDepartmentInfoEN.DepartmentAbbrName) && GetStrLen(objDepartmentInfoEN.DepartmentAbbrName) > 8)
{
 throw new Exception("字段[部门简称]的长度不能超过8!");
}
...
{
 throw new Exception("字段[上级部门Id]的长度不能超过6!");
}
...
{
if (strDepartmentId == "") return null;
string strAction = "GetObjByDepartmentId";
clsDepartmentInfoEN objDepartmentInfoEN;
...
objDepartmentInfoEN = JsonConvert.DeserializeObject<clsDepartmentInfoEN>(strJson);
return objDepartmentInfoEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsDepartmentInfoEN GetFirstObj(string strWhereCond)
{
...
{
 List<clsDepartmentInfoEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsDepartmentInfoEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsDepartmentInfoEN> GetObjLstByDepartmentIdLst(List<string> arrDepartmentId)
{
 List<clsDepartmentInfoEN> arrObjLst; 
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsDepartmentInfoEN> GetObjLstByRange(stuRangePara objRangePara)
{
 List<clsDepartmentInfoEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsDepartmentInfoEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsDepartmentInfoEN> arrObjLst; 
...
try
{
 clsDepartmentInfoEN objDepartmentInfoEN = clsDepartmentInfoWApi.GetObjByDepartmentId(strDepartmentId);
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelDepartmentInfos(List<string> arrDepartmentId)
{
string strAction = "DelDepartmentInfos";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrDepartmentId);
...
{
string strAction = "DelDepartmentInfosByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsDepartmentInfoEN objDepartmentInfoEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJson = clsJSON.GetJsonFromObj<clsDepartmentInfoEN>(objDepartmentInfoEN);
if (clsPubFun4WApi.Post(mstrApiControllerName, strAction, dictParam, strJson, out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
...
public static string AddNewRecordWithMaxId(clsDepartmentInfoEN objDepartmentInfoEN)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsDepartmentInfoEN objDepartmentInfoEN)
{
if (string.IsNullOrEmpty(objDepartmentInfoEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objDepartmentInfoEN.DepartmentId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsDepartmentInfoEN objDepartmentInfoEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objDepartmentInfoEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsDepartmentInfoEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsDepartmentInfoEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsDepartmentInfoEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsDepartmentInfoEN._AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsDepartmentInfoEN objInFor in arrObj)
{
//Rows
...
public static DataTable GetDataTableByObjLst(List<clsDepartmentInfoEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conDepartmentInfo.DepartmentId, Type.GetType("System.String"));
objDT.Columns.Add(conDepartmentInfo.DepartmentName, Type.GetType("System.String"));
objDT.Columns.Add(conDepartmentInfo.DepartmentAbbrName, Type.GetType("System.String"));
objDT.Columns.Add(conDepartmentInfo.DepartmentTypeId, Type.GetType("System.String"));
objDT.Columns.Add(conDepartmentInfo.UpDepartmentId, Type.GetType("System.String"));
objDT.Columns.Add(conDepartmentInfo.InUse, Type.GetType("System.Boolean"));
objDT.Columns.Add(conDepartmentInfo.OrderNum, Type.GetType("System.Int32"));
objDT.Columns.Add(conDepartmentInfo.Memo, Type.GetType("System.String"));
foreach (clsDepartmentInfoEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conDepartmentInfo.DepartmentId] = objInFor[conDepartmentInfo.DepartmentId];
objDR[conDepartmentInfo.DepartmentName] = objInFor[conDepartmentInfo.DepartmentName];
objDR[conDepartmentInfo.DepartmentAbbrName] = objInFor[conDepartmentInfo.DepartmentAbbrName];
objDR[conDepartmentInfo.DepartmentTypeId] = objInFor[conDepartmentInfo.DepartmentTypeId];
objDR[conDepartmentInfo.UpDepartmentId] = objInFor[conDepartmentInfo.UpDepartmentId];
objDR[conDepartmentInfo.InUse] = objInFor[conDepartmentInfo.InUse];
objDR[conDepartmentInfo.OrderNum] = objInFor[conDepartmentInfo.OrderNum];
objDR[conDepartmentInfo.Memo] = objInFor[conDepartmentInfo.Memo];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4DepartmentInfo : clsCommFun4BL
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsDepartmentInfoWApi.ReFreshThisCache();
}
}
