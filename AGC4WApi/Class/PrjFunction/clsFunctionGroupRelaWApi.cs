...
/// 静态类
/// </summary>
public static class  clsFunctionGroupRelaWApi_Static
{
...
try
{
objFunctionGroupRelaEN.sfUpdFldSetStr = objFunctionGroupRelaEN.getsfUpdFldSetStr();
clsFunctionGroupRelaWApi.CheckPropertyNew(objFunctionGroupRelaEN); 
bool bolResult = clsFunctionGroupRelaWApi.UpdateRecord(objFunctionGroupRelaEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFunctionGroupRelaWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsFunctionGroupRelaEN objFunctionGroupRelaEN)
{
//检测记录是否存在
...
public static bool AddNewRecord(this clsFunctionGroupRelaEN objFunctionGroupRelaEN)
{
try
{
clsFunctionGroupRelaWApi.CheckPropertyNew(objFunctionGroupRelaEN); 
bool bolResult = clsFunctionGroupRelaWApi.AddNewRecord(objFunctionGroupRelaEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFunctionGroupRelaWApi.ReFreshCache();
return bolResult;
}
...
{
clsFunctionGroupRelaWApi.CheckPropertyNew(objFunctionGroupRelaEN); 
bool bolResult = clsFunctionGroupRelaWApi.UpdateWithCondition(objFunctionGroupRelaEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFunctionGroupRelaWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsFunctionGroupRelaWApi
{
private static readonly string mstrApiControllerName = "FunctionGroupRelaApi";
...
public static clsCommFun4BL objCommFun4WApi = null;
 ...
 public clsFunctionGroupRelaWApi()
 {
 }
...
{
if (!Object.Equals(null, objFunctionGroupRelaEN.FunctionGroupId) && GetStrLen(objFunctionGroupRelaEN.FunctionGroupId) > 4)
{
 throw new Exception("字段[函数组Id]的长度不能超过4!");
}
if (!Object.Equals(null, objFunctionGroupRelaEN.FuncId4GC) && GetStrLen(objFunctionGroupRelaEN.FuncId4GC) > 10)
{
 throw new Exception("字段[函数ID]的长度不能超过10!");
}
if (!Object.Equals(null, objFunctionGroupRelaEN.UpdDate) && GetStrLen(objFunctionGroupRelaEN.UpdDate) > 20)
{
 throw new Exception("字段[修改日期]的长度不能超过20!");
}
if (!Object.Equals(null, objFunctionGroupRelaEN.UpdUser) && GetStrLen(objFunctionGroupRelaEN.UpdUser) > 20)
{
 throw new Exception("字段[修改者]的长度不能超过20!");
}
if (!Object.Equals(null, objFunctionGroupRelaEN.Memo) && GetStrLen(objFunctionGroupRelaEN.Memo) > 1000)
{
...
clsFunctionGroupRelaEN objFunctionGroupRelaEN;
...
objFunctionGroupRelaEN = JsonConvert.DeserializeObject<clsFunctionGroupRelaEN>(strJson);
return objFunctionGroupRelaEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsFunctionGroupRelaEN GetFirstObj(string strWhereCond)
{
...
from objFunctionGroupRelaEN in arrFunctionGroupRelaObjLstCache
where objFunctionGroupRelaEN.mId == lngmId 
select objFunctionGroupRelaEN;
if (arrFunctionGroupRelaObjLst_Sel.Count() == 0)
{
   clsFunctionGroupRelaEN obj = clsFunctionGroupRelaWApi.GetObjBymId(lngmId);
   if (obj != null)
 {
...
{
 List<clsFunctionGroupRelaEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsFunctionGroupRelaEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsFunctionGroupRelaEN> GetObjLstByMIdLst(List<long> arrMId)
{
 List<clsFunctionGroupRelaEN> arrObjLst; 
...
public static IEnumerable<clsFunctionGroupRelaEN> GetObjLstByMIdLstCache(List<long> arrMId)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsFunctionGroupRelaEN._CurrTabName);
List<clsFunctionGroupRelaEN> arrFunctionGroupRelaObjLstCache = GetObjLstCache();
IEnumerable <clsFunctionGroupRelaEN> arrFunctionGroupRelaObjLst_Sel =
from objFunctionGroupRelaEN in arrFunctionGroupRelaObjLstCache
where arrMId.Contains(objFunctionGroupRelaEN.mId)
select objFunctionGroupRelaEN;
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsFunctionGroupRelaEN> GetObjLstByRange(stuRangePara objRangePara)
{
 List<clsFunctionGroupRelaEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsFunctionGroupRelaEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsFunctionGroupRelaEN> arrObjLst; 
...
try
{
 clsFunctionGroupRelaEN objFunctionGroupRelaEN = clsFunctionGroupRelaWApi.GetObjBymId(lngmId);
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelFunctionGroupRelas(List<string> arrmId)
{
string strAction = "DelFunctionGroupRelas";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrmId);
...
{
string strAction = "DelFunctionGroupRelasByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsFunctionGroupRelaEN objFunctionGroupRelaEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJson = clsJSON.GetJsonFromObj<clsFunctionGroupRelaEN>(objFunctionGroupRelaEN);
if (clsPubFun4WApi.Post(mstrApiControllerName, strAction, dictParam, strJson, out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <param name = "objFunctionGroupRelaEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
public static string AddNewRecordWithReturnKey(clsFunctionGroupRelaEN objFunctionGroupRelaEN)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsFunctionGroupRelaEN objFunctionGroupRelaEN)
{
if (string.IsNullOrEmpty(objFunctionGroupRelaEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objFunctionGroupRelaEN.mId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsFunctionGroupRelaEN objFunctionGroupRelaEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objFunctionGroupRelaEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsFunctionGroupRelaEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsFunctionGroupRelaEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsFunctionGroupRelaEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsFunctionGroupRelaEN._AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsFunctionGroupRelaEN objInFor in arrObj)
{
//Rows
...
if (clsFunctionGroupRelaWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsFunctionGroupRelaEN._CurrTabName);
CacheHelper.Remove(strKey);
clsFunctionGroupRelaWApi.objCommFun4WApi.ReFreshCache();
}
}
...
var strKey = clsFunctionGroupRelaEN._CurrTabName;
List<clsFunctionGroupRelaEN> arrFunctionGroupRelaObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
...
public static DataTable GetDataTableByObjLst(List<clsFunctionGroupRelaEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conFunctionGroupRela.mId, Type.GetType("System.Int64"));
objDT.Columns.Add(conFunctionGroupRela.FunctionGroupId, Type.GetType("System.String"));
objDT.Columns.Add(conFunctionGroupRela.FuncId4GC, Type.GetType("System.String"));
objDT.Columns.Add(conFunctionGroupRela.UpdDate, Type.GetType("System.String"));
objDT.Columns.Add(conFunctionGroupRela.UpdUser, Type.GetType("System.String"));
objDT.Columns.Add(conFunctionGroupRela.Memo, Type.GetType("System.String"));
foreach (clsFunctionGroupRelaEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conFunctionGroupRela.mId] = objInFor[conFunctionGroupRela.mId];
objDR[conFunctionGroupRela.FunctionGroupId] = objInFor[conFunctionGroupRela.FunctionGroupId];
objDR[conFunctionGroupRela.FuncId4GC] = objInFor[conFunctionGroupRela.FuncId4GC];
objDR[conFunctionGroupRela.UpdDate] = objInFor[conFunctionGroupRela.UpdDate];
objDR[conFunctionGroupRela.UpdUser] = objInFor[conFunctionGroupRela.UpdUser];
objDR[conFunctionGroupRela.Memo] = objInFor[conFunctionGroupRela.Memo];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4FunctionGroupRela : clsCommFun4BL
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFunctionGroupRelaWApi.ReFreshThisCache();
}
}
