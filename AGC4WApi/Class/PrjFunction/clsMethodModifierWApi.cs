...
/// 静态类
/// </summary>
public static class  clsMethodModifierWApi_Static
{
...
try
{
objMethodModifierEN.sfUpdFldSetStr = objMethodModifierEN.getsfUpdFldSetStr();
clsMethodModifierWApi.CheckPropertyNew(objMethodModifierEN); 
bool bolResult = clsMethodModifierWApi.UpdateRecord(objMethodModifierEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsMethodModifierWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsMethodModifierEN objMethodModifierEN)
{
//检测记录是否存在
...
public static bool AddNewRecord(this clsMethodModifierEN objMethodModifierEN)
{
try
{
 if (string.IsNullOrEmpty(objMethodModifierEN.MethodModifierId) == true || clsMethodModifierWApi.IsExist(objMethodModifierEN.MethodModifierId) == true)
 {
     objMethodModifierEN.MethodModifierId = clsMethodModifierWApi.GetMaxStrId();
 }
clsMethodModifierWApi.CheckPropertyNew(objMethodModifierEN); 
bool bolResult = clsMethodModifierWApi.AddNewRecord(objMethodModifierEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsMethodModifierWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// <param name = "objMethodModifierEN">需要添加的实体对象</param>
 /// <returns>如果插入成功则返回TRUE,否则为FALSE</returns>
public static string AddNewRecordWithMaxId(this clsMethodModifierEN objMethodModifierEN)
{
try
{
clsMethodModifierWApi.CheckPropertyNew(objMethodModifierEN); 
string strMethodModifierId = clsMethodModifierWApi.AddNewRecordWithMaxId(objMethodModifierEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsMethodModifierWApi.ReFreshCache();
...
{
clsMethodModifierWApi.CheckPropertyNew(objMethodModifierEN); 
bool bolResult = clsMethodModifierWApi.UpdateWithCondition(objMethodModifierEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsMethodModifierWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsMethodModifierWApi
{
private static readonly string mstrApiControllerName = "MethodModifierApi";
...
List<clsMethodModifierEN> arrObjLst = GetObjLst("1=1");
objDDL.DataValueField="MethodModifierId";
objDDL.DataTextField="MethodModifierName";
...
List<clsMethodModifierEN> arrObjLst = clsMethodModifierWApi.GetObjLst(strCondition).OrderBy(x=>x.OrderNum).ToList();
//初始化一个对象列表
...
{
if (!Object.Equals(null, objMethodModifierEN.MethodModifierId) && GetStrLen(objMethodModifierEN.MethodModifierId) > 2)
{
 throw new Exception("字段[函数修饰语Id]的长度不能超过2!");
}
if (!Object.Equals(null, objMethodModifierEN.MethodModifierName) && GetStrLen(objMethodModifierEN.MethodModifierName) > 50)
{
 throw new Exception("字段[函数修饰语名称]的长度不能超过50!");
}
if (!Object.Equals(null, objMethodModifierEN.Memo) && GetStrLen(objMethodModifierEN.Memo) > 1000)
{
...
{
if (strMethodModifierId == "") return null;
string strAction = "GetObjByMethodModifierId";
clsMethodModifierEN objMethodModifierEN;
...
objMethodModifierEN = JsonConvert.DeserializeObject<clsMethodModifierEN>(strJson);
return objMethodModifierEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsMethodModifierEN GetFirstObj(string strWhereCond)
{
...
{
if (string.IsNullOrEmpty(strMethodModifierId) == true) return null;
//初始化列表缓存
...
from objMethodModifierEN in arrMethodModifierObjLstCache
where objMethodModifierEN.MethodModifierId == strMethodModifierId 
select objMethodModifierEN;
if (arrMethodModifierObjLst_Sel.Count() == 0)
{
   clsMethodModifierEN obj = clsMethodModifierWApi.GetObjByMethodModifierId(strMethodModifierId);
   if (obj != null)
 {
...
//初始化列表缓存
List<clsMethodModifierEN> arrMethodModifierObjLstCache = GetObjLstCache();
IEnumerable <clsMethodModifierEN> arrMethodModifierObjLst_Sel1 =
from objMethodModifierEN in arrMethodModifierObjLstCache
where objMethodModifierEN.MethodModifierId == strMethodModifierId 
select objMethodModifierEN;
List <clsMethodModifierEN> arrMethodModifierObjLst_Sel = new List<clsMethodModifierEN>();
foreach (clsMethodModifierEN obj in arrMethodModifierObjLst_Sel1)
{
arrMethodModifierObjLst_Sel.Add(obj);
}
if (arrMethodModifierObjLst_Sel.Count > 0)
{
return arrMethodModifierObjLst_Sel[0].MethodModifierName;
}
string strErrMsgForGetObjById = string.Format("在MethodModifier对象缓存列表中,找不到记录[MethodModifierId = {0}](函数:{1})", strMethodModifierId, clsStackTrace.GetCurrFunction());
clsLog.LogErrorS2("clsMethodModifierBL", clsStackTrace.GetCurrClassFunction(), strErrMsgForGetObjById, "", "");
...
string strErrMsgForGetObjById = string.Format("在MethodModifier对象缓存列表中,找不到记录的相关名称[MethodModifierId = {0}](函数:{1})", strMethodModifierId, clsStackTrace.GetCurrFunction());
clsLog.LogErrorS2("clsMethodModifierBL", clsStackTrace.GetCurrClassFunction(), strErrMsgForGetObjById, "", "");
throw new Exception(strErrMsgForGetObjById);
}
...
{
 List<clsMethodModifierEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsMethodModifierEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// </summary>
 /// <param name = "arrMethodModifierId">关键字列表</param>
 /// <returns>返回对象列表</returns>
public static List<clsMethodModifierEN> GetObjLstByMethodModifierIdLst(List<string> arrMethodModifierId)
{
 List<clsMethodModifierEN> arrObjLst; 
string strAction = "GetObjLstByMethodModifierIdLst";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrMethodModifierId);
...
throw new Exception(strMsg);
 ...
 /// </summary>
 /// <param name = "arrMethodModifierId">所给的关键字列表</param>
 /// <returns>根据关键字列表获取的对象</returns>
public static IEnumerable<clsMethodModifierEN> GetObjLstByMethodModifierIdLstCache(List<string> arrMethodModifierId)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsMethodModifierEN._CurrTabName);
List<clsMethodModifierEN> arrMethodModifierObjLstCache = GetObjLstCache();
IEnumerable <clsMethodModifierEN> arrMethodModifierObjLst_Sel =
from objMethodModifierEN in arrMethodModifierObjLstCache
where arrMethodModifierId.Contains(objMethodModifierEN.MethodModifierId)
select objMethodModifierEN;
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsMethodModifierEN> GetObjLstByRange(stuRangePara objRangePara)
{
 List<clsMethodModifierEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsMethodModifierEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsMethodModifierEN> arrObjLst; 
...
try
{
 clsMethodModifierEN objMethodModifierEN = clsMethodModifierWApi.GetObjByMethodModifierId(strMethodModifierId);
if (clsPubFun4WApi.Delete(mstrApiControllerName, strAction, strMethodModifierId.ToString(), out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelMethodModifiers(List<string> arrMethodModifierId)
{
string strAction = "DelMethodModifiers";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrMethodModifierId);
...
{
string strAction = "DelMethodModifiersByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsMethodModifierEN objMethodModifierEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJson = clsJSON.GetJsonFromObj<clsMethodModifierEN>(objMethodModifierEN);
if (clsPubFun4WApi.Post(mstrApiControllerName, strAction, dictParam, strJson, out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
...
public static string AddNewRecordWithMaxId(clsMethodModifierEN objMethodModifierEN)
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsMethodModifierWApi.ReFreshCache();
var strMethodModifierId = (string)jobjReturn0["returnStr"];
return strMethodModifierId;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsMethodModifierEN objMethodModifierEN)
{
if (string.IsNullOrEmpty(objMethodModifierEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objMethodModifierEN.MethodModifierId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsMethodModifierEN objMethodModifierEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objMethodModifierEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsMethodModifierEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsMethodModifierEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsMethodModifierEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsMethodModifierEN._AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsMethodModifierEN objInFor in arrObj)
{
//Rows
...
if (clsMethodModifierWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsMethodModifierEN._CurrTabName);
CacheHelper.Remove(strKey);
clsMethodModifierWApi.objCommFun4WApi.ReFreshCache();
}
}
...
var strKey = clsMethodModifierEN._CurrTabName;
List<clsMethodModifierEN> arrMethodModifierObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
...
public static DataTable GetDataTableByObjLst(List<clsMethodModifierEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conMethodModifier.MethodModifierId, Type.GetType("System.String"));
objDT.Columns.Add(conMethodModifier.MethodModifierName, Type.GetType("System.String"));
objDT.Columns.Add(conMethodModifier.OrderNum, Type.GetType("System.Int32"));
objDT.Columns.Add(conMethodModifier.Memo, Type.GetType("System.String"));
foreach (clsMethodModifierEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conMethodModifier.MethodModifierId] = objInFor[conMethodModifier.MethodModifierId];
objDR[conMethodModifier.MethodModifierName] = objInFor[conMethodModifier.MethodModifierName];
objDR[conMethodModifier.OrderNum] = objInFor[conMethodModifier.OrderNum];
objDR[conMethodModifier.Memo] = objInFor[conMethodModifier.Memo];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4MethodModifier : clsCommFun4BL
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsMethodModifierWApi.ReFreshThisCache();
}
}
