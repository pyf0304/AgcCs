...
/// 静态类
/// </summary>
public static class  clsFunctionTemplateRelaWApi_Static
{
...
try
{
objFunctionTemplateRelaEN.sfUpdFldSetStr = objFunctionTemplateRelaEN.getsfUpdFldSetStr();
clsFunctionTemplateRelaWApi.CheckPropertyNew(objFunctionTemplateRelaEN); 
bool bolResult = clsFunctionTemplateRelaWApi.UpdateRecord(objFunctionTemplateRelaEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFunctionTemplateRelaWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsFunctionTemplateRelaEN objFunctionTemplateRelaEN)
{
//检测记录是否存在
...
public static bool AddNewRecord(this clsFunctionTemplateRelaEN objFunctionTemplateRelaEN)
{
try
{
clsFunctionTemplateRelaWApi.CheckPropertyNew(objFunctionTemplateRelaEN); 
bool bolResult = clsFunctionTemplateRelaWApi.AddNewRecord(objFunctionTemplateRelaEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFunctionTemplateRelaWApi.ReFreshCache();
return bolResult;
}
...
{
clsFunctionTemplateRelaWApi.CheckPropertyNew(objFunctionTemplateRelaEN); 
bool bolResult = clsFunctionTemplateRelaWApi.UpdateWithCondition(objFunctionTemplateRelaEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFunctionTemplateRelaWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsFunctionTemplateRelaWApi
{
private static readonly string mstrApiControllerName = "FunctionTemplateRelaApi";
...
public static clsCommFun4BL objCommFun4WApi = null;
 ...
 public clsFunctionTemplateRelaWApi()
 {
 }
...
{
if (!Object.Equals(null, objFunctionTemplateRelaEN.FunctionTemplateId) && GetStrLen(objFunctionTemplateRelaEN.FunctionTemplateId) > 4)
{
 throw new Exception("字段[函数模板Id]的长度不能超过4!");
}
if (!Object.Equals(null, objFunctionTemplateRelaEN.CodeTypeId) && GetStrLen(objFunctionTemplateRelaEN.CodeTypeId) > 4)
{
 throw new Exception("字段[代码类型Id]的长度不能超过4!");
}
if (!Object.Equals(null, objFunctionTemplateRelaEN.RegionTypeId) && GetStrLen(objFunctionTemplateRelaEN.RegionTypeId) > 4)
{
 throw new Exception("字段[区域类型Id]的长度不能超过4!");
}
if (!Object.Equals(null, objFunctionTemplateRelaEN.FuncCodeTypeId) && GetStrLen(objFunctionTemplateRelaEN.FuncCodeTypeId) > 4)
{
 throw new Exception("字段[函数代码类型Id]的长度不能超过4!");
}
if (!Object.Equals(null, objFunctionTemplateRelaEN.FuncId4GC) && GetStrLen(objFunctionTemplateRelaEN.FuncId4GC) > 10)
{
 throw new Exception("字段[函数ID]的长度不能超过10!");
}
if (!Object.Equals(null, objFunctionTemplateRelaEN.UpdDate) && GetStrLen(objFunctionTemplateRelaEN.UpdDate) > 20)
{
 throw new Exception("字段[修改日期]的长度不能超过20!");
}
if (!Object.Equals(null, objFunctionTemplateRelaEN.UpdUser) && GetStrLen(objFunctionTemplateRelaEN.UpdUser) > 20)
{
 throw new Exception("字段[修改者]的长度不能超过20!");
}
if (!Object.Equals(null, objFunctionTemplateRelaEN.Memo) && GetStrLen(objFunctionTemplateRelaEN.Memo) > 1000)
{
...
objFunctionTemplateRelaEN = JsonConvert.DeserializeObject<clsFunctionTemplateRelaEN>(strJson);
return objFunctionTemplateRelaEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsFunctionTemplateRelaEN GetFirstObj(string strWhereCond)
{
...
public static clsFunctionTemplateRelaEN GetObjBymIdCache(long lngmId,string strFunctionTemplateId)
{
//初始化列表缓存
...
from objFunctionTemplateRelaEN in arrFunctionTemplateRelaObjLstCache
where objFunctionTemplateRelaEN.mId == lngmId 
select objFunctionTemplateRelaEN;
if (arrFunctionTemplateRelaObjLst_Sel.Count() == 0)
{
   clsFunctionTemplateRelaEN obj = clsFunctionTemplateRelaWApi.GetObjBymId(lngmId);
   if (obj != null)
 {
...
{
 List<clsFunctionTemplateRelaEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsFunctionTemplateRelaEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsFunctionTemplateRelaEN> GetObjLstByMIdLst(List<long> arrMId)
{
 List<clsFunctionTemplateRelaEN> arrObjLst; 
...
public static IEnumerable<clsFunctionTemplateRelaEN> GetObjLstByMIdLstCache(List<long> arrMId)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsFunctionTemplateRelaEN._CurrTabName);
List<clsFunctionTemplateRelaEN> arrFunctionTemplateRelaObjLstCache = GetObjLstCache();
IEnumerable <clsFunctionTemplateRelaEN> arrFunctionTemplateRelaObjLst_Sel =
from objFunctionTemplateRelaEN in arrFunctionTemplateRelaObjLstCache
where arrMId.Contains(objFunctionTemplateRelaEN.mId)
select objFunctionTemplateRelaEN;
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsFunctionTemplateRelaEN> GetObjLstByRange(stuRangePara objRangePara)
{
 List<clsFunctionTemplateRelaEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsFunctionTemplateRelaEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsFunctionTemplateRelaEN> arrObjLst; 
...
try
{
 clsFunctionTemplateRelaEN objFunctionTemplateRelaEN = clsFunctionTemplateRelaWApi.GetObjBymId(lngmId);
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelFunctionTemplateRelas(List<string> arrmId)
{
string strAction = "DelFunctionTemplateRelas";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrmId);
...
{
string strAction = "DelFunctionTemplateRelasByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsFunctionTemplateRelaEN objFunctionTemplateRelaEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJson = clsJSON.GetJsonFromObj<clsFunctionTemplateRelaEN>(objFunctionTemplateRelaEN);
if (clsPubFun4WApi.Post(mstrApiControllerName, strAction, dictParam, strJson, out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <param name = "objFunctionTemplateRelaEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
public static string AddNewRecordWithReturnKey(clsFunctionTemplateRelaEN objFunctionTemplateRelaEN)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsFunctionTemplateRelaEN objFunctionTemplateRelaEN)
{
if (string.IsNullOrEmpty(objFunctionTemplateRelaEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objFunctionTemplateRelaEN.mId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsFunctionTemplateRelaEN objFunctionTemplateRelaEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objFunctionTemplateRelaEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsFunctionTemplateRelaEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsFunctionTemplateRelaEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsFunctionTemplateRelaEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsFunctionTemplateRelaEN._AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsFunctionTemplateRelaEN objInFor in arrObj)
{
//Rows
...
if (clsFunctionTemplateRelaWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsFunctionTemplateRelaEN._CurrTabName);
CacheHelper.Remove(strKey);
clsFunctionTemplateRelaWApi.objCommFun4WApi.ReFreshCache();
}
}
...
public static List<clsFunctionTemplateRelaEN> GetObjLstCache(string strFunctionTemplateId)
{

//初始化列表缓存
var strWhereCond = "1=1";
var strKey = clsFunctionTemplateRelaEN._CurrTabName;
List<clsFunctionTemplateRelaEN> arrFunctionTemplateRelaObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
...
public static DataTable GetDataTableByObjLst(List<clsFunctionTemplateRelaEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conFunctionTemplateRela.mId, Type.GetType("System.Int64"));
objDT.Columns.Add(conFunctionTemplateRela.FunctionTemplateId, Type.GetType("System.String"));
objDT.Columns.Add(conFunctionTemplateRela.CodeTypeId, Type.GetType("System.String"));
objDT.Columns.Add(conFunctionTemplateRela.RegionTypeId, Type.GetType("System.String"));
objDT.Columns.Add(conFunctionTemplateRela.FuncCodeTypeId, Type.GetType("System.String"));
objDT.Columns.Add(conFunctionTemplateRela.FuncId4GC, Type.GetType("System.String"));
objDT.Columns.Add(conFunctionTemplateRela.IsGeneCode, Type.GetType("System.Boolean"));
objDT.Columns.Add(conFunctionTemplateRela.OrderNum, Type.GetType("System.Int32"));
objDT.Columns.Add(conFunctionTemplateRela.UpdDate, Type.GetType("System.String"));
objDT.Columns.Add(conFunctionTemplateRela.UpdUser, Type.GetType("System.String"));
objDT.Columns.Add(conFunctionTemplateRela.Memo, Type.GetType("System.String"));
foreach (clsFunctionTemplateRelaEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conFunctionTemplateRela.mId] = objInFor[conFunctionTemplateRela.mId];
objDR[conFunctionTemplateRela.FunctionTemplateId] = objInFor[conFunctionTemplateRela.FunctionTemplateId];
objDR[conFunctionTemplateRela.CodeTypeId] = objInFor[conFunctionTemplateRela.CodeTypeId];
objDR[conFunctionTemplateRela.RegionTypeId] = objInFor[conFunctionTemplateRela.RegionTypeId];
objDR[conFunctionTemplateRela.FuncCodeTypeId] = objInFor[conFunctionTemplateRela.FuncCodeTypeId];
objDR[conFunctionTemplateRela.FuncId4GC] = objInFor[conFunctionTemplateRela.FuncId4GC];
objDR[conFunctionTemplateRela.IsGeneCode] = objInFor[conFunctionTemplateRela.IsGeneCode];
objDR[conFunctionTemplateRela.OrderNum] = objInFor[conFunctionTemplateRela.OrderNum];
objDR[conFunctionTemplateRela.UpdDate] = objInFor[conFunctionTemplateRela.UpdDate];
objDR[conFunctionTemplateRela.UpdUser] = objInFor[conFunctionTemplateRela.UpdUser];
objDR[conFunctionTemplateRela.Memo] = objInFor[conFunctionTemplateRela.Memo];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4FunctionTemplateRela : clsCommFun4BLV2
{
 ...
 /// </summary>
public override void ReFreshCache(string strFunctionTemplateId)
{
string strMsg;
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFunctionTemplateRelaWApi.ReFreshThisCache(strFunctionTemplateId);
}
}
