 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsPrjProcessWApi
 表名:PrjProcess(00050027)
 * 版本:2025.08.02.1(服务器:PYF-THINKPAD)
 日期:2025/08/09 21:41:08
 生成者:pyf
 生成服务器IP:
 工程名称:AGC(0005)
...
/// 静态类
/// </summary>
public static class  clsPrjProcessWApi_Static
{
 ...
 /// <param name = "strPrjProcessId">项目过程ID</param>
...
return objPrjProcessEN;
 ...
 /// </summary>
 /// <param name = "objPrjProcessEN">需要设置字段值的实体对象</param>
 /// <param name = "strPrjProcessName">项目过程名称</param>
 /// <param name = "strComparisonOp">比较运算符,如果有值,可用于组织条件串</param>
 /// <returns>返回对象,可以继续连写</returns>
...
return objPrjProcessEN;
 ...
 /// </summary>
 /// <param name = "objPrjProcessEN">需要设置字段值的实体对象</param>
 /// <param name = "bolIsViewRela">是否界面相关</param>
 /// <param name = "strComparisonOp">比较运算符,如果有值,可用于组织条件串</param>
 /// <returns>返回对象,可以继续连写</returns>
...
try
{
objPrjProcessEN.sfUpdFldSetStr = objPrjProcessEN.getsfUpdFldSetStr();
clsPrjProcessWApi.CheckPropertyNew(objPrjProcessEN); 
bool bolResult = clsPrjProcessWApi.UpdateRecord(objPrjProcessEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsPrjProcessWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsPrjProcessEN objPrjProcessEN)
{
//检测记录是否存在
...
public static bool AddNewRecord(this clsPrjProcessEN objPrjProcessEN)
{
try
{
 if (string.IsNullOrEmpty(objPrjProcessEN.PrjProcessId) == true || clsPrjProcessWApi.IsExist(objPrjProcessEN.PrjProcessId) == true)
 {
     objPrjProcessEN.PrjProcessId = clsPrjProcessWApi.GetMaxStrId();
 }
clsPrjProcessWApi.CheckPropertyNew(objPrjProcessEN); 
bool bolResult = clsPrjProcessWApi.AddNewRecord(objPrjProcessEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsPrjProcessWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// <param name = "objPrjProcessEN">需要添加的实体对象</param>
 /// <returns>如果插入成功则返回TRUE,否则为FALSE</returns>
public static string AddNewRecordWithMaxId(this clsPrjProcessEN objPrjProcessEN)
{
try
{
clsPrjProcessWApi.CheckPropertyNew(objPrjProcessEN); 
string strPrjProcessId = clsPrjProcessWApi.AddNewRecordWithMaxId(objPrjProcessEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsPrjProcessWApi.ReFreshCache();
...
{
clsPrjProcessWApi.CheckPropertyNew(objPrjProcessEN); 
bool bolResult = clsPrjProcessWApi.UpdateWithCondition(objPrjProcessEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsPrjProcessWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsPrjProcessWApi
{
private static readonly string mstrApiControllerName = "PrjProcessApi";
...
{
if (!Object.Equals(null, objPrjProcessEN.PrjProcessId) && GetStrLen(objPrjProcessEN.PrjProcessId) > 4)
{
 throw new Exception("字段[项目过程ID]的长度不能超过4!");
}
if (!Object.Equals(null, objPrjProcessEN.PrjProcessName) && GetStrLen(objPrjProcessEN.PrjProcessName) > 30)
{
 throw new Exception("字段[项目过程名称]的长度不能超过30!");
}
if (!Object.Equals(null, objPrjProcessEN.PrjProcessTypeId) && GetStrLen(objPrjProcessEN.PrjProcessTypeId) > 2)
{
 throw new Exception("字段[项目过程分类ID]的长度不能超过2!");
}
if (!Object.Equals(null, objPrjProcessEN.Memo) && GetStrLen(objPrjProcessEN.Memo) > 1000)
{
...
{
if (strPrjProcessId == "") return null;
string strAction = "GetObjByPrjProcessId";
clsPrjProcessEN objPrjProcessEN;
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strPrjProcessId"] = strPrjProcessId,
};
try
{
...
objPrjProcessEN = JsonConvert.DeserializeObject<clsPrjProcessEN>(strJson);
return objPrjProcessEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsPrjProcessEN GetFirstObj(string strWhereCond)
{
...
{
if (string.IsNullOrEmpty(strPrjProcessId) == true) return null;
//初始化列表缓存
...
from objPrjProcessEN in arrPrjProcessObjLstCache
where objPrjProcessEN.PrjProcessId == strPrjProcessId 
select objPrjProcessEN;
if (arrPrjProcessObjLst_Sel.Count() == 0)
{
   clsPrjProcessEN obj = clsPrjProcessWApi.GetObjByPrjProcessId(strPrjProcessId);
   if (obj != null)
 {
...
{
 List<clsPrjProcessEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsPrjProcessEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// </summary>
 /// <param name = "arrPrjProcessId">关键字列表</param>
 /// <returns>返回对象列表</returns>
public static List<clsPrjProcessEN> GetObjLstByPrjProcessIdLst(List<string> arrPrjProcessId)
{
 List<clsPrjProcessEN> arrObjLst; 
string strAction = "GetObjLstByPrjProcessIdLst";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrPrjProcessId);
...
throw new Exception(strMsg);
 ...
 /// </summary>
 /// <param name = "arrPrjProcessId">所给的关键字列表</param>
 /// <returns>根据关键字列表获取的对象</returns>
public static IEnumerable<clsPrjProcessEN> GetObjLstByPrjProcessIdLstCache(List<string> arrPrjProcessId)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsPrjProcessEN._CurrTabName);
List<clsPrjProcessEN> arrPrjProcessObjLstCache = GetObjLstCache();
IEnumerable <clsPrjProcessEN> arrPrjProcessObjLst_Sel =
from objPrjProcessEN in arrPrjProcessObjLstCache
where arrPrjProcessId.Contains(objPrjProcessEN.PrjProcessId)
select objPrjProcessEN;
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsPrjProcessEN> GetObjLstByRange(stuRangePara objRangePara)
{
 List<clsPrjProcessEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsPrjProcessEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsPrjProcessEN> arrObjLst; 
...
try
{
 clsPrjProcessEN objPrjProcessEN = clsPrjProcessWApi.GetObjByPrjProcessId(strPrjProcessId);
if (clsPubFun4WApi.Delete(mstrApiControllerName, strAction, strPrjProcessId.ToString(), out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelPrjProcesss(List<string> arrPrjProcessId)
{
string strAction = "DelPrjProcesss";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrPrjProcessId);
...
{
string strAction = "DelPrjProcesssByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsPrjProcessEN objPrjProcessEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJson = clsJSON.GetJsonFromObj<clsPrjProcessEN>(objPrjProcessEN);
if (clsPubFun4WApi.Post(mstrApiControllerName, strAction, dictParam, strJson, out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
...
public static string AddNewRecordWithMaxId(clsPrjProcessEN objPrjProcessEN)
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsPrjProcessWApi.ReFreshCache();
var strPrjProcessId = (string)jobjReturn0["returnStr"];
return strPrjProcessId;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsPrjProcessEN objPrjProcessEN)
{
if (string.IsNullOrEmpty(objPrjProcessEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objPrjProcessEN.PrjProcessId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsPrjProcessEN objPrjProcessEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objPrjProcessEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsPrjProcessEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsPrjProcessEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsPrjProcessEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsPrjProcessEN._AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsPrjProcessEN objInFor in arrObj)
{
//Rows
...
if (clsPrjProcessWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsPrjProcessEN._CurrTabName);
CacheHelper.Remove(strKey);
clsPrjProcessWApi.objCommFun4WApi.ReFreshCache();
}
}
...
var strKey = clsPrjProcessEN._CurrTabName;
List<clsPrjProcessEN> arrPrjProcessObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
...
public static DataTable GetDataTableByObjLst(List<clsPrjProcessEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conPrjProcess.PrjProcessId, Type.GetType("System.String"));
objDT.Columns.Add(conPrjProcess.PrjProcessName, Type.GetType("System.String"));
objDT.Columns.Add(conPrjProcess.PrjProcessTypeId, Type.GetType("System.String"));
objDT.Columns.Add(conPrjProcess.Memo, Type.GetType("System.String"));
objDT.Columns.Add(conPrjProcess.IsViewRela, Type.GetType("System.Boolean"));
foreach (clsPrjProcessEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conPrjProcess.PrjProcessId] = objInFor[conPrjProcess.PrjProcessId];
objDR[conPrjProcess.PrjProcessName] = objInFor[conPrjProcess.PrjProcessName];
objDR[conPrjProcess.PrjProcessTypeId] = objInFor[conPrjProcess.PrjProcessTypeId];
objDR[conPrjProcess.Memo] = objInFor[conPrjProcess.Memo];
objDR[conPrjProcess.IsViewRela] = objInFor[conPrjProcess.IsViewRela];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4PrjProcess : clsCommFun4BL
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsPrjProcessWApi.ReFreshThisCache();
}
}
