...
/// 静态类
/// </summary>
public static class  clsDataNodeDirectMapWApi_Static
{
...
clsDataNodeDirectMapWApi.CheckPropertyNew(objDataNodeDirectMapEN); 
bool bolResult = clsDataNodeDirectMapWApi.UpdateRecord(objDataNodeDirectMapEN);
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsDataNodeDirectMapEN objDataNodeDirectMapEN)
{
//检测记录是否存在
...
public static bool AddNewRecord(this clsDataNodeDirectMapEN objDataNodeDirectMapEN)
{
try
{
clsDataNodeDirectMapWApi.CheckPropertyNew(objDataNodeDirectMapEN); 
bool bolResult = clsDataNodeDirectMapWApi.AddNewRecord(objDataNodeDirectMapEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsDataNodeDirectMapWApi.ReFreshCache(objDataNodeDirectMapEN.PrjId);
return bolResult;
}
...
{
clsDataNodeDirectMapWApi.CheckPropertyNew(objDataNodeDirectMapEN); 
bool bolResult = clsDataNodeDirectMapWApi.UpdateWithCondition(objDataNodeDirectMapEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsDataNodeDirectMapWApi.ReFreshCache(objDataNodeDirectMapEN.PrjId);
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsDataNodeDirectMapWApi
{
private static readonly string mstrApiControllerName = "DataNodeDirectMapApi";
...
public static clsCommFun4BLV2 objCommFun4WApi = null;
 ...
 public clsDataNodeDirectMapWApi()
 {
 }
...
{
if (!Object.Equals(null, objDataNodeDirectMapEN.AssociationMappingId) && GetStrLen(objDataNodeDirectMapEN.AssociationMappingId) > 2)
{
 throw new Exception("字段[关联关系映射Id]的长度不能超过2!");
}
if (!Object.Equals(null, objDataNodeDirectMapEN.FuncMapModeId) && GetStrLen(objDataNodeDirectMapEN.FuncMapModeId) > 2)
{
 throw new Exception("字段[函数映射模式Id]的长度不能超过2!");
}
if (!Object.Equals(null, objDataNodeDirectMapEN.TabId) && GetStrLen(objDataNodeDirectMapEN.TabId) > 8)
{
 throw new Exception("字段[表ID]的长度不能超过8!");
}
if (!Object.Equals(null, objDataNodeDirectMapEN.DnFunctionId) && GetStrLen(objDataNodeDirectMapEN.DnFunctionId) > 8)
{
 throw new Exception("字段[DN函数Id]的长度不能超过8!");
}
if (!Object.Equals(null, objDataNodeDirectMapEN.PrjId) && GetStrLen(objDataNodeDirectMapEN.PrjId) > 4)
{
 throw new Exception("字段[工程Id]的长度不能超过4!");
}
if (!Object.Equals(null, objDataNodeDirectMapEN.UpdDate) && GetStrLen(objDataNodeDirectMapEN.UpdDate) > 20)
{
 throw new Exception("字段[修改日期]的长度不能超过20!");
}
if (!Object.Equals(null, objDataNodeDirectMapEN.UpdUser) && GetStrLen(objDataNodeDirectMapEN.UpdUser) > 20)
{
 throw new Exception("字段[修改者]的长度不能超过20!");
}
if (!Object.Equals(null, objDataNodeDirectMapEN.Memo) && GetStrLen(objDataNodeDirectMapEN.Memo) > 1000)
{
...
clsDataNodeDirectMapEN objDataNodeDirectMapEN;
...
objDataNodeDirectMapEN = JsonConvert.DeserializeObject<clsDataNodeDirectMapEN>(strJson);
return objDataNodeDirectMapEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsDataNodeDirectMapEN GetFirstObj(string strWhereCond)
{
...
from objDataNodeDirectMapEN in arrDataNodeDirectMapObjLstCache
where objDataNodeDirectMapEN.mId == lngmId 
select objDataNodeDirectMapEN;
if (arrDataNodeDirectMapObjLst_Sel.Count() == 0)
{
   clsDataNodeDirectMapEN obj = clsDataNodeDirectMapWApi.GetObjBymId(lngmId);
   if (obj != null)
 {
...
{
 List<clsDataNodeDirectMapEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsDataNodeDirectMapEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsDataNodeDirectMapEN> GetObjLstByMIdLst(List<long> arrMId)
{
 List<clsDataNodeDirectMapEN> arrObjLst; 
...
public static IEnumerable<clsDataNodeDirectMapEN> GetObjLstByMIdLstCache(List<long> arrMId, string strPrjId)
{
//初始化列表缓存
string strKey = string.Format("{0}_{1}", clsDataNodeDirectMapEN._CurrTabName, strPrjId);
List<clsDataNodeDirectMapEN> arrDataNodeDirectMapObjLstCache = GetObjLstCache(strPrjId);
IEnumerable <clsDataNodeDirectMapEN> arrDataNodeDirectMapObjLst_Sel =
from objDataNodeDirectMapEN in arrDataNodeDirectMapObjLstCache
where arrMId.Contains(objDataNodeDirectMapEN.mId)
select objDataNodeDirectMapEN;
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsDataNodeDirectMapEN> GetObjLstByRange(stuRangePara objRangePara)
{
 List<clsDataNodeDirectMapEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsDataNodeDirectMapEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsDataNodeDirectMapEN> arrObjLst; 
...
try
{
 clsDataNodeDirectMapEN objDataNodeDirectMapEN = clsDataNodeDirectMapWApi.GetObjBymId(lngmId);
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelDataNodeDirectMaps(List<string> arrmId)
{
string strAction = "DelDataNodeDirectMaps";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrmId);
...
if ((int)jobjReturn0["errorId"] == 0)
{
 clsDataNodeDirectMapEN objDataNodeDirectMapEN = clsDataNodeDirectMapWApi.GetObjBymId(long.Parse(arrmId[0]));
clsDataNodeDirectMapWApi.ReFreshCache(objDataNodeDirectMapEN.PrjId);
var intReturnInt = (int)jobjReturn0["returnInt"];
return intReturnInt;
}
...
{
string strAction = "DelDataNodeDirectMapsByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsDataNodeDirectMapEN objDataNodeDirectMapEN)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <param name = "objDataNodeDirectMapEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
public static string AddNewRecordWithReturnKey(clsDataNodeDirectMapEN objDataNodeDirectMapEN)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsDataNodeDirectMapEN objDataNodeDirectMapEN)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsDataNodeDirectMapEN objDataNodeDirectMapEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objDataNodeDirectMapEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsDataNodeDirectMapEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsDataNodeDirectMapEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsDataNodeDirectMapEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsDataNodeDirectMapEN._AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsDataNodeDirectMapEN objInFor in arrObj)
{
//Rows
...
{
  var strMsg = string.Format("参数:[strPrjId]不能为空！(In clsDataNodeDirectMapWApi.ReFreshThisCache)");
 throw new Exception  (strMsg);
}
if (strPrjId.Length != 4)
{
var strMsg = string.Format("缓存分类变量:[strPrjId]的长度:[{0}]不正确！(clsDataNodeDirectMapWApi.ReFreshThisCache)", strPrjId.Length);
throw new Exception (strMsg);
}
string strMsg0;
...
if (clsDataNodeDirectMapWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}_{1}", clsDataNodeDirectMapEN._CurrTabName, strPrjId);
CacheHelper.Remove(strKey);
clsDataNodeDirectMapWApi.objCommFun4WApi.ReFreshCache(strPrjId.ToString());
}
}
...
if (string.IsNullOrEmpty(strPrjId) == true)
{
  var strMsg = string.Format("参数:[strPrjId]不能为空！(In clsDataNodeDirectMapWApi.GetObjLstCache)");
 throw new Exception  (strMsg);
}
if (strPrjId.Length != 4)
{
var strMsg = string.Format("缓存分类变量:[strPrjId]的长度:[{0}]不正确！(clsDataNodeDirectMapWApi.GetObjLstCache)", strPrjId.Length);
throw new Exception (strMsg);
}
//初始化列表缓存
var strWhereCond = "1=1";
if (string.IsNullOrEmpty(clsDataNodeDirectMapEN._WhereFormat) == false)
{
strWhereCond =string.Format(clsDataNodeDirectMapEN._WhereFormat, strPrjId);
}
else
{
strWhereCond = string.Format("{0}='{1}'",conDataNodeDirectMap.PrjId, strPrjId);
}
var strKey = string.Format("{0}_{1}", clsDataNodeDirectMapEN._CurrTabName, strPrjId);
List<clsDataNodeDirectMapEN> arrDataNodeDirectMapObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
return arrDataNodeDirectMapObjLstCache;
 ...
 /// </summary>
 /// <returns>从缓存中获取的所有对象列表</returns>
public static List<clsDataNodeDirectMapEN> GetObjLstCacheFromObjLst(string strPrjId,List<clsDataNodeDirectMapEN> arrObjLst_P)
{


if (string.IsNullOrEmpty(strPrjId) == true)
{
  var strMsg = string.Format("参数:[strPrjId]不能为空！(In clsDataNodeDirectMapWApi.GetObjLstCacheFromObjLst)");
 throw new Exception  (strMsg);
}
if (strPrjId.Length != 4)
{
var strMsg = string.Format("缓存分类变量:[strPrjId]的长度:[{0}]不正确！(clsDataNodeDirectMapWApi.GetObjLstCacheFromObjLst)", strPrjId.Length);
throw new Exception (strMsg);
}
var strKey = string.Format("{0}_{1}", clsDataNodeDirectMapEN._CurrTabName, strPrjId);
List<clsDataNodeDirectMapEN> arrDataNodeDirectMapObjLstCache = null;
if (CacheHelper.Exsits(strKey) == true)
{
arrDataNodeDirectMapObjLstCache = CacheHelper.Get<List<clsDataNodeDirectMapEN>>(strKey);
}
else
{
...
public static DataTable GetDataTableByObjLst(List<clsDataNodeDirectMapEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conDataNodeDirectMap.mId, Type.GetType("System.Int64"));
objDT.Columns.Add(conDataNodeDirectMap.InDataNodeId, Type.GetType("System.Int64"));
objDT.Columns.Add(conDataNodeDirectMap.OutDataNodeId, Type.GetType("System.Int64"));
objDT.Columns.Add(conDataNodeDirectMap.AssociationMappingId, Type.GetType("System.String"));
objDT.Columns.Add(conDataNodeDirectMap.FuncMapModeId, Type.GetType("System.String"));
objDT.Columns.Add(conDataNodeDirectMap.TabId, Type.GetType("System.String"));
objDT.Columns.Add(conDataNodeDirectMap.DnFunctionId, Type.GetType("System.String"));
objDT.Columns.Add(conDataNodeDirectMap.PrjId, Type.GetType("System.String"));
objDT.Columns.Add(conDataNodeDirectMap.UpdDate, Type.GetType("System.String"));
objDT.Columns.Add(conDataNodeDirectMap.UpdUser, Type.GetType("System.String"));
objDT.Columns.Add(conDataNodeDirectMap.Memo, Type.GetType("System.String"));
foreach (clsDataNodeDirectMapEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conDataNodeDirectMap.mId] = objInFor[conDataNodeDirectMap.mId];
objDR[conDataNodeDirectMap.InDataNodeId] = objInFor[conDataNodeDirectMap.InDataNodeId];
objDR[conDataNodeDirectMap.OutDataNodeId] = objInFor[conDataNodeDirectMap.OutDataNodeId];
objDR[conDataNodeDirectMap.AssociationMappingId] = objInFor[conDataNodeDirectMap.AssociationMappingId];
objDR[conDataNodeDirectMap.FuncMapModeId] = objInFor[conDataNodeDirectMap.FuncMapModeId];
objDR[conDataNodeDirectMap.TabId] = objInFor[conDataNodeDirectMap.TabId];
objDR[conDataNodeDirectMap.DnFunctionId] = objInFor[conDataNodeDirectMap.DnFunctionId];
objDR[conDataNodeDirectMap.PrjId] = objInFor[conDataNodeDirectMap.PrjId];
objDR[conDataNodeDirectMap.UpdDate] = objInFor[conDataNodeDirectMap.UpdDate];
objDR[conDataNodeDirectMap.UpdUser] = objInFor[conDataNodeDirectMap.UpdUser];
objDR[conDataNodeDirectMap.Memo] = objInFor[conDataNodeDirectMap.Memo];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4DataNodeDirectMap : clsCommFun4BLV2
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsDataNodeDirectMapWApi.ReFreshThisCache(strPrjId);
}
}
