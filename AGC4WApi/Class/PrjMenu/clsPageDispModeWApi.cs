...
List<clsPageDispModeEN> arrObjLst = clsPageDispModeWApi.GetObjLst(strCondition);
//初始化一个对象列表
...
{
if (strPageDispModeId == "") return null;
...
if (clsPageDispModeEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
...
{
//Columns
foreach (string strAttrName in clsPageDispModeEN._AttributeName)
{
