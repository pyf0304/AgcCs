...
public static IEnumerable<clsvEditRegionFldCountInUseEN> GetObjLstByRegionIdLstCache(List<string> arrRegionId, string strPrjId)
{
//初始化列表缓存
string strKey = string.Format("{0}_{1}", clsvEditRegionFldCountInUseEN._CurrTabName, strPrjId);
List<clsvEditRegionFldCountInUseEN> arrvEditRegionFldCountInUseObjLstCache = GetObjLstCache(strPrjId);
...
return arrvEditRegionFldCountInUseObjLstCache;
 ...
 /// </summary>
 /// <returns>从缓存中获取的所有对象列表</returns>
public static List<clsvEditRegionFldCountInUseEN> GetObjLstCacheFromObjLst(string strPrjId,List<clsvEditRegionFldCountInUseEN> arrObjLst_P)
{
