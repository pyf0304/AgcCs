...
public static IEnumerable<clsvEditRegionFldCountEN> GetObjLstByRegionIdLstCache(List<string> arrRegionId, string strPrjId)
{
//初始化列表缓存
string strKey = string.Format("{0}_{1}", clsvEditRegionFldCountEN._CurrTabName, strPrjId);
List<clsvEditRegionFldCountEN> arrvEditRegionFldCountObjLstCache = GetObjLstCache(strPrjId);
...
return arrvEditRegionFldCountObjLstCache;
 ...
 /// </summary>
 /// <returns>从缓存中获取的所有对象列表</returns>
public static List<clsvEditRegionFldCountEN> GetObjLstCacheFromObjLst(string strPrjId,List<clsvEditRegionFldCountEN> arrObjLst_P)
{
