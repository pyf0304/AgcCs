...
{
if (strRegionTypeId == "") return null;
...
if (clsRegionTypeEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
...
{
//Columns
foreach (string strAttrName in clsRegionTypeEN._AttributeName)
{
