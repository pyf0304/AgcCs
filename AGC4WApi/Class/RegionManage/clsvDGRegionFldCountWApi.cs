 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvDGRegionFldCountWApi
 表名:vDGRegionFldCount(00050577)
 * 版本:2023.08.23.1(服务器:WIN-SRV103-116)
 日期:2023/08/23 23:10:24
 生成者:pyf
 生成服务器IP:
 工程名称:AGC(0005)
...
/// 静态类
/// </summary>
public static class  clsvDGRegionFldCountWApi_Static
{
...
return objvDGRegionFldCountEN;
 ...
 /// <param name = "strComparisonOp">比较运算符,如果有值,可用于组织条件串</param>
 /// <returns>返回对象,可以继续连写</returns>
public static clsvDGRegionFldCountEN SetPrjId(this clsvDGRegionFldCountEN objvDGRegionFldCountEN, string strPrjId, string strComparisonOp="")
	{
clsCheckSql.CheckFieldLen(strPrjId, 4, convDGRegionFldCount.PrjId);
clsCheckSql.CheckFieldForeignKey(strPrjId, 4, convDGRegionFldCount.PrjId);
objvDGRegionFldCountEN.PrjId = strPrjId; //工程ID
if (string.IsNullOrEmpty(strComparisonOp) == false)
{
if (objvDGRegionFldCountEN.dicFldComparisonOp.ContainsKey(convDGRegionFldCount.PrjId) == false)
{
objvDGRegionFldCountEN.dicFldComparisonOp.Add(convDGRegionFldCount.PrjId, strComparisonOp);
}
else
{
objvDGRegionFldCountEN.dicFldComparisonOp[convDGRegionFldCount.PrjId] = strComparisonOp;
}
}
return objvDGRegionFldCountEN;
	}
...
strWhereCond += string.Format(" And {0} {2} '{1}'", convDGRegionFldCount.PrjId, objvDGRegionFldCountCond.PrjId, strComparisonOpPrjId);
 ...
 /// </summary>
public class clsvDGRegionFldCountWApi
{
private static readonly string mstrApiControllerName = "vDGRegionFldCountApi";

 public clsvDGRegionFldCountWApi()
 {
 }
...
clsvDGRegionFldCountEN objvDGRegionFldCountEN;
...
objvDGRegionFldCountEN = JsonConvert.DeserializeObject<clsvDGRegionFldCountEN>(strJson);
return objvDGRegionFldCountEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsvDGRegionFldCountEN GetFirstObj(string strWhereCond)
{
...
{
 List<clsvDGRegionFldCountEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsvDGRegionFldCountEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsvDGRegionFldCountEN> GetObjLstByRegionIdLst(List<string> arrRegionId)
{
 List<clsvDGRegionFldCountEN> arrObjLst; 
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsvDGRegionFldCountEN> GetObjLstByRange(stuRangePara objRangePara)
{
 List<clsvDGRegionFldCountEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsvDGRegionFldCountEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsvDGRegionFldCountEN> arrObjLst; 
...
public static DataTable ToDataTable(List<clsvDGRegionFldCountEN> arrObj)
{
...
Type type = typeof(clsvDGRegionFldCountEN);
...
foreach (clsvDGRegionFldCountEN objInFor in arrObj)
{
//Rows
...
{
string strKey = string.Format("{0}", clsvDGRegionFldCountEN._CurrTabName);
...
public static DataTable GetDataTableByObjLst(List<clsvDGRegionFldCountEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(convDGRegionFldCount.RegionId, Type.GetType("System.String"));
objDT.Columns.Add(convDGRegionFldCount.FldCount, Type.GetType("System.Int32"));
objDT.Columns.Add(convDGRegionFldCount.PrjId, Type.GetType("System.String"));
foreach (clsvDGRegionFldCountEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[convDGRegionFldCount.RegionId] = objInFor[convDGRegionFldCount.RegionId];
objDR[convDGRegionFldCount.FldCount] = objInFor[convDGRegionFldCount.FldCount];
objDR[convDGRegionFldCount.PrjId] = objInFor[convDGRegionFldCount.PrjId];
