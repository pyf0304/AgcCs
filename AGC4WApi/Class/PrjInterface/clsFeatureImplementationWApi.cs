...
/// 静态类
/// </summary>
public static class  clsFeatureImplementationWApi_Static
{
...
try
{
objFeatureImplementationEN.sfUpdFldSetStr = objFeatureImplementationEN.getsfUpdFldSetStr();
clsFeatureImplementationWApi.CheckPropertyNew(objFeatureImplementationEN); 
bool bolResult = clsFeatureImplementationWApi.UpdateRecord(objFeatureImplementationEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFeatureImplementationWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsFeatureImplementationEN objFeatureImplementationEN)
{
//检测记录是否存在
...
public static bool AddNewRecord(this clsFeatureImplementationEN objFeatureImplementationEN)
{
try
{
clsFeatureImplementationWApi.CheckPropertyNew(objFeatureImplementationEN); 
bool bolResult = clsFeatureImplementationWApi.AddNewRecord(objFeatureImplementationEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFeatureImplementationWApi.ReFreshCache();
return bolResult;
}
...
{
clsFeatureImplementationWApi.CheckPropertyNew(objFeatureImplementationEN); 
bool bolResult = clsFeatureImplementationWApi.UpdateWithCondition(objFeatureImplementationEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFeatureImplementationWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsFeatureImplementationWApi
{
private static readonly string mstrApiControllerName = "FeatureImplementationApi";
...
public static clsCommFun4BL objCommFun4WApi = null;
 ...
 public clsFeatureImplementationWApi()
 {
 }
...
{
if (!Object.Equals(null, objFeatureImplementationEN.FeatureId) && GetStrLen(objFeatureImplementationEN.FeatureId) > 4)
{
 throw new Exception("字段[功能Id]的长度不能超过4!");
}
if (!Object.Equals(null, objFeatureImplementationEN.ViewImplId) && GetStrLen(objFeatureImplementationEN.ViewImplId) > 4)
{
 throw new Exception("字段[界面实现Id]的长度不能超过4!");
}
if (!Object.Equals(null, objFeatureImplementationEN.UpdDate) && GetStrLen(objFeatureImplementationEN.UpdDate) > 20)
{
 throw new Exception("字段[修改日期]的长度不能超过20!");
}
if (!Object.Equals(null, objFeatureImplementationEN.UpdUser) && GetStrLen(objFeatureImplementationEN.UpdUser) > 20)
{
 throw new Exception("字段[修改者]的长度不能超过20!");
}
if (!Object.Equals(null, objFeatureImplementationEN.Memo) && GetStrLen(objFeatureImplementationEN.Memo) > 1000)
{
...
objFeatureImplementationEN = JsonConvert.DeserializeObject<clsFeatureImplementationEN>(strJson);
return objFeatureImplementationEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsFeatureImplementationEN GetFirstObj(string strWhereCond)
{
...
where objFeatureImplementationEN.mId == lngmId 
select objFeatureImplementationEN;
if (arrFeatureImplementationObjLst_Sel.Count() == 0)
{
   clsFeatureImplementationEN obj = clsFeatureImplementationWApi.GetObjBymId(lngmId);
   if (obj != null)
 {
...
{
 List<clsFeatureImplementationEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsFeatureImplementationEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsFeatureImplementationEN> GetObjLstByMIdLst(List<long> arrMId)
{
 List<clsFeatureImplementationEN> arrObjLst; 
...
public static IEnumerable<clsFeatureImplementationEN> GetObjLstByMIdLstCache(List<long> arrMId)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsFeatureImplementationEN._CurrTabName);
List<clsFeatureImplementationEN> arrFeatureImplementationObjLstCache = GetObjLstCache();
IEnumerable <clsFeatureImplementationEN> arrFeatureImplementationObjLst_Sel =
from objFeatureImplementationEN in arrFeatureImplementationObjLstCache
where arrMId.Contains(objFeatureImplementationEN.mId)
select objFeatureImplementationEN;
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsFeatureImplementationEN> GetObjLstByRange(stuRangePara objRangePara)
{
 List<clsFeatureImplementationEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsFeatureImplementationEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsFeatureImplementationEN> arrObjLst; 
...
try
{
 clsFeatureImplementationEN objFeatureImplementationEN = clsFeatureImplementationWApi.GetObjBymId(lngmId);
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelFeatureImplementations(List<string> arrmId)
{
string strAction = "DelFeatureImplementations";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrmId);
...
{
string strAction = "DelFeatureImplementationsByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsFeatureImplementationEN objFeatureImplementationEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJson = clsJSON.GetJsonFromObj<clsFeatureImplementationEN>(objFeatureImplementationEN);
if (clsPubFun4WApi.Post(mstrApiControllerName, strAction, dictParam, strJson, out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <param name = "objFeatureImplementationEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
public static string AddNewRecordWithReturnKey(clsFeatureImplementationEN objFeatureImplementationEN)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsFeatureImplementationEN objFeatureImplementationEN)
{
if (string.IsNullOrEmpty(objFeatureImplementationEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objFeatureImplementationEN.mId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsFeatureImplementationEN objFeatureImplementationEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objFeatureImplementationEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsFeatureImplementationEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsFeatureImplementationEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsFeatureImplementationEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsFeatureImplementationEN._AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsFeatureImplementationEN objInFor in arrObj)
{
//Rows
...
if (clsFeatureImplementationWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsFeatureImplementationEN._CurrTabName);
CacheHelper.Remove(strKey);
clsFeatureImplementationWApi.objCommFun4WApi.ReFreshCache();
}
}
...
var strKey = clsFeatureImplementationEN._CurrTabName;
List<clsFeatureImplementationEN> arrFeatureImplementationObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
...
public static DataTable GetDataTableByObjLst(List<clsFeatureImplementationEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conFeatureImplementation.mId, Type.GetType("System.Int64"));
objDT.Columns.Add(conFeatureImplementation.FeatureId, Type.GetType("System.String"));
objDT.Columns.Add(conFeatureImplementation.ViewImplId, Type.GetType("System.String"));
objDT.Columns.Add(conFeatureImplementation.IsDefault, Type.GetType("System.Boolean"));
objDT.Columns.Add(conFeatureImplementation.UpdDate, Type.GetType("System.String"));
objDT.Columns.Add(conFeatureImplementation.UpdUser, Type.GetType("System.String"));
objDT.Columns.Add(conFeatureImplementation.Memo, Type.GetType("System.String"));
foreach (clsFeatureImplementationEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conFeatureImplementation.mId] = objInFor[conFeatureImplementation.mId];
objDR[conFeatureImplementation.FeatureId] = objInFor[conFeatureImplementation.FeatureId];
objDR[conFeatureImplementation.ViewImplId] = objInFor[conFeatureImplementation.ViewImplId];
objDR[conFeatureImplementation.IsDefault] = objInFor[conFeatureImplementation.IsDefault];
objDR[conFeatureImplementation.UpdDate] = objInFor[conFeatureImplementation.UpdDate];
objDR[conFeatureImplementation.UpdUser] = objInFor[conFeatureImplementation.UpdUser];
objDR[conFeatureImplementation.Memo] = objInFor[conFeatureImplementation.Memo];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4FeatureImplementation : clsCommFun4BL
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFeatureImplementationWApi.ReFreshThisCache();
}
}
