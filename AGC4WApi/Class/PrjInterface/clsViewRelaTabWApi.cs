...
/// 静态类
/// </summary>
public static class  clsViewRelaTabWApi_Static
{
...
try
{
objViewRelaTabEN.sfUpdFldSetStr = objViewRelaTabEN.getsfUpdFldSetStr();
clsViewRelaTabWApi.CheckPropertyNew(objViewRelaTabEN); 
bool bolResult = clsViewRelaTabWApi.UpdateRecord(objViewRelaTabEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsViewRelaTabWApi.ReFreshCache(objViewRelaTabEN.PrjId);
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsViewRelaTabEN objViewRelaTabEN)
{
//检测记录是否存在
...
public static bool AddNewRecord(this clsViewRelaTabEN objViewRelaTabEN)
{
try
{
clsViewRelaTabWApi.CheckPropertyNew(objViewRelaTabEN); 
bool bolResult = clsViewRelaTabWApi.AddNewRecord(objViewRelaTabEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsViewRelaTabWApi.ReFreshCache(objViewRelaTabEN.PrjId);
return bolResult;
}
...
{
clsViewRelaTabWApi.CheckPropertyNew(objViewRelaTabEN); 
bool bolResult = clsViewRelaTabWApi.UpdateWithCondition(objViewRelaTabEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsViewRelaTabWApi.ReFreshCache(objViewRelaTabEN.PrjId);
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsViewRelaTabWApi
{
private static readonly string mstrApiControllerName = "ViewRelaTabApi";
...
{
if (!Object.Equals(null, objViewRelaTabEN.ViewId) && GetStrLen(objViewRelaTabEN.ViewId) > 8)
{
 throw new Exception("字段[界面Id]的长度不能超过8!");
}
if (!Object.Equals(null, objViewRelaTabEN.RegionId) && GetStrLen(objViewRelaTabEN.RegionId) > 10)
{
 throw new Exception("字段[区域Id]的长度不能超过10!");
}
if (!Object.Equals(null, objViewRelaTabEN.InOutTypeId) && GetStrLen(objViewRelaTabEN.InOutTypeId) > 2)
{
 throw new Exception("字段[INOUT类型ID]的长度不能超过2!");
}
if (!Object.Equals(null, objViewRelaTabEN.ViewTabTypeId) && GetStrLen(objViewRelaTabEN.ViewTabTypeId) > 4)
{
 throw new Exception("字段[界面表类型码]的长度不能超过4!");
}
if (!Object.Equals(null, objViewRelaTabEN.TabId) && GetStrLen(objViewRelaTabEN.TabId) > 8)
{
 throw new Exception("字段[表ID]的长度不能超过8!");
}
if (!Object.Equals(null, objViewRelaTabEN.TabFunction) && GetStrLen(objViewRelaTabEN.TabFunction) > 500)
{
 throw new Exception("字段[表功能说明]的长度不能超过500!");
}
if (!Object.Equals(null, objViewRelaTabEN.PrjId) && GetStrLen(objViewRelaTabEN.PrjId) > 4)
{
 throw new Exception("字段[工程Id]的长度不能超过4!");
}
if (!Object.Equals(null, objViewRelaTabEN.UpdDate) && GetStrLen(objViewRelaTabEN.UpdDate) > 20)
{
 throw new Exception("字段[修改日期]的长度不能超过20!");
}
if (!Object.Equals(null, objViewRelaTabEN.UpdUser) && GetStrLen(objViewRelaTabEN.UpdUser) > 20)
{
 throw new Exception("字段[修改者]的长度不能超过20!");
}
if (!Object.Equals(null, objViewRelaTabEN.Memo) && GetStrLen(objViewRelaTabEN.Memo) > 1000)
{
...
objViewRelaTabEN = JsonConvert.DeserializeObject<clsViewRelaTabEN>(strJson);
return objViewRelaTabEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsViewRelaTabEN GetFirstObj(string strWhereCond)
{
...
from objViewRelaTabEN in arrViewRelaTabObjLstCache
where objViewRelaTabEN.mId == lngmId 
select objViewRelaTabEN;
if (arrViewRelaTabObjLst_Sel.Count() == 0)
{
   clsViewRelaTabEN obj = clsViewRelaTabWApi.GetObjBymId(lngmId);
   if (obj != null)
 {
...
{
 List<clsViewRelaTabEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsViewRelaTabEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsViewRelaTabEN> GetObjLstByMIdLst(List<long> arrMId)
{
 List<clsViewRelaTabEN> arrObjLst; 
...
public static IEnumerable<clsViewRelaTabEN> GetObjLstByMIdLstCache(List<long> arrMId, string strPrjId)
{
//初始化列表缓存
string strKey = string.Format("{0}_{1}", clsViewRelaTabEN._CurrTabName, strPrjId);
List<clsViewRelaTabEN> arrViewRelaTabObjLstCache = GetObjLstCache(strPrjId);
IEnumerable <clsViewRelaTabEN> arrViewRelaTabObjLst_Sel =
from objViewRelaTabEN in arrViewRelaTabObjLstCache
where arrMId.Contains(objViewRelaTabEN.mId)
select objViewRelaTabEN;
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsViewRelaTabEN> GetObjLstByRange(stuRangePara objRangePara)
{
 List<clsViewRelaTabEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsViewRelaTabEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsViewRelaTabEN> arrObjLst; 
...
try
{
 clsViewRelaTabEN objViewRelaTabEN = clsViewRelaTabWApi.GetObjBymId(lngmId);
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelViewRelaTabs(List<string> arrmId)
{
string strAction = "DelViewRelaTabs";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrmId);
...
if ((int)jobjReturn0["errorId"] == 0)
{
 clsViewRelaTabEN objViewRelaTabEN = clsViewRelaTabWApi.GetObjBymId(long.Parse(arrmId[0]));
clsViewRelaTabWApi.ReFreshCache(objViewRelaTabEN.PrjId);
var intReturnInt = (int)jobjReturn0["returnInt"];
return intReturnInt;
}
...
{
string strAction = "DelViewRelaTabsByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsViewRelaTabEN objViewRelaTabEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJson = clsJSON.GetJsonFromObj<clsViewRelaTabEN>(objViewRelaTabEN);
if (clsPubFun4WApi.Post(mstrApiControllerName, strAction, dictParam, strJson, out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <param name = "objViewRelaTabEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
public static string AddNewRecordWithReturnKey(clsViewRelaTabEN objViewRelaTabEN)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsViewRelaTabEN objViewRelaTabEN)
{
if (string.IsNullOrEmpty(objViewRelaTabEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objViewRelaTabEN.mId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsViewRelaTabEN objViewRelaTabEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objViewRelaTabEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsViewRelaTabEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsViewRelaTabEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsViewRelaTabEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsViewRelaTabEN._AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsViewRelaTabEN objInFor in arrObj)
{
//Rows
...
{
  var strMsg = string.Format("参数:[strPrjId]不能为空！(In clsViewRelaTabWApi.ReFreshThisCache)");
 throw new Exception  (strMsg);
}
if (strPrjId.Length != 4)
{
var strMsg = string.Format("缓存分类变量:[strPrjId]的长度:[{0}]不正确！(clsViewRelaTabWApi.ReFreshThisCache)", strPrjId.Length);
throw new Exception (strMsg);
}
string strMsg0;
...
if (clsViewRelaTabWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}_{1}", clsViewRelaTabEN._CurrTabName, strPrjId);
CacheHelper.Remove(strKey);
clsViewRelaTabWApi.objCommFun4WApi.ReFreshCache(strPrjId.ToString());
}
}
...
if (string.IsNullOrEmpty(strPrjId) == true)
{
  var strMsg = string.Format("参数:[strPrjId]不能为空！(In clsViewRelaTabWApi.GetObjLstCache)");
 throw new Exception  (strMsg);
}
if (strPrjId.Length != 4)
{
var strMsg = string.Format("缓存分类变量:[strPrjId]的长度:[{0}]不正确！(clsViewRelaTabWApi.GetObjLstCache)", strPrjId.Length);
throw new Exception (strMsg);
}
//初始化列表缓存
var strWhereCond = "1=1";
if (string.IsNullOrEmpty(clsViewRelaTabEN._WhereFormat) == false)
{
strWhereCond =string.Format(clsViewRelaTabEN._WhereFormat, strPrjId);
}
else
{
strWhereCond = string.Format("{0}='{1}'",conViewRelaTab.PrjId, strPrjId);
}
var strKey = string.Format("{0}_{1}", clsViewRelaTabEN._CurrTabName, strPrjId);
List<clsViewRelaTabEN> arrViewRelaTabObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
return arrViewRelaTabObjLstCache;
 ...
 /// </summary>
 /// <returns>从缓存中获取的所有对象列表</returns>
public static List<clsViewRelaTabEN> GetObjLstCacheFromObjLst(string strPrjId,List<clsViewRelaTabEN> arrObjLst_P)
{


if (string.IsNullOrEmpty(strPrjId) == true)
{
  var strMsg = string.Format("参数:[strPrjId]不能为空！(In clsViewRelaTabWApi.GetObjLstCacheFromObjLst)");
 throw new Exception  (strMsg);
}
if (strPrjId.Length != 4)
{
var strMsg = string.Format("缓存分类变量:[strPrjId]的长度:[{0}]不正确！(clsViewRelaTabWApi.GetObjLstCacheFromObjLst)", strPrjId.Length);
throw new Exception (strMsg);
}
var strKey = string.Format("{0}_{1}", clsViewRelaTabEN._CurrTabName, strPrjId);
List<clsViewRelaTabEN> arrViewRelaTabObjLstCache = null;
if (CacheHelper.Exsits(strKey) == true)
{
arrViewRelaTabObjLstCache = CacheHelper.Get<List<clsViewRelaTabEN>>(strKey);
}
else
{
...
public static DataTable GetDataTableByObjLst(List<clsViewRelaTabEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conViewRelaTab.mId, Type.GetType("System.Int64"));
objDT.Columns.Add(conViewRelaTab.ViewId, Type.GetType("System.String"));
objDT.Columns.Add(conViewRelaTab.RegionId, Type.GetType("System.String"));
objDT.Columns.Add(conViewRelaTab.InOutTypeId, Type.GetType("System.String"));
objDT.Columns.Add(conViewRelaTab.ViewTabTypeId, Type.GetType("System.String"));
objDT.Columns.Add(conViewRelaTab.TabId, Type.GetType("System.String"));
objDT.Columns.Add(conViewRelaTab.TabFunction, Type.GetType("System.String"));
objDT.Columns.Add(conViewRelaTab.PrjId, Type.GetType("System.String"));
objDT.Columns.Add(conViewRelaTab.UpdDate, Type.GetType("System.String"));
objDT.Columns.Add(conViewRelaTab.UpdUser, Type.GetType("System.String"));
objDT.Columns.Add(conViewRelaTab.Memo, Type.GetType("System.String"));
foreach (clsViewRelaTabEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conViewRelaTab.mId] = objInFor[conViewRelaTab.mId];
objDR[conViewRelaTab.ViewId] = objInFor[conViewRelaTab.ViewId];
objDR[conViewRelaTab.RegionId] = objInFor[conViewRelaTab.RegionId];
objDR[conViewRelaTab.InOutTypeId] = objInFor[conViewRelaTab.InOutTypeId];
objDR[conViewRelaTab.ViewTabTypeId] = objInFor[conViewRelaTab.ViewTabTypeId];
objDR[conViewRelaTab.TabId] = objInFor[conViewRelaTab.TabId];
objDR[conViewRelaTab.TabFunction] = objInFor[conViewRelaTab.TabFunction];
objDR[conViewRelaTab.PrjId] = objInFor[conViewRelaTab.PrjId];
objDR[conViewRelaTab.UpdDate] = objInFor[conViewRelaTab.UpdDate];
objDR[conViewRelaTab.UpdUser] = objInFor[conViewRelaTab.UpdUser];
objDR[conViewRelaTab.Memo] = objInFor[conViewRelaTab.Memo];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4ViewRelaTab : clsCommFun4BLV2
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsViewRelaTabWApi.ReFreshThisCache(strPrjId);
}
}
