...
{
if (strPrjFileStateId == "") return null;
...
if (clsPrjFileStateEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
...
{
//Columns
foreach (string strAttrName in clsPrjFileStateEN._AttributeName)
{
