...
/// 静态类
/// </summary>
public static class  clsInOutTypeWApi_Static
{
...
try
{
objInOutTypeEN.sfUpdFldSetStr = objInOutTypeEN.getsfUpdFldSetStr();
clsInOutTypeWApi.CheckPropertyNew(objInOutTypeEN); 
bool bolResult = clsInOutTypeWApi.UpdateRecord(objInOutTypeEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsInOutTypeWApi.ReFreshCache();
return bolResult;
}
...
public static bool AddNewRecord(this clsInOutTypeEN objInOutTypeEN)
{
 if (string.IsNullOrEmpty(objInOutTypeEN.InOutTypeId) == true)
 {
...
clsStackTrace.GetCurrClassFunction()); 
 ...
 if (clsInOutTypeWApi.IsExist(objInOutTypeEN.InOutTypeId) == true)
 {
...
{
clsInOutTypeWApi.CheckPropertyNew(objInOutTypeEN); 
bool bolResult = clsInOutTypeWApi.AddNewRecord(objInOutTypeEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsInOutTypeWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// <param name = "objInOutTypeEN">需要添加的实体对象</param>
 /// <returns>如果插入成功则返回TRUE,否则为FALSE</returns>
public static string AddNewRecordWithMaxId(this clsInOutTypeEN objInOutTypeEN)
{
try
{
clsInOutTypeWApi.CheckPropertyNew(objInOutTypeEN); 
string strInOutTypeId = clsInOutTypeWApi.AddNewRecordWithMaxId(objInOutTypeEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsInOutTypeWApi.ReFreshCache();
...
{
clsInOutTypeWApi.CheckPropertyNew(objInOutTypeEN); 
bool bolResult = clsInOutTypeWApi.UpdateWithCondition(objInOutTypeEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsInOutTypeWApi.ReFreshCache();
return bolResult;
}
...
public const string NotOUT_IN_04 = "04";
 ...
 /// </summary>
public class clsInOutTypeWApi
{
private static readonly string mstrApiControllerName = "InOutTypeApi";
...
List<clsInOutTypeEN> arrObjLst = GetObjLst("1=1");
...
List<clsInOutTypeEN> arrObjLst = clsInOutTypeWApi.GetObjLst(strCondition);
//初始化一个对象列表
...
{
if (!Object.Equals(null, objInOutTypeEN.InOutTypeId) && GetStrLen(objInOutTypeEN.InOutTypeId) > 2)
{
 throw new Exception("字段[INOUT类型ID]的长度不能超过2!");
}
if (!Object.Equals(null, objInOutTypeEN.InOutTypeName) && GetStrLen(objInOutTypeEN.InOutTypeName) > 30)
{
 throw new Exception("字段[INOUT类型名称]的长度不能超过30!");
}
if (!Object.Equals(null, objInOutTypeEN.InOutTypeENName) && GetStrLen(objInOutTypeEN.InOutTypeENName) > 30)
{
 throw new Exception("字段[INOUT类型英文名]的长度不能超过30!");
}
if (!Object.Equals(null, objInOutTypeEN.Memo) && GetStrLen(objInOutTypeEN.Memo) > 1000)
{
...
{
if (strInOutTypeId == "") return null;
string strAction = "GetObjByInOutTypeId";
clsInOutTypeEN objInOutTypeEN;
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strInOutTypeId"] = strInOutTypeId,
};
try
{
...
objInOutTypeEN = JsonConvert.DeserializeObject<clsInOutTypeEN>(strJson);
return objInOutTypeEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsInOutTypeEN GetFirstObj(string strWhereCond)
{
...
{
if (string.IsNullOrEmpty(strInOutTypeId) == true) return null;
//初始化列表缓存
...
from objInOutTypeEN in arrInOutTypeObjLstCache
where objInOutTypeEN.InOutTypeId == strInOutTypeId 
select objInOutTypeEN;
if (arrInOutTypeObjLst_Sel.Count() == 0)
{
   clsInOutTypeEN obj = clsInOutTypeWApi.GetObjByInOutTypeId(strInOutTypeId);
   if (obj != null)
 {
...
//初始化列表缓存
List<clsInOutTypeEN> arrInOutTypeObjLstCache = GetObjLstCache();
IEnumerable <clsInOutTypeEN> arrInOutTypeObjLst_Sel1 =
from objInOutTypeEN in arrInOutTypeObjLstCache
where objInOutTypeEN.InOutTypeId == strInOutTypeId 
select objInOutTypeEN;
List <clsInOutTypeEN> arrInOutTypeObjLst_Sel = new List<clsInOutTypeEN>();
foreach (clsInOutTypeEN obj in arrInOutTypeObjLst_Sel1)
{
arrInOutTypeObjLst_Sel.Add(obj);
}
if (arrInOutTypeObjLst_Sel.Count > 0)
{
return arrInOutTypeObjLst_Sel[0].InOutTypeName;
}
string strErrMsgForGetObjById = string.Format("在InOutType对象缓存列表中,找不到记录[InOutTypeId = {0}](函数:{1})", strInOutTypeId, clsStackTrace.GetCurrFunction());
clsLog.LogErrorS2("clsInOutTypeBL", clsStackTrace.GetCurrClassFunction(), strErrMsgForGetObjById, "", "");
...
string strErrMsgForGetObjById = string.Format("在InOutType对象缓存列表中,找不到记录的相关名称[InOutTypeId = {0}](函数:{1})", strInOutTypeId, clsStackTrace.GetCurrFunction());
clsLog.LogErrorS2("clsInOutTypeBL", clsStackTrace.GetCurrClassFunction(), strErrMsgForGetObjById, "", "");
throw new Exception(strErrMsgForGetObjById);
}
...
arrObjLst = JsonConvert.DeserializeObject<List<clsInOutTypeEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// </summary>
 /// <param name = "arrInOutTypeId">关键字列表</param>
 /// <returns>返回对象列表</returns>
public static List<clsInOutTypeEN> GetObjLstByInOutTypeIdLst(List<string> arrInOutTypeId)
{
 List<clsInOutTypeEN> arrObjLst; 
string strAction = "GetObjLstByInOutTypeIdLst";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrInOutTypeId);
...
throw new Exception(strMsg);
 ...
 /// </summary>
 /// <param name = "arrInOutTypeId">所给的关键字列表</param>
 /// <returns>根据关键字列表获取的对象</returns>
public static IEnumerable<clsInOutTypeEN> GetObjLstByInOutTypeIdLstCache(List<string> arrInOutTypeId)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsInOutTypeEN._CurrTabName);
List<clsInOutTypeEN> arrInOutTypeObjLstCache = GetObjLstCache();
IEnumerable <clsInOutTypeEN> arrInOutTypeObjLst_Sel =
from objInOutTypeEN in arrInOutTypeObjLstCache
where arrInOutTypeId.Contains(objInOutTypeEN.InOutTypeId)
select objInOutTypeEN;
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsInOutTypeEN> GetObjLstByRange(stuRangePara objRangePara)
{
 List<clsInOutTypeEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsInOutTypeEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsInOutTypeEN> arrObjLst; 
...
try
{
 clsInOutTypeEN objInOutTypeEN = clsInOutTypeWApi.GetObjByInOutTypeId(strInOutTypeId);
if (clsPubFun4WApi.Delete(mstrApiControllerName, strAction, strInOutTypeId.ToString(), out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelInOutTypes(List<string> arrInOutTypeId)
{
string strAction = "DelInOutTypes";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrInOutTypeId);
...
{
string strAction = "DelInOutTypesByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsInOutTypeEN objInOutTypeEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJson = clsJSON.GetJsonFromObj<clsInOutTypeEN>(objInOutTypeEN);
if (clsPubFun4WApi.Post(mstrApiControllerName, strAction, dictParam, strJson, out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
...
public static string AddNewRecordWithMaxId(clsInOutTypeEN objInOutTypeEN)
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsInOutTypeWApi.ReFreshCache();
var strInOutTypeId = (string)jobjReturn0["returnStr"];
return strInOutTypeId;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsInOutTypeEN objInOutTypeEN)
{
if (string.IsNullOrEmpty(objInOutTypeEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objInOutTypeEN.InOutTypeId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsInOutTypeEN objInOutTypeEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objInOutTypeEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsInOutTypeEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsInOutTypeEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsInOutTypeEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsInOutTypeEN._AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsInOutTypeEN objInFor in arrObj)
{
//Rows
...
if (clsInOutTypeWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsInOutTypeEN._CurrTabName);
CacheHelper.Remove(strKey);
clsInOutTypeWApi.objCommFun4WApi.ReFreshCache();
}
}
...
var strKey = clsInOutTypeEN._CurrTabName;
List<clsInOutTypeEN> arrInOutTypeObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
...
public static DataTable GetDataTableByObjLst(List<clsInOutTypeEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conInOutType.InOutTypeId, Type.GetType("System.String"));
objDT.Columns.Add(conInOutType.InOutTypeName, Type.GetType("System.String"));
objDT.Columns.Add(conInOutType.InOutTypeENName, Type.GetType("System.String"));
objDT.Columns.Add(conInOutType.Memo, Type.GetType("System.String"));
foreach (clsInOutTypeEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conInOutType.InOutTypeId] = objInFor[conInOutType.InOutTypeId];
objDR[conInOutType.InOutTypeName] = objInFor[conInOutType.InOutTypeName];
objDR[conInOutType.InOutTypeENName] = objInFor[conInOutType.InOutTypeENName];
objDR[conInOutType.Memo] = objInFor[conInOutType.Memo];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4InOutType : clsCommFun4BL
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsInOutTypeWApi.ReFreshThisCache();
}
}
