...
{
if (strRequirementTypeId == "") return null;
...
if (clsCMRequirementTypeEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
...
{
//Columns
foreach (string strAttrName in clsCMRequirementTypeEN._AttributeName)
{
