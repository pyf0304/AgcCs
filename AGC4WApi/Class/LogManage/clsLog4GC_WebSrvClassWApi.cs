 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsLog4GC_WebSrvClassWApi
 表名:Log4GC_WebSrvClass(00050370)
 * 版本:2025.08.02.1(服务器:PYF-THINKPAD)
 日期:2025/08/09 21:40:57
 生成者:pyf
 生成服务器IP:
 工程名称:AGC(0005)
...
/// 静态类
/// </summary>
public static class  clsLog4GC_WebSrvClassWApi_Static
{
...
try
{
objLog4GC_WebSrvClassEN.sfUpdFldSetStr = objLog4GC_WebSrvClassEN.getsfUpdFldSetStr();
clsLog4GC_WebSrvClassWApi.CheckPropertyNew(objLog4GC_WebSrvClassEN); 
bool bolResult = clsLog4GC_WebSrvClassWApi.UpdateRecord(objLog4GC_WebSrvClassEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsLog4GC_WebSrvClassWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsLog4GC_WebSrvClassEN objLog4GC_WebSrvClassEN)
{
//检测记录是否存在
...
public static bool AddNewRecord(this clsLog4GC_WebSrvClassEN objLog4GC_WebSrvClassEN)
{
try
{
clsLog4GC_WebSrvClassWApi.CheckPropertyNew(objLog4GC_WebSrvClassEN); 
bool bolResult = clsLog4GC_WebSrvClassWApi.AddNewRecord(objLog4GC_WebSrvClassEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsLog4GC_WebSrvClassWApi.ReFreshCache();
return bolResult;
}
...
{
clsLog4GC_WebSrvClassWApi.CheckPropertyNew(objLog4GC_WebSrvClassEN); 
bool bolResult = clsLog4GC_WebSrvClassWApi.UpdateWithCondition(objLog4GC_WebSrvClassEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsLog4GC_WebSrvClassWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsLog4GC_WebSrvClassWApi
{
private static readonly string mstrApiControllerName = "Log4GC_WebSrvClassApi";
...
public static clsCommFun4BL objCommFun4WApi = null;
 ...
 public clsLog4GC_WebSrvClassWApi()
 {
 }
...
{
if (!Object.Equals(null, objLog4GC_WebSrvClassEN.UserId) && GetStrLen(objLog4GC_WebSrvClassEN.UserId) > 18)
{
 throw new Exception("字段[用户Id]的长度不能超过18!");
}
if (!Object.Equals(null, objLog4GC_WebSrvClassEN.WebSrvClassId) && GetStrLen(objLog4GC_WebSrvClassEN.WebSrvClassId) > 8)
{
 throw new Exception("字段[类Id]的长度不能超过8!");
}
if (!Object.Equals(null, objLog4GC_WebSrvClassEN.GeneCodeDate) && GetStrLen(objLog4GC_WebSrvClassEN.GeneCodeDate) > 20)
{
 throw new Exception("字段[生成代码日期]的长度不能超过20!");
}
if (!Object.Equals(null, objLog4GC_WebSrvClassEN.VersionGeneCode) && GetStrLen(objLog4GC_WebSrvClassEN.VersionGeneCode) > 30)
{
 throw new Exception("字段[生成代码版本]的长度不能超过30!");
}
if (!Object.Equals(null, objLog4GC_WebSrvClassEN.Memo) && GetStrLen(objLog4GC_WebSrvClassEN.Memo) > 1000)
{
...
clsLog4GC_WebSrvClassEN objLog4GC_WebSrvClassEN;
...
objLog4GC_WebSrvClassEN = JsonConvert.DeserializeObject<clsLog4GC_WebSrvClassEN>(strJson);
return objLog4GC_WebSrvClassEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsLog4GC_WebSrvClassEN GetFirstObj(string strWhereCond)
{
...
from objLog4GC_WebSrvClassEN in arrLog4GC_WebSrvClassObjLstCache
where objLog4GC_WebSrvClassEN.mId == lngmId 
select objLog4GC_WebSrvClassEN;
if (arrLog4GC_WebSrvClassObjLst_Sel.Count() == 0)
{
   clsLog4GC_WebSrvClassEN obj = clsLog4GC_WebSrvClassWApi.GetObjBymId(lngmId);
   if (obj != null)
 {
...
{
 List<clsLog4GC_WebSrvClassEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsLog4GC_WebSrvClassEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsLog4GC_WebSrvClassEN> GetObjLstByMIdLst(List<long> arrMId)
{
 List<clsLog4GC_WebSrvClassEN> arrObjLst; 
...
public static IEnumerable<clsLog4GC_WebSrvClassEN> GetObjLstByMIdLstCache(List<long> arrMId)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsLog4GC_WebSrvClassEN._CurrTabName);
List<clsLog4GC_WebSrvClassEN> arrLog4GC_WebSrvClassObjLstCache = GetObjLstCache();
IEnumerable <clsLog4GC_WebSrvClassEN> arrLog4GC_WebSrvClassObjLst_Sel =
from objLog4GC_WebSrvClassEN in arrLog4GC_WebSrvClassObjLstCache
where arrMId.Contains(objLog4GC_WebSrvClassEN.mId)
select objLog4GC_WebSrvClassEN;
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsLog4GC_WebSrvClassEN> GetObjLstByRange(stuRangePara objRangePara)
{
 List<clsLog4GC_WebSrvClassEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsLog4GC_WebSrvClassEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsLog4GC_WebSrvClassEN> arrObjLst; 
...
try
{
 clsLog4GC_WebSrvClassEN objLog4GC_WebSrvClassEN = clsLog4GC_WebSrvClassWApi.GetObjBymId(lngmId);
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelLog4GC_WebSrvClasss(List<string> arrmId)
{
string strAction = "DelLog4GC_WebSrvClasss";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrmId);
...
{
string strAction = "DelLog4GC_WebSrvClasssByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsLog4GC_WebSrvClassEN objLog4GC_WebSrvClassEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJson = clsJSON.GetJsonFromObj<clsLog4GC_WebSrvClassEN>(objLog4GC_WebSrvClassEN);
if (clsPubFun4WApi.Post(mstrApiControllerName, strAction, dictParam, strJson, out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <param name = "objLog4GC_WebSrvClassEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
public static string AddNewRecordWithReturnKey(clsLog4GC_WebSrvClassEN objLog4GC_WebSrvClassEN)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsLog4GC_WebSrvClassEN objLog4GC_WebSrvClassEN)
{
if (string.IsNullOrEmpty(objLog4GC_WebSrvClassEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objLog4GC_WebSrvClassEN.mId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsLog4GC_WebSrvClassEN objLog4GC_WebSrvClassEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objLog4GC_WebSrvClassEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsLog4GC_WebSrvClassEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsLog4GC_WebSrvClassEN._AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsLog4GC_WebSrvClassEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsLog4GC_WebSrvClassEN._AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsLog4GC_WebSrvClassEN objInFor in arrObj)
{
//Rows
...
if (clsLog4GC_WebSrvClassWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsLog4GC_WebSrvClassEN._CurrTabName);
CacheHelper.Remove(strKey);
clsLog4GC_WebSrvClassWApi.objCommFun4WApi.ReFreshCache();
}
}
...
var strKey = clsLog4GC_WebSrvClassEN._CurrTabName;
List<clsLog4GC_WebSrvClassEN> arrLog4GC_WebSrvClassObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
...
public static DataTable GetDataTableByObjLst(List<clsLog4GC_WebSrvClassEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conLog4GC_WebSrvClass.mId, Type.GetType("System.Int64"));
objDT.Columns.Add(conLog4GC_WebSrvClass.UserId, Type.GetType("System.String"));
objDT.Columns.Add(conLog4GC_WebSrvClass.WebSrvClassId, Type.GetType("System.String"));
objDT.Columns.Add(conLog4GC_WebSrvClass.GeneCodeDate, Type.GetType("System.String"));
objDT.Columns.Add(conLog4GC_WebSrvClass.VersionGeneCode, Type.GetType("System.String"));
objDT.Columns.Add(conLog4GC_WebSrvClass.Memo, Type.GetType("System.String"));
foreach (clsLog4GC_WebSrvClassEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conLog4GC_WebSrvClass.mId] = objInFor[conLog4GC_WebSrvClass.mId];
objDR[conLog4GC_WebSrvClass.UserId] = objInFor[conLog4GC_WebSrvClass.UserId];
objDR[conLog4GC_WebSrvClass.WebSrvClassId] = objInFor[conLog4GC_WebSrvClass.WebSrvClassId];
objDR[conLog4GC_WebSrvClass.GeneCodeDate] = objInFor[conLog4GC_WebSrvClass.GeneCodeDate];
objDR[conLog4GC_WebSrvClass.VersionGeneCode] = objInFor[conLog4GC_WebSrvClass.VersionGeneCode];
objDR[conLog4GC_WebSrvClass.Memo] = objInFor[conLog4GC_WebSrvClass.Memo];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4Log4GC_WebSrvClass : clsCommFun4BL
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsLog4GC_WebSrvClassWApi.ReFreshThisCache();
}
}
