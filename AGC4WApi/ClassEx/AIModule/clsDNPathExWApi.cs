...
namespace AGC4WApi
{
public static class clsDnPathExWApi_Static
{
...
clsDnPathWApi.CopyTo(objDnPathENS, objDnPathENT);
 return objDnPathENT;
}
...
public static bool EditRecordEx(this clsDnPathEN objDnPathEN)
{
try
{
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsDnPathExWApi
{
private static readonly string mstrApiControllerName = "DnPathExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsDnPathEN> arrDnPathObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsDnPathEN objDnPathEN)
{
